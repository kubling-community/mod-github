...
/**
 * The WebhookWorkflowJobCompletedWorkflowJob model module.
 * @module model/WebhookWorkflowJobCompletedWorkflowJob
 * @version 1.1.4
 */
class WebhookWorkflowJobCompletedWorkflowJob {
    /**
     * Constructs a new <code>WebhookWorkflowJobCompletedWorkflowJob</code>.
     * @alias module:model/WebhookWorkflowJobCompletedWorkflowJob
     * @param checkRunUrl {String} 
     * @param completedAt {String} 
     * @param conclusion {module:model/WebhookWorkflowJobCompletedWorkflowJob.ConclusionEnum} 
    ...
    constructor(checkRunUrl, completedAt, conclusion, createdAt, headSha, htmlUrl, id, labels, name, nodeId, runAttempt, runId, runUrl, runnerGroupId, runnerGroupName, runnerId, runnerName, startedAt, status, headBranch, workflowName, steps, url) { 
        ...
        WebhookWorkflowJobCompletedWorkflowJob.initialize(this, checkRunUrl, completedAt, conclusion, createdAt, headSha, htmlUrl, id, labels, name, nodeId, runAttempt, runId, runUrl, runnerGroupId, runnerGroupName, runnerId, runnerName, startedAt, status, headBranch, workflowName, steps, url);
    }
    ...
    /**
     * Constructs a <code>WebhookWorkflowJobCompletedWorkflowJob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookWorkflowJobCompletedWorkflowJob} obj Optional instance to populate.
     * @return {module:model/WebhookWorkflowJobCompletedWorkflowJob} The populated <code>WebhookWorkflowJobCompletedWorkflowJob</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookWorkflowJobCompletedWorkflowJob();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookWorkflowJobCompletedWorkflowJob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookWorkflowJobCompletedWorkflowJob</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookWorkflowJobCompletedWorkflowJob.RequiredProperties) {
...
WebhookWorkflowJobCompletedWorkflowJob.RequiredProperties = ["check_run_url", "completed_at", "conclusion", "created_at", "head_sha", "html_url", "id", "labels", "name", "node_id", "run_attempt", "run_id", "run_url", "runner_group_id", "runner_group_name", "runner_id", "runner_name", "started_at", "status", "head_branch", "workflow_name", "steps", "url"];

/**
 * @member {String} check_run_url
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['check_run_url'] = undefined;

/**
 * @member {String} completed_at
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['completed_at'] = undefined;

/**
 * @member {module:model/WebhookWorkflowJobCompletedWorkflowJob.ConclusionEnum} conclusion
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['conclusion'] = undefined;

/**
 * The time that the job created.
 * @member {String} created_at
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['created_at'] = undefined;

/**
 * @member {String} head_sha
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['head_sha'] = undefined;

/**
 * @member {String} html_url
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['id'] = undefined;

/**
 * @member {Array.<String>} labels
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['labels'] = undefined;

/**
 * @member {String} name
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['node_id'] = undefined;

/**
 * @member {Number} run_attempt
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['run_attempt'] = undefined;

/**
 * @member {Number} run_id
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['run_id'] = undefined;

/**
 * @member {String} run_url
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['run_url'] = undefined;

/**
 * @member {Number} runner_group_id
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['runner_group_id'] = undefined;

/**
 * @member {String} runner_group_name
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['runner_group_name'] = undefined;

/**
 * @member {Number} runner_id
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['runner_id'] = undefined;

/**
 * @member {String} runner_name
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['runner_name'] = undefined;

/**
 * @member {String} started_at
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['started_at'] = undefined;

/**
 * @member {String} status
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['status'] = undefined;

/**
 * The name of the current branch.
 * @member {String} head_branch
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['head_branch'] = undefined;

/**
 * The name of the workflow.
 * @member {String} workflow_name
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['workflow_name'] = undefined;

/**
 * @member {Array.<Object>} steps
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['steps'] = undefined;

/**
 * @member {String} url
 */
WebhookWorkflowJobCompletedWorkflowJob.prototype['url'] = undefined;
 ...
 * @readonly
 */
WebhookWorkflowJobCompletedWorkflowJob['ConclusionEnum'] = {
...
export default WebhookWorkflowJobCompletedWorkflowJob;
