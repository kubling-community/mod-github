...
/**
 * The WebhookLabelDeleted model module.
 * @module model/WebhookLabelDeleted
 * @version 1.1.4
 */
class WebhookLabelDeleted {
    /**
     * Constructs a new <code>WebhookLabelDeleted</code>.
     * @alias module:model/WebhookLabelDeleted
     * @param action {module:model/WebhookLabelDeleted.ActionEnum} 
    ...
    constructor(action, label, repository, sender) { 
        ...
        WebhookLabelDeleted.initialize(this, action, label, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookLabelDeleted</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookLabelDeleted} obj Optional instance to populate.
     * @return {module:model/WebhookLabelDeleted} The populated <code>WebhookLabelDeleted</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookLabelDeleted();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookLabelDeleted</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookLabelDeleted</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookLabelDeleted.RequiredProperties) {
...
WebhookLabelDeleted.RequiredProperties = ["action", "label", "repository", "sender"];

/**
 * @member {module:model/WebhookLabelDeleted.ActionEnum} action
 */
WebhookLabelDeleted.prototype['action'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookLabelDeleted.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookLabelDeleted.prototype['installation'] = undefined;

/**
 * @member {module:model/WebhooksLabel} label
 */
WebhookLabelDeleted.prototype['label'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookLabelDeleted.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookLabelDeleted.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookLabelDeleted.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookLabelDeleted['ActionEnum'] = {
...
export default WebhookLabelDeleted;
