...
class Actor {
     ...
     */
    constructor(id, login, gravatarId, url, avatarUrl) { 
        
        Actor.initialize(this, id, login, gravatarId, url, avatarUrl);
    }
     ...
     */
    static initialize(obj, id, login, gravatarId, url, avatarUrl) { 
        obj['id'] = id;
        obj['login'] = login;
...
Actor.RequiredProperties = ["id", "login", "gravatar_id", "url", "avatar_url"];
