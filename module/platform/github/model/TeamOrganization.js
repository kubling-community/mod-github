...
/**
 * The TeamOrganization model module.
 * @module model/TeamOrganization
 * @version 1.1.4
 */
class TeamOrganization {
    /**
     * Constructs a new <code>TeamOrganization</code>.
     * Team Organization
     * @alias module:model/TeamOrganization
     * @param login {String} 
     * @param id {Number} 
     * @param nodeId {String} 
     * @param url {String} 
     ...
     */
    constructor(login, id, nodeId, url, reposUrl, eventsUrl, hooksUrl, issuesUrl, membersUrl, publicMembersUrl, avatarUrl, description, hasOrganizationProjects, hasRepositoryProjects, publicRepos, publicGists, followers, following, htmlUrl, createdAt, type, updatedAt, archivedAt) { 
        
        TeamOrganization.initialize(this, login, id, nodeId, url, reposUrl, eventsUrl, hooksUrl, issuesUrl, membersUrl, publicMembersUrl, avatarUrl, description, hasOrganizationProjects, hasRepositoryProjects, publicRepos, publicGists, followers, following, htmlUrl, createdAt, type, updatedAt, archivedAt);
    }
     ...
     */
    static initialize(obj, login, id, nodeId, url, reposUrl, eventsUrl, hooksUrl, issuesUrl, membersUrl, publicMembersUrl, avatarUrl, description, hasOrganizationProjects, hasRepositoryProjects, publicRepos, publicGists, followers, following, htmlUrl, createdAt, type, updatedAt, archivedAt) { 
        obj['login'] = login;
        obj['id'] = id;
        obj['node_id'] = nodeId;
        obj['url'] = url;
    ...
    /**
     * Constructs a <code>TeamOrganization</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TeamOrganization} obj Optional instance to populate.
     * @return {module:model/TeamOrganization} The populated <code>TeamOrganization</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TeamOrganization();
    ...
    /**
     * Validates the JSON data with respect to <code>TeamOrganization</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TeamOrganization</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TeamOrganization.RequiredProperties) {
...
TeamOrganization.RequiredProperties = ["login", "id", "node_id", "url", "repos_url", "events_url", "hooks_url", "issues_url", "members_url", "public_members_url", "avatar_url", "description", "has_organization_projects", "has_repository_projects", "public_repos", "public_gists", "followers", "following", "html_url", "created_at", "type", "updated_at", "archived_at"];

/**
 * @member {String} login
 */
TeamOrganization.prototype['login'] = undefined;

/**
 * @member {Number} id
 */
TeamOrganization.prototype['id'] = undefined;

/**
 * @member {String} node_id
 */
TeamOrganization.prototype['node_id'] = undefined;

/**
 * @member {String} url
 */
TeamOrganization.prototype['url'] = undefined;

/**
 * @member {String} repos_url
 */
TeamOrganization.prototype['repos_url'] = undefined;

/**
 * @member {String} events_url
 */
TeamOrganization.prototype['events_url'] = undefined;

/**
 * @member {String} hooks_url
 */
TeamOrganization.prototype['hooks_url'] = undefined;

/**
 * @member {String} issues_url
 */
TeamOrganization.prototype['issues_url'] = undefined;

/**
 * @member {String} members_url
 */
TeamOrganization.prototype['members_url'] = undefined;

/**
 * @member {String} public_members_url
 */
TeamOrganization.prototype['public_members_url'] = undefined;

/**
 * @member {String} avatar_url
 */
TeamOrganization.prototype['avatar_url'] = undefined;

/**
 * @member {String} description
 */
TeamOrganization.prototype['description'] = undefined;

/**
 * @member {String} name
 */
TeamOrganization.prototype['name'] = undefined;

/**
 * @member {String} company
 */
TeamOrganization.prototype['company'] = undefined;

/**
 * @member {String} blog
 */
TeamOrganization.prototype['blog'] = undefined;

/**
 * @member {String} location
 */
TeamOrganization.prototype['location'] = undefined;

/**
 * @member {String} email
 */
TeamOrganization.prototype['email'] = undefined;

/**
 * @member {String} twitter_username
 */
TeamOrganization.prototype['twitter_username'] = undefined;

/**
 * @member {Boolean} is_verified
 */
TeamOrganization.prototype['is_verified'] = undefined;

/**
 * @member {Boolean} has_organization_projects
 */
TeamOrganization.prototype['has_organization_projects'] = undefined;

/**
 * @member {Boolean} has_repository_projects
 */
TeamOrganization.prototype['has_repository_projects'] = undefined;

/**
 * @member {Number} public_repos
 */
TeamOrganization.prototype['public_repos'] = undefined;

/**
 * @member {Number} public_gists
 */
TeamOrganization.prototype['public_gists'] = undefined;

/**
 * @member {Number} followers
 */
TeamOrganization.prototype['followers'] = undefined;

/**
 * @member {Number} following
 */
TeamOrganization.prototype['following'] = undefined;

/**
 * @member {String} html_url
 */
TeamOrganization.prototype['html_url'] = undefined;

/**
 * @member {Date} created_at
 */
TeamOrganization.prototype['created_at'] = undefined;

/**
 * @member {String} type
 */
TeamOrganization.prototype['type'] = undefined;

/**
 * @member {Number} total_private_repos
 */
TeamOrganization.prototype['total_private_repos'] = undefined;

/**
 * @member {Number} owned_private_repos
 */
TeamOrganization.prototype['owned_private_repos'] = undefined;

/**
 * @member {Number} private_gists
 */
TeamOrganization.prototype['private_gists'] = undefined;

/**
 * @member {Number} disk_usage
 */
TeamOrganization.prototype['disk_usage'] = undefined;

/**
 * @member {Number} collaborators
 */
TeamOrganization.prototype['collaborators'] = undefined;

/**
 * @member {String} billing_email
 */
TeamOrganization.prototype['billing_email'] = undefined;

/**
 * @member {module:model/OrganizationFullPlan} plan
 */
TeamOrganization.prototype['plan'] = undefined;

/**
 * @member {String} default_repository_permission
 */
TeamOrganization.prototype['default_repository_permission'] = undefined;

/**
 * @member {Boolean} members_can_create_repositories
 */
TeamOrganization.prototype['members_can_create_repositories'] = undefined;

/**
 * @member {Boolean} two_factor_requirement_enabled
 */
TeamOrganization.prototype['two_factor_requirement_enabled'] = undefined;

/**
 * @member {String} members_allowed_repository_creation_type
 */
TeamOrganization.prototype['members_allowed_repository_creation_type'] = undefined;

/**
 * @member {Boolean} members_can_create_public_repositories
 */
TeamOrganization.prototype['members_can_create_public_repositories'] = undefined;

/**
 * @member {Boolean} members_can_create_private_repositories
 */
TeamOrganization.prototype['members_can_create_private_repositories'] = undefined;

/**
 * @member {Boolean} members_can_create_internal_repositories
 */
TeamOrganization.prototype['members_can_create_internal_repositories'] = undefined;

/**
 * @member {Boolean} members_can_create_pages
 */
TeamOrganization.prototype['members_can_create_pages'] = undefined;

/**
 * @member {Boolean} members_can_create_public_pages
 */
TeamOrganization.prototype['members_can_create_public_pages'] = undefined;

/**
 * @member {Boolean} members_can_create_private_pages
 */
TeamOrganization.prototype['members_can_create_private_pages'] = undefined;

/**
 * @member {Boolean} members_can_fork_private_repositories
 */
TeamOrganization.prototype['members_can_fork_private_repositories'] = undefined;

/**
 * @member {Boolean} web_commit_signoff_required
 */
TeamOrganization.prototype['web_commit_signoff_required'] = undefined;

/**
 * @member {Date} updated_at
 */
TeamOrganization.prototype['updated_at'] = undefined;

/**
 * @member {Date} archived_at
 */
TeamOrganization.prototype['archived_at'] = undefined;
