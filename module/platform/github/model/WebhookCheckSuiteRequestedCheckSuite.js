...
/**
 * The WebhookCheckSuiteRequestedCheckSuite model module.
 * @module model/WebhookCheckSuiteRequestedCheckSuite
 * @version 1.1.4
 */
class WebhookCheckSuiteRequestedCheckSuite {
    /**
     * Constructs a new <code>WebhookCheckSuiteRequestedCheckSuite</code>.
     * The [check_suite](https://docs.github.com/rest/checks/suites#get-a-check-suite).
     * @alias module:model/WebhookCheckSuiteRequestedCheckSuite
     * @param after {String} 
     * @param app {module:model/App3} 
     * @param before {String} 
     * @param checkRunsUrl {String} 
     * @param conclusion {module:model/WebhookCheckSuiteRequestedCheckSuite.ConclusionEnum} The summary conclusion for all check runs that are part of the check suite. This value will be `null` until the check run has completed.
     ...
     * @param status {module:model/WebhookCheckSuiteRequestedCheckSuite.StatusEnum} The summary status for all check runs that are part of the check suite. Can be `requested`, `in_progress`, or `completed`.
    ...
    constructor(after, app, before, checkRunsUrl, conclusion, createdAt, headBranch, headCommit, headSha, id, latestCheckRunsCount, nodeId, pullRequests, status, updatedAt, url) { 
        ...
        WebhookCheckSuiteRequestedCheckSuite.initialize(this, after, app, before, checkRunsUrl, conclusion, createdAt, headBranch, headCommit, headSha, id, latestCheckRunsCount, nodeId, pullRequests, status, updatedAt, url);
    }
    ...
    /**
     * Constructs a <code>WebhookCheckSuiteRequestedCheckSuite</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookCheckSuiteRequestedCheckSuite} obj Optional instance to populate.
     * @return {module:model/WebhookCheckSuiteRequestedCheckSuite} The populated <code>WebhookCheckSuiteRequestedCheckSuite</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookCheckSuiteRequestedCheckSuite();

            if (data.hasOwnProperty('after')) {
                obj['after'] = ApiClient.convertToType(data['after'], 'String');
            }
            if (data.hasOwnProperty('app')) {
                obj['app'] = App3.constructFromObject(data['app']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookCheckSuiteRequestedCheckSuite</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookCheckSuiteRequestedCheckSuite</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookCheckSuiteRequestedCheckSuite.RequiredProperties) {
...
WebhookCheckSuiteRequestedCheckSuite.RequiredProperties = ["after", "app", "before", "check_runs_url", "conclusion", "created_at", "head_branch", "head_commit", "head_sha", "id", "latest_check_runs_count", "node_id", "pull_requests", "status", "updated_at", "url"];

/**
 * @member {String} after
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['after'] = undefined;

/**
 * @member {module:model/App3} app
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['app'] = undefined;

/**
 * @member {String} before
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['before'] = undefined;

/**
 * @member {String} check_runs_url
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['check_runs_url'] = undefined;
 ...
 * @member {module:model/WebhookCheckSuiteRequestedCheckSuite.ConclusionEnum} conclusion
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['conclusion'] = undefined;

/**
 * @member {Date} created_at
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['created_at'] = undefined;

/**
 * The head branch name the changes are on.
 * @member {String} head_branch
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['head_branch'] = undefined;

/**
 * @member {module:model/SimpleCommit} head_commit
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['head_commit'] = undefined;

/**
 * The SHA of the head commit that is being checked.
 * @member {String} head_sha
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['head_sha'] = undefined;

/**
 * @member {Number} id
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['id'] = undefined;

/**
 * @member {Number} latest_check_runs_count
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['latest_check_runs_count'] = undefined;

/**
 * @member {String} node_id
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['node_id'] = undefined;

/**
 * An array of pull requests that match this check suite. A pull request matches a check suite if they have the same `head_sha` and `head_branch`. When the check suite's `head_branch` is in a forked repository it will be `null` and the `pull_requests` array will be empty.
 * @member {Array.<module:model/CheckRunPullRequest>} pull_requests
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['pull_requests'] = undefined;

/**
 * @member {Boolean} rerequestable
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['rerequestable'] = undefined;

/**
 * @member {Boolean} runs_rerequestable
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['runs_rerequestable'] = undefined;

/**
 * The summary status for all check runs that are part of the check suite. Can be `requested`, `in_progress`, or `completed`.
 * @member {module:model/WebhookCheckSuiteRequestedCheckSuite.StatusEnum} status
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['status'] = undefined;

/**
 * @member {Date} updated_at
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['updated_at'] = undefined;

/**
 * URL that points to the check suite API resource.
 * @member {String} url
 */
WebhookCheckSuiteRequestedCheckSuite.prototype['url'] = undefined;
 ...
 * @readonly
 */
WebhookCheckSuiteRequestedCheckSuite['ConclusionEnum'] = {
 ...
 * @readonly
 */
WebhookCheckSuiteRequestedCheckSuite['StatusEnum'] = {
...
export default WebhookCheckSuiteRequestedCheckSuite;
