...
class AutoMerge {
     ...
     */
    constructor(enabledBy, mergeMethod, commitTitle, commitMessage) { 
        
        AutoMerge.initialize(this, enabledBy, mergeMethod, commitTitle, commitMessage);
    }
     ...
     */
    static initialize(obj, enabledBy, mergeMethod, commitTitle, commitMessage) { 
...
AutoMerge.RequiredProperties = ["enabled_by", "merge_method", "commit_title", "commit_message"];
