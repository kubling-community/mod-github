...
import SimplePullRequest3Base from './SimplePullRequest3Base';
...
/**
 * The SimplePullRequest4 model module.
 * @module model/SimplePullRequest4
 * @version 1.1.4
 */
class SimplePullRequest4 {
    /**
     * Constructs a new <code>SimplePullRequest4</code>.
     * @alias module:model/SimplePullRequest4
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/SimplePullRequest4.ActiveLockReasonEnum} 
     * @param assignee {module:model/User} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/SimplePullRequest4.AuthorAssociationEnum} How the author is associated with the repository.
     * @param autoMerge {module:model/PullRequestAutoMerge1} 
     * @param base {module:model/SimplePullRequest3Base} 
     * @param body {String} 
     ...
     * @param draft {Boolean} 
     * @param head {module:model/SimplePullRequest3Base} 
     ...
     * @param state {module:model/SimplePullRequest4.StateEnum} 
    ...
    /**
     * Constructs a <code>SimplePullRequest4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimplePullRequest4} obj Optional instance to populate.
     * @return {module:model/SimplePullRequest4} The populated <code>SimplePullRequest4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimplePullRequest4();
            ...
            if (data.hasOwnProperty('base')) {
                obj['base'] = SimplePullRequest3Base.constructFromObject(data['base']);
            }
            ...
            if (data.hasOwnProperty('head')) {
                obj['head'] = SimplePullRequest3Base.constructFromObject(data['head']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SimplePullRequest4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimplePullRequest4</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SimplePullRequest4.RequiredProperties) {
        ...
        if (data['base']) { // data not null
          SimplePullRequest3Base.validateJSON(data['base']);
        }
        // ensure the json data is a string
        ...
        if (data['head']) { // data not null
          SimplePullRequest3Base.validateJSON(data['head']);
        }
        // ensure the json data is a string
 ...
 */
SimplePullRequest4.prototype['_links'] = undefined;

/**
 * @member {module:model/SimplePullRequest4.ActiveLockReasonEnum} active_lock_reason
 */
SimplePullRequest4.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User} assignee
 */
SimplePullRequest4.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
SimplePullRequest4.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/SimplePullRequest4.AuthorAssociationEnum} author_association
 */
SimplePullRequest4.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge1} auto_merge
 */
SimplePullRequest4.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/SimplePullRequest3Base} base
 */
SimplePullRequest4.prototype['base'] = undefined;

/**
 * @member {String} body
 */
SimplePullRequest4.prototype['body'] = undefined;

/**
 * @member {String} closed_at
 */
SimplePullRequest4.prototype['closed_at'] = undefined;

/**
 * @member {String} comments_url
 */
SimplePullRequest4.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
SimplePullRequest4.prototype['commits_url'] = undefined;

/**
 * @member {String} created_at
 */
SimplePullRequest4.prototype['created_at'] = undefined;

/**
 * @member {String} diff_url
 */
SimplePullRequest4.prototype['diff_url'] = undefined;

/**
 * @member {Boolean} draft
 */
SimplePullRequest4.prototype['draft'] = undefined;

/**
 * @member {module:model/SimplePullRequest3Base} head
 */
SimplePullRequest4.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
SimplePullRequest4.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
SimplePullRequest4.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
SimplePullRequest4.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
SimplePullRequest4.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
SimplePullRequest4.prototype['locked'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
SimplePullRequest4.prototype['merge_commit_sha'] = undefined;

/**
 * @member {String} merged_at
 */
SimplePullRequest4.prototype['merged_at'] = undefined;

/**
 * @member {module:model/Milestone1} milestone
 */
SimplePullRequest4.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
SimplePullRequest4.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
SimplePullRequest4.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
SimplePullRequest4.prototype['patch_url'] = undefined;

/**
 * @member {Array.<module:model/WebhooksPullRequest5RequestedReviewersInner>} requested_reviewers
 */
SimplePullRequest4.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
SimplePullRequest4.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
SimplePullRequest4.prototype['review_comment_url'] = undefined;

/**
 * @member {String} review_comments_url
 */
SimplePullRequest4.prototype['review_comments_url'] = undefined;

/**
 * @member {module:model/SimplePullRequest4.StateEnum} state
 */
SimplePullRequest4.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
SimplePullRequest4.prototype['statuses_url'] = undefined;

/**
 * @member {String} title
 */
SimplePullRequest4.prototype['title'] = undefined;

/**
 * @member {String} updated_at
 */
SimplePullRequest4.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
SimplePullRequest4.prototype['url'] = undefined;

/**
 * @member {module:model/User} user
 */
SimplePullRequest4.prototype['user'] = undefined;
 ...
 * @readonly
 */
SimplePullRequest4['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
SimplePullRequest4['AuthorAssociationEnum'] = {
...
export default SimplePullRequest4;
