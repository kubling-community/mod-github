...
class ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions {
     ...
     */
    constructor(url, usersUrl, teamsUrl, users, teams) { 
        
        ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions.initialize(this, url, usersUrl, teamsUrl, users, teams);
    }
     ...
     */
    static initialize(obj, url, usersUrl, teamsUrl, users, teams) { 
        obj['url'] = url;
...
ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions.RequiredProperties = ["url", "users_url", "teams_url", "users", "teams"];
