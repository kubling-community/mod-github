...
class ContentTree {
    ...
    constructor(type, size, name, path, sha, url, gitUrl, htmlUrl, downloadUrl, links) { 
        ...
        ContentTree.initialize(this, type, size, name, path, sha, url, gitUrl, htmlUrl, downloadUrl, links);
    }
...
ContentTree.RequiredProperties = ["type", "size", "name", "path", "sha", "url", "git_url", "html_url", "download_url", "_links"];
