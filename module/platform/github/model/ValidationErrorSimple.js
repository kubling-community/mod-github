...
class ValidationErrorSimple {
     ...
     */
    constructor(message, documentationUrl) { 
        
        ValidationErrorSimple.initialize(this, message, documentationUrl);
    }
     ...
     */
    static initialize(obj, message, documentationUrl) { 
        obj['message'] = message;
...
ValidationErrorSimple.RequiredProperties = ["message", "documentation_url"];
