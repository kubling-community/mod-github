...
/**
 * The RepositoryRuleDetailedOneOf15 model module.
 * @module model/RepositoryRuleDetailedOneOf15
 * @version 1.1.4
 */
class RepositoryRuleDetailedOneOf15 {
    /**
     * Constructs a new <code>RepositoryRuleDetailedOneOf15</code>.
     * @alias module:model/RepositoryRuleDetailedOneOf15
     * @implements module:model/RepositoryRuleCodeScanning
     * @implements module:model/RepositoryRuleRulesetInfo
     * @param type {module:model/RepositoryRuleDetailedOneOf15.TypeEnum} 
     */
    constructor(type) { 
        RepositoryRuleCodeScanning.initialize(this, type);RepositoryRuleRulesetInfo.initialize(this);
        RepositoryRuleDetailedOneOf15.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>RepositoryRuleDetailedOneOf15</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryRuleDetailedOneOf15} obj Optional instance to populate.
     * @return {module:model/RepositoryRuleDetailedOneOf15} The populated <code>RepositoryRuleDetailedOneOf15</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryRuleDetailedOneOf15();
            RepositoryRuleCodeScanning.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryRuleDetailedOneOf15</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryRuleDetailedOneOf15</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RepositoryRuleDetailedOneOf15.RequiredProperties) {
...
RepositoryRuleDetailedOneOf15.RequiredProperties = ["type"];

/**
 * @member {module:model/RepositoryRuleDetailedOneOf15.TypeEnum} type
 */
RepositoryRuleDetailedOneOf15.prototype['type'] = undefined;

/**
 * @member {module:model/RepositoryRuleCodeScanningParameters} parameters
 */
RepositoryRuleDetailedOneOf15.prototype['parameters'] = undefined;

/**
 * The type of source for the ruleset that includes this rule.
 * @member {module:model/RepositoryRuleDetailedOneOf15.RulesetSourceTypeEnum} ruleset_source_type
 */
RepositoryRuleDetailedOneOf15.prototype['ruleset_source_type'] = undefined;

/**
 * The name of the source of the ruleset that includes this rule.
 * @member {String} ruleset_source
 */
RepositoryRuleDetailedOneOf15.prototype['ruleset_source'] = undefined;

/**
 * The ID of the ruleset that includes this rule.
 * @member {Number} ruleset_id
 */
RepositoryRuleDetailedOneOf15.prototype['ruleset_id'] = undefined;


// Implement RepositoryRuleCodeScanning interface:
/**
 ...
 * @readonly
 */
RepositoryRuleDetailedOneOf15['TypeEnum'] = {
 ...
 * @readonly
 */
RepositoryRuleDetailedOneOf15['RulesetSourceTypeEnum'] = {
...
export default RepositoryRuleDetailedOneOf15;
