...
class IssueEventDismissedReview {
    ...
    constructor(state, reviewId, dismissalMessage) { 
        ...
        IssueEventDismissedReview.initialize(this, state, reviewId, dismissalMessage);
    }
...
IssueEventDismissedReview.RequiredProperties = ["state", "review_id", "dismissal_message"];
