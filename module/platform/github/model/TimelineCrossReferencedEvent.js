...
class TimelineCrossReferencedEvent {
     ...
     */
    constructor(event, createdAt, updatedAt, source) { 
        
        TimelineCrossReferencedEvent.initialize(this, event, createdAt, updatedAt, source);
    }
     ...
     */
    static initialize(obj, event, createdAt, updatedAt, source) { 
        obj['event'] = event;
...
TimelineCrossReferencedEvent.RequiredProperties = ["event", "created_at", "updated_at", "source"];
