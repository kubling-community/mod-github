...
class PullRequestHeadRepoLicense {
     ...
     * @param nodeId {String} 
     */
    constructor(key, name, url, spdxId, nodeId) { 
        
        PullRequestHeadRepoLicense.initialize(this, key, name, url, spdxId, nodeId);
    }
     ...
     */
    static initialize(obj, key, name, url, spdxId, nodeId) { 
        obj['key'] = key;
        obj['name'] = name;
        obj['url'] = url;
        obj['spdx_id'] = spdxId;
...
PullRequestHeadRepoLicense.RequiredProperties = ["key", "name", "url", "spdx_id", "node_id"];
