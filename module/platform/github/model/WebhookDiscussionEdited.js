...
import WebhookDiscussionEditedChanges from './WebhookDiscussionEditedChanges';

/**
 * The WebhookDiscussionEdited model module.
 * @module model/WebhookDiscussionEdited
 * @version 1.1.4
 */
class WebhookDiscussionEdited {
    /**
     * Constructs a new <code>WebhookDiscussionEdited</code>.
     * @alias module:model/WebhookDiscussionEdited
     * @param action {module:model/WebhookDiscussionEdited.ActionEnum} 
    ...
    constructor(action, discussion, repository, sender) { 
        ...
        WebhookDiscussionEdited.initialize(this, action, discussion, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookDiscussionEdited</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookDiscussionEdited} obj Optional instance to populate.
     * @return {module:model/WebhookDiscussionEdited} The populated <code>WebhookDiscussionEdited</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookDiscussionEdited();

            if (data.hasOwnProperty('action')) {
                obj['action'] = ApiClient.convertToType(data['action'], 'String');
            }
            if (data.hasOwnProperty('changes')) {
                obj['changes'] = WebhookDiscussionEditedChanges.constructFromObject(data['changes']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDiscussionEdited</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDiscussionEdited</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookDiscussionEdited.RequiredProperties) {
        ...
        if (data['changes']) { // data not null
          WebhookDiscussionEditedChanges.validateJSON(data['changes']);
        }
...
WebhookDiscussionEdited.RequiredProperties = ["action", "discussion", "repository", "sender"];

/**
 * @member {module:model/WebhookDiscussionEdited.ActionEnum} action
 */
WebhookDiscussionEdited.prototype['action'] = undefined;

/**
 * @member {module:model/WebhookDiscussionEditedChanges} changes
 */
WebhookDiscussionEdited.prototype['changes'] = undefined;

/**
 * @member {module:model/Discussion} discussion
 */
WebhookDiscussionEdited.prototype['discussion'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookDiscussionEdited.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookDiscussionEdited.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookDiscussionEdited.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookDiscussionEdited.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookDiscussionEdited.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookDiscussionEdited['ActionEnum'] = {
...
export default WebhookDiscussionEdited;
