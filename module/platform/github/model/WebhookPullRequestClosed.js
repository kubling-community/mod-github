...
/**
 * The WebhookPullRequestClosed model module.
 * @module model/WebhookPullRequestClosed
 * @version 1.1.4
 */
class WebhookPullRequestClosed {
    /**
     * Constructs a new <code>WebhookPullRequestClosed</code>.
     * @alias module:model/WebhookPullRequestClosed
     * @param action {module:model/WebhookPullRequestClosed.ActionEnum} 
    ...
    constructor(action, number, pullRequest, repository, sender) { 
        ...
        WebhookPullRequestClosed.initialize(this, action, number, pullRequest, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookPullRequestClosed</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookPullRequestClosed} obj Optional instance to populate.
     * @return {module:model/WebhookPullRequestClosed} The populated <code>WebhookPullRequestClosed</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookPullRequestClosed();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookPullRequestClosed</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookPullRequestClosed</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookPullRequestClosed.RequiredProperties) {
...
WebhookPullRequestClosed.RequiredProperties = ["action", "number", "pull_request", "repository", "sender"];

/**
 * @member {module:model/WebhookPullRequestClosed.ActionEnum} action
 */
WebhookPullRequestClosed.prototype['action'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookPullRequestClosed.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookPullRequestClosed.prototype['installation'] = undefined;

/**
 * The pull request number.
 * @member {Number} number
 */
WebhookPullRequestClosed.prototype['number'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookPullRequestClosed.prototype['organization'] = undefined;

/**
 * @member {module:model/PullRequestWebhook} pull_request
 */
WebhookPullRequestClosed.prototype['pull_request'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookPullRequestClosed.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookPullRequestClosed.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookPullRequestClosed['ActionEnum'] = {
...
export default WebhookPullRequestClosed;
