...
/**
 * The WebhookPackagePublishedPackagePackageVersionNpmMetadata model module.
 * @module model/WebhookPackagePublishedPackagePackageVersionNpmMetadata
 * @version 1.1.4
 */
class WebhookPackagePublishedPackagePackageVersionNpmMetadata {
    /**
     * Constructs a new <code>WebhookPackagePublishedPackagePackageVersionNpmMetadata</code>.
     * @alias module:model/WebhookPackagePublishedPackagePackageVersionNpmMetadata
     */
    constructor() { 
        
        WebhookPackagePublishedPackagePackageVersionNpmMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhookPackagePublishedPackagePackageVersionNpmMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookPackagePublishedPackagePackageVersionNpmMetadata} obj Optional instance to populate.
     * @return {module:model/WebhookPackagePublishedPackagePackageVersionNpmMetadata} The populated <code>WebhookPackagePublishedPackagePackageVersionNpmMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookPackagePublishedPackagePackageVersionNpmMetadata();
            ...
            if (data.hasOwnProperty('bugs')) {
                obj['bugs'] = ApiClient.convertToType(data['bugs'], Object);
            }
            ...
            if (data.hasOwnProperty('dist')) {
                obj['dist'] = ApiClient.convertToType(data['dist'], Object);
            }
            ...
            if (data.hasOwnProperty('repository')) {
                obj['repository'] = ApiClient.convertToType(data['repository'], Object);
            }
            ...
            if (data.hasOwnProperty('maintainers')) {
                obj['maintainers'] = ApiClient.convertToType(data['maintainers'], [Object]);
            }
            ...
            if (data.hasOwnProperty('directories')) {
                obj['directories'] = ApiClient.convertToType(data['directories'], Object);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookPackagePublishedPackagePackageVersionNpmMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookPackagePublishedPackagePackageVersionNpmMetadata</code>.
     */
 ...
 * @member {String} name
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['name'] = undefined;

/**
 * @member {String} version
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['version'] = undefined;

/**
 * @member {String} npm_user
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['npm_user'] = undefined;

/**
 * @member {Object} author
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['author'] = undefined;

/**
 * @member {Object} bugs
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['bugs'] = undefined;

/**
 * @member {Object} dependencies
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['dependencies'] = undefined;

/**
 * @member {Object} dev_dependencies
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['dev_dependencies'] = undefined;

/**
 * @member {Object} peer_dependencies
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['peer_dependencies'] = undefined;

/**
 * @member {Object} optional_dependencies
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['optional_dependencies'] = undefined;

/**
 * @member {String} description
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['description'] = undefined;

/**
 * @member {Object} dist
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['dist'] = undefined;

/**
 * @member {String} git_head
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['git_head'] = undefined;

/**
 * @member {String} homepage
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['homepage'] = undefined;

/**
 * @member {String} license
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['license'] = undefined;

/**
 * @member {String} main
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['main'] = undefined;

/**
 * @member {Object} repository
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['repository'] = undefined;

/**
 * @member {Object} scripts
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['scripts'] = undefined;

/**
 * @member {String} id
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['id'] = undefined;

/**
 * @member {String} node_version
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['node_version'] = undefined;

/**
 * @member {String} npm_version
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['npm_version'] = undefined;

/**
 * @member {Boolean} has_shrinkwrap
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['has_shrinkwrap'] = undefined;

/**
 * @member {Array.<Object>} maintainers
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['maintainers'] = undefined;

/**
 * @member {Array.<Object>} contributors
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['contributors'] = undefined;

/**
 * @member {Object} engines
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['engines'] = undefined;

/**
 * @member {Array.<String>} keywords
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['keywords'] = undefined;

/**
 * @member {Array.<String>} files
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['files'] = undefined;

/**
 * @member {Object} bin
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['bin'] = undefined;

/**
 * @member {Object} man
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['man'] = undefined;

/**
 * @member {Object} directories
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['directories'] = undefined;

/**
 * @member {Array.<String>} os
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['os'] = undefined;

/**
 * @member {Array.<String>} cpu
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['cpu'] = undefined;

/**
 * @member {String} readme
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['readme'] = undefined;

/**
 * @member {String} installation_command
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['installation_command'] = undefined;

/**
 * @member {Number} release_id
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['release_id'] = undefined;

/**
 * @member {String} commit_oid
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['commit_oid'] = undefined;

/**
 * @member {Boolean} published_via_actions
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['published_via_actions'] = undefined;

/**
 * @member {Number} deleted_by_id
 */
WebhookPackagePublishedPackagePackageVersionNpmMetadata.prototype['deleted_by_id'] = undefined;
...
export default WebhookPackagePublishedPackagePackageVersionNpmMetadata;
