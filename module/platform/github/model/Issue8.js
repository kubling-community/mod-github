...
/**
 * The Issue8 model module.
 * @module model/Issue8
 * @version 1.1.4
 */
class Issue8 {
    /**
     * Constructs a new <code>Issue8</code>.
     * The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
     * @alias module:model/Issue8
     * @param activeLockReason {module:model/Issue8.ActiveLockReasonEnum} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/Issue8.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param state {module:model/Issue8.StateEnum} State of the issue; either 'open' or 'closed'
    ...
    constructor(activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, state, title, updatedAt, url, user) { 
        ...
        Issue8.initialize(this, activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, state, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>Issue8</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Issue8} obj Optional instance to populate.
     * @return {module:model/Issue8} The populated <code>Issue8</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('performed_via_github_app')) {
                obj['performed_via_github_app'] = App16.constructFromObject(data['performed_via_github_app']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Issue8</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Issue8</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Issue8.RequiredProperties) {
        ...
        if (data['performed_via_github_app']) { // data not null
          App16.validateJSON(data['performed_via_github_app']);
        }
...
Issue8.RequiredProperties = ["active_lock_reason", "assignees", "author_association", "body", "closed_at", "comments", "comments_url", "created_at", "events_url", "html_url", "id", "labels_url", "milestone", "node_id", "number", "reactions", "repository_url", "state", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/Issue8.ActiveLockReasonEnum} active_lock_reason
 */
Issue8.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User} assignee
 */
Issue8.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User1>} assignees
 */
Issue8.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/Issue8.AuthorAssociationEnum} author_association
 */
Issue8.prototype['author_association'] = undefined;

/**
 * Contents of the issue
 * @member {String} body
 */
Issue8.prototype['body'] = undefined;

/**
 * @member {Date} closed_at
 */
Issue8.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
Issue8.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
Issue8.prototype['comments_url'] = undefined;

/**
 * @member {Date} created_at
 */
Issue8.prototype['created_at'] = undefined;

/**
 * @member {Boolean} draft
 */
Issue8.prototype['draft'] = undefined;

/**
 * @member {String} events_url
 */
Issue8.prototype['events_url'] = undefined;

/**
 * @member {String} html_url
 */
Issue8.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
Issue8.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label1>} labels
 */
Issue8.prototype['labels'] = undefined;

/**
 * @member {String} labels_url
 */
Issue8.prototype['labels_url'] = undefined;

/**
 * @member {Boolean} locked
 */
Issue8.prototype['locked'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
Issue8.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
Issue8.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
Issue8.prototype['number'] = undefined;

/**
 * @member {module:model/App16} performed_via_github_app
 */
Issue8.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/WebhooksIssuePullRequest} pull_request
 */
Issue8.prototype['pull_request'] = undefined;

/**
 * @member {module:model/Reactions} reactions
 */
Issue8.prototype['reactions'] = undefined;

/**
 * @member {String} repository_url
 */
Issue8.prototype['repository_url'] = undefined;

/**
 * State of the issue; either 'open' or 'closed'
 * @member {module:model/Issue8.StateEnum} state
 */
Issue8.prototype['state'] = undefined;

/**
 * @member {String} state_reason
 */
Issue8.prototype['state_reason'] = undefined;

/**
 * @member {String} timeline_url
 */
Issue8.prototype['timeline_url'] = undefined;

/**
 * Title of the issue
 * @member {String} title
 */
Issue8.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
Issue8.prototype['updated_at'] = undefined;

/**
 * URL for the issue
 * @member {String} url
 */
Issue8.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
Issue8.prototype['user'] = undefined;
