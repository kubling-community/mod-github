...
class Project {
     ...
     */
    constructor(ownerUrl, url, htmlUrl, columnsUrl, id, nodeId, name, body, number, state, creator, createdAt, updatedAt) { 
        
        Project.initialize(this, ownerUrl, url, htmlUrl, columnsUrl, id, nodeId, name, body, number, state, creator, createdAt, updatedAt);
    }
     ...
     */
    static initialize(obj, ownerUrl, url, htmlUrl, columnsUrl, id, nodeId, name, body, number, state, creator, createdAt, updatedAt) { 
...
Project.RequiredProperties = ["owner_url", "url", "html_url", "columns_url", "id", "node_id", "name", "body", "number", "state", "creator", "created_at", "updated_at"];
