...
/**
 * The DeploymentWorkflowRun1 model module.
 * @module model/DeploymentWorkflowRun1
 * @version 1.1.4
 */
class DeploymentWorkflowRun1 {
    /**
     * Constructs a new <code>DeploymentWorkflowRun1</code>.
     * @alias module:model/DeploymentWorkflowRun1
     * @param actor {module:model/User} 
     * @param checkSuiteId {Number} 
     * @param checkSuiteNodeId {String} 
     * @param conclusion {module:model/DeploymentWorkflowRun1.ConclusionEnum} 
     ...
     * @param status {module:model/DeploymentWorkflowRun1.StatusEnum} 
    ...
    constructor(actor, checkSuiteId, checkSuiteNodeId, conclusion, createdAt, displayTitle, event, headBranch, headSha, htmlUrl, id, name, nodeId, path, pullRequests, runAttempt, runNumber, runStartedAt, status, triggeringActor, updatedAt, url, workflowId) { 
        ...
        DeploymentWorkflowRun1.initialize(this, actor, checkSuiteId, checkSuiteNodeId, conclusion, createdAt, displayTitle, event, headBranch, headSha, htmlUrl, id, name, nodeId, path, pullRequests, runAttempt, runNumber, runStartedAt, status, triggeringActor, updatedAt, url, workflowId);
    }
    ...
    /**
     * Constructs a <code>DeploymentWorkflowRun1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeploymentWorkflowRun1} obj Optional instance to populate.
     * @return {module:model/DeploymentWorkflowRun1} The populated <code>DeploymentWorkflowRun1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeploymentWorkflowRun1();
    ...
    /**
     * Validates the JSON data with respect to <code>DeploymentWorkflowRun1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeploymentWorkflowRun1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeploymentWorkflowRun1.RequiredProperties) {
...
DeploymentWorkflowRun1.RequiredProperties = ["actor", "check_suite_id", "check_suite_node_id", "conclusion", "created_at", "display_title", "event", "head_branch", "head_sha", "html_url", "id", "name", "node_id", "path", "pull_requests", "run_attempt", "run_number", "run_started_at", "status", "triggering_actor", "updated_at", "url", "workflow_id"];

/**
 * @member {module:model/User} actor
 */
DeploymentWorkflowRun1.prototype['actor'] = undefined;

/**
 * @member {String} artifacts_url
 */
DeploymentWorkflowRun1.prototype['artifacts_url'] = undefined;

/**
 * @member {String} cancel_url
 */
DeploymentWorkflowRun1.prototype['cancel_url'] = undefined;

/**
 * @member {Number} check_suite_id
 */
DeploymentWorkflowRun1.prototype['check_suite_id'] = undefined;

/**
 * @member {String} check_suite_node_id
 */
DeploymentWorkflowRun1.prototype['check_suite_node_id'] = undefined;

/**
 * @member {String} check_suite_url
 */
DeploymentWorkflowRun1.prototype['check_suite_url'] = undefined;

/**
 * @member {module:model/DeploymentWorkflowRun1.ConclusionEnum} conclusion
 */
DeploymentWorkflowRun1.prototype['conclusion'] = undefined;

/**
 * @member {Date} created_at
 */
DeploymentWorkflowRun1.prototype['created_at'] = undefined;

/**
 * @member {String} display_title
 */
DeploymentWorkflowRun1.prototype['display_title'] = undefined;

/**
 * @member {String} event
 */
DeploymentWorkflowRun1.prototype['event'] = undefined;

/**
 * @member {String} head_branch
 */
DeploymentWorkflowRun1.prototype['head_branch'] = undefined;

/**
 * @member {Object} head_commit
 */
DeploymentWorkflowRun1.prototype['head_commit'] = undefined;

/**
 * @member {module:model/DeploymentWorkflowRun1HeadRepository} head_repository
 */
DeploymentWorkflowRun1.prototype['head_repository'] = undefined;

/**
 * @member {String} head_sha
 */
DeploymentWorkflowRun1.prototype['head_sha'] = undefined;

/**
 * @member {String} html_url
 */
DeploymentWorkflowRun1.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
DeploymentWorkflowRun1.prototype['id'] = undefined;

/**
 * @member {String} jobs_url
 */
DeploymentWorkflowRun1.prototype['jobs_url'] = undefined;

/**
 * @member {String} logs_url
 */
DeploymentWorkflowRun1.prototype['logs_url'] = undefined;

/**
 * @member {String} name
 */
DeploymentWorkflowRun1.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
DeploymentWorkflowRun1.prototype['node_id'] = undefined;

/**
 * @member {String} path
 */
DeploymentWorkflowRun1.prototype['path'] = undefined;

/**
 * @member {String} previous_attempt_url
 */
DeploymentWorkflowRun1.prototype['previous_attempt_url'] = undefined;

/**
 * @member {Array.<module:model/CheckRunPullRequest>} pull_requests
 */
DeploymentWorkflowRun1.prototype['pull_requests'] = undefined;

/**
 * @member {Array.<module:model/DeploymentWorkflowRunReferencedWorkflowsInner>} referenced_workflows
 */
DeploymentWorkflowRun1.prototype['referenced_workflows'] = undefined;

/**
 * @member {module:model/DeploymentWorkflowRun1HeadRepository} repository
 */
DeploymentWorkflowRun1.prototype['repository'] = undefined;

/**
 * @member {String} rerun_url
 */
DeploymentWorkflowRun1.prototype['rerun_url'] = undefined;

/**
 * @member {Number} run_attempt
 */
DeploymentWorkflowRun1.prototype['run_attempt'] = undefined;

/**
 * @member {Number} run_number
 */
DeploymentWorkflowRun1.prototype['run_number'] = undefined;

/**
 * @member {Date} run_started_at
 */
DeploymentWorkflowRun1.prototype['run_started_at'] = undefined;

/**
 * @member {module:model/DeploymentWorkflowRun1.StatusEnum} status
 */
DeploymentWorkflowRun1.prototype['status'] = undefined;

/**
 * @member {module:model/User} triggering_actor
 */
DeploymentWorkflowRun1.prototype['triggering_actor'] = undefined;

/**
 * @member {Date} updated_at
 */
DeploymentWorkflowRun1.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
DeploymentWorkflowRun1.prototype['url'] = undefined;

/**
 * @member {Number} workflow_id
 */
DeploymentWorkflowRun1.prototype['workflow_id'] = undefined;

/**
 * @member {String} workflow_url
 */
DeploymentWorkflowRun1.prototype['workflow_url'] = undefined;
 ...
 * @readonly
 */
DeploymentWorkflowRun1['ConclusionEnum'] = {
 ...
 * @readonly
 */
DeploymentWorkflowRun1['StatusEnum'] = {
...
export default DeploymentWorkflowRun1;
