...
/**
 * The Issue3 model module.
 * @module model/Issue3
 * @version 1.1.4
 */
class Issue3 {
    /**
     * Constructs a new <code>Issue3</code>.
     * The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
     * @alias module:model/Issue3
     * @param activeLockReason {module:model/Issue3.ActiveLockReasonEnum} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/Issue3.AuthorAssociationEnum} How the author is associated with the repository.
    ...
    constructor(activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user) { 
        ...
        Issue3.initialize(this, activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>Issue3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Issue3} obj Optional instance to populate.
     * @return {module:model/Issue3} The populated <code>Issue3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('performed_via_github_app')) {
                obj['performed_via_github_app'] = App13.constructFromObject(data['performed_via_github_app']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Issue3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Issue3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Issue3.RequiredProperties) {
        ...
        if (data['performed_via_github_app']) { // data not null
          App13.validateJSON(data['performed_via_github_app']);
        }
...
Issue3.RequiredProperties = ["active_lock_reason", "assignees", "author_association", "body", "closed_at", "comments", "comments_url", "created_at", "events_url", "html_url", "id", "labels_url", "milestone", "node_id", "number", "reactions", "repository_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/Issue3.ActiveLockReasonEnum} active_lock_reason
 */
Issue3.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User1} assignee
 */
Issue3.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User1>} assignees
 */
Issue3.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/Issue3.AuthorAssociationEnum} author_association
 */
Issue3.prototype['author_association'] = undefined;

/**
 * Contents of the issue
 * @member {String} body
 */
Issue3.prototype['body'] = undefined;

/**
 * @member {Date} closed_at
 */
Issue3.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
Issue3.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
Issue3.prototype['comments_url'] = undefined;

/**
 * @member {Date} created_at
 */
Issue3.prototype['created_at'] = undefined;

/**
 * @member {Boolean} draft
 */
Issue3.prototype['draft'] = undefined;

/**
 * @member {String} events_url
 */
Issue3.prototype['events_url'] = undefined;

/**
 * @member {String} html_url
 */
Issue3.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
Issue3.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
Issue3.prototype['labels'] = undefined;

/**
 * @member {String} labels_url
 */
Issue3.prototype['labels_url'] = undefined;

/**
 * @member {Boolean} locked
 */
Issue3.prototype['locked'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
Issue3.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
Issue3.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
Issue3.prototype['number'] = undefined;

/**
 * @member {module:model/App13} performed_via_github_app
 */
Issue3.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/WebhooksIssuePullRequest} pull_request
 */
Issue3.prototype['pull_request'] = undefined;

/**
 * @member {module:model/Reactions} reactions
 */
Issue3.prototype['reactions'] = undefined;

/**
 * @member {String} repository_url
 */
Issue3.prototype['repository_url'] = undefined;

/**
 * State of the issue; either 'open' or 'closed'
 * @member {module:model/Issue3.StateEnum} state
 */
Issue3.prototype['state'] = undefined;

/**
 * @member {String} state_reason
 */
Issue3.prototype['state_reason'] = undefined;

/**
 * @member {String} timeline_url
 */
Issue3.prototype['timeline_url'] = undefined;

/**
 * Title of the issue
 * @member {String} title
 */
Issue3.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
Issue3.prototype['updated_at'] = undefined;

/**
 * URL for the issue
 * @member {String} url
 */
Issue3.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
Issue3.prototype['user'] = undefined;
