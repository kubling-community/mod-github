...
/**
 * The WebhookIssueCommentEditedIssue model module.
 * @module model/WebhookIssueCommentEditedIssue
 * @version 1.1.4
 */
class WebhookIssueCommentEditedIssue {
    /**
     * Constructs a new <code>WebhookIssueCommentEditedIssue</code>.
     * The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) the comment belongs to.
     * @alias module:model/WebhookIssueCommentEditedIssue
     ...
     * @param state {module:model/WebhookIssueCommentEditedIssue.StateEnum} State of the issue; either 'open' or 'closed'
     * @param title {String} 
    ...
    constructor(activeLockReason, assignee, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labels, labelsUrl, locked, milestone, nodeId, number, reactions, repositoryUrl, state, title, updatedAt, url, user) { 
        ...
        WebhookIssueCommentEditedIssue.initialize(this, activeLockReason, assignee, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labels, labelsUrl, locked, milestone, nodeId, number, reactions, repositoryUrl, state, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>WebhookIssueCommentEditedIssue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookIssueCommentEditedIssue} obj Optional instance to populate.
     * @return {module:model/WebhookIssueCommentEditedIssue} The populated <code>WebhookIssueCommentEditedIssue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookIssueCommentEditedIssue();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookIssueCommentEditedIssue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookIssueCommentEditedIssue</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookIssueCommentEditedIssue.RequiredProperties) {
...
WebhookIssueCommentEditedIssue.RequiredProperties = ["active_lock_reason", "assignee", "assignees", "author_association", "body", "closed_at", "comments", "comments_url", "created_at", "events_url", "html_url", "id", "labels", "labels_url", "locked", "milestone", "node_id", "number", "reactions", "repository_url", "state", "title", "updated_at", "url", "user"];

/**
 * @member {String} active_lock_reason
 */
WebhookIssueCommentEditedIssue.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User1} assignee
 */
WebhookIssueCommentEditedIssue.prototype['assignee'] = undefined;

/**
 * @member {Array.<Object>} assignees
 */
WebhookIssueCommentEditedIssue.prototype['assignees'] = undefined;

/**
 * @member {String} author_association
 */
WebhookIssueCommentEditedIssue.prototype['author_association'] = undefined;

/**
 * @member {String} body
 */
WebhookIssueCommentEditedIssue.prototype['body'] = undefined;

/**
 * @member {String} closed_at
 */
WebhookIssueCommentEditedIssue.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
WebhookIssueCommentEditedIssue.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
WebhookIssueCommentEditedIssue.prototype['comments_url'] = undefined;

/**
 * @member {String} created_at
 */
WebhookIssueCommentEditedIssue.prototype['created_at'] = undefined;

/**
 * @member {Boolean} draft
 */
WebhookIssueCommentEditedIssue.prototype['draft'] = undefined;

/**
 * @member {String} events_url
 */
WebhookIssueCommentEditedIssue.prototype['events_url'] = undefined;

/**
 * @member {String} html_url
 */
WebhookIssueCommentEditedIssue.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhookIssueCommentEditedIssue.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
WebhookIssueCommentEditedIssue.prototype['labels'] = undefined;

/**
 * @member {String} labels_url
 */
WebhookIssueCommentEditedIssue.prototype['labels_url'] = undefined;

/**
 * @member {Boolean} locked
 */
WebhookIssueCommentEditedIssue.prototype['locked'] = undefined;

/**
 * @member {Object} milestone
 */
WebhookIssueCommentEditedIssue.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
WebhookIssueCommentEditedIssue.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
WebhookIssueCommentEditedIssue.prototype['number'] = undefined;

/**
 * @member {Object} performed_via_github_app
 */
WebhookIssueCommentEditedIssue.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/WebhooksIssuePullRequest} pull_request
 */
WebhookIssueCommentEditedIssue.prototype['pull_request'] = undefined;

/**
 * @member {module:model/WebhookIssueCommentCreatedIssueAllOfReactions} reactions
 */
WebhookIssueCommentEditedIssue.prototype['reactions'] = undefined;

/**
 * @member {String} repository_url
 */
WebhookIssueCommentEditedIssue.prototype['repository_url'] = undefined;

/**
 * State of the issue; either 'open' or 'closed'
 * @member {module:model/WebhookIssueCommentEditedIssue.StateEnum} state
 */
WebhookIssueCommentEditedIssue.prototype['state'] = undefined;

/**
 * @member {String} state_reason
 */
WebhookIssueCommentEditedIssue.prototype['state_reason'] = undefined;

/**
 * @member {String} timeline_url
 */
WebhookIssueCommentEditedIssue.prototype['timeline_url'] = undefined;

/**
 * @member {String} title
 */
WebhookIssueCommentEditedIssue.prototype['title'] = undefined;

/**
 * @member {String} updated_at
 */
WebhookIssueCommentEditedIssue.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
WebhookIssueCommentEditedIssue.prototype['url'] = undefined;

/**
 * @member {module:model/WebhooksSponsorshipMaintainer} user
 */
WebhookIssueCommentEditedIssue.prototype['user'] = undefined;
 ...
 * @readonly
 */
WebhookIssueCommentEditedIssue['StateEnum'] = {
...
export default WebhookIssueCommentEditedIssue;
