...
import PullRequestAutoMerge1 from './PullRequestAutoMerge1';
...
/**
 * The PullRequest13 model module.
 * @module model/PullRequest13
 * @version 1.1.4
 */
class PullRequest13 {
    /**
     * Constructs a new <code>PullRequest13</code>.
     * @alias module:model/PullRequest13
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/PullRequest13.ActiveLockReasonEnum} 
     * @param assignee {module:model/User} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/PullRequest13.AuthorAssociationEnum} How the author is associated with the repository.
     * @param autoMerge {module:model/PullRequestAutoMerge1} 
     ...
     * @param state {module:model/PullRequest13.StateEnum} State of this Pull Request. Either `open` or `closed`.
    ...
    constructor(links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
        ...
        PullRequest13.initialize(this, links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>PullRequest13</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequest13} obj Optional instance to populate.
     * @return {module:model/PullRequest13} The populated <code>PullRequest13</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequest13();
            ...
            if (data.hasOwnProperty('auto_merge')) {
                obj['auto_merge'] = PullRequestAutoMerge1.constructFromObject(data['auto_merge']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequest13</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequest13</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PullRequest13.RequiredProperties) {
        ...
        if (data['auto_merge']) { // data not null
          PullRequestAutoMerge1.validateJSON(data['auto_merge']);
        }
...
PullRequest13.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "auto_merge", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "draft", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksPullRequest5Links} _links
 */
PullRequest13.prototype['_links'] = undefined;

/**
 * @member {module:model/PullRequest13.ActiveLockReasonEnum} active_lock_reason
 */
PullRequest13.prototype['active_lock_reason'] = undefined;

/**
 * @member {Number} additions
 */
PullRequest13.prototype['additions'] = undefined;

/**
 * @member {module:model/User} assignee
 */
PullRequest13.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
PullRequest13.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/PullRequest13.AuthorAssociationEnum} author_association
 */
PullRequest13.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge1} auto_merge
 */
PullRequest13.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequestBase} base
 */
PullRequest13.prototype['base'] = undefined;

/**
 * @member {String} body
 */
PullRequest13.prototype['body'] = undefined;

/**
 * @member {Number} changed_files
 */
PullRequest13.prototype['changed_files'] = undefined;

/**
 * @member {Date} closed_at
 */
PullRequest13.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
PullRequest13.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
PullRequest13.prototype['comments_url'] = undefined;

/**
 * @member {Number} commits
 */
PullRequest13.prototype['commits'] = undefined;

/**
 * @member {String} commits_url
 */
PullRequest13.prototype['commits_url'] = undefined;

/**
 * @member {Date} created_at
 */
PullRequest13.prototype['created_at'] = undefined;

/**
 * @member {Number} deletions
 */
PullRequest13.prototype['deletions'] = undefined;

/**
 * @member {String} diff_url
 */
PullRequest13.prototype['diff_url'] = undefined;

/**
 * Indicates whether or not the pull request is a draft.
 * @member {Boolean} draft
 */
PullRequest13.prototype['draft'] = undefined;

/**
 * @member {module:model/WebhookPullRequestReviewCommentDeletedPullRequestHead} head
 */
PullRequest13.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
PullRequest13.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
PullRequest13.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
PullRequest13.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
PullRequest13.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
PullRequest13.prototype['locked'] = undefined;

/**
 * Indicates whether maintainers can modify the pull request.
 * @member {Boolean} maintainer_can_modify
 */
PullRequest13.prototype['maintainer_can_modify'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
PullRequest13.prototype['merge_commit_sha'] = undefined;

/**
 * @member {Boolean} mergeable
 */
PullRequest13.prototype['mergeable'] = undefined;

/**
 * @member {String} mergeable_state
 */
PullRequest13.prototype['mergeable_state'] = undefined;

/**
 * @member {Boolean} merged
 */
PullRequest13.prototype['merged'] = undefined;

/**
 * @member {Date} merged_at
 */
PullRequest13.prototype['merged_at'] = undefined;

/**
 * @member {module:model/User} merged_by
 */
PullRequest13.prototype['merged_by'] = undefined;

/**
 * @member {module:model/Milestone1} milestone
 */
PullRequest13.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
PullRequest13.prototype['node_id'] = undefined;

/**
 * Number uniquely identifying the pull request within its repository.
 * @member {Number} number
 */
PullRequest13.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
PullRequest13.prototype['patch_url'] = undefined;

/**
 * @member {Boolean} rebaseable
 */
PullRequest13.prototype['rebaseable'] = undefined;

/**
 * @member {Array.<module:model/WebhooksPullRequest5RequestedReviewersInner>} requested_reviewers
 */
PullRequest13.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
PullRequest13.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
PullRequest13.prototype['review_comment_url'] = undefined;

/**
 * @member {Number} review_comments
 */
PullRequest13.prototype['review_comments'] = undefined;

/**
 * @member {String} review_comments_url
 */
PullRequest13.prototype['review_comments_url'] = undefined;

/**
 * State of this Pull Request. Either `open` or `closed`.
 * @member {module:model/PullRequest13.StateEnum} state
 */
PullRequest13.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
PullRequest13.prototype['statuses_url'] = undefined;

/**
 * The title of the pull request.
 * @member {String} title
 */
PullRequest13.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
PullRequest13.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
PullRequest13.prototype['url'] = undefined;

/**
 * @member {module:model/User} user
 */
PullRequest13.prototype['user'] = undefined;
 ...
 * @readonly
 */
PullRequest13['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
PullRequest13['AuthorAssociationEnum'] = {
