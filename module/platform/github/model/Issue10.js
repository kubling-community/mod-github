...
/**
 * The Issue10 model module.
 * @module model/Issue10
 * @version 1.1.4
 */
class Issue10 {
    /**
     * Constructs a new <code>Issue10</code>.
     * The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
     * @alias module:model/Issue10
     * @param activeLockReason {module:model/Issue10.ActiveLockReasonEnum} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/Issue10.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     */
    constructor(activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, locked, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user) { 
        
        Issue10.initialize(this, activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, locked, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user);
    }
     ...
     */
    static initialize(obj, activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, locked, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user) { 
    ...
    /**
     * Constructs a <code>Issue10</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Issue10} obj Optional instance to populate.
     * @return {module:model/Issue10} The populated <code>Issue10</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('labels')) {
                obj['labels'] = ApiClient.convertToType(data['labels'], [Label1]);
            }
            ...
            if (data.hasOwnProperty('performed_via_github_app')) {
                obj['performed_via_github_app'] = App1.constructFromObject(data['performed_via_github_app']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Issue10</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Issue10</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Issue10.RequiredProperties) {
        ...
        if (data['performed_via_github_app']) { // data not null
          App1.validateJSON(data['performed_via_github_app']);
        }
...
Issue10.RequiredProperties = ["active_lock_reason", "assignees", "author_association", "body", "closed_at", "comments", "comments_url", "created_at", "events_url", "html_url", "id", "labels_url", "locked", "milestone", "node_id", "number", "reactions", "repository_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/Issue10.ActiveLockReasonEnum} active_lock_reason
 */
Issue10.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User} assignee
 */
Issue10.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
Issue10.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/Issue10.AuthorAssociationEnum} author_association
 */
Issue10.prototype['author_association'] = undefined;

/**
 * Contents of the issue
 * @member {String} body
 */
Issue10.prototype['body'] = undefined;

/**
 * @member {Date} closed_at
 */
Issue10.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
Issue10.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
Issue10.prototype['comments_url'] = undefined;

/**
 * @member {Date} created_at
 */
Issue10.prototype['created_at'] = undefined;

/**
 * @member {Boolean} draft
 */
Issue10.prototype['draft'] = undefined;

/**
 * @member {String} events_url
 */
Issue10.prototype['events_url'] = undefined;

/**
 * @member {String} html_url
 */
Issue10.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
Issue10.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label1>} labels
 */
Issue10.prototype['labels'] = undefined;

/**
 * @member {String} labels_url
 */
Issue10.prototype['labels_url'] = undefined;

/**
 * @member {Boolean} locked
 */
Issue10.prototype['locked'] = undefined;

/**
 * @member {module:model/Milestone1} milestone
 */
Issue10.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
Issue10.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
Issue10.prototype['number'] = undefined;

/**
 * @member {module:model/App1} performed_via_github_app
 */
Issue10.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/WebhooksIssuePullRequest} pull_request
 */
Issue10.prototype['pull_request'] = undefined;

/**
 * @member {module:model/Reactions} reactions
 */
Issue10.prototype['reactions'] = undefined;

/**
 * @member {String} repository_url
 */
Issue10.prototype['repository_url'] = undefined;

/**
 * State of the issue; either 'open' or 'closed'
 * @member {module:model/Issue10.StateEnum} state
 */
Issue10.prototype['state'] = undefined;

/**
 * @member {String} state_reason
 */
Issue10.prototype['state_reason'] = undefined;

/**
 * @member {String} timeline_url
 */
Issue10.prototype['timeline_url'] = undefined;

/**
 * Title of the issue
 * @member {String} title
 */
Issue10.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
Issue10.prototype['updated_at'] = undefined;

/**
 * URL for the issue
 * @member {String} url
 */
Issue10.prototype['url'] = undefined;

/**
 * @member {module:model/User} user
 */
Issue10.prototype['user'] = undefined;
