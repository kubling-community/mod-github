...
class CodeSearchResultItem {
     ...
     * @param score {Number} 
     */
    constructor(name, path, sha, url, gitUrl, htmlUrl, repository, score) { 
        
        CodeSearchResultItem.initialize(this, name, path, sha, url, gitUrl, htmlUrl, repository, score);
    }
     ...
     */
    static initialize(obj, name, path, sha, url, gitUrl, htmlUrl, repository, score) { 
        obj['name'] = name;
        obj['path'] = path;
        obj['sha'] = sha;
        obj['url'] = url;
...
CodeSearchResultItem.RequiredProperties = ["name", "path", "sha", "url", "git_url", "html_url", "repository", "score"];
