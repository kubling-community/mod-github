...
/**
 * The Repository9 model module.
 * @module model/Repository9
 * @version 1.1.4
 */
class Repository9 {
    /**
     * Constructs a new <code>Repository9</code>.
     * A git repository
     * @alias module:model/Repository9
     ...
     * @param url {String} 
     * @param visibility {module:model/Repository9.VisibilityEnum} 
    ...
    constructor(archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl, cloneUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description, downloadsUrl, eventsUrl, fork, forks, forksCount, forksUrl, fullName, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, hasDownloads, hasIssues, hasPages, hasProjects, hasWiki, hasDiscussions, homepage, hooksUrl, htmlUrl, id, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, language, languagesUrl, license, mergesUrl, milestonesUrl, mirrorUrl, name, nodeId, notificationsUrl, openIssues, openIssuesCount, owner, _private, pullsUrl, pushedAt, releasesUrl, size, sshUrl, stargazersCount, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, svnUrl, tagsUrl, teamsUrl, topics, treesUrl, updatedAt, url, visibility, watchers, watchersCount) { 
        ...
        Repository9.initialize(this, archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl, cloneUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description, downloadsUrl, eventsUrl, fork, forks, forksCount, forksUrl, fullName, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, hasDownloads, hasIssues, hasPages, hasProjects, hasWiki, hasDiscussions, homepage, hooksUrl, htmlUrl, id, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, language, languagesUrl, license, mergesUrl, milestonesUrl, mirrorUrl, name, nodeId, notificationsUrl, openIssues, openIssuesCount, owner, _private, pullsUrl, pushedAt, releasesUrl, size, sshUrl, stargazersCount, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, svnUrl, tagsUrl, teamsUrl, topics, treesUrl, updatedAt, url, visibility, watchers, watchersCount);
    }
    ...
    /**
     * Constructs a <code>Repository9</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Repository9} obj Optional instance to populate.
     * @return {module:model/Repository9} The populated <code>Repository9</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Repository9();
    ...
    /**
     * Validates the JSON data with respect to <code>Repository9</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Repository9</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Repository9.RequiredProperties) {
 ...
 * @default false
 */
Repository9.prototype['allow_auto_merge'] = false;

/**
 * Whether to allow private forks
 * @member {Boolean} allow_forking
 */
Repository9.prototype['allow_forking'] = undefined;
 ...
 * @default true
 */
Repository9.prototype['allow_merge_commit'] = true;
 ...
 * @default true
 */
Repository9.prototype['allow_rebase_merge'] = true;
 ...
 * @default true
 */
Repository9.prototype['allow_squash_merge'] = true;

/**
 * @member {Boolean} allow_update_branch
 */
Repository9.prototype['allow_update_branch'] = undefined;

/**
 * @member {String} archive_url
 */
Repository9.prototype['archive_url'] = undefined;
 ...
 * @default false
 */
Repository9.prototype['archived'] = false;

/**
 * @member {String} assignees_url
 */
Repository9.prototype['assignees_url'] = undefined;

/**
 * @member {String} blobs_url
 */
Repository9.prototype['blobs_url'] = undefined;

/**
 * @member {String} branches_url
 */
Repository9.prototype['branches_url'] = undefined;

/**
 * @member {String} clone_url
 */
Repository9.prototype['clone_url'] = undefined;

/**
 * @member {String} collaborators_url
 */
Repository9.prototype['collaborators_url'] = undefined;

/**
 * @member {String} comments_url
 */
Repository9.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
Repository9.prototype['commits_url'] = undefined;

/**
 * @member {String} compare_url
 */
Repository9.prototype['compare_url'] = undefined;

/**
 * @member {String} contents_url
 */
Repository9.prototype['contents_url'] = undefined;

/**
 * @member {String} contributors_url
 */
Repository9.prototype['contributors_url'] = undefined;

/**
 * @member {module:model/RepositoryCreatedAt} created_at
 */
Repository9.prototype['created_at'] = undefined;

/**
 * The default branch of the repository.
 * @member {String} default_branch
 */
Repository9.prototype['default_branch'] = undefined;
 ...
 * @default false
 */
Repository9.prototype['delete_branch_on_merge'] = false;

/**
 * @member {String} deployments_url
 */
Repository9.prototype['deployments_url'] = undefined;

/**
 * @member {String} description
 */
Repository9.prototype['description'] = undefined;

/**
 * Returns whether or not this repository is disabled.
 * @member {Boolean} disabled
 */
Repository9.prototype['disabled'] = undefined;

/**
 * @member {String} downloads_url
 */
Repository9.prototype['downloads_url'] = undefined;

/**
 * @member {String} events_url
 */
Repository9.prototype['events_url'] = undefined;

/**
 * @member {Boolean} fork
 */
Repository9.prototype['fork'] = undefined;

/**
 * @member {Number} forks
 */
Repository9.prototype['forks'] = undefined;

/**
 * @member {Number} forks_count
 */
Repository9.prototype['forks_count'] = undefined;

/**
 * @member {String} forks_url
 */
Repository9.prototype['forks_url'] = undefined;

/**
 * @member {String} full_name
 */
Repository9.prototype['full_name'] = undefined;

/**
 * @member {String} git_commits_url
 */
Repository9.prototype['git_commits_url'] = undefined;

/**
 * @member {String} git_refs_url
 */
Repository9.prototype['git_refs_url'] = undefined;

/**
 * @member {String} git_tags_url
 */
Repository9.prototype['git_tags_url'] = undefined;

/**
 * @member {String} git_url
 */
Repository9.prototype['git_url'] = undefined;
 ...
 * @default true
 */
Repository9.prototype['has_downloads'] = true;
 ...
 * @default true
 */
Repository9.prototype['has_issues'] = true;

/**
 * @member {Boolean} has_pages
 */
Repository9.prototype['has_pages'] = undefined;
 ...
 * @default true
 */
Repository9.prototype['has_projects'] = true;
 ...
 * @default true
 */
Repository9.prototype['has_wiki'] = true;
 ...
 * @default false
 */
Repository9.prototype['has_discussions'] = false;

/**
 * @member {String} homepage
 */
Repository9.prototype['homepage'] = undefined;

/**
 * @member {String} hooks_url
 */
Repository9.prototype['hooks_url'] = undefined;

/**
 * @member {String} html_url
 */
Repository9.prototype['html_url'] = undefined;

/**
 * Unique identifier of the repository
 * @member {Number} id
 */
Repository9.prototype['id'] = undefined;

/**
 * @member {Boolean} is_template
 */
Repository9.prototype['is_template'] = undefined;

/**
 * @member {String} issue_comment_url
 */
Repository9.prototype['issue_comment_url'] = undefined;

/**
 * @member {String} issue_events_url
 */
Repository9.prototype['issue_events_url'] = undefined;

/**
 * @member {String} issues_url
 */
Repository9.prototype['issues_url'] = undefined;

/**
 * @member {String} keys_url
 */
Repository9.prototype['keys_url'] = undefined;

/**
 * @member {String} labels_url
 */
Repository9.prototype['labels_url'] = undefined;

/**
 * @member {String} language
 */
Repository9.prototype['language'] = undefined;

/**
 * @member {String} languages_url
 */
Repository9.prototype['languages_url'] = undefined;

/**
 * @member {module:model/License} license
 */
Repository9.prototype['license'] = undefined;

/**
 * @member {String} master_branch
 */
Repository9.prototype['master_branch'] = undefined;

/**
 * The default value for a merge commit message.  - `PR_TITLE` - default to the pull request's title. - `PR_BODY` - default to the pull request's body. - `BLANK` - default to a blank commit message.
 * @member {module:model/Repository9.MergeCommitMessageEnum} merge_commit_message
 */
Repository9.prototype['merge_commit_message'] = undefined;

/**
 * The default value for a merge commit title.  - `PR_TITLE` - default to the pull request's title. - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
 * @member {module:model/Repository9.MergeCommitTitleEnum} merge_commit_title
 */
Repository9.prototype['merge_commit_title'] = undefined;

/**
 * @member {String} merges_url
 */
Repository9.prototype['merges_url'] = undefined;

/**
 * @member {String} milestones_url
 */
Repository9.prototype['milestones_url'] = undefined;

/**
 * @member {String} mirror_url
 */
Repository9.prototype['mirror_url'] = undefined;

/**
 * The name of the repository.
 * @member {String} name
 */
Repository9.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
Repository9.prototype['node_id'] = undefined;

/**
 * @member {String} notifications_url
 */
Repository9.prototype['notifications_url'] = undefined;

/**
 * @member {Number} open_issues
 */
Repository9.prototype['open_issues'] = undefined;

/**
 * @member {Number} open_issues_count
 */
Repository9.prototype['open_issues_count'] = undefined;

/**
 * @member {String} organization
 */
Repository9.prototype['organization'] = undefined;

/**
 * @member {module:model/User} owner
 */
Repository9.prototype['owner'] = undefined;

/**
 * @member {module:model/RepositoryPermissions} permissions
 */
Repository9.prototype['permissions'] = undefined;

/**
 * Whether the repository is private or public.
 * @member {Boolean} private
 */
Repository9.prototype['private'] = undefined;

/**
 * @member {Boolean} public
 */
Repository9.prototype['public'] = undefined;

/**
 * @member {String} pulls_url
 */
Repository9.prototype['pulls_url'] = undefined;

/**
 * @member {module:model/RepositoryPushedAt} pushed_at
 */
Repository9.prototype['pushed_at'] = undefined;

/**
 * @member {String} releases_url
 */
Repository9.prototype['releases_url'] = undefined;

/**
 * @member {String} role_name
 */
Repository9.prototype['role_name'] = undefined;

/**
 * @member {Number} size
 */
Repository9.prototype['size'] = undefined;

/**
 * The default value for a squash merge commit message.
 * @member {module:model/Repository9.SquashMergeCommitMessageEnum} squash_merge_commit_message
 */
Repository9.prototype['squash_merge_commit_message'] = undefined;

/**
 * The default value for a squash merge commit title.
 * @member {module:model/Repository9.SquashMergeCommitTitleEnum} squash_merge_commit_title
 */
Repository9.prototype['squash_merge_commit_title'] = undefined;

/**
 * @member {String} ssh_url
 */
Repository9.prototype['ssh_url'] = undefined;

/**
 * @member {Number} stargazers
 */
Repository9.prototype['stargazers'] = undefined;

/**
 * @member {Number} stargazers_count
 */
Repository9.prototype['stargazers_count'] = undefined;

/**
 * @member {String} stargazers_url
 */
Repository9.prototype['stargazers_url'] = undefined;

/**
 * @member {String} statuses_url
 */
Repository9.prototype['statuses_url'] = undefined;

/**
 * @member {String} subscribers_url
 */
Repository9.prototype['subscribers_url'] = undefined;

/**
 * @member {String} subscription_url
 */
Repository9.prototype['subscription_url'] = undefined;

/**
 * @member {String} svn_url
 */
Repository9.prototype['svn_url'] = undefined;

/**
 * @member {String} tags_url
 */
Repository9.prototype['tags_url'] = undefined;

/**
 * @member {String} teams_url
 */
Repository9.prototype['teams_url'] = undefined;

/**
 * @member {Array.<String>} topics
 */
Repository9.prototype['topics'] = undefined;

/**
 * @member {String} trees_url
 */
Repository9.prototype['trees_url'] = undefined;

/**
 * @member {Date} updated_at
 */
Repository9.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
Repository9.prototype['url'] = undefined;
 ...
 * @default false
 */
Repository9.prototype['use_squash_pr_title_as_default'] = false;

/**
 * @member {module:model/Repository9.VisibilityEnum} visibility
 */
Repository9.prototype['visibility'] = undefined;

/**
 * @member {Number} watchers
 */
Repository9.prototype['watchers'] = undefined;

/**
 * @member {Number} watchers_count
 */
Repository9.prototype['watchers_count'] = undefined;

/**
 * Whether to require contributors to sign off on web-based commits
 * @member {Boolean} web_commit_signoff_required
 */
Repository9.prototype['web_commit_signoff_required'] = undefined;
 ...
 * @readonly
 */
Repository9['MergeCommitMessageEnum'] = {
 ...
 * @readonly
 */
Repository9['MergeCommitTitleEnum'] = {
 ...
 * @readonly
 */
Repository9['SquashMergeCommitMessageEnum'] = {
 ...
 * @readonly
 */
Repository9['SquashMergeCommitTitleEnum'] = {
