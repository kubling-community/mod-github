...
class LockedIssueEvent {
     ...
     */
    constructor(id, nodeId, url, actor, event, commitId, commitUrl, createdAt, performedViaGithubApp, lockReason) { 
        
        LockedIssueEvent.initialize(this, id, nodeId, url, actor, event, commitId, commitUrl, createdAt, performedViaGithubApp, lockReason);
    }
     ...
     */
    static initialize(obj, id, nodeId, url, actor, event, commitId, commitUrl, createdAt, performedViaGithubApp, lockReason) { 
        obj['id'] = id;
        obj['node_id'] = nodeId;
        obj['url'] = url;
        obj['actor'] = actor;
...
LockedIssueEvent.RequiredProperties = ["id", "node_id", "url", "actor", "event", "commit_id", "commit_url", "created_at", "performed_via_github_app", "lock_reason"];
