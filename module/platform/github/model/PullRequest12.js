...
import PullRequest12Head from './PullRequest12Head';
...
/**
 * The PullRequest12 model module.
 * @module model/PullRequest12
 * @version 1.1.4
 */
class PullRequest12 {
    /**
     * Constructs a new <code>PullRequest12</code>.
     * @alias module:model/PullRequest12
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/PullRequest12.ActiveLockReasonEnum} 
     * @param assignee {module:model/User1} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/PullRequest12.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param head {module:model/PullRequest12Head} 
     ...
     * @param state {module:model/PullRequest12.StateEnum} State of this Pull Request. Either `open` or `closed`.
    ...
    constructor(links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
        ...
        PullRequest12.initialize(this, links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>PullRequest12</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequest12} obj Optional instance to populate.
     * @return {module:model/PullRequest12} The populated <code>PullRequest12</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequest12();
            ...
            if (data.hasOwnProperty('head')) {
                obj['head'] = PullRequest12Head.constructFromObject(data['head']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequest12</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequest12</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PullRequest12.RequiredProperties) {
        ...
        if (data['head']) { // data not null
          PullRequest12Head.validateJSON(data['head']);
        }
        // ensure the json data is a string
...
PullRequest12.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "auto_merge", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "draft", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksPullRequest5Links} _links
 */
PullRequest12.prototype['_links'] = undefined;

/**
 * @member {module:model/PullRequest12.ActiveLockReasonEnum} active_lock_reason
 */
PullRequest12.prototype['active_lock_reason'] = undefined;

/**
 * @member {Number} additions
 */
PullRequest12.prototype['additions'] = undefined;

/**
 * @member {module:model/User1} assignee
 */
PullRequest12.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User1>} assignees
 */
PullRequest12.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/PullRequest12.AuthorAssociationEnum} author_association
 */
PullRequest12.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
PullRequest12.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequestBase} base
 */
PullRequest12.prototype['base'] = undefined;

/**
 * @member {String} body
 */
PullRequest12.prototype['body'] = undefined;

/**
 * @member {Number} changed_files
 */
PullRequest12.prototype['changed_files'] = undefined;

/**
 * @member {Date} closed_at
 */
PullRequest12.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
PullRequest12.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
PullRequest12.prototype['comments_url'] = undefined;

/**
 * @member {Number} commits
 */
PullRequest12.prototype['commits'] = undefined;

/**
 * @member {String} commits_url
 */
PullRequest12.prototype['commits_url'] = undefined;

/**
 * @member {Date} created_at
 */
PullRequest12.prototype['created_at'] = undefined;

/**
 * @member {Number} deletions
 */
PullRequest12.prototype['deletions'] = undefined;

/**
 * @member {String} diff_url
 */
PullRequest12.prototype['diff_url'] = undefined;

/**
 * Indicates whether or not the pull request is a draft.
 * @member {Boolean} draft
 */
PullRequest12.prototype['draft'] = undefined;

/**
 * @member {module:model/PullRequest12Head} head
 */
PullRequest12.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
PullRequest12.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
PullRequest12.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
PullRequest12.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
PullRequest12.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
PullRequest12.prototype['locked'] = undefined;

/**
 * Indicates whether maintainers can modify the pull request.
 * @member {Boolean} maintainer_can_modify
 */
PullRequest12.prototype['maintainer_can_modify'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
PullRequest12.prototype['merge_commit_sha'] = undefined;

/**
 * @member {Boolean} mergeable
 */
PullRequest12.prototype['mergeable'] = undefined;

/**
 * @member {String} mergeable_state
 */
PullRequest12.prototype['mergeable_state'] = undefined;

/**
 * @member {Boolean} merged
 */
PullRequest12.prototype['merged'] = undefined;

/**
 * @member {Date} merged_at
 */
PullRequest12.prototype['merged_at'] = undefined;

/**
 * @member {module:model/User} merged_by
 */
PullRequest12.prototype['merged_by'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
PullRequest12.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
PullRequest12.prototype['node_id'] = undefined;

/**
 * Number uniquely identifying the pull request within its repository.
 * @member {Number} number
 */
PullRequest12.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
PullRequest12.prototype['patch_url'] = undefined;

/**
 * @member {Boolean} rebaseable
 */
PullRequest12.prototype['rebaseable'] = undefined;

/**
 * @member {Array.<module:model/PullRequestRequestedReviewersInner>} requested_reviewers
 */
PullRequest12.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
PullRequest12.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
PullRequest12.prototype['review_comment_url'] = undefined;

/**
 * @member {Number} review_comments
 */
PullRequest12.prototype['review_comments'] = undefined;

/**
 * @member {String} review_comments_url
 */
PullRequest12.prototype['review_comments_url'] = undefined;

/**
 * State of this Pull Request. Either `open` or `closed`.
 * @member {module:model/PullRequest12.StateEnum} state
 */
PullRequest12.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
PullRequest12.prototype['statuses_url'] = undefined;

/**
 * The title of the pull request.
 * @member {String} title
 */
PullRequest12.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
PullRequest12.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
PullRequest12.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
PullRequest12.prototype['user'] = undefined;
 ...
 * @readonly
 */
PullRequest12['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
PullRequest12['AuthorAssociationEnum'] = {
