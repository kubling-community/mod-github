...
/**
 * The CodespacesCreateForAuthenticatedUserRequestOneOf model module.
 * @module model/CodespacesCreateForAuthenticatedUserRequestOneOf
 * @version 1.1.4
 */
class CodespacesCreateForAuthenticatedUserRequestOneOf {
    /**
     * Constructs a new <code>CodespacesCreateForAuthenticatedUserRequestOneOf</code>.
     * @alias module:model/CodespacesCreateForAuthenticatedUserRequestOneOf
     * @param repositoryId {Number} Repository id for this codespace
     */
    constructor(repositoryId) { 
        
        CodespacesCreateForAuthenticatedUserRequestOneOf.initialize(this, repositoryId);
    }
    ...
    /**
     * Constructs a <code>CodespacesCreateForAuthenticatedUserRequestOneOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CodespacesCreateForAuthenticatedUserRequestOneOf} obj Optional instance to populate.
     * @return {module:model/CodespacesCreateForAuthenticatedUserRequestOneOf} The populated <code>CodespacesCreateForAuthenticatedUserRequestOneOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CodespacesCreateForAuthenticatedUserRequestOneOf();
    ...
    /**
     * Validates the JSON data with respect to <code>CodespacesCreateForAuthenticatedUserRequestOneOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CodespacesCreateForAuthenticatedUserRequestOneOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CodespacesCreateForAuthenticatedUserRequestOneOf.RequiredProperties) {
...
CodespacesCreateForAuthenticatedUserRequestOneOf.RequiredProperties = ["repository_id"];

/**
 * Repository id for this codespace
 * @member {Number} repository_id
 */
CodespacesCreateForAuthenticatedUserRequestOneOf.prototype['repository_id'] = undefined;

/**
 * Git ref (typically a branch name) for this codespace
 * @member {String} ref
 */
CodespacesCreateForAuthenticatedUserRequestOneOf.prototype['ref'] = undefined;

/**
 * The requested location for a new codespace. Best efforts are made to respect this upon creation. Assigned by IP if not provided.
 * @member {String} location
 */
CodespacesCreateForAuthenticatedUserRequestOneOf.prototype['location'] = undefined;

/**
 * The geographic area for this codespace. If not specified, the value is assigned by IP. This property replaces `location`, which is being deprecated.
 * @member {module:model/CodespacesCreateForAuthenticatedUserRequestOneOf.GeoEnum} geo
 */
CodespacesCreateForAuthenticatedUserRequestOneOf.prototype['geo'] = undefined;

/**
 * IP for location auto-detection when proxying a request
 * @member {String} client_ip
 */
CodespacesCreateForAuthenticatedUserRequestOneOf.prototype['client_ip'] = undefined;

/**
 * Machine type to use for this codespace
 * @member {String} machine
 */
CodespacesCreateForAuthenticatedUserRequestOneOf.prototype['machine'] = undefined;

/**
 * Path to devcontainer.json config to use for this codespace
 * @member {String} devcontainer_path
 */
CodespacesCreateForAuthenticatedUserRequestOneOf.prototype['devcontainer_path'] = undefined;

/**
 * Whether to authorize requested permissions from devcontainer.json
 * @member {Boolean} multi_repo_permissions_opt_out
 */
CodespacesCreateForAuthenticatedUserRequestOneOf.prototype['multi_repo_permissions_opt_out'] = undefined;

/**
 * Working directory for this codespace
 * @member {String} working_directory
 */
CodespacesCreateForAuthenticatedUserRequestOneOf.prototype['working_directory'] = undefined;

/**
 * Time in minutes before codespace stops from inactivity
 * @member {Number} idle_timeout_minutes
 */
CodespacesCreateForAuthenticatedUserRequestOneOf.prototype['idle_timeout_minutes'] = undefined;

/**
 * Display name for this codespace
 * @member {String} display_name
 */
CodespacesCreateForAuthenticatedUserRequestOneOf.prototype['display_name'] = undefined;

/**
 * Duration in minutes after codespace has gone idle in which it will be deleted. Must be integer minutes between 0 and 43200 (30 days).
 * @member {Number} retention_period_minutes
 */
CodespacesCreateForAuthenticatedUserRequestOneOf.prototype['retention_period_minutes'] = undefined;
 ...
 * @readonly
 */
CodespacesCreateForAuthenticatedUserRequestOneOf['GeoEnum'] = {
...
export default CodespacesCreateForAuthenticatedUserRequestOneOf;
