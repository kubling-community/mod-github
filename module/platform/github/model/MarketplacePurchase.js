...
class MarketplacePurchase {
    ...
    constructor(account, billingCycle, freeTrialEndsOn, onFreeTrial, plan, unitCount) { 
        ...
        MarketplacePurchase.initialize(this, account, billingCycle, freeTrialEndsOn, onFreeTrial, plan, unitCount);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MarketplacePurchase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MarketplacePurchase</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MarketplacePurchase.RequiredProperties) {
...
MarketplacePurchase.RequiredProperties = ["account", "billing_cycle", "free_trial_ends_on", "on_free_trial", "plan", "unit_count"];

/**
 * @member {module:model/WebhooksMarketplacePurchaseAccount} account
 */
MarketplacePurchase.prototype['account'] = undefined;

/**
 * @member {String} billing_cycle
 */
MarketplacePurchase.prototype['billing_cycle'] = undefined;

/**
 * @member {String} free_trial_ends_on
 */
MarketplacePurchase.prototype['free_trial_ends_on'] = undefined;

/**
 * @member {String} next_billing_date
 */
MarketplacePurchase.prototype['next_billing_date'] = undefined;

/**
 * @member {Boolean} on_free_trial
 */
MarketplacePurchase.prototype['on_free_trial'] = undefined;

/**
 * @member {module:model/WebhooksPreviousMarketplacePurchasePlan} plan
 */
MarketplacePurchase.prototype['plan'] = undefined;

/**
 * @member {Number} unit_count
 */
MarketplacePurchase.prototype['unit_count'] = undefined;
