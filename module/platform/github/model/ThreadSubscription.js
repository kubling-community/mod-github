...
class ThreadSubscription {
     ...
     * @param url {String} 
     */
    constructor(subscribed, ignored, reason, createdAt, url) { 
        
        ThreadSubscription.initialize(this, subscribed, ignored, reason, createdAt, url);
    }
     ...
     */
    static initialize(obj, subscribed, ignored, reason, createdAt, url) { 
...
ThreadSubscription.RequiredProperties = ["subscribed", "ignored", "reason", "created_at", "url"];
