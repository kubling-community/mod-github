...
/**
 * The WebhookTeamCreated model module.
 * @module model/WebhookTeamCreated
 * @version 1.1.4
 */
class WebhookTeamCreated {
    /**
     * Constructs a new <code>WebhookTeamCreated</code>.
     * @alias module:model/WebhookTeamCreated
     * @param action {module:model/WebhookTeamCreated.ActionEnum} 
    ...
    constructor(action, organization, sender, team) { 
        ...
        WebhookTeamCreated.initialize(this, action, organization, sender, team);
    }
    ...
    /**
     * Constructs a <code>WebhookTeamCreated</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookTeamCreated} obj Optional instance to populate.
     * @return {module:model/WebhookTeamCreated} The populated <code>WebhookTeamCreated</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookTeamCreated();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookTeamCreated</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookTeamCreated</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookTeamCreated.RequiredProperties) {
...
WebhookTeamCreated.RequiredProperties = ["action", "organization", "sender", "team"];

/**
 * @member {module:model/WebhookTeamCreated.ActionEnum} action
 */
WebhookTeamCreated.prototype['action'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookTeamCreated.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookTeamCreated.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookTeamCreated.prototype['organization'] = undefined;

/**
 * @member {module:model/Repository14} repository
 */
WebhookTeamCreated.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookTeamCreated.prototype['sender'] = undefined;

/**
 * @member {module:model/WebhooksTeam1} team
 */
WebhookTeamCreated.prototype['team'] = undefined;
...
export default WebhookTeamCreated;
