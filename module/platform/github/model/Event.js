...
class Event {
     ...
     */
    constructor(id, type, actor, repo, payload, _public, createdAt) { 
        
        Event.initialize(this, id, type, actor, repo, payload, _public, createdAt);
    }
     ...
     */
    static initialize(obj, id, type, actor, repo, payload, _public, createdAt) { 
        obj['id'] = id;
        obj['type'] = type;
        obj['actor'] = actor;
        obj['repo'] = repo;
...
Event.RequiredProperties = ["id", "type", "actor", "repo", "payload", "public", "created_at"];
