...
class PullRequest {
     ...
     * @param activeLockReason {module:model/PullRequest.ActiveLockReasonEnum} 
     * @param assignee {module:model/User1} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/PullRequest.AuthorAssociationEnum} How the author is associated with the repository.
...
PullRequest.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "auto_merge", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "draft", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];
 ...
 * @readonly
 */
PullRequest['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
PullRequest['AuthorAssociationEnum'] = {
