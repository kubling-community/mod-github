...
/**
 * The WebhooksSponsorshipMaintainer model module.
 * @module model/WebhooksSponsorshipMaintainer
 * @version 1.1.4
 */
class WebhooksSponsorshipMaintainer {
    /**
     * Constructs a new <code>WebhooksSponsorshipMaintainer</code>.
     * @alias module:model/WebhooksSponsorshipMaintainer
     */
    constructor() { 
        
        WebhooksSponsorshipMaintainer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhooksSponsorshipMaintainer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhooksSponsorshipMaintainer} obj Optional instance to populate.
     * @return {module:model/WebhooksSponsorshipMaintainer} The populated <code>WebhooksSponsorshipMaintainer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhooksSponsorshipMaintainer();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhooksSponsorshipMaintainer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhooksSponsorshipMaintainer</code>.
     */
 ...
 */
WebhooksSponsorshipMaintainer.prototype['avatar_url'] = undefined;

/**
 * @member {String} events_url
 */
WebhooksSponsorshipMaintainer.prototype['events_url'] = undefined;

/**
 * @member {String} followers_url
 */
WebhooksSponsorshipMaintainer.prototype['followers_url'] = undefined;

/**
 * @member {String} following_url
 */
WebhooksSponsorshipMaintainer.prototype['following_url'] = undefined;

/**
 * @member {String} gists_url
 */
WebhooksSponsorshipMaintainer.prototype['gists_url'] = undefined;

/**
 * @member {String} gravatar_id
 */
WebhooksSponsorshipMaintainer.prototype['gravatar_id'] = undefined;

/**
 * @member {String} html_url
 */
WebhooksSponsorshipMaintainer.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhooksSponsorshipMaintainer.prototype['id'] = undefined;

/**
 * @member {String} login
 */
WebhooksSponsorshipMaintainer.prototype['login'] = undefined;

/**
 * @member {String} node_id
 */
WebhooksSponsorshipMaintainer.prototype['node_id'] = undefined;

/**
 * @member {String} organizations_url
 */
WebhooksSponsorshipMaintainer.prototype['organizations_url'] = undefined;

/**
 * @member {String} received_events_url
 */
WebhooksSponsorshipMaintainer.prototype['received_events_url'] = undefined;

/**
 * @member {String} repos_url
 */
WebhooksSponsorshipMaintainer.prototype['repos_url'] = undefined;

/**
 * @member {Boolean} site_admin
 */
WebhooksSponsorshipMaintainer.prototype['site_admin'] = undefined;

/**
 * @member {String} starred_url
 */
WebhooksSponsorshipMaintainer.prototype['starred_url'] = undefined;

/**
 * @member {String} subscriptions_url
 */
WebhooksSponsorshipMaintainer.prototype['subscriptions_url'] = undefined;

/**
 * @member {String} type
 */
WebhooksSponsorshipMaintainer.prototype['type'] = undefined;

/**
 * @member {String} url
 */
WebhooksSponsorshipMaintainer.prototype['url'] = undefined;
...
export default WebhooksSponsorshipMaintainer;
