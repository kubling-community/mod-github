...
/**
 * The WebhookDiscussionCreated model module.
 * @module model/WebhookDiscussionCreated
 * @version 1.1.4
 */
class WebhookDiscussionCreated {
    /**
     * Constructs a new <code>WebhookDiscussionCreated</code>.
     * @alias module:model/WebhookDiscussionCreated
     * @param action {module:model/WebhookDiscussionCreated.ActionEnum} 
    ...
    constructor(action, discussion, repository, sender) { 
        ...
        WebhookDiscussionCreated.initialize(this, action, discussion, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookDiscussionCreated</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookDiscussionCreated} obj Optional instance to populate.
     * @return {module:model/WebhookDiscussionCreated} The populated <code>WebhookDiscussionCreated</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookDiscussionCreated();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDiscussionCreated</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDiscussionCreated</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookDiscussionCreated.RequiredProperties) {
...
WebhookDiscussionCreated.RequiredProperties = ["action", "discussion", "repository", "sender"];

/**
 * @member {module:model/WebhookDiscussionCreated.ActionEnum} action
 */
WebhookDiscussionCreated.prototype['action'] = undefined;

/**
 * @member {module:model/Discussion} discussion
 */
WebhookDiscussionCreated.prototype['discussion'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookDiscussionCreated.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookDiscussionCreated.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookDiscussionCreated.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookDiscussionCreated.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookDiscussionCreated.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookDiscussionCreated['ActionEnum'] = {
...
export default WebhookDiscussionCreated;
