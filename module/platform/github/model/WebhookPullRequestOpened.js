...
/**
 * The WebhookPullRequestOpened model module.
 * @module model/WebhookPullRequestOpened
 * @version 1.1.4
 */
class WebhookPullRequestOpened {
    /**
     * Constructs a new <code>WebhookPullRequestOpened</code>.
     * @alias module:model/WebhookPullRequestOpened
     * @param action {module:model/WebhookPullRequestOpened.ActionEnum} 
    ...
    constructor(action, number, pullRequest, repository, sender) { 
        ...
        WebhookPullRequestOpened.initialize(this, action, number, pullRequest, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookPullRequestOpened</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookPullRequestOpened} obj Optional instance to populate.
     * @return {module:model/WebhookPullRequestOpened} The populated <code>WebhookPullRequestOpened</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookPullRequestOpened();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookPullRequestOpened</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookPullRequestOpened</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookPullRequestOpened.RequiredProperties) {
...
WebhookPullRequestOpened.RequiredProperties = ["action", "number", "pull_request", "repository", "sender"];

/**
 * @member {module:model/WebhookPullRequestOpened.ActionEnum} action
 */
WebhookPullRequestOpened.prototype['action'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookPullRequestOpened.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookPullRequestOpened.prototype['installation'] = undefined;

/**
 * The pull request number.
 * @member {Number} number
 */
WebhookPullRequestOpened.prototype['number'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookPullRequestOpened.prototype['organization'] = undefined;

/**
 * @member {module:model/PullRequestWebhook} pull_request
 */
WebhookPullRequestOpened.prototype['pull_request'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookPullRequestOpened.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookPullRequestOpened.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookPullRequestOpened['ActionEnum'] = {
...
export default WebhookPullRequestOpened;
