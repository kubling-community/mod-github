...
import WorkflowStep4 from './WorkflowStep4';

/**
 * The WebhookWorkflowJobWaitingWorkflowJob model module.
 * @module model/WebhookWorkflowJobWaitingWorkflowJob
 * @version 1.1.4
 */
class WebhookWorkflowJobWaitingWorkflowJob {
    /**
     * Constructs a new <code>WebhookWorkflowJobWaitingWorkflowJob</code>.
     * @alias module:model/WebhookWorkflowJobWaitingWorkflowJob
     ...
     * @param status {module:model/WebhookWorkflowJobWaitingWorkflowJob.StatusEnum} 
     * @param steps {Array.<module:model/WorkflowStep4>} 
     * @param url {String} 
     */
    constructor(checkRunUrl, completedAt, conclusion, createdAt, headSha, htmlUrl, id, labels, name, nodeId, runAttempt, runId, runUrl, runnerGroupId, runnerGroupName, runnerId, runnerName, startedAt, headBranch, workflowName, status, steps, url) { 
        
        WebhookWorkflowJobWaitingWorkflowJob.initialize(this, checkRunUrl, completedAt, conclusion, createdAt, headSha, htmlUrl, id, labels, name, nodeId, runAttempt, runId, runUrl, runnerGroupId, runnerGroupName, runnerId, runnerName, startedAt, headBranch, workflowName, status, steps, url);
    }
     ...
     */
    static initialize(obj, checkRunUrl, completedAt, conclusion, createdAt, headSha, htmlUrl, id, labels, name, nodeId, runAttempt, runId, runUrl, runnerGroupId, runnerGroupName, runnerId, runnerName, startedAt, headBranch, workflowName, status, steps, url) { 
    ...
    /**
     * Constructs a <code>WebhookWorkflowJobWaitingWorkflowJob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookWorkflowJobWaitingWorkflowJob} obj Optional instance to populate.
     * @return {module:model/WebhookWorkflowJobWaitingWorkflowJob} The populated <code>WebhookWorkflowJobWaitingWorkflowJob</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookWorkflowJobWaitingWorkflowJob();
            ...
            if (data.hasOwnProperty('steps')) {
                obj['steps'] = ApiClient.convertToType(data['steps'], [WorkflowStep4]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookWorkflowJobWaitingWorkflowJob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookWorkflowJobWaitingWorkflowJob</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookWorkflowJobWaitingWorkflowJob.RequiredProperties) {
        ...
        if (data['steps']) { // data not null
            ...
            for (const item of data['steps']) {
                WorkflowStep4.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
WebhookWorkflowJobWaitingWorkflowJob.RequiredProperties = ["check_run_url", "completed_at", "conclusion", "created_at", "head_sha", "html_url", "id", "labels", "name", "node_id", "run_attempt", "run_id", "run_url", "runner_group_id", "runner_group_name", "runner_id", "runner_name", "started_at", "head_branch", "workflow_name", "status", "steps", "url"];

/**
 * @member {String} check_run_url
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['check_run_url'] = undefined;

/**
 * @member {String} completed_at
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['completed_at'] = undefined;

/**
 * @member {String} conclusion
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['conclusion'] = undefined;

/**
 * The time that the job created.
 * @member {String} created_at
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['created_at'] = undefined;

/**
 * @member {String} head_sha
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['head_sha'] = undefined;

/**
 * @member {String} html_url
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['id'] = undefined;

/**
 * @member {Array.<String>} labels
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['labels'] = undefined;

/**
 * @member {String} name
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['node_id'] = undefined;

/**
 * @member {Number} run_attempt
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['run_attempt'] = undefined;

/**
 * @member {Number} run_id
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['run_id'] = undefined;

/**
 * @member {String} run_url
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['run_url'] = undefined;

/**
 * @member {Number} runner_group_id
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['runner_group_id'] = undefined;

/**
 * @member {String} runner_group_name
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['runner_group_name'] = undefined;

/**
 * @member {Number} runner_id
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['runner_id'] = undefined;

/**
 * @member {String} runner_name
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['runner_name'] = undefined;

/**
 * @member {Date} started_at
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['started_at'] = undefined;

/**
 * The name of the current branch.
 * @member {String} head_branch
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['head_branch'] = undefined;

/**
 * The name of the workflow.
 * @member {String} workflow_name
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['workflow_name'] = undefined;

/**
 * @member {module:model/WebhookWorkflowJobWaitingWorkflowJob.StatusEnum} status
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['status'] = undefined;

/**
 * @member {Array.<module:model/WorkflowStep4>} steps
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['steps'] = undefined;

/**
 * @member {String} url
 */
WebhookWorkflowJobWaitingWorkflowJob.prototype['url'] = undefined;
 ...
 * @readonly
 */
WebhookWorkflowJobWaitingWorkflowJob['StatusEnum'] = {
...
export default WebhookWorkflowJobWaitingWorkflowJob;
