...
class PullRequestBaseRepo {
     ...
     * @param owner {module:model/PullRequestHeadRepoOwner} 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('owner')) {
                obj['owner'] = PullRequestHeadRepoOwner.constructFromObject(data['owner']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['owner']) { // data not null
          PullRequestHeadRepoOwner.validateJSON(data['owner']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/PullRequestHeadRepoOwner} owner
 */
 ...
 */
PullRequestBaseRepo.prototype['has_discussions'] = undefined;
 ...
 */
PullRequestBaseRepo.prototype['web_commit_signoff_required'] = undefined;
