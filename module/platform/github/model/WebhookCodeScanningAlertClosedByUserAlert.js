...
/**
 * The WebhookCodeScanningAlertClosedByUserAlert model module.
 * @module model/WebhookCodeScanningAlertClosedByUserAlert
 * @version 1.1.4
 */
class WebhookCodeScanningAlertClosedByUserAlert {
    /**
     * Constructs a new <code>WebhookCodeScanningAlertClosedByUserAlert</code>.
     * The code scanning alert involved in the event.
     * @alias module:model/WebhookCodeScanningAlertClosedByUserAlert
     ...
     * @param dismissedReason {module:model/WebhookCodeScanningAlertClosedByUserAlert.DismissedReasonEnum} The reason for dismissing or closing the alert.
     ...
     * @param state {module:model/WebhookCodeScanningAlertClosedByUserAlert.StateEnum} State of a code scanning alert.
    ...
    constructor(createdAt, dismissedAt, dismissedBy, dismissedReason, htmlUrl, number, rule, state, tool, url) { 
        ...
        WebhookCodeScanningAlertClosedByUserAlert.initialize(this, createdAt, dismissedAt, dismissedBy, dismissedReason, htmlUrl, number, rule, state, tool, url);
    }
    ...
    /**
     * Constructs a <code>WebhookCodeScanningAlertClosedByUserAlert</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookCodeScanningAlertClosedByUserAlert} obj Optional instance to populate.
     * @return {module:model/WebhookCodeScanningAlertClosedByUserAlert} The populated <code>WebhookCodeScanningAlertClosedByUserAlert</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookCodeScanningAlertClosedByUserAlert();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookCodeScanningAlertClosedByUserAlert</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookCodeScanningAlertClosedByUserAlert</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookCodeScanningAlertClosedByUserAlert.RequiredProperties) {
...
WebhookCodeScanningAlertClosedByUserAlert.RequiredProperties = ["created_at", "dismissed_at", "dismissed_by", "dismissed_reason", "html_url", "number", "rule", "state", "tool", "url"];

/**
 * The time that the alert was created in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ.`
 * @member {Date} created_at
 */
WebhookCodeScanningAlertClosedByUserAlert.prototype['created_at'] = undefined;

/**
 * The time that the alert was dismissed in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`.
 * @member {Date} dismissed_at
 */
WebhookCodeScanningAlertClosedByUserAlert.prototype['dismissed_at'] = undefined;

/**
 * @member {module:model/User} dismissed_by
 */
WebhookCodeScanningAlertClosedByUserAlert.prototype['dismissed_by'] = undefined;

/**
 * The reason for dismissing or closing the alert.
 * @member {module:model/WebhookCodeScanningAlertClosedByUserAlert.DismissedReasonEnum} dismissed_reason
 */
WebhookCodeScanningAlertClosedByUserAlert.prototype['dismissed_reason'] = undefined;

/**
 * The GitHub URL of the alert resource.
 * @member {String} html_url
 */
WebhookCodeScanningAlertClosedByUserAlert.prototype['html_url'] = undefined;

/**
 * @member {module:model/AlertInstance} most_recent_instance
 */
WebhookCodeScanningAlertClosedByUserAlert.prototype['most_recent_instance'] = undefined;

/**
 * The code scanning alert number.
 * @member {Number} number
 */
WebhookCodeScanningAlertClosedByUserAlert.prototype['number'] = undefined;

/**
 * @member {module:model/WebhookCodeScanningAlertClosedByUserAlertRule} rule
 */
WebhookCodeScanningAlertClosedByUserAlert.prototype['rule'] = undefined;

/**
 * State of a code scanning alert.
 * @member {module:model/WebhookCodeScanningAlertClosedByUserAlert.StateEnum} state
 */
WebhookCodeScanningAlertClosedByUserAlert.prototype['state'] = undefined;

/**
 * @member {module:model/WebhookCodeScanningAlertClosedByUserAlertTool} tool
 */
WebhookCodeScanningAlertClosedByUserAlert.prototype['tool'] = undefined;

/**
 * @member {String} url
 */
WebhookCodeScanningAlertClosedByUserAlert.prototype['url'] = undefined;
 ...
 * @readonly
 */
WebhookCodeScanningAlertClosedByUserAlert['DismissedReasonEnum'] = {
 ...
 * @readonly
 */
WebhookCodeScanningAlertClosedByUserAlert['StateEnum'] = {
...
export default WebhookCodeScanningAlertClosedByUserAlert;
