...
/**
 * The DeploymentWorkflowRun model module.
 * @module model/DeploymentWorkflowRun
 * @version 1.1.4
 */
class DeploymentWorkflowRun {
    /**
     * Constructs a new <code>DeploymentWorkflowRun</code>.
     * @alias module:model/DeploymentWorkflowRun
     * @param actor {module:model/User} 
     * @param checkSuiteId {Number} 
     * @param checkSuiteNodeId {String} 
     * @param conclusion {module:model/DeploymentWorkflowRun.ConclusionEnum} 
     ...
     * @param status {module:model/DeploymentWorkflowRun.StatusEnum} 
     * @param updatedAt {Date} 
     * @param url {String} 
     * @param workflowId {Number} 
     */
    constructor(actor, checkSuiteId, checkSuiteNodeId, conclusion, createdAt, displayTitle, event, headBranch, headSha, htmlUrl, id, name, nodeId, path, pullRequests, runAttempt, runNumber, runStartedAt, status, updatedAt, url, workflowId) { 
        
        DeploymentWorkflowRun.initialize(this, actor, checkSuiteId, checkSuiteNodeId, conclusion, createdAt, displayTitle, event, headBranch, headSha, htmlUrl, id, name, nodeId, path, pullRequests, runAttempt, runNumber, runStartedAt, status, updatedAt, url, workflowId);
    }
     ...
     */
    static initialize(obj, actor, checkSuiteId, checkSuiteNodeId, conclusion, createdAt, displayTitle, event, headBranch, headSha, htmlUrl, id, name, nodeId, path, pullRequests, runAttempt, runNumber, runStartedAt, status, updatedAt, url, workflowId) { 
        obj['actor'] = actor;
    ...
    /**
     * Constructs a <code>DeploymentWorkflowRun</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeploymentWorkflowRun} obj Optional instance to populate.
     * @return {module:model/DeploymentWorkflowRun} The populated <code>DeploymentWorkflowRun</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeploymentWorkflowRun();
    ...
    /**
     * Validates the JSON data with respect to <code>DeploymentWorkflowRun</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeploymentWorkflowRun</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeploymentWorkflowRun.RequiredProperties) {
...
DeploymentWorkflowRun.RequiredProperties = ["actor", "check_suite_id", "check_suite_node_id", "conclusion", "created_at", "display_title", "event", "head_branch", "head_sha", "html_url", "id", "name", "node_id", "path", "pull_requests", "run_attempt", "run_number", "run_started_at", "status", "updated_at", "url", "workflow_id"];

/**
 * @member {module:model/User} actor
 */
DeploymentWorkflowRun.prototype['actor'] = undefined;

/**
 * @member {String} artifacts_url
 */
DeploymentWorkflowRun.prototype['artifacts_url'] = undefined;

/**
 * @member {String} cancel_url
 */
DeploymentWorkflowRun.prototype['cancel_url'] = undefined;

/**
 * @member {Number} check_suite_id
 */
DeploymentWorkflowRun.prototype['check_suite_id'] = undefined;

/**
 * @member {String} check_suite_node_id
 */
DeploymentWorkflowRun.prototype['check_suite_node_id'] = undefined;

/**
 * @member {String} check_suite_url
 */
DeploymentWorkflowRun.prototype['check_suite_url'] = undefined;

/**
 * @member {module:model/DeploymentWorkflowRun.ConclusionEnum} conclusion
 */
DeploymentWorkflowRun.prototype['conclusion'] = undefined;

/**
 * @member {Date} created_at
 */
DeploymentWorkflowRun.prototype['created_at'] = undefined;

/**
 * @member {String} display_title
 */
DeploymentWorkflowRun.prototype['display_title'] = undefined;

/**
 * @member {String} event
 */
DeploymentWorkflowRun.prototype['event'] = undefined;

/**
 * @member {String} head_branch
 */
DeploymentWorkflowRun.prototype['head_branch'] = undefined;

/**
 * @member {Object} head_commit
 */
DeploymentWorkflowRun.prototype['head_commit'] = undefined;

/**
 * @member {module:model/DeploymentWorkflowRunHeadRepository} head_repository
 */
DeploymentWorkflowRun.prototype['head_repository'] = undefined;

/**
 * @member {String} head_sha
 */
DeploymentWorkflowRun.prototype['head_sha'] = undefined;

/**
 * @member {String} html_url
 */
DeploymentWorkflowRun.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
DeploymentWorkflowRun.prototype['id'] = undefined;

/**
 * @member {String} jobs_url
 */
DeploymentWorkflowRun.prototype['jobs_url'] = undefined;

/**
 * @member {String} logs_url
 */
DeploymentWorkflowRun.prototype['logs_url'] = undefined;

/**
 * @member {String} name
 */
DeploymentWorkflowRun.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
DeploymentWorkflowRun.prototype['node_id'] = undefined;

/**
 * @member {String} path
 */
DeploymentWorkflowRun.prototype['path'] = undefined;

/**
 * @member {Object} previous_attempt_url
 */
DeploymentWorkflowRun.prototype['previous_attempt_url'] = undefined;

/**
 * @member {Array.<module:model/CheckRunPullRequest>} pull_requests
 */
DeploymentWorkflowRun.prototype['pull_requests'] = undefined;

/**
 * @member {Array.<module:model/DeploymentWorkflowRunReferencedWorkflowsInner>} referenced_workflows
 */
DeploymentWorkflowRun.prototype['referenced_workflows'] = undefined;

/**
 * @member {module:model/DeploymentWorkflowRunHeadRepository} repository
 */
DeploymentWorkflowRun.prototype['repository'] = undefined;

/**
 * @member {String} rerun_url
 */
DeploymentWorkflowRun.prototype['rerun_url'] = undefined;

/**
 * @member {Number} run_attempt
 */
DeploymentWorkflowRun.prototype['run_attempt'] = undefined;

/**
 * @member {Number} run_number
 */
DeploymentWorkflowRun.prototype['run_number'] = undefined;

/**
 * @member {Date} run_started_at
 */
DeploymentWorkflowRun.prototype['run_started_at'] = undefined;

/**
 * @member {module:model/DeploymentWorkflowRun.StatusEnum} status
 */
DeploymentWorkflowRun.prototype['status'] = undefined;

/**
 * @member {module:model/User} triggering_actor
 */
DeploymentWorkflowRun.prototype['triggering_actor'] = undefined;

/**
 * @member {Date} updated_at
 */
DeploymentWorkflowRun.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
DeploymentWorkflowRun.prototype['url'] = undefined;

/**
 * @member {Number} workflow_id
 */
DeploymentWorkflowRun.prototype['workflow_id'] = undefined;

/**
 * @member {String} workflow_url
 */
DeploymentWorkflowRun.prototype['workflow_url'] = undefined;
 ...
 * @readonly
 */
DeploymentWorkflowRun['ConclusionEnum'] = {
 ...
 * @readonly
 */
DeploymentWorkflowRun['StatusEnum'] = {
...
export default DeploymentWorkflowRun;
