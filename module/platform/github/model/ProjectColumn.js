...
class ProjectColumn {
     ...
     */
    constructor(url, projectUrl, cardsUrl, id, nodeId, name, createdAt, updatedAt) { 
        
        ProjectColumn.initialize(this, url, projectUrl, cardsUrl, id, nodeId, name, createdAt, updatedAt);
    }
     ...
     */
    static initialize(obj, url, projectUrl, cardsUrl, id, nodeId, name, createdAt, updatedAt) { 
        obj['url'] = url;
...
ProjectColumn.RequiredProperties = ["url", "project_url", "cards_url", "id", "node_id", "name", "created_at", "updated_at"];
