...
/**
 * The Repository11 model module.
 * @module model/Repository11
 * @version 1.1.4
 */
class Repository11 {
    /**
     * Constructs a new <code>Repository11</code>.
     * A git repository
     * @alias module:model/Repository11
     ...
     * @param url {String} 
     * @param visibility {module:model/Repository11.VisibilityEnum} 
    ...
    constructor(archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl, cloneUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description, downloadsUrl, eventsUrl, fork, forks, forksCount, forksUrl, fullName, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, hasDownloads, hasIssues, hasPages, hasProjects, hasWiki, hasDiscussions, homepage, hooksUrl, htmlUrl, id, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, language, languagesUrl, license, mergesUrl, milestonesUrl, mirrorUrl, name, nodeId, notificationsUrl, openIssues, openIssuesCount, owner, _private, pullsUrl, pushedAt, releasesUrl, size, sshUrl, stargazersCount, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, svnUrl, tagsUrl, teamsUrl, topics, treesUrl, updatedAt, url, visibility, watchers, watchersCount) { 
        ...
        Repository11.initialize(this, archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl, cloneUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description, downloadsUrl, eventsUrl, fork, forks, forksCount, forksUrl, fullName, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, hasDownloads, hasIssues, hasPages, hasProjects, hasWiki, hasDiscussions, homepage, hooksUrl, htmlUrl, id, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, language, languagesUrl, license, mergesUrl, milestonesUrl, mirrorUrl, name, nodeId, notificationsUrl, openIssues, openIssuesCount, owner, _private, pullsUrl, pushedAt, releasesUrl, size, sshUrl, stargazersCount, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, svnUrl, tagsUrl, teamsUrl, topics, treesUrl, updatedAt, url, visibility, watchers, watchersCount);
    }
    ...
    /**
     * Constructs a <code>Repository11</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Repository11} obj Optional instance to populate.
     * @return {module:model/Repository11} The populated <code>Repository11</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Repository11();
    ...
    /**
     * Validates the JSON data with respect to <code>Repository11</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Repository11</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Repository11.RequiredProperties) {
 ...
 * @default false
 */
Repository11.prototype['allow_auto_merge'] = false;

/**
 * Whether to allow private forks
 * @member {Boolean} allow_forking
 */
Repository11.prototype['allow_forking'] = undefined;
 ...
 * @default true
 */
Repository11.prototype['allow_merge_commit'] = true;
 ...
 * @default true
 */
Repository11.prototype['allow_rebase_merge'] = true;
 ...
 * @default true
 */
Repository11.prototype['allow_squash_merge'] = true;

/**
 * @member {Boolean} allow_update_branch
 */
Repository11.prototype['allow_update_branch'] = undefined;

/**
 * @member {String} archive_url
 */
Repository11.prototype['archive_url'] = undefined;
 ...
 * @default false
 */
Repository11.prototype['archived'] = false;

/**
 * @member {String} assignees_url
 */
Repository11.prototype['assignees_url'] = undefined;

/**
 * @member {String} blobs_url
 */
Repository11.prototype['blobs_url'] = undefined;

/**
 * @member {String} branches_url
 */
Repository11.prototype['branches_url'] = undefined;

/**
 * @member {String} clone_url
 */
Repository11.prototype['clone_url'] = undefined;

/**
 * @member {String} collaborators_url
 */
Repository11.prototype['collaborators_url'] = undefined;

/**
 * @member {String} comments_url
 */
Repository11.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
Repository11.prototype['commits_url'] = undefined;

/**
 * @member {String} compare_url
 */
Repository11.prototype['compare_url'] = undefined;

/**
 * @member {String} contents_url
 */
Repository11.prototype['contents_url'] = undefined;

/**
 * @member {String} contributors_url
 */
Repository11.prototype['contributors_url'] = undefined;

/**
 * @member {module:model/RepositoryCreatedAt} created_at
 */
Repository11.prototype['created_at'] = undefined;

/**
 * The default branch of the repository.
 * @member {String} default_branch
 */
Repository11.prototype['default_branch'] = undefined;
 ...
 * @default false
 */
Repository11.prototype['delete_branch_on_merge'] = false;

/**
 * @member {String} deployments_url
 */
Repository11.prototype['deployments_url'] = undefined;

/**
 * @member {String} description
 */
Repository11.prototype['description'] = undefined;

/**
 * Returns whether or not this repository is disabled.
 * @member {Boolean} disabled
 */
Repository11.prototype['disabled'] = undefined;

/**
 * @member {String} downloads_url
 */
Repository11.prototype['downloads_url'] = undefined;

/**
 * @member {String} events_url
 */
Repository11.prototype['events_url'] = undefined;

/**
 * @member {Boolean} fork
 */
Repository11.prototype['fork'] = undefined;

/**
 * @member {Number} forks
 */
Repository11.prototype['forks'] = undefined;

/**
 * @member {Number} forks_count
 */
Repository11.prototype['forks_count'] = undefined;

/**
 * @member {String} forks_url
 */
Repository11.prototype['forks_url'] = undefined;

/**
 * @member {String} full_name
 */
Repository11.prototype['full_name'] = undefined;

/**
 * @member {String} git_commits_url
 */
Repository11.prototype['git_commits_url'] = undefined;

/**
 * @member {String} git_refs_url
 */
Repository11.prototype['git_refs_url'] = undefined;

/**
 * @member {String} git_tags_url
 */
Repository11.prototype['git_tags_url'] = undefined;

/**
 * @member {String} git_url
 */
Repository11.prototype['git_url'] = undefined;
 ...
 * @default true
 */
Repository11.prototype['has_downloads'] = true;
 ...
 * @default true
 */
Repository11.prototype['has_issues'] = true;

/**
 * @member {Boolean} has_pages
 */
Repository11.prototype['has_pages'] = undefined;
 ...
 * @default true
 */
Repository11.prototype['has_projects'] = true;
 ...
 * @default true
 */
Repository11.prototype['has_wiki'] = true;
 ...
 * @default false
 */
Repository11.prototype['has_discussions'] = false;

/**
 * @member {String} homepage
 */
Repository11.prototype['homepage'] = undefined;

/**
 * @member {String} hooks_url
 */
Repository11.prototype['hooks_url'] = undefined;

/**
 * @member {String} html_url
 */
Repository11.prototype['html_url'] = undefined;

/**
 * Unique identifier of the repository
 * @member {Number} id
 */
Repository11.prototype['id'] = undefined;

/**
 * @member {Boolean} is_template
 */
Repository11.prototype['is_template'] = undefined;

/**
 * @member {String} issue_comment_url
 */
Repository11.prototype['issue_comment_url'] = undefined;

/**
 * @member {String} issue_events_url
 */
Repository11.prototype['issue_events_url'] = undefined;

/**
 * @member {String} issues_url
 */
Repository11.prototype['issues_url'] = undefined;

/**
 * @member {String} keys_url
 */
Repository11.prototype['keys_url'] = undefined;

/**
 * @member {String} labels_url
 */
Repository11.prototype['labels_url'] = undefined;

/**
 * @member {String} language
 */
Repository11.prototype['language'] = undefined;

/**
 * @member {String} languages_url
 */
Repository11.prototype['languages_url'] = undefined;

/**
 * @member {module:model/License} license
 */
Repository11.prototype['license'] = undefined;

/**
 * @member {String} master_branch
 */
Repository11.prototype['master_branch'] = undefined;

/**
 * @member {String} merges_url
 */
Repository11.prototype['merges_url'] = undefined;

/**
 * @member {String} milestones_url
 */
Repository11.prototype['milestones_url'] = undefined;

/**
 * @member {String} mirror_url
 */
Repository11.prototype['mirror_url'] = undefined;

/**
 * The name of the repository.
 * @member {String} name
 */
Repository11.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
Repository11.prototype['node_id'] = undefined;

/**
 * @member {String} notifications_url
 */
Repository11.prototype['notifications_url'] = undefined;

/**
 * @member {Number} open_issues
 */
Repository11.prototype['open_issues'] = undefined;

/**
 * @member {Number} open_issues_count
 */
Repository11.prototype['open_issues_count'] = undefined;

/**
 * @member {String} organization
 */
Repository11.prototype['organization'] = undefined;

/**
 * @member {module:model/User} owner
 */
Repository11.prototype['owner'] = undefined;

/**
 * @member {module:model/RepositoryPermissions} permissions
 */
Repository11.prototype['permissions'] = undefined;

/**
 * Whether the repository is private or public.
 * @member {Boolean} private
 */
Repository11.prototype['private'] = undefined;

/**
 * @member {Boolean} public
 */
Repository11.prototype['public'] = undefined;

/**
 * @member {String} pulls_url
 */
Repository11.prototype['pulls_url'] = undefined;

/**
 * @member {module:model/RepositoryPushedAt} pushed_at
 */
Repository11.prototype['pushed_at'] = undefined;

/**
 * @member {String} releases_url
 */
Repository11.prototype['releases_url'] = undefined;

/**
 * @member {String} role_name
 */
Repository11.prototype['role_name'] = undefined;

/**
 * @member {Number} size
 */
Repository11.prototype['size'] = undefined;

/**
 * @member {String} ssh_url
 */
Repository11.prototype['ssh_url'] = undefined;

/**
 * @member {Number} stargazers
 */
Repository11.prototype['stargazers'] = undefined;

/**
 * @member {Number} stargazers_count
 */
Repository11.prototype['stargazers_count'] = undefined;

/**
 * @member {String} stargazers_url
 */
Repository11.prototype['stargazers_url'] = undefined;

/**
 * @member {String} statuses_url
 */
Repository11.prototype['statuses_url'] = undefined;

/**
 * @member {String} subscribers_url
 */
Repository11.prototype['subscribers_url'] = undefined;

/**
 * @member {String} subscription_url
 */
Repository11.prototype['subscription_url'] = undefined;

/**
 * @member {String} svn_url
 */
Repository11.prototype['svn_url'] = undefined;

/**
 * @member {String} tags_url
 */
Repository11.prototype['tags_url'] = undefined;

/**
 * @member {String} teams_url
 */
Repository11.prototype['teams_url'] = undefined;

/**
 * @member {Array.<String>} topics
 */
Repository11.prototype['topics'] = undefined;

/**
 * @member {String} trees_url
 */
Repository11.prototype['trees_url'] = undefined;

/**
 * @member {Date} updated_at
 */
Repository11.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
Repository11.prototype['url'] = undefined;

/**
 * @member {module:model/Repository11.VisibilityEnum} visibility
 */
Repository11.prototype['visibility'] = undefined;

/**
 * @member {Number} watchers
 */
Repository11.prototype['watchers'] = undefined;

/**
 * @member {Number} watchers_count
 */
Repository11.prototype['watchers_count'] = undefined;

/**
 * Whether to require contributors to sign off on web-based commits
 * @member {Boolean} web_commit_signoff_required
 */
Repository11.prototype['web_commit_signoff_required'] = undefined;
