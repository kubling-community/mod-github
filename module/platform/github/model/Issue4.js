...
/**
 * The Issue4 model module.
 * @module model/Issue4
 * @version 1.1.4
 */
class Issue4 {
    /**
     * Constructs a new <code>Issue4</code>.
     * The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
     * @alias module:model/Issue4
     * @param activeLockReason {module:model/Issue4.ActiveLockReasonEnum} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/Issue4.AuthorAssociationEnum} How the author is associated with the repository.
    ...
    constructor(activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, locked, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user) { 
        ...
        Issue4.initialize(this, activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, locked, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>Issue4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Issue4} obj Optional instance to populate.
     * @return {module:model/Issue4} The populated <code>Issue4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('performed_via_github_app')) {
                obj['performed_via_github_app'] = App14.constructFromObject(data['performed_via_github_app']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Issue4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Issue4</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Issue4.RequiredProperties) {
        ...
        if (data['performed_via_github_app']) { // data not null
          App14.validateJSON(data['performed_via_github_app']);
        }
...
Issue4.RequiredProperties = ["active_lock_reason", "assignees", "author_association", "body", "closed_at", "comments", "comments_url", "created_at", "events_url", "html_url", "id", "labels_url", "locked", "milestone", "node_id", "number", "reactions", "repository_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/Issue4.ActiveLockReasonEnum} active_lock_reason
 */
Issue4.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User} assignee
 */
Issue4.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
Issue4.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/Issue4.AuthorAssociationEnum} author_association
 */
Issue4.prototype['author_association'] = undefined;

/**
 * Contents of the issue
 * @member {String} body
 */
Issue4.prototype['body'] = undefined;

/**
 * @member {Date} closed_at
 */
Issue4.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
Issue4.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
Issue4.prototype['comments_url'] = undefined;

/**
 * @member {Date} created_at
 */
Issue4.prototype['created_at'] = undefined;

/**
 * @member {Boolean} draft
 */
Issue4.prototype['draft'] = undefined;

/**
 * @member {String} events_url
 */
Issue4.prototype['events_url'] = undefined;

/**
 * @member {String} html_url
 */
Issue4.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
Issue4.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label1>} labels
 */
Issue4.prototype['labels'] = undefined;

/**
 * @member {String} labels_url
 */
Issue4.prototype['labels_url'] = undefined;

/**
 * @member {Boolean} locked
 */
Issue4.prototype['locked'] = undefined;

/**
 * @member {module:model/Milestone1} milestone
 */
Issue4.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
Issue4.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
Issue4.prototype['number'] = undefined;

/**
 * @member {module:model/App14} performed_via_github_app
 */
Issue4.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/WebhooksIssuePullRequest} pull_request
 */
Issue4.prototype['pull_request'] = undefined;

/**
 * @member {module:model/Reactions} reactions
 */
Issue4.prototype['reactions'] = undefined;

/**
 * @member {String} repository_url
 */
Issue4.prototype['repository_url'] = undefined;

/**
 * State of the issue; either 'open' or 'closed'
 * @member {module:model/Issue4.StateEnum} state
 */
Issue4.prototype['state'] = undefined;

/**
 * @member {String} state_reason
 */
Issue4.prototype['state_reason'] = undefined;

/**
 * @member {String} timeline_url
 */
Issue4.prototype['timeline_url'] = undefined;

/**
 * Title of the issue
 * @member {String} title
 */
Issue4.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
Issue4.prototype['updated_at'] = undefined;

/**
 * URL for the issue
 * @member {String} url
 */
Issue4.prototype['url'] = undefined;

/**
 * @member {module:model/User} user
 */
Issue4.prototype['user'] = undefined;
