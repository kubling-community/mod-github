...
/**
 * The Repository8 model module.
 * @module model/Repository8
 * @version 1.1.4
 */
class Repository8 {
    /**
     * Constructs a new <code>Repository8</code>.
     * A git repository
     * @alias module:model/Repository8
     ...
     * @param url {String} 
     * @param visibility {module:model/Repository8.VisibilityEnum} 
    ...
    constructor(archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl, cloneUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description, downloadsUrl, eventsUrl, fork, forks, forksCount, forksUrl, fullName, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, hasDownloads, hasIssues, hasPages, hasProjects, hasWiki, homepage, hooksUrl, htmlUrl, id, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, language, languagesUrl, license, mergesUrl, milestonesUrl, mirrorUrl, name, nodeId, notificationsUrl, openIssues, openIssuesCount, owner, _private, pullsUrl, pushedAt, releasesUrl, size, sshUrl, stargazersCount, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, svnUrl, tagsUrl, teamsUrl, topics, treesUrl, updatedAt, url, visibility, watchers, watchersCount) { 
        ...
        Repository8.initialize(this, archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl, cloneUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description, downloadsUrl, eventsUrl, fork, forks, forksCount, forksUrl, fullName, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, hasDownloads, hasIssues, hasPages, hasProjects, hasWiki, homepage, hooksUrl, htmlUrl, id, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, language, languagesUrl, license, mergesUrl, milestonesUrl, mirrorUrl, name, nodeId, notificationsUrl, openIssues, openIssuesCount, owner, _private, pullsUrl, pushedAt, releasesUrl, size, sshUrl, stargazersCount, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, svnUrl, tagsUrl, teamsUrl, topics, treesUrl, updatedAt, url, visibility, watchers, watchersCount);
    }
    ...
    /**
     * Constructs a <code>Repository8</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Repository8} obj Optional instance to populate.
     * @return {module:model/Repository8} The populated <code>Repository8</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Repository8();
    ...
    /**
     * Validates the JSON data with respect to <code>Repository8</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Repository8</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Repository8.RequiredProperties) {
 ...
 * @default false
 */
Repository8.prototype['allow_auto_merge'] = false;

/**
 * Whether to allow private forks
 * @member {Boolean} allow_forking
 */
Repository8.prototype['allow_forking'] = undefined;
 ...
 * @default true
 */
Repository8.prototype['allow_merge_commit'] = true;
 ...
 * @default true
 */
Repository8.prototype['allow_rebase_merge'] = true;
 ...
 * @default true
 */
Repository8.prototype['allow_squash_merge'] = true;

/**
 * @member {Boolean} allow_update_branch
 */
Repository8.prototype['allow_update_branch'] = undefined;

/**
 * @member {String} archive_url
 */
Repository8.prototype['archive_url'] = undefined;
 ...
 * @default false
 */
Repository8.prototype['archived'] = false;

/**
 * @member {String} assignees_url
 */
Repository8.prototype['assignees_url'] = undefined;

/**
 * @member {String} blobs_url
 */
Repository8.prototype['blobs_url'] = undefined;

/**
 * @member {String} branches_url
 */
Repository8.prototype['branches_url'] = undefined;

/**
 * @member {String} clone_url
 */
Repository8.prototype['clone_url'] = undefined;

/**
 * @member {String} collaborators_url
 */
Repository8.prototype['collaborators_url'] = undefined;

/**
 * @member {String} comments_url
 */
Repository8.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
Repository8.prototype['commits_url'] = undefined;

/**
 * @member {String} compare_url
 */
Repository8.prototype['compare_url'] = undefined;

/**
 * @member {String} contents_url
 */
Repository8.prototype['contents_url'] = undefined;

/**
 * @member {String} contributors_url
 */
Repository8.prototype['contributors_url'] = undefined;

/**
 * @member {module:model/RepositoryCreatedAt} created_at
 */
Repository8.prototype['created_at'] = undefined;

/**
 * The default branch of the repository.
 * @member {String} default_branch
 */
Repository8.prototype['default_branch'] = undefined;
 ...
 * @default false
 */
Repository8.prototype['delete_branch_on_merge'] = false;

/**
 * @member {String} deployments_url
 */
Repository8.prototype['deployments_url'] = undefined;

/**
 * @member {String} description
 */
Repository8.prototype['description'] = undefined;

/**
 * Returns whether or not this repository is disabled.
 * @member {Boolean} disabled
 */
Repository8.prototype['disabled'] = undefined;

/**
 * @member {String} downloads_url
 */
Repository8.prototype['downloads_url'] = undefined;

/**
 * @member {String} events_url
 */
Repository8.prototype['events_url'] = undefined;

/**
 * @member {Boolean} fork
 */
Repository8.prototype['fork'] = undefined;

/**
 * @member {Number} forks
 */
Repository8.prototype['forks'] = undefined;

/**
 * @member {Number} forks_count
 */
Repository8.prototype['forks_count'] = undefined;

/**
 * @member {String} forks_url
 */
Repository8.prototype['forks_url'] = undefined;

/**
 * @member {String} full_name
 */
Repository8.prototype['full_name'] = undefined;

/**
 * @member {String} git_commits_url
 */
Repository8.prototype['git_commits_url'] = undefined;

/**
 * @member {String} git_refs_url
 */
Repository8.prototype['git_refs_url'] = undefined;

/**
 * @member {String} git_tags_url
 */
Repository8.prototype['git_tags_url'] = undefined;

/**
 * @member {String} git_url
 */
Repository8.prototype['git_url'] = undefined;
 ...
 * @default true
 */
Repository8.prototype['has_downloads'] = true;
 ...
 * @default true
 */
Repository8.prototype['has_issues'] = true;

/**
 * @member {Boolean} has_pages
 */
Repository8.prototype['has_pages'] = undefined;
 ...
 * @default true
 */
Repository8.prototype['has_projects'] = true;
 ...
 * @default true
 */
Repository8.prototype['has_wiki'] = true;

/**
 * @member {String} homepage
 */
Repository8.prototype['homepage'] = undefined;

/**
 * @member {String} hooks_url
 */
Repository8.prototype['hooks_url'] = undefined;

/**
 * @member {String} html_url
 */
Repository8.prototype['html_url'] = undefined;

/**
 * Unique identifier of the repository
 * @member {Number} id
 */
Repository8.prototype['id'] = undefined;

/**
 * @member {Boolean} is_template
 */
Repository8.prototype['is_template'] = undefined;

/**
 * @member {String} issue_comment_url
 */
Repository8.prototype['issue_comment_url'] = undefined;

/**
 * @member {String} issue_events_url
 */
Repository8.prototype['issue_events_url'] = undefined;

/**
 * @member {String} issues_url
 */
Repository8.prototype['issues_url'] = undefined;

/**
 * @member {String} keys_url
 */
Repository8.prototype['keys_url'] = undefined;

/**
 * @member {String} labels_url
 */
Repository8.prototype['labels_url'] = undefined;

/**
 * @member {String} language
 */
Repository8.prototype['language'] = undefined;

/**
 * @member {String} languages_url
 */
Repository8.prototype['languages_url'] = undefined;

/**
 * @member {module:model/License} license
 */
Repository8.prototype['license'] = undefined;

/**
 * @member {String} master_branch
 */
Repository8.prototype['master_branch'] = undefined;

/**
 * @member {String} merges_url
 */
Repository8.prototype['merges_url'] = undefined;

/**
 * @member {String} milestones_url
 */
Repository8.prototype['milestones_url'] = undefined;

/**
 * @member {String} mirror_url
 */
Repository8.prototype['mirror_url'] = undefined;

/**
 * The name of the repository.
 * @member {String} name
 */
Repository8.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
Repository8.prototype['node_id'] = undefined;

/**
 * @member {String} notifications_url
 */
Repository8.prototype['notifications_url'] = undefined;

/**
 * @member {Number} open_issues
 */
Repository8.prototype['open_issues'] = undefined;

/**
 * @member {Number} open_issues_count
 */
Repository8.prototype['open_issues_count'] = undefined;

/**
 * @member {String} organization
 */
Repository8.prototype['organization'] = undefined;

/**
 * @member {module:model/User} owner
 */
Repository8.prototype['owner'] = undefined;

/**
 * @member {module:model/RepositoryPermissions} permissions
 */
Repository8.prototype['permissions'] = undefined;

/**
 * Whether the repository is private or public.
 * @member {Boolean} private
 */
Repository8.prototype['private'] = undefined;

/**
 * @member {Boolean} public
 */
Repository8.prototype['public'] = undefined;

/**
 * @member {String} pulls_url
 */
Repository8.prototype['pulls_url'] = undefined;

/**
 * @member {module:model/RepositoryPushedAt} pushed_at
 */
Repository8.prototype['pushed_at'] = undefined;

/**
 * @member {String} releases_url
 */
Repository8.prototype['releases_url'] = undefined;

/**
 * @member {String} role_name
 */
Repository8.prototype['role_name'] = undefined;

/**
 * @member {Number} size
 */
Repository8.prototype['size'] = undefined;

/**
 * @member {String} ssh_url
 */
Repository8.prototype['ssh_url'] = undefined;

/**
 * @member {Number} stargazers
 */
Repository8.prototype['stargazers'] = undefined;

/**
 * @member {Number} stargazers_count
 */
Repository8.prototype['stargazers_count'] = undefined;

/**
 * @member {String} stargazers_url
 */
Repository8.prototype['stargazers_url'] = undefined;

/**
 * @member {String} statuses_url
 */
Repository8.prototype['statuses_url'] = undefined;

/**
 * @member {String} subscribers_url
 */
Repository8.prototype['subscribers_url'] = undefined;

/**
 * @member {String} subscription_url
 */
Repository8.prototype['subscription_url'] = undefined;

/**
 * @member {String} svn_url
 */
Repository8.prototype['svn_url'] = undefined;

/**
 * @member {String} tags_url
 */
Repository8.prototype['tags_url'] = undefined;

/**
 * @member {String} teams_url
 */
Repository8.prototype['teams_url'] = undefined;

/**
 * @member {Array.<String>} topics
 */
Repository8.prototype['topics'] = undefined;

/**
 * @member {String} trees_url
 */
Repository8.prototype['trees_url'] = undefined;

/**
 * @member {Date} updated_at
 */
Repository8.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
Repository8.prototype['url'] = undefined;

/**
 * @member {module:model/Repository8.VisibilityEnum} visibility
 */
Repository8.prototype['visibility'] = undefined;

/**
 * @member {Number} watchers
 */
Repository8.prototype['watchers'] = undefined;

/**
 * @member {Number} watchers_count
 */
Repository8.prototype['watchers_count'] = undefined;
