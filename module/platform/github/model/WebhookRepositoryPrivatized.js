...
/**
 * The WebhookRepositoryPrivatized model module.
 * @module model/WebhookRepositoryPrivatized
 * @version 1.1.4
 */
class WebhookRepositoryPrivatized {
    /**
     * Constructs a new <code>WebhookRepositoryPrivatized</code>.
     * @alias module:model/WebhookRepositoryPrivatized
     * @param action {module:model/WebhookRepositoryPrivatized.ActionEnum} 
    ...
    constructor(action, repository, sender) { 
        ...
        WebhookRepositoryPrivatized.initialize(this, action, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookRepositoryPrivatized</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookRepositoryPrivatized} obj Optional instance to populate.
     * @return {module:model/WebhookRepositoryPrivatized} The populated <code>WebhookRepositoryPrivatized</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookRepositoryPrivatized();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookRepositoryPrivatized</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookRepositoryPrivatized</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookRepositoryPrivatized.RequiredProperties) {
...
WebhookRepositoryPrivatized.RequiredProperties = ["action", "repository", "sender"];

/**
 * @member {module:model/WebhookRepositoryPrivatized.ActionEnum} action
 */
WebhookRepositoryPrivatized.prototype['action'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookRepositoryPrivatized.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookRepositoryPrivatized.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookRepositoryPrivatized.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookRepositoryPrivatized.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookRepositoryPrivatized.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookRepositoryPrivatized['ActionEnum'] = {
...
export default WebhookRepositoryPrivatized;
