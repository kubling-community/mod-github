...
/**
 * The WebhooksRelease model module.
 * @module model/WebhooksRelease
 * @version 1.1.4
 */
class WebhooksRelease {
    /**
     * Constructs a new <code>WebhooksRelease</code>.
     * The [release](https://docs.github.com/rest/releases/releases/#get-a-release) object.
     * @alias module:model/WebhooksRelease
    ...
    constructor(assets, assetsUrl, author, body, createdAt, draft, htmlUrl, id, name, nodeId, prerelease, publishedAt, tagName, tarballUrl, targetCommitish, uploadUrl, url, zipballUrl) { 
        ...
        WebhooksRelease.initialize(this, assets, assetsUrl, author, body, createdAt, draft, htmlUrl, id, name, nodeId, prerelease, publishedAt, tagName, tarballUrl, targetCommitish, uploadUrl, url, zipballUrl);
    }
    ...
    /**
     * Constructs a <code>WebhooksRelease</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhooksRelease} obj Optional instance to populate.
     * @return {module:model/WebhooksRelease} The populated <code>WebhooksRelease</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhooksRelease();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhooksRelease</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhooksRelease</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhooksRelease.RequiredProperties) {
...
WebhooksRelease.RequiredProperties = ["assets", "assets_url", "author", "body", "created_at", "draft", "html_url", "id", "name", "node_id", "prerelease", "published_at", "tag_name", "tarball_url", "target_commitish", "upload_url", "url", "zipball_url"];

/**
 * @member {Array.<module:model/ReleaseAsset>} assets
 */
WebhooksRelease.prototype['assets'] = undefined;

/**
 * @member {String} assets_url
 */
WebhooksRelease.prototype['assets_url'] = undefined;

/**
 * @member {module:model/User} author
 */
WebhooksRelease.prototype['author'] = undefined;

/**
 * @member {String} body
 */
WebhooksRelease.prototype['body'] = undefined;

/**
 * @member {Date} created_at
 */
WebhooksRelease.prototype['created_at'] = undefined;

/**
 * @member {String} discussion_url
 */
WebhooksRelease.prototype['discussion_url'] = undefined;

/**
 * Whether the release is a draft or published
 * @member {Boolean} draft
 */
WebhooksRelease.prototype['draft'] = undefined;

/**
 * @member {String} html_url
 */
WebhooksRelease.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhooksRelease.prototype['id'] = undefined;

/**
 * @member {String} name
 */
WebhooksRelease.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
WebhooksRelease.prototype['node_id'] = undefined;

/**
 * Whether the release is identified as a prerelease or a full release.
 * @member {Boolean} prerelease
 */
WebhooksRelease.prototype['prerelease'] = undefined;

/**
 * @member {Date} published_at
 */
WebhooksRelease.prototype['published_at'] = undefined;

/**
 * @member {module:model/Reactions} reactions
 */
WebhooksRelease.prototype['reactions'] = undefined;

/**
 * The name of the tag.
 * @member {String} tag_name
 */
WebhooksRelease.prototype['tag_name'] = undefined;

/**
 * @member {String} tarball_url
 */
WebhooksRelease.prototype['tarball_url'] = undefined;

/**
 * Specifies the commitish value that determines where the Git tag is created from.
 * @member {String} target_commitish
 */
WebhooksRelease.prototype['target_commitish'] = undefined;

/**
 * @member {String} upload_url
 */
WebhooksRelease.prototype['upload_url'] = undefined;

/**
 * @member {String} url
 */
WebhooksRelease.prototype['url'] = undefined;

/**
 * @member {String} zipball_url
 */
WebhooksRelease.prototype['zipball_url'] = undefined;
...
export default WebhooksRelease;
