...
import WebhookPackageUpdatedPackagePackageVersionPackageFilesInner from './WebhookPackageUpdatedPackagePackageVersionPackageFilesInner';
import WebhookPackageUpdatedPackagePackageVersionRelease from './WebhookPackageUpdatedPackagePackageVersionRelease';
import WebhookRubygemsMetadata from './WebhookRubygemsMetadata';

/**
 * The WebhookPackageUpdatedPackagePackageVersion model module.
 * @module model/WebhookPackageUpdatedPackagePackageVersion
 * @version 1.1.4
 */
class WebhookPackageUpdatedPackagePackageVersion {
    /**
     * Constructs a new <code>WebhookPackageUpdatedPackagePackageVersion</code>.
     * @alias module:model/WebhookPackageUpdatedPackagePackageVersion
     ...
     * @param name {String} 
     * @param packageFiles {Array.<module:model/WebhookPackageUpdatedPackagePackageVersionPackageFilesInner>} 
     ...
     */
    constructor(author, body, bodyHtml, createdAt, description, htmlUrl, id, installationCommand, metadata, name, packageFiles, summary, targetCommitish, targetOid, updatedAt, version) { 
        
        WebhookPackageUpdatedPackagePackageVersion.initialize(this, author, body, bodyHtml, createdAt, description, htmlUrl, id, installationCommand, metadata, name, packageFiles, summary, targetCommitish, targetOid, updatedAt, version);
    }
     ...
     */
    static initialize(obj, author, body, bodyHtml, createdAt, description, htmlUrl, id, installationCommand, metadata, name, packageFiles, summary, targetCommitish, targetOid, updatedAt, version) { 
        obj['author'] = author;
        obj['body'] = body;
    ...
    /**
     * Constructs a <code>WebhookPackageUpdatedPackagePackageVersion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookPackageUpdatedPackagePackageVersion} obj Optional instance to populate.
     * @return {module:model/WebhookPackageUpdatedPackagePackageVersion} The populated <code>WebhookPackageUpdatedPackagePackageVersion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookPackageUpdatedPackagePackageVersion();
            ...
            if (data.hasOwnProperty('package_files')) {
                obj['package_files'] = ApiClient.convertToType(data['package_files'], [WebhookPackageUpdatedPackagePackageVersionPackageFilesInner]);
            }
            ...
            if (data.hasOwnProperty('release')) {
                obj['release'] = WebhookPackageUpdatedPackagePackageVersionRelease.constructFromObject(data['release']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookPackageUpdatedPackagePackageVersion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookPackageUpdatedPackagePackageVersion</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookPackageUpdatedPackagePackageVersion.RequiredProperties) {
        ...
        if (data['package_files']) { // data not null
            ...
            for (const item of data['package_files']) {
                WebhookPackageUpdatedPackagePackageVersionPackageFilesInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['release']) { // data not null
          WebhookPackageUpdatedPackagePackageVersionRelease.validateJSON(data['release']);
        }
...
WebhookPackageUpdatedPackagePackageVersion.RequiredProperties = ["author", "body", "body_html", "created_at", "description", "html_url", "id", "installation_command", "metadata", "name", "package_files", "summary", "target_commitish", "target_oid", "updated_at", "version"];

/**
 * @member {module:model/User} author
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['author'] = undefined;

/**
 * @member {String} body
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['body'] = undefined;

/**
 * @member {String} body_html
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['body_html'] = undefined;

/**
 * @member {String} created_at
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['created_at'] = undefined;

/**
 * @member {String} description
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['description'] = undefined;

/**
 * @member {Array.<module:model/WebhookPackagePublishedPackagePackageVersionDockerMetadataInner>} docker_metadata
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['docker_metadata'] = undefined;

/**
 * @member {Boolean} draft
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['draft'] = undefined;

/**
 * @member {String} html_url
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['id'] = undefined;

/**
 * @member {String} installation_command
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['installation_command'] = undefined;

/**
 * @member {String} manifest
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['manifest'] = undefined;

/**
 * @member {Array.<Object.<String, Object>>} metadata
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['metadata'] = undefined;

/**
 * @member {String} name
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['name'] = undefined;

/**
 * @member {Array.<module:model/WebhookPackageUpdatedPackagePackageVersionPackageFilesInner>} package_files
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['package_files'] = undefined;

/**
 * @member {String} package_url
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['package_url'] = undefined;

/**
 * @member {Boolean} prerelease
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['prerelease'] = undefined;

/**
 * @member {module:model/WebhookPackageUpdatedPackagePackageVersionRelease} release
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['release'] = undefined;

/**
 * @member {Array.<module:model/WebhookRubygemsMetadata>} rubygems_metadata
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['rubygems_metadata'] = undefined;

/**
 * @member {String} source_url
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['source_url'] = undefined;

/**
 * @member {String} summary
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['summary'] = undefined;

/**
 * @member {String} tag_name
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['tag_name'] = undefined;

/**
 * @member {String} target_commitish
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['target_commitish'] = undefined;

/**
 * @member {String} target_oid
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['target_oid'] = undefined;

/**
 * @member {String} updated_at
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['updated_at'] = undefined;

/**
 * @member {String} version
 */
WebhookPackageUpdatedPackagePackageVersion.prototype['version'] = undefined;
...
export default WebhookPackageUpdatedPackagePackageVersion;
