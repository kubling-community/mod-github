...
import ProtectedBranchAllowForkSyncing from './ProtectedBranchAllowForkSyncing';
import ProtectedBranchEnforceAdmins from './ProtectedBranchEnforceAdmins';
import ProtectedBranchLockBranch from './ProtectedBranchLockBranch';
...
class ProtectedBranch {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('required_linear_history')) {
                obj['required_linear_history'] = ProtectedBranchRequiredLinearHistory.constructFromObject(data['required_linear_history']);
            }
            if (data.hasOwnProperty('allow_force_pushes')) {
                obj['allow_force_pushes'] = ProtectedBranchRequiredLinearHistory.constructFromObject(data['allow_force_pushes']);
            }
            if (data.hasOwnProperty('allow_deletions')) {
                obj['allow_deletions'] = ProtectedBranchRequiredLinearHistory.constructFromObject(data['allow_deletions']);
            }
            ...
            if (data.hasOwnProperty('block_creations')) {
                obj['block_creations'] = ProtectedBranchRequiredLinearHistory.constructFromObject(data['block_creations']);
            }
            if (data.hasOwnProperty('lock_branch')) {
                obj['lock_branch'] = ProtectedBranchLockBranch.constructFromObject(data['lock_branch']);
            }
            if (data.hasOwnProperty('allow_fork_syncing')) {
                obj['allow_fork_syncing'] = ProtectedBranchAllowForkSyncing.constructFromObject(data['allow_fork_syncing']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['required_linear_history']) { // data not null
          ProtectedBranchRequiredLinearHistory.validateJSON(data['required_linear_history']);
        }
        // validate the optional field `allow_force_pushes`
        if (data['allow_force_pushes']) { // data not null
          ProtectedBranchRequiredLinearHistory.validateJSON(data['allow_force_pushes']);
        }
        // validate the optional field `allow_deletions`
        if (data['allow_deletions']) { // data not null
          ProtectedBranchRequiredLinearHistory.validateJSON(data['allow_deletions']);
        }
        ...
        if (data['block_creations']) { // data not null
          ProtectedBranchRequiredLinearHistory.validateJSON(data['block_creations']);
        }
        // validate the optional field `lock_branch`
        if (data['lock_branch']) { // data not null
          ProtectedBranchLockBranch.validateJSON(data['lock_branch']);
        }
        // validate the optional field `allow_fork_syncing`
        if (data['allow_fork_syncing']) { // data not null
          ProtectedBranchAllowForkSyncing.validateJSON(data['allow_fork_syncing']);
        }
...
/**
 * @member {module:model/ProtectedBranchRequiredLinearHistory} required_linear_history
 */
ProtectedBranch.prototype['required_linear_history'] = undefined;

/**
 * @member {module:model/ProtectedBranchRequiredLinearHistory} allow_force_pushes
 */
ProtectedBranch.prototype['allow_force_pushes'] = undefined;

/**
 * @member {module:model/ProtectedBranchRequiredLinearHistory} allow_deletions
 */
...
/**
 * @member {module:model/ProtectedBranchRequiredLinearHistory} block_creations
 */
ProtectedBranch.prototype['block_creations'] = undefined;

/**
 * @member {module:model/ProtectedBranchLockBranch} lock_branch
 */
ProtectedBranch.prototype['lock_branch'] = undefined;

/**
 * @member {module:model/ProtectedBranchAllowForkSyncing} allow_fork_syncing
 */
ProtectedBranch.prototype['allow_fork_syncing'] = undefined;
