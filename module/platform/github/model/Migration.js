...
class Migration {
     ...
     * @param nodeId {String} 
     */
    constructor(id, owner, guid, state, lockRepositories, excludeMetadata, excludeGitData, excludeAttachments, excludeReleases, excludeOwnerProjects, orgMetadataOnly, repositories, url, createdAt, updatedAt, nodeId) { 
        
        Migration.initialize(this, id, owner, guid, state, lockRepositories, excludeMetadata, excludeGitData, excludeAttachments, excludeReleases, excludeOwnerProjects, orgMetadataOnly, repositories, url, createdAt, updatedAt, nodeId);
    }
     ...
     */
    static initialize(obj, id, owner, guid, state, lockRepositories, excludeMetadata, excludeGitData, excludeAttachments, excludeReleases, excludeOwnerProjects, orgMetadataOnly, repositories, url, createdAt, updatedAt, nodeId) { 
        obj['id'] = id;
        obj['owner'] = owner;
        obj['guid'] = guid;
        obj['state'] = state;
...
Migration.RequiredProperties = ["id", "owner", "guid", "state", "lock_repositories", "exclude_metadata", "exclude_git_data", "exclude_attachments", "exclude_releases", "exclude_owner_projects", "org_metadata_only", "repositories", "url", "created_at", "updated_at", "node_id"];
