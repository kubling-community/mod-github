...
class ReleaseAsset {
    ...
    constructor(browserDownloadUrl, contentType, createdAt, downloadCount, id, label, name, nodeId, size, state, updatedAt, url) { 
        ...
        ReleaseAsset.initialize(this, browserDownloadUrl, contentType, createdAt, downloadCount, id, label, name, nodeId, size, state, updatedAt, url);
    }
...
ReleaseAsset.RequiredProperties = ["browser_download_url", "content_type", "created_at", "download_count", "id", "label", "name", "node_id", "size", "state", "updated_at", "url"];
