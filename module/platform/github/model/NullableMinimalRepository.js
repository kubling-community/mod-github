...
/**
 * The NullableMinimalRepository model module.
 * @module model/NullableMinimalRepository
 * @version 1.1.4
 */
class NullableMinimalRepository {
    /**
     * Constructs a new <code>NullableMinimalRepository</code>.
     * Minimal Repository
     * @alias module:model/NullableMinimalRepository
     * @param id {Number} 
     * @param nodeId {String} 
     * @param name {String} 
    ...
    constructor(id, nodeId, name, fullName, owner, _private, htmlUrl, description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, downloadsUrl, eventsUrl, forksUrl, gitCommitsUrl, gitRefsUrl, gitTagsUrl, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, notificationsUrl, pullsUrl, releasesUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, hooksUrl) { 
        ...
        NullableMinimalRepository.initialize(this, id, nodeId, name, fullName, owner, _private, htmlUrl, description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, downloadsUrl, eventsUrl, forksUrl, gitCommitsUrl, gitRefsUrl, gitTagsUrl, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, notificationsUrl, pullsUrl, releasesUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, hooksUrl);
    }
    ...
    /**
     * Constructs a <code>NullableMinimalRepository</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NullableMinimalRepository} obj Optional instance to populate.
     * @return {module:model/NullableMinimalRepository} The populated <code>NullableMinimalRepository</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NullableMinimalRepository();
    ...
    /**
     * Validates the JSON data with respect to <code>NullableMinimalRepository</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NullableMinimalRepository</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NullableMinimalRepository.RequiredProperties) {
...
NullableMinimalRepository.RequiredProperties = ["id", "node_id", "name", "full_name", "owner", "private", "html_url", "description", "fork", "url", "archive_url", "assignees_url", "blobs_url", "branches_url", "collaborators_url", "comments_url", "commits_url", "compare_url", "contents_url", "contributors_url", "deployments_url", "downloads_url", "events_url", "forks_url", "git_commits_url", "git_refs_url", "git_tags_url", "issue_comment_url", "issue_events_url", "issues_url", "keys_url", "labels_url", "languages_url", "merges_url", "milestones_url", "notifications_url", "pulls_url", "releases_url", "stargazers_url", "statuses_url", "subscribers_url", "subscription_url", "tags_url", "teams_url", "trees_url", "hooks_url"];

/**
 * @member {Number} id
 */
NullableMinimalRepository.prototype['id'] = undefined;

/**
 * @member {String} node_id
 */
NullableMinimalRepository.prototype['node_id'] = undefined;

/**
 * @member {String} name
 */
NullableMinimalRepository.prototype['name'] = undefined;

/**
 * @member {String} full_name
 */
NullableMinimalRepository.prototype['full_name'] = undefined;

/**
 * @member {module:model/SimpleUser} owner
 */
NullableMinimalRepository.prototype['owner'] = undefined;

/**
 * @member {Boolean} private
 */
NullableMinimalRepository.prototype['private'] = undefined;

/**
 * @member {String} html_url
 */
NullableMinimalRepository.prototype['html_url'] = undefined;

/**
 * @member {String} description
 */
NullableMinimalRepository.prototype['description'] = undefined;

/**
 * @member {Boolean} fork
 */
NullableMinimalRepository.prototype['fork'] = undefined;

/**
 * @member {String} url
 */
NullableMinimalRepository.prototype['url'] = undefined;

/**
 * @member {String} archive_url
 */
NullableMinimalRepository.prototype['archive_url'] = undefined;

/**
 * @member {String} assignees_url
 */
NullableMinimalRepository.prototype['assignees_url'] = undefined;

/**
 * @member {String} blobs_url
 */
NullableMinimalRepository.prototype['blobs_url'] = undefined;

/**
 * @member {String} branches_url
 */
NullableMinimalRepository.prototype['branches_url'] = undefined;

/**
 * @member {String} collaborators_url
 */
NullableMinimalRepository.prototype['collaborators_url'] = undefined;

/**
 * @member {String} comments_url
 */
NullableMinimalRepository.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
NullableMinimalRepository.prototype['commits_url'] = undefined;

/**
 * @member {String} compare_url
 */
NullableMinimalRepository.prototype['compare_url'] = undefined;

/**
 * @member {String} contents_url
 */
NullableMinimalRepository.prototype['contents_url'] = undefined;

/**
 * @member {String} contributors_url
 */
NullableMinimalRepository.prototype['contributors_url'] = undefined;

/**
 * @member {String} deployments_url
 */
NullableMinimalRepository.prototype['deployments_url'] = undefined;

/**
 * @member {String} downloads_url
 */
NullableMinimalRepository.prototype['downloads_url'] = undefined;

/**
 * @member {String} events_url
 */
NullableMinimalRepository.prototype['events_url'] = undefined;

/**
 * @member {String} forks_url
 */
NullableMinimalRepository.prototype['forks_url'] = undefined;

/**
 * @member {String} git_commits_url
 */
NullableMinimalRepository.prototype['git_commits_url'] = undefined;

/**
 * @member {String} git_refs_url
 */
NullableMinimalRepository.prototype['git_refs_url'] = undefined;

/**
 * @member {String} git_tags_url
 */
NullableMinimalRepository.prototype['git_tags_url'] = undefined;

/**
 * @member {String} git_url
 */
NullableMinimalRepository.prototype['git_url'] = undefined;

/**
 * @member {String} issue_comment_url
 */
NullableMinimalRepository.prototype['issue_comment_url'] = undefined;

/**
 * @member {String} issue_events_url
 */
NullableMinimalRepository.prototype['issue_events_url'] = undefined;

/**
 * @member {String} issues_url
 */
NullableMinimalRepository.prototype['issues_url'] = undefined;

/**
 * @member {String} keys_url
 */
NullableMinimalRepository.prototype['keys_url'] = undefined;

/**
 * @member {String} labels_url
 */
NullableMinimalRepository.prototype['labels_url'] = undefined;

/**
 * @member {String} languages_url
 */
NullableMinimalRepository.prototype['languages_url'] = undefined;

/**
 * @member {String} merges_url
 */
NullableMinimalRepository.prototype['merges_url'] = undefined;

/**
 * @member {String} milestones_url
 */
NullableMinimalRepository.prototype['milestones_url'] = undefined;

/**
 * @member {String} notifications_url
 */
NullableMinimalRepository.prototype['notifications_url'] = undefined;

/**
 * @member {String} pulls_url
 */
NullableMinimalRepository.prototype['pulls_url'] = undefined;

/**
 * @member {String} releases_url
 */
NullableMinimalRepository.prototype['releases_url'] = undefined;

/**
 * @member {String} ssh_url
 */
NullableMinimalRepository.prototype['ssh_url'] = undefined;

/**
 * @member {String} stargazers_url
 */
NullableMinimalRepository.prototype['stargazers_url'] = undefined;

/**
 * @member {String} statuses_url
 */
NullableMinimalRepository.prototype['statuses_url'] = undefined;

/**
 * @member {String} subscribers_url
 */
NullableMinimalRepository.prototype['subscribers_url'] = undefined;

/**
 * @member {String} subscription_url
 */
NullableMinimalRepository.prototype['subscription_url'] = undefined;

/**
 * @member {String} tags_url
 */
NullableMinimalRepository.prototype['tags_url'] = undefined;

/**
 * @member {String} teams_url
 */
NullableMinimalRepository.prototype['teams_url'] = undefined;

/**
 * @member {String} trees_url
 */
NullableMinimalRepository.prototype['trees_url'] = undefined;

/**
 * @member {String} clone_url
 */
NullableMinimalRepository.prototype['clone_url'] = undefined;

/**
 * @member {String} mirror_url
 */
NullableMinimalRepository.prototype['mirror_url'] = undefined;

/**
 * @member {String} hooks_url
 */
NullableMinimalRepository.prototype['hooks_url'] = undefined;

/**
 * @member {String} svn_url
 */
NullableMinimalRepository.prototype['svn_url'] = undefined;

/**
 * @member {String} homepage
 */
NullableMinimalRepository.prototype['homepage'] = undefined;

/**
 * @member {String} language
 */
NullableMinimalRepository.prototype['language'] = undefined;

/**
 * @member {Number} forks_count
 */
NullableMinimalRepository.prototype['forks_count'] = undefined;

/**
 * @member {Number} stargazers_count
 */
NullableMinimalRepository.prototype['stargazers_count'] = undefined;

/**
 * @member {Number} watchers_count
 */
NullableMinimalRepository.prototype['watchers_count'] = undefined;

/**
 * The size of the repository, in kilobytes. Size is calculated hourly. When a repository is initially created, the size is 0.
 * @member {Number} size
 */
NullableMinimalRepository.prototype['size'] = undefined;

/**
 * @member {String} default_branch
 */
NullableMinimalRepository.prototype['default_branch'] = undefined;

/**
 * @member {Number} open_issues_count
 */
NullableMinimalRepository.prototype['open_issues_count'] = undefined;

/**
 * @member {Boolean} is_template
 */
NullableMinimalRepository.prototype['is_template'] = undefined;

/**
 * @member {Array.<String>} topics
 */
NullableMinimalRepository.prototype['topics'] = undefined;

/**
 * @member {Boolean} has_issues
 */
NullableMinimalRepository.prototype['has_issues'] = undefined;

/**
 * @member {Boolean} has_projects
 */
NullableMinimalRepository.prototype['has_projects'] = undefined;

/**
 * @member {Boolean} has_wiki
 */
NullableMinimalRepository.prototype['has_wiki'] = undefined;

/**
 * @member {Boolean} has_pages
 */
NullableMinimalRepository.prototype['has_pages'] = undefined;

/**
 * @member {Boolean} has_downloads
 */
NullableMinimalRepository.prototype['has_downloads'] = undefined;

/**
 * @member {Boolean} has_discussions
 */
NullableMinimalRepository.prototype['has_discussions'] = undefined;

/**
 * @member {Boolean} archived
 */
NullableMinimalRepository.prototype['archived'] = undefined;

/**
 * @member {Boolean} disabled
 */
NullableMinimalRepository.prototype['disabled'] = undefined;

/**
 * @member {String} visibility
 */
NullableMinimalRepository.prototype['visibility'] = undefined;

/**
 * @member {Date} pushed_at
 */
NullableMinimalRepository.prototype['pushed_at'] = undefined;

/**
 * @member {Date} created_at
 */
NullableMinimalRepository.prototype['created_at'] = undefined;

/**
 * @member {Date} updated_at
 */
NullableMinimalRepository.prototype['updated_at'] = undefined;

/**
 * @member {module:model/MinimalRepositoryPermissions} permissions
 */
NullableMinimalRepository.prototype['permissions'] = undefined;

/**
 * @member {String} role_name
 */
NullableMinimalRepository.prototype['role_name'] = undefined;

/**
 * @member {String} temp_clone_token
 */
NullableMinimalRepository.prototype['temp_clone_token'] = undefined;

/**
 * @member {Boolean} delete_branch_on_merge
 */
NullableMinimalRepository.prototype['delete_branch_on_merge'] = undefined;

/**
 * @member {Number} subscribers_count
 */
NullableMinimalRepository.prototype['subscribers_count'] = undefined;

/**
 * @member {Number} network_count
 */
NullableMinimalRepository.prototype['network_count'] = undefined;

/**
 * @member {module:model/CodeOfConduct} code_of_conduct
 */
NullableMinimalRepository.prototype['code_of_conduct'] = undefined;

/**
 * @member {module:model/MinimalRepositoryLicense} license
 */
NullableMinimalRepository.prototype['license'] = undefined;

/**
 * @member {Number} forks
 */
NullableMinimalRepository.prototype['forks'] = undefined;

/**
 * @member {Number} open_issues
 */
NullableMinimalRepository.prototype['open_issues'] = undefined;

/**
 * @member {Number} watchers
 */
NullableMinimalRepository.prototype['watchers'] = undefined;

/**
 * @member {Boolean} allow_forking
 */
NullableMinimalRepository.prototype['allow_forking'] = undefined;

/**
 * @member {Boolean} web_commit_signoff_required
 */
NullableMinimalRepository.prototype['web_commit_signoff_required'] = undefined;

/**
 * @member {module:model/SecurityAndAnalysis} security_and_analysis
 */
NullableMinimalRepository.prototype['security_and_analysis'] = undefined;
...
export default NullableMinimalRepository;
