...
class OrganizationFullPlan {
     ...
     */
    constructor(name, space, privateRepos) { 
        
        OrganizationFullPlan.initialize(this, name, space, privateRepos);
    }
     ...
     */
    static initialize(obj, name, space, privateRepos) { 
        obj['name'] = name;
        obj['space'] = space;
...
OrganizationFullPlan.RequiredProperties = ["name", "space", "private_repos"];
