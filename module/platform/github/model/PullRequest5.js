...
/**
 * The PullRequest5 model module.
 * @module model/PullRequest5
 * @version 1.1.4
 */
class PullRequest5 {
    /**
     * Constructs a new <code>PullRequest5</code>.
     * @alias module:model/PullRequest5
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/PullRequest5.ActiveLockReasonEnum} 
     * @param assignee {module:model/User} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/PullRequest5.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param state {module:model/PullRequest5.StateEnum} State of this Pull Request. Either `open` or `closed`.
    ...
    constructor(links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
        ...
        PullRequest5.initialize(this, links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>PullRequest5</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequest5} obj Optional instance to populate.
     * @return {module:model/PullRequest5} The populated <code>PullRequest5</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequest5();
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequest5</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequest5</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PullRequest5.RequiredProperties) {
...
PullRequest5.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "auto_merge", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "draft", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksPullRequest5Links} _links
 */
PullRequest5.prototype['_links'] = undefined;

/**
 * @member {module:model/PullRequest5.ActiveLockReasonEnum} active_lock_reason
 */
PullRequest5.prototype['active_lock_reason'] = undefined;

/**
 * @member {Number} additions
 */
PullRequest5.prototype['additions'] = undefined;

/**
 * @member {module:model/User} assignee
 */
PullRequest5.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User1>} assignees
 */
PullRequest5.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/PullRequest5.AuthorAssociationEnum} author_association
 */
PullRequest5.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
PullRequest5.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequestBase} base
 */
PullRequest5.prototype['base'] = undefined;

/**
 * @member {String} body
 */
PullRequest5.prototype['body'] = undefined;

/**
 * @member {Number} changed_files
 */
PullRequest5.prototype['changed_files'] = undefined;

/**
 * @member {Date} closed_at
 */
PullRequest5.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
PullRequest5.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
PullRequest5.prototype['comments_url'] = undefined;

/**
 * @member {Number} commits
 */
PullRequest5.prototype['commits'] = undefined;

/**
 * @member {String} commits_url
 */
PullRequest5.prototype['commits_url'] = undefined;

/**
 * @member {Date} created_at
 */
PullRequest5.prototype['created_at'] = undefined;

/**
 * @member {Number} deletions
 */
PullRequest5.prototype['deletions'] = undefined;

/**
 * @member {String} diff_url
 */
PullRequest5.prototype['diff_url'] = undefined;

/**
 * Indicates whether or not the pull request is a draft.
 * @member {Boolean} draft
 */
PullRequest5.prototype['draft'] = undefined;

/**
 * @member {module:model/PullRequestHead} head
 */
PullRequest5.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
PullRequest5.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
PullRequest5.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
PullRequest5.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
PullRequest5.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
PullRequest5.prototype['locked'] = undefined;

/**
 * Indicates whether maintainers can modify the pull request.
 * @member {Boolean} maintainer_can_modify
 */
PullRequest5.prototype['maintainer_can_modify'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
PullRequest5.prototype['merge_commit_sha'] = undefined;

/**
 * @member {Boolean} mergeable
 */
PullRequest5.prototype['mergeable'] = undefined;

/**
 * @member {String} mergeable_state
 */
PullRequest5.prototype['mergeable_state'] = undefined;

/**
 * @member {Boolean} merged
 */
PullRequest5.prototype['merged'] = undefined;

/**
 * @member {Date} merged_at
 */
PullRequest5.prototype['merged_at'] = undefined;

/**
 * @member {module:model/User1} merged_by
 */
PullRequest5.prototype['merged_by'] = undefined;

/**
 * @member {module:model/Milestone1} milestone
 */
PullRequest5.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
PullRequest5.prototype['node_id'] = undefined;

/**
 * Number uniquely identifying the pull request within its repository.
 * @member {Number} number
 */
PullRequest5.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
PullRequest5.prototype['patch_url'] = undefined;

/**
 * @member {Boolean} rebaseable
 */
PullRequest5.prototype['rebaseable'] = undefined;

/**
 * @member {Array.<module:model/PullRequestRequestedReviewersInner>} requested_reviewers
 */
PullRequest5.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
PullRequest5.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
PullRequest5.prototype['review_comment_url'] = undefined;

/**
 * @member {Number} review_comments
 */
PullRequest5.prototype['review_comments'] = undefined;

/**
 * @member {String} review_comments_url
 */
PullRequest5.prototype['review_comments_url'] = undefined;

/**
 * State of this Pull Request. Either `open` or `closed`.
 * @member {module:model/PullRequest5.StateEnum} state
 */
PullRequest5.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
PullRequest5.prototype['statuses_url'] = undefined;

/**
 * The title of the pull request.
 * @member {String} title
 */
PullRequest5.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
PullRequest5.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
PullRequest5.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
PullRequest5.prototype['user'] = undefined;
 ...
 * @readonly
 */
PullRequest5['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
PullRequest5['AuthorAssociationEnum'] = {
