...
class TopicSearchResultItem {
     ...
     * @param score {Number} 
     */
    constructor(name, displayName, shortDescription, description, createdBy, released, createdAt, updatedAt, featured, curated, score) { 
        
        TopicSearchResultItem.initialize(this, name, displayName, shortDescription, description, createdBy, released, createdAt, updatedAt, featured, curated, score);
    }
     ...
     */
    static initialize(obj, name, displayName, shortDescription, description, createdBy, released, createdAt, updatedAt, featured, curated, score) { 
        obj['name'] = name;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('related')) {
                obj['related'] = ApiClient.convertToType(data['related'], [TopicSearchResultItemRelatedInner]);
            }
            if (data.hasOwnProperty('aliases')) {
                obj['aliases'] = ApiClient.convertToType(data['aliases'], [TopicSearchResultItemRelatedInner]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['related']) { // data not null
            ...
            for (const item of data['related']) {
                TopicSearchResultItemRelatedInner.validateJSON(item);
            };
        }
...
TopicSearchResultItem.RequiredProperties = ["name", "display_name", "short_description", "description", "created_by", "released", "created_at", "updated_at", "featured", "curated", "score"];
...
/**
 * @member {Array.<module:model/TopicSearchResultItemRelatedInner>} related
 */
TopicSearchResultItem.prototype['related'] = undefined;

/**
 * @member {Array.<module:model/TopicSearchResultItemRelatedInner>} aliases
 */
