...
class ThreadSubject {
     ...
     * @param type {String} 
     */
    constructor(title, url, latestCommentUrl, type) { 
        
        ThreadSubject.initialize(this, title, url, latestCommentUrl, type);
    }
     ...
     */
    static initialize(obj, title, url, latestCommentUrl, type) { 
        obj['title'] = title;
        obj['url'] = url;
...
ThreadSubject.RequiredProperties = ["title", "url", "latest_comment_url", "type"];
