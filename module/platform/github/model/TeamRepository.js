...
class TeamRepository {
    ...
    constructor(id, nodeId, name, fullName, license, forks, owner, _private, htmlUrl, description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, downloadsUrl, eventsUrl, forksUrl, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, notificationsUrl, pullsUrl, releasesUrl, sshUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, cloneUrl, mirrorUrl, hooksUrl, svnUrl, homepage, language, forksCount, stargazersCount, watchersCount, size, defaultBranch, openIssuesCount, hasIssues, hasProjects, hasWiki, hasPages, hasDownloads, archived, disabled, pushedAt, createdAt, updatedAt, openIssues, watchers) { 
        ...
        TeamRepository.initialize(this, id, nodeId, name, fullName, license, forks, owner, _private, htmlUrl, description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, downloadsUrl, eventsUrl, forksUrl, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, notificationsUrl, pullsUrl, releasesUrl, sshUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, cloneUrl, mirrorUrl, hooksUrl, svnUrl, homepage, language, forksCount, stargazersCount, watchersCount, size, defaultBranch, openIssuesCount, hasIssues, hasProjects, hasWiki, hasPages, hasDownloads, archived, disabled, pushedAt, createdAt, updatedAt, openIssues, watchers);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TeamRepository</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TeamRepository</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TeamRepository.RequiredProperties) {
 ...
 */
TeamRepository.prototype['role_name'] = undefined;
 ...
 * @default false
 */
TeamRepository.prototype['allow_auto_merge'] = false;
 ...
 * @default false
 */
TeamRepository.prototype['allow_forking'] = false;
 ...
 * @default false
 */
TeamRepository.prototype['web_commit_signoff_required'] = false;
