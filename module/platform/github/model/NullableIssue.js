...
class NullableIssue {
     ...
     */
    constructor(id, nodeId, url, repositoryUrl, labelsUrl, commentsUrl, eventsUrl, htmlUrl, number, state, title, user, labels, assignee, milestone, locked, comments, closedAt, createdAt, updatedAt, authorAssociation) { 
        
        NullableIssue.initialize(this, id, nodeId, url, repositoryUrl, labelsUrl, commentsUrl, eventsUrl, htmlUrl, number, state, title, user, labels, assignee, milestone, locked, comments, closedAt, createdAt, updatedAt, authorAssociation);
    }
     ...
     */
    static initialize(obj, id, nodeId, url, repositoryUrl, labelsUrl, commentsUrl, eventsUrl, htmlUrl, number, state, title, user, labels, assignee, milestone, locked, comments, closedAt, createdAt, updatedAt, authorAssociation) { 
        obj['id'] = id;
        obj['node_id'] = nodeId;
        obj['url'] = url;
...
NullableIssue.RequiredProperties = ["id", "node_id", "url", "repository_url", "labels_url", "comments_url", "events_url", "html_url", "number", "state", "title", "user", "labels", "assignee", "milestone", "locked", "comments", "closed_at", "created_at", "updated_at", "author_association"];
