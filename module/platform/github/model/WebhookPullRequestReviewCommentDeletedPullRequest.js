...
import WebhookPullRequestReviewCommentDeletedPullRequestHead from './WebhookPullRequestReviewCommentDeletedPullRequestHead';
import WebhooksPullRequest5Links from './WebhooksPullRequest5Links';
import WebhooksPullRequest5RequestedReviewersInner from './WebhooksPullRequest5RequestedReviewersInner';

/**
 * The WebhookPullRequestReviewCommentDeletedPullRequest model module.
 * @module model/WebhookPullRequestReviewCommentDeletedPullRequest
 * @version 1.1.4
 */
class WebhookPullRequestReviewCommentDeletedPullRequest {
    /**
     * Constructs a new <code>WebhookPullRequestReviewCommentDeletedPullRequest</code>.
     * @alias module:model/WebhookPullRequestReviewCommentDeletedPullRequest
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/WebhookPullRequestReviewCommentDeletedPullRequest.ActiveLockReasonEnum} 
     * @param assignee {module:model/User} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/WebhookPullRequestReviewCommentDeletedPullRequest.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param head {module:model/WebhookPullRequestReviewCommentDeletedPullRequestHead} 
     ...
     * @param milestone {module:model/Milestone1} 
     * @param nodeId {String} 
     * @param number {Number} 
     * @param patchUrl {String} 
     * @param requestedReviewers {Array.<module:model/WebhooksPullRequest5RequestedReviewersInner>} 
     * @param requestedTeams {Array.<module:model/Team>} 
     * @param reviewCommentUrl {String} 
     * @param reviewCommentsUrl {String} 
     * @param state {module:model/WebhookPullRequestReviewCommentDeletedPullRequest.StateEnum} 
     ...
     */
    constructor(links, activeLockReason, assignee, assignees, authorAssociation, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
        
        WebhookPullRequestReviewCommentDeletedPullRequest.initialize(this, links, activeLockReason, assignee, assignees, authorAssociation, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user);
    }
     ...
     */
    static initialize(obj, links, activeLockReason, assignee, assignees, authorAssociation, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
        obj['_links'] = links;
    ...
    /**
     * Constructs a <code>WebhookPullRequestReviewCommentDeletedPullRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookPullRequestReviewCommentDeletedPullRequest} obj Optional instance to populate.
     * @return {module:model/WebhookPullRequestReviewCommentDeletedPullRequest} The populated <code>WebhookPullRequestReviewCommentDeletedPullRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookPullRequestReviewCommentDeletedPullRequest();
            ...
            if (data.hasOwnProperty('head')) {
                obj['head'] = WebhookPullRequestReviewCommentDeletedPullRequestHead.constructFromObject(data['head']);
            }
            ...
            if (data.hasOwnProperty('milestone')) {
                obj['milestone'] = Milestone1.constructFromObject(data['milestone']);
            }
            ...
            if (data.hasOwnProperty('requested_reviewers')) {
                obj['requested_reviewers'] = ApiClient.convertToType(data['requested_reviewers'], [WebhooksPullRequest5RequestedReviewersInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookPullRequestReviewCommentDeletedPullRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookPullRequestReviewCommentDeletedPullRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookPullRequestReviewCommentDeletedPullRequest.RequiredProperties) {
        ...
        if (data['head']) { // data not null
          WebhookPullRequestReviewCommentDeletedPullRequestHead.validateJSON(data['head']);
        }
        // ensure the json data is a string
        ...
        if (data['milestone']) { // data not null
          Milestone1.validateJSON(data['milestone']);
        }
        // ensure the json data is a string
        ...
        if (data['requested_reviewers']) { // data not null
            ...
            for (const item of data['requested_reviewers']) {
                WebhooksPullRequest5RequestedReviewersInner.validateJSON(item);
            };
        }
...
WebhookPullRequestReviewCommentDeletedPullRequest.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksPullRequest5Links} _links
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['_links'] = undefined;

/**
 * @member {module:model/WebhookPullRequestReviewCommentDeletedPullRequest.ActiveLockReasonEnum} active_lock_reason
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User} assignee
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/WebhookPullRequestReviewCommentDeletedPullRequest.AuthorAssociationEnum} author_association
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequestBase} base
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['base'] = undefined;

/**
 * @member {String} body
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['body'] = undefined;

/**
 * @member {String} closed_at
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['closed_at'] = undefined;

/**
 * @member {String} comments_url
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['commits_url'] = undefined;

/**
 * @member {String} created_at
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['created_at'] = undefined;

/**
 * @member {String} diff_url
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['diff_url'] = undefined;

/**
 * @member {Boolean} draft
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['draft'] = undefined;

/**
 * @member {module:model/WebhookPullRequestReviewCommentDeletedPullRequestHead} head
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['locked'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['merge_commit_sha'] = undefined;

/**
 * @member {String} merged_at
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['merged_at'] = undefined;

/**
 * @member {module:model/Milestone1} milestone
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['patch_url'] = undefined;

/**
 * @member {Array.<module:model/WebhooksPullRequest5RequestedReviewersInner>} requested_reviewers
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['review_comment_url'] = undefined;

/**
 * @member {String} review_comments_url
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['review_comments_url'] = undefined;

/**
 * @member {module:model/WebhookPullRequestReviewCommentDeletedPullRequest.StateEnum} state
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['statuses_url'] = undefined;

/**
 * @member {String} title
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['title'] = undefined;

/**
 * @member {String} updated_at
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
WebhookPullRequestReviewCommentDeletedPullRequest.prototype['user'] = undefined;
 ...
 * @readonly
 */
WebhookPullRequestReviewCommentDeletedPullRequest['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
WebhookPullRequestReviewCommentDeletedPullRequest['AuthorAssociationEnum'] = {
 ...
 * @readonly
 */
WebhookPullRequestReviewCommentDeletedPullRequest['StateEnum'] = {
...
export default WebhookPullRequestReviewCommentDeletedPullRequest;
