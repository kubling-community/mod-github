...
/**
 * The PullRequestHeadRepoOwner model module.
 * @module model/PullRequestHeadRepoOwner
 * @version 1.1.4
 */
class PullRequestHeadRepoOwner {
    /**
     * Constructs a new <code>PullRequestHeadRepoOwner</code>.
     * @alias module:model/PullRequestHeadRepoOwner
     ...
     * @param url {String} 
     */
    constructor(avatarUrl, eventsUrl, followersUrl, followingUrl, gistsUrl, gravatarId, htmlUrl, id, nodeId, login, organizationsUrl, receivedEventsUrl, reposUrl, siteAdmin, starredUrl, subscriptionsUrl, type, url) { 
        
        PullRequestHeadRepoOwner.initialize(this, avatarUrl, eventsUrl, followersUrl, followingUrl, gistsUrl, gravatarId, htmlUrl, id, nodeId, login, organizationsUrl, receivedEventsUrl, reposUrl, siteAdmin, starredUrl, subscriptionsUrl, type, url);
    }
     ...
     */
    static initialize(obj, avatarUrl, eventsUrl, followersUrl, followingUrl, gistsUrl, gravatarId, htmlUrl, id, nodeId, login, organizationsUrl, receivedEventsUrl, reposUrl, siteAdmin, starredUrl, subscriptionsUrl, type, url) { 
    ...
    /**
     * Constructs a <code>PullRequestHeadRepoOwner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestHeadRepoOwner} obj Optional instance to populate.
     * @return {module:model/PullRequestHeadRepoOwner} The populated <code>PullRequestHeadRepoOwner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestHeadRepoOwner();
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestHeadRepoOwner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestHeadRepoOwner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PullRequestHeadRepoOwner.RequiredProperties) {
...
PullRequestHeadRepoOwner.RequiredProperties = ["avatar_url", "events_url", "followers_url", "following_url", "gists_url", "gravatar_id", "html_url", "id", "node_id", "login", "organizations_url", "received_events_url", "repos_url", "site_admin", "starred_url", "subscriptions_url", "type", "url"];

/**
 * @member {String} avatar_url
 */
PullRequestHeadRepoOwner.prototype['avatar_url'] = undefined;

/**
 * @member {String} events_url
 */
PullRequestHeadRepoOwner.prototype['events_url'] = undefined;

/**
 * @member {String} followers_url
 */
PullRequestHeadRepoOwner.prototype['followers_url'] = undefined;

/**
 * @member {String} following_url
 */
PullRequestHeadRepoOwner.prototype['following_url'] = undefined;

/**
 * @member {String} gists_url
 */
PullRequestHeadRepoOwner.prototype['gists_url'] = undefined;

/**
 * @member {String} gravatar_id
 */
PullRequestHeadRepoOwner.prototype['gravatar_id'] = undefined;

/**
 * @member {String} html_url
 */
PullRequestHeadRepoOwner.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
PullRequestHeadRepoOwner.prototype['id'] = undefined;

/**
 * @member {String} node_id
 */
PullRequestHeadRepoOwner.prototype['node_id'] = undefined;

/**
 * @member {String} login
 */
PullRequestHeadRepoOwner.prototype['login'] = undefined;

/**
 * @member {String} organizations_url
 */
PullRequestHeadRepoOwner.prototype['organizations_url'] = undefined;

/**
 * @member {String} received_events_url
 */
PullRequestHeadRepoOwner.prototype['received_events_url'] = undefined;

/**
 * @member {String} repos_url
 */
PullRequestHeadRepoOwner.prototype['repos_url'] = undefined;

/**
 * @member {Boolean} site_admin
 */
PullRequestHeadRepoOwner.prototype['site_admin'] = undefined;

/**
 * @member {String} starred_url
 */
PullRequestHeadRepoOwner.prototype['starred_url'] = undefined;

/**
 * @member {String} subscriptions_url
 */
PullRequestHeadRepoOwner.prototype['subscriptions_url'] = undefined;

/**
 * @member {String} type
 */
PullRequestHeadRepoOwner.prototype['type'] = undefined;

/**
 * @member {String} url
 */
PullRequestHeadRepoOwner.prototype['url'] = undefined;
...
export default PullRequestHeadRepoOwner;
