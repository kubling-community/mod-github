...
/**
 * The RepositoryAdvisoryPrivateFork model module.
 * @module model/RepositoryAdvisoryPrivateFork
 * @version 1.1.4
 */
class RepositoryAdvisoryPrivateFork {
    /**
     * Constructs a new <code>RepositoryAdvisoryPrivateFork</code>.
     * A temporary private fork of the advisory&#39;s repository for collaborating on a fix.
     * @alias module:model/RepositoryAdvisoryPrivateFork
     * @implements module:model/SimpleRepository
    ...
    constructor(id, nodeId, name, fullName, owner, _private, htmlUrl, description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, downloadsUrl, eventsUrl, forksUrl, gitCommitsUrl, gitRefsUrl, gitTagsUrl, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, notificationsUrl, pullsUrl, releasesUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, hooksUrl) { 
        ...
        RepositoryAdvisoryPrivateFork.initialize(this, id, nodeId, name, fullName, owner, _private, htmlUrl, description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, downloadsUrl, eventsUrl, forksUrl, gitCommitsUrl, gitRefsUrl, gitTagsUrl, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, notificationsUrl, pullsUrl, releasesUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, hooksUrl);
    }
    ...
    /**
     * Constructs a <code>RepositoryAdvisoryPrivateFork</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryAdvisoryPrivateFork} obj Optional instance to populate.
     * @return {module:model/RepositoryAdvisoryPrivateFork} The populated <code>RepositoryAdvisoryPrivateFork</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryAdvisoryPrivateFork();
            SimpleRepository.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryAdvisoryPrivateFork</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryAdvisoryPrivateFork</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RepositoryAdvisoryPrivateFork.RequiredProperties) {
...
RepositoryAdvisoryPrivateFork.RequiredProperties = ["id", "node_id", "name", "full_name", "owner", "private", "html_url", "description", "fork", "url", "archive_url", "assignees_url", "blobs_url", "branches_url", "collaborators_url", "comments_url", "commits_url", "compare_url", "contents_url", "contributors_url", "deployments_url", "downloads_url", "events_url", "forks_url", "git_commits_url", "git_refs_url", "git_tags_url", "issue_comment_url", "issue_events_url", "issues_url", "keys_url", "labels_url", "languages_url", "merges_url", "milestones_url", "notifications_url", "pulls_url", "releases_url", "stargazers_url", "statuses_url", "subscribers_url", "subscription_url", "tags_url", "teams_url", "trees_url", "hooks_url"];

/**
 * A unique identifier of the repository.
 * @member {Number} id
 */
RepositoryAdvisoryPrivateFork.prototype['id'] = undefined;

/**
 * The GraphQL identifier of the repository.
 * @member {String} node_id
 */
RepositoryAdvisoryPrivateFork.prototype['node_id'] = undefined;

/**
 * The name of the repository.
 * @member {String} name
 */
RepositoryAdvisoryPrivateFork.prototype['name'] = undefined;

/**
 * The full, globally unique, name of the repository.
 * @member {String} full_name
 */
RepositoryAdvisoryPrivateFork.prototype['full_name'] = undefined;

/**
 * @member {module:model/SimpleUser} owner
 */
RepositoryAdvisoryPrivateFork.prototype['owner'] = undefined;

/**
 * Whether the repository is private.
 * @member {Boolean} private
 */
RepositoryAdvisoryPrivateFork.prototype['private'] = undefined;

/**
 * The URL to view the repository on GitHub.com.
 * @member {String} html_url
 */
RepositoryAdvisoryPrivateFork.prototype['html_url'] = undefined;

/**
 * The repository description.
 * @member {String} description
 */
RepositoryAdvisoryPrivateFork.prototype['description'] = undefined;

/**
 * Whether the repository is a fork.
 * @member {Boolean} fork
 */
RepositoryAdvisoryPrivateFork.prototype['fork'] = undefined;

/**
 * The URL to get more information about the repository from the GitHub API.
 * @member {String} url
 */
RepositoryAdvisoryPrivateFork.prototype['url'] = undefined;

/**
 * A template for the API URL to download the repository as an archive.
 * @member {String} archive_url
 */
RepositoryAdvisoryPrivateFork.prototype['archive_url'] = undefined;

/**
 * A template for the API URL to list the available assignees for issues in the repository.
 * @member {String} assignees_url
 */
RepositoryAdvisoryPrivateFork.prototype['assignees_url'] = undefined;

/**
 * A template for the API URL to create or retrieve a raw Git blob in the repository.
 * @member {String} blobs_url
 */
RepositoryAdvisoryPrivateFork.prototype['blobs_url'] = undefined;

/**
 * A template for the API URL to get information about branches in the repository.
 * @member {String} branches_url
 */
RepositoryAdvisoryPrivateFork.prototype['branches_url'] = undefined;

/**
 * A template for the API URL to get information about collaborators of the repository.
 * @member {String} collaborators_url
 */
RepositoryAdvisoryPrivateFork.prototype['collaborators_url'] = undefined;

/**
 * A template for the API URL to get information about comments on the repository.
 * @member {String} comments_url
 */
RepositoryAdvisoryPrivateFork.prototype['comments_url'] = undefined;

/**
 * A template for the API URL to get information about commits on the repository.
 * @member {String} commits_url
 */
RepositoryAdvisoryPrivateFork.prototype['commits_url'] = undefined;

/**
 * A template for the API URL to compare two commits or refs.
 * @member {String} compare_url
 */
RepositoryAdvisoryPrivateFork.prototype['compare_url'] = undefined;

/**
 * A template for the API URL to get the contents of the repository.
 * @member {String} contents_url
 */
RepositoryAdvisoryPrivateFork.prototype['contents_url'] = undefined;

/**
 * A template for the API URL to list the contributors to the repository.
 * @member {String} contributors_url
 */
RepositoryAdvisoryPrivateFork.prototype['contributors_url'] = undefined;

/**
 * The API URL to list the deployments of the repository.
 * @member {String} deployments_url
 */
RepositoryAdvisoryPrivateFork.prototype['deployments_url'] = undefined;

/**
 * The API URL to list the downloads on the repository.
 * @member {String} downloads_url
 */
RepositoryAdvisoryPrivateFork.prototype['downloads_url'] = undefined;

/**
 * The API URL to list the events of the repository.
 * @member {String} events_url
 */
RepositoryAdvisoryPrivateFork.prototype['events_url'] = undefined;

/**
 * The API URL to list the forks of the repository.
 * @member {String} forks_url
 */
RepositoryAdvisoryPrivateFork.prototype['forks_url'] = undefined;

/**
 * A template for the API URL to get information about Git commits of the repository.
 * @member {String} git_commits_url
 */
RepositoryAdvisoryPrivateFork.prototype['git_commits_url'] = undefined;

/**
 * A template for the API URL to get information about Git refs of the repository.
 * @member {String} git_refs_url
 */
RepositoryAdvisoryPrivateFork.prototype['git_refs_url'] = undefined;

/**
 * A template for the API URL to get information about Git tags of the repository.
 * @member {String} git_tags_url
 */
RepositoryAdvisoryPrivateFork.prototype['git_tags_url'] = undefined;

/**
 * A template for the API URL to get information about issue comments on the repository.
 * @member {String} issue_comment_url
 */
RepositoryAdvisoryPrivateFork.prototype['issue_comment_url'] = undefined;

/**
 * A template for the API URL to get information about issue events on the repository.
 * @member {String} issue_events_url
 */
RepositoryAdvisoryPrivateFork.prototype['issue_events_url'] = undefined;

/**
 * A template for the API URL to get information about issues on the repository.
 * @member {String} issues_url
 */
RepositoryAdvisoryPrivateFork.prototype['issues_url'] = undefined;

/**
 * A template for the API URL to get information about deploy keys on the repository.
 * @member {String} keys_url
 */
RepositoryAdvisoryPrivateFork.prototype['keys_url'] = undefined;

/**
 * A template for the API URL to get information about labels of the repository.
 * @member {String} labels_url
 */
RepositoryAdvisoryPrivateFork.prototype['labels_url'] = undefined;

/**
 * The API URL to get information about the languages of the repository.
 * @member {String} languages_url
 */
RepositoryAdvisoryPrivateFork.prototype['languages_url'] = undefined;

/**
 * The API URL to merge branches in the repository.
 * @member {String} merges_url
 */
RepositoryAdvisoryPrivateFork.prototype['merges_url'] = undefined;

/**
 * A template for the API URL to get information about milestones of the repository.
 * @member {String} milestones_url
 */
RepositoryAdvisoryPrivateFork.prototype['milestones_url'] = undefined;

/**
 * A template for the API URL to get information about notifications on the repository.
 * @member {String} notifications_url
 */
RepositoryAdvisoryPrivateFork.prototype['notifications_url'] = undefined;

/**
 * A template for the API URL to get information about pull requests on the repository.
 * @member {String} pulls_url
 */
RepositoryAdvisoryPrivateFork.prototype['pulls_url'] = undefined;

/**
 * A template for the API URL to get information about releases on the repository.
 * @member {String} releases_url
 */
RepositoryAdvisoryPrivateFork.prototype['releases_url'] = undefined;

/**
 * The API URL to list the stargazers on the repository.
 * @member {String} stargazers_url
 */
RepositoryAdvisoryPrivateFork.prototype['stargazers_url'] = undefined;

/**
 * A template for the API URL to get information about statuses of a commit.
 * @member {String} statuses_url
 */
RepositoryAdvisoryPrivateFork.prototype['statuses_url'] = undefined;

/**
 * The API URL to list the subscribers on the repository.
 * @member {String} subscribers_url
 */
RepositoryAdvisoryPrivateFork.prototype['subscribers_url'] = undefined;

/**
 * The API URL to subscribe to notifications for this repository.
 * @member {String} subscription_url
 */
RepositoryAdvisoryPrivateFork.prototype['subscription_url'] = undefined;

/**
 * The API URL to get information about tags on the repository.
 * @member {String} tags_url
 */
RepositoryAdvisoryPrivateFork.prototype['tags_url'] = undefined;

/**
 * The API URL to list the teams on the repository.
 * @member {String} teams_url
 */
RepositoryAdvisoryPrivateFork.prototype['teams_url'] = undefined;

/**
 * A template for the API URL to create or retrieve a raw Git tree of the repository.
 * @member {String} trees_url
 */
RepositoryAdvisoryPrivateFork.prototype['trees_url'] = undefined;

/**
 * The API URL to list the hooks on the repository.
 * @member {String} hooks_url
 */
RepositoryAdvisoryPrivateFork.prototype['hooks_url'] = undefined;


// Implement SimpleRepository interface:
/**
 * A unique identifier of the repository.
 * @member {Number} id
 */
...
export default RepositoryAdvisoryPrivateFork;
