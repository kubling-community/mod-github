...
import RuleSuiteRuleEvaluationsInner from './RuleSuiteRuleEvaluationsInner';

/**
 * The RuleSuite model module.
 * @module model/RuleSuite
 * @version 1.1.4
 */
class RuleSuite {
    /**
     * Constructs a new <code>RuleSuite</code>.
     * Response
     * @alias module:model/RuleSuite
     */
    constructor() { 
        
        RuleSuite.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RuleSuite</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RuleSuite} obj Optional instance to populate.
     * @return {module:model/RuleSuite} The populated <code>RuleSuite</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RuleSuite();
            ...
            if (data.hasOwnProperty('rule_evaluations')) {
                obj['rule_evaluations'] = ApiClient.convertToType(data['rule_evaluations'], [RuleSuiteRuleEvaluationsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RuleSuite</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuleSuite</code>.
     */
    static validateJSON(data) {
        ...
        if (data['rule_evaluations']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['rule_evaluations'])) {
                throw new Error("Expected the field `rule_evaluations` to be an array in the JSON data but got " + data['rule_evaluations']);
            }
            // validate the optional field `rule_evaluations` (array)
            for (const item of data['rule_evaluations']) {
                RuleSuiteRuleEvaluationsInner.validateJSON(item);
            };
        }
 ...
 * @member {Number} id
 */
RuleSuite.prototype['id'] = undefined;

/**
 * The number that identifies the user.
 * @member {Number} actor_id
 */
RuleSuite.prototype['actor_id'] = undefined;

/**
 * The handle for the GitHub user account.
 * @member {String} actor_name
 */
RuleSuite.prototype['actor_name'] = undefined;

/**
 * The first commit sha before the push evaluation.
 * @member {String} before_sha
 */
RuleSuite.prototype['before_sha'] = undefined;

/**
 * The last commit sha in the push evaluation.
 * @member {String} after_sha
 */
RuleSuite.prototype['after_sha'] = undefined;

/**
 * The ref name that the evaluation ran on.
 * @member {String} ref
 */
RuleSuite.prototype['ref'] = undefined;

/**
 * The ID of the repository associated with the rule evaluation.
 * @member {Number} repository_id
 */
RuleSuite.prototype['repository_id'] = undefined;

/**
 * The name of the repository without the `.git` extension.
 * @member {String} repository_name
 */
RuleSuite.prototype['repository_name'] = undefined;

/**
 * @member {Date} pushed_at
 */
RuleSuite.prototype['pushed_at'] = undefined;

/**
 * The result of the rule evaluations for rules with the `active` enforcement status.
 * @member {module:model/RuleSuite.ResultEnum} result
 */
RuleSuite.prototype['result'] = undefined;

/**
 * The result of the rule evaluations for rules with the `active` and `evaluate` enforcement statuses, demonstrating whether rules would pass or fail if all rules in the rule suite were `active`.
 * @member {module:model/RuleSuite.EvaluationResultEnum} evaluation_result
 */
RuleSuite.prototype['evaluation_result'] = undefined;

/**
 * Details on the evaluated rules.
 * @member {Array.<module:model/RuleSuiteRuleEvaluationsInner>} rule_evaluations
 */
RuleSuite.prototype['rule_evaluations'] = undefined;
 ...
 * @readonly
 */
RuleSuite['EvaluationResultEnum'] = {
