...
/**
 * The App2Permissions model module.
 * @module model/App2Permissions
 * @version 1.1.4
 */
class App2Permissions {
    /**
     * Constructs a new <code>App2Permissions</code>.
     * The set of permissions for the GitHub app
     * @alias module:model/App2Permissions
     */
    constructor() { 
        
        App2Permissions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>App2Permissions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/App2Permissions} obj Optional instance to populate.
     * @return {module:model/App2Permissions} The populated <code>App2Permissions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new App2Permissions();
    ...
    /**
     * Validates the JSON data with respect to <code>App2Permissions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>App2Permissions</code>.
     */
...
/**
 * @member {module:model/App2Permissions.ActionsEnum} actions
 */
App2Permissions.prototype['actions'] = undefined;

/**
 * @member {module:model/App2Permissions.AdministrationEnum} administration
 */
App2Permissions.prototype['administration'] = undefined;

/**
 * @member {module:model/App2Permissions.ChecksEnum} checks
 */
App2Permissions.prototype['checks'] = undefined;

/**
 * @member {module:model/App2Permissions.ContentReferencesEnum} content_references
 */
App2Permissions.prototype['content_references'] = undefined;

/**
 * @member {module:model/App2Permissions.ContentsEnum} contents
 */
App2Permissions.prototype['contents'] = undefined;

/**
 * @member {module:model/App2Permissions.DeploymentsEnum} deployments
 */
App2Permissions.prototype['deployments'] = undefined;

/**
 * @member {module:model/App2Permissions.DiscussionsEnum} discussions
 */
App2Permissions.prototype['discussions'] = undefined;

/**
 * @member {module:model/App2Permissions.EmailsEnum} emails
 */
App2Permissions.prototype['emails'] = undefined;

/**
 * @member {module:model/App2Permissions.EnvironmentsEnum} environments
 */
App2Permissions.prototype['environments'] = undefined;

/**
 * @member {module:model/App2Permissions.IssuesEnum} issues
 */
App2Permissions.prototype['issues'] = undefined;

/**
 * @member {module:model/App2Permissions.KeysEnum} keys
 */
App2Permissions.prototype['keys'] = undefined;

/**
 * @member {module:model/App2Permissions.MembersEnum} members
 */
App2Permissions.prototype['members'] = undefined;

/**
 * @member {module:model/App2Permissions.MetadataEnum} metadata
 */
App2Permissions.prototype['metadata'] = undefined;

/**
 * @member {module:model/App2Permissions.OrganizationAdministrationEnum} organization_administration
 */
App2Permissions.prototype['organization_administration'] = undefined;

/**
 * @member {module:model/App2Permissions.OrganizationHooksEnum} organization_hooks
 */
App2Permissions.prototype['organization_hooks'] = undefined;

/**
 * @member {module:model/App2Permissions.OrganizationPackagesEnum} organization_packages
 */
App2Permissions.prototype['organization_packages'] = undefined;

/**
 * @member {module:model/App2Permissions.OrganizationPlanEnum} organization_plan
 */
App2Permissions.prototype['organization_plan'] = undefined;

/**
 * @member {module:model/App2Permissions.OrganizationProjectsEnum} organization_projects
 */
App2Permissions.prototype['organization_projects'] = undefined;

/**
 * @member {module:model/App2Permissions.OrganizationSecretsEnum} organization_secrets
 */
App2Permissions.prototype['organization_secrets'] = undefined;

/**
 * @member {module:model/App2Permissions.OrganizationSelfHostedRunnersEnum} organization_self_hosted_runners
 */
App2Permissions.prototype['organization_self_hosted_runners'] = undefined;

/**
 * @member {module:model/App2Permissions.OrganizationUserBlockingEnum} organization_user_blocking
 */
App2Permissions.prototype['organization_user_blocking'] = undefined;

/**
 * @member {module:model/App2Permissions.PackagesEnum} packages
 */
App2Permissions.prototype['packages'] = undefined;

/**
 * @member {module:model/App2Permissions.PagesEnum} pages
 */
App2Permissions.prototype['pages'] = undefined;

/**
 * @member {module:model/App2Permissions.PullRequestsEnum} pull_requests
 */
App2Permissions.prototype['pull_requests'] = undefined;

/**
 * @member {module:model/App2Permissions.RepositoryHooksEnum} repository_hooks
 */
App2Permissions.prototype['repository_hooks'] = undefined;

/**
 * @member {module:model/App2Permissions.RepositoryProjectsEnum} repository_projects
 */
App2Permissions.prototype['repository_projects'] = undefined;

/**
 * @member {module:model/App2Permissions.SecretScanningAlertsEnum} secret_scanning_alerts
 */
App2Permissions.prototype['secret_scanning_alerts'] = undefined;

/**
 * @member {module:model/App2Permissions.SecretsEnum} secrets
 */
App2Permissions.prototype['secrets'] = undefined;

/**
 * @member {module:model/App2Permissions.SecurityEventsEnum} security_events
 */
App2Permissions.prototype['security_events'] = undefined;

/**
 * @member {module:model/App2Permissions.SecurityScanningAlertEnum} security_scanning_alert
 */
App2Permissions.prototype['security_scanning_alert'] = undefined;

/**
 * @member {module:model/App2Permissions.SingleFileEnum} single_file
 */
App2Permissions.prototype['single_file'] = undefined;

/**
 * @member {module:model/App2Permissions.StatusesEnum} statuses
 */
App2Permissions.prototype['statuses'] = undefined;

/**
 * @member {module:model/App2Permissions.TeamDiscussionsEnum} team_discussions
 */
App2Permissions.prototype['team_discussions'] = undefined;

/**
 * @member {module:model/App2Permissions.VulnerabilityAlertsEnum} vulnerability_alerts
 */
App2Permissions.prototype['vulnerability_alerts'] = undefined;

/**
 * @member {module:model/App2Permissions.WorkflowsEnum} workflows
 */
App2Permissions.prototype['workflows'] = undefined;
 ...
 * @readonly
 */
App2Permissions['AdministrationEnum'] = {
 ...
 * @readonly
 */
App2Permissions['ContentReferencesEnum'] = {
 ...
 * @readonly
 */
App2Permissions['DeploymentsEnum'] = {
 ...
 * @readonly
 */
App2Permissions['DiscussionsEnum'] = {
 ...
 * @readonly
 */
App2Permissions['EnvironmentsEnum'] = {
 ...
 * @readonly
 */
App2Permissions['OrganizationAdministrationEnum'] = {
 ...
 * @readonly
 */
App2Permissions['OrganizationHooksEnum'] = {
 ...
 * @readonly
 */
App2Permissions['OrganizationPackagesEnum'] = {
 ...
 * @readonly
 */
App2Permissions['OrganizationPlanEnum'] = {
 ...
 * @readonly
 */
App2Permissions['OrganizationProjectsEnum'] = {
 ...
 * @readonly
 */
App2Permissions['OrganizationSecretsEnum'] = {
 ...
 * @readonly
 */
App2Permissions['OrganizationSelfHostedRunnersEnum'] = {
 ...
 * @readonly
 */
App2Permissions['OrganizationUserBlockingEnum'] = {
 ...
 * @readonly
 */
App2Permissions['PullRequestsEnum'] = {
 ...
 * @readonly
 */
App2Permissions['RepositoryHooksEnum'] = {
 ...
 * @readonly
 */
App2Permissions['RepositoryProjectsEnum'] = {
 ...
 * @readonly
 */
App2Permissions['SecretScanningAlertsEnum'] = {
 ...
 * @readonly
 */
App2Permissions['SecurityEventsEnum'] = {
 ...
 * @readonly
 */
App2Permissions['SecurityScanningAlertEnum'] = {
 ...
 * @readonly
 */
App2Permissions['SingleFileEnum'] = {
 ...
 * @readonly
 */
App2Permissions['TeamDiscussionsEnum'] = {
 ...
 * @readonly
 */
App2Permissions['VulnerabilityAlertsEnum'] = {
...
export default App2Permissions;
