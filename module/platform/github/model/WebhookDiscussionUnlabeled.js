...
/**
 * The WebhookDiscussionUnlabeled model module.
 * @module model/WebhookDiscussionUnlabeled
 * @version 1.1.4
 */
class WebhookDiscussionUnlabeled {
    /**
     * Constructs a new <code>WebhookDiscussionUnlabeled</code>.
     * @alias module:model/WebhookDiscussionUnlabeled
     * @param action {module:model/WebhookDiscussionUnlabeled.ActionEnum} 
    ...
    constructor(action, discussion, label, repository, sender) { 
        ...
        WebhookDiscussionUnlabeled.initialize(this, action, discussion, label, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookDiscussionUnlabeled</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookDiscussionUnlabeled} obj Optional instance to populate.
     * @return {module:model/WebhookDiscussionUnlabeled} The populated <code>WebhookDiscussionUnlabeled</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookDiscussionUnlabeled();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDiscussionUnlabeled</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDiscussionUnlabeled</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookDiscussionUnlabeled.RequiredProperties) {
...
WebhookDiscussionUnlabeled.RequiredProperties = ["action", "discussion", "label", "repository", "sender"];

/**
 * @member {module:model/WebhookDiscussionUnlabeled.ActionEnum} action
 */
WebhookDiscussionUnlabeled.prototype['action'] = undefined;

/**
 * @member {module:model/Discussion} discussion
 */
WebhookDiscussionUnlabeled.prototype['discussion'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookDiscussionUnlabeled.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookDiscussionUnlabeled.prototype['installation'] = undefined;

/**
 * @member {module:model/WebhooksLabel} label
 */
WebhookDiscussionUnlabeled.prototype['label'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookDiscussionUnlabeled.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookDiscussionUnlabeled.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookDiscussionUnlabeled.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookDiscussionUnlabeled['ActionEnum'] = {
...
export default WebhookDiscussionUnlabeled;
