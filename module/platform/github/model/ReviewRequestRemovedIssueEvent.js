...
class ReviewRequestRemovedIssueEvent {
     ...
     */
    constructor(id, nodeId, url, actor, event, commitId, commitUrl, createdAt, performedViaGithubApp, reviewRequester) { 
        
        ReviewRequestRemovedIssueEvent.initialize(this, id, nodeId, url, actor, event, commitId, commitUrl, createdAt, performedViaGithubApp, reviewRequester);
    }
     ...
     */
    static initialize(obj, id, nodeId, url, actor, event, commitId, commitUrl, createdAt, performedViaGithubApp, reviewRequester) { 
        obj['id'] = id;
        obj['node_id'] = nodeId;
        obj['url'] = url;
        obj['actor'] = actor;
...
ReviewRequestRemovedIssueEvent.RequiredProperties = ["id", "node_id", "url", "actor", "event", "commit_id", "commit_url", "created_at", "performed_via_github_app", "review_requester"];
