...
/**
 * The WebhookDiscussionUnlocked model module.
 * @module model/WebhookDiscussionUnlocked
 * @version 1.1.4
 */
class WebhookDiscussionUnlocked {
    /**
     * Constructs a new <code>WebhookDiscussionUnlocked</code>.
     * @alias module:model/WebhookDiscussionUnlocked
     * @param action {module:model/WebhookDiscussionUnlocked.ActionEnum} 
    ...
    constructor(action, discussion, repository, sender) { 
        ...
        WebhookDiscussionUnlocked.initialize(this, action, discussion, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookDiscussionUnlocked</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookDiscussionUnlocked} obj Optional instance to populate.
     * @return {module:model/WebhookDiscussionUnlocked} The populated <code>WebhookDiscussionUnlocked</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookDiscussionUnlocked();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDiscussionUnlocked</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDiscussionUnlocked</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookDiscussionUnlocked.RequiredProperties) {
...
WebhookDiscussionUnlocked.RequiredProperties = ["action", "discussion", "repository", "sender"];

/**
 * @member {module:model/WebhookDiscussionUnlocked.ActionEnum} action
 */
WebhookDiscussionUnlocked.prototype['action'] = undefined;

/**
 * @member {module:model/Discussion} discussion
 */
WebhookDiscussionUnlocked.prototype['discussion'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookDiscussionUnlocked.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookDiscussionUnlocked.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookDiscussionUnlocked.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookDiscussionUnlocked.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookDiscussionUnlocked.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookDiscussionUnlocked['ActionEnum'] = {
...
export default WebhookDiscussionUnlocked;
