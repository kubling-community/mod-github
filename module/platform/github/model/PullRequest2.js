...
/**
 * The PullRequest2 model module.
 * @module model/PullRequest2
 * @version 1.1.4
 */
class PullRequest2 {
    /**
     * Constructs a new <code>PullRequest2</code>.
     * @alias module:model/PullRequest2
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/PullRequest2.ActiveLockReasonEnum} 
     * @param assignee {module:model/User} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/PullRequest2.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param state {module:model/PullRequest2.StateEnum} State of this Pull Request. Either `open` or `closed`.
    ...
    /**
     * Constructs a <code>PullRequest2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequest2} obj Optional instance to populate.
     * @return {module:model/PullRequest2} The populated <code>PullRequest2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequest2();
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequest2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequest2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PullRequest2.RequiredProperties) {
...
PullRequest2.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "auto_merge", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "draft", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksPullRequest5Links} _links
 */
PullRequest2.prototype['_links'] = undefined;

/**
 * @member {module:model/PullRequest2.ActiveLockReasonEnum} active_lock_reason
 */
PullRequest2.prototype['active_lock_reason'] = undefined;

/**
 * @member {Number} additions
 */
PullRequest2.prototype['additions'] = undefined;

/**
 * @member {module:model/User} assignee
 */
PullRequest2.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
PullRequest2.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/PullRequest2.AuthorAssociationEnum} author_association
 */
PullRequest2.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
PullRequest2.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequestBase} base
 */
PullRequest2.prototype['base'] = undefined;

/**
 * @member {String} body
 */
PullRequest2.prototype['body'] = undefined;

/**
 * @member {Number} changed_files
 */
PullRequest2.prototype['changed_files'] = undefined;

/**
 * @member {Date} closed_at
 */
PullRequest2.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
PullRequest2.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
PullRequest2.prototype['comments_url'] = undefined;

/**
 * @member {Number} commits
 */
PullRequest2.prototype['commits'] = undefined;

/**
 * @member {String} commits_url
 */
PullRequest2.prototype['commits_url'] = undefined;

/**
 * @member {Date} created_at
 */
PullRequest2.prototype['created_at'] = undefined;

/**
 * @member {Number} deletions
 */
PullRequest2.prototype['deletions'] = undefined;

/**
 * @member {String} diff_url
 */
PullRequest2.prototype['diff_url'] = undefined;

/**
 * Indicates whether or not the pull request is a draft.
 * @member {Boolean} draft
 */
PullRequest2.prototype['draft'] = undefined;

/**
 * @member {module:model/PullRequestBase} head
 */
PullRequest2.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
PullRequest2.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
PullRequest2.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
PullRequest2.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
PullRequest2.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
PullRequest2.prototype['locked'] = undefined;

/**
 * Indicates whether maintainers can modify the pull request.
 * @member {Boolean} maintainer_can_modify
 */
PullRequest2.prototype['maintainer_can_modify'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
PullRequest2.prototype['merge_commit_sha'] = undefined;

/**
 * @member {Boolean} mergeable
 */
PullRequest2.prototype['mergeable'] = undefined;

/**
 * @member {String} mergeable_state
 */
PullRequest2.prototype['mergeable_state'] = undefined;

/**
 * @member {Boolean} merged
 */
PullRequest2.prototype['merged'] = undefined;

/**
 * @member {Date} merged_at
 */
PullRequest2.prototype['merged_at'] = undefined;

/**
 * @member {module:model/User} merged_by
 */
PullRequest2.prototype['merged_by'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
PullRequest2.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
PullRequest2.prototype['node_id'] = undefined;

/**
 * Number uniquely identifying the pull request within its repository.
 * @member {Number} number
 */
PullRequest2.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
PullRequest2.prototype['patch_url'] = undefined;

/**
 * @member {Boolean} rebaseable
 */
PullRequest2.prototype['rebaseable'] = undefined;

/**
 * @member {Array.<module:model/PullRequestRequestedReviewersInner>} requested_reviewers
 */
PullRequest2.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
PullRequest2.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
PullRequest2.prototype['review_comment_url'] = undefined;

/**
 * @member {Number} review_comments
 */
PullRequest2.prototype['review_comments'] = undefined;

/**
 * @member {String} review_comments_url
 */
PullRequest2.prototype['review_comments_url'] = undefined;

/**
 * State of this Pull Request. Either `open` or `closed`.
 * @member {module:model/PullRequest2.StateEnum} state
 */
PullRequest2.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
PullRequest2.prototype['statuses_url'] = undefined;

/**
 * The title of the pull request.
 * @member {String} title
 */
PullRequest2.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
PullRequest2.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
PullRequest2.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
PullRequest2.prototype['user'] = undefined;
 ...
 * @readonly
 */
PullRequest2['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
PullRequest2['AuthorAssociationEnum'] = {
