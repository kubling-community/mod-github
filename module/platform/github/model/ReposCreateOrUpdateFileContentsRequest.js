...
class ReposCreateOrUpdateFileContentsRequest {
    ...
    constructor(message, content) { 
        ...
        ReposCreateOrUpdateFileContentsRequest.initialize(this, message, content);
    }
     ...
     */
    static initialize(obj, message, content) { 
        obj['message'] = message;
        obj['content'] = content;
    }
...
ReposCreateOrUpdateFileContentsRequest.RequiredProperties = ["message", "content"];
