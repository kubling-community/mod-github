...
class Page {
     ...
     */
    constructor(url, status, cname, custom404, _public) { 
        
        Page.initialize(this, url, status, cname, custom404, _public);
    }
     ...
     */
    static initialize(obj, url, status, cname, custom404, _public) { 
        obj['url'] = url;
        obj['status'] = status;
        obj['cname'] = cname;
...
Page.RequiredProperties = ["url", "status", "cname", "custom_404", "public"];
