...
/**
 * The WebhookDiscussionReopened model module.
 * @module model/WebhookDiscussionReopened
 * @version 1.1.4
 */
class WebhookDiscussionReopened {
    /**
     * Constructs a new <code>WebhookDiscussionReopened</code>.
     * @alias module:model/WebhookDiscussionReopened
     * @param action {module:model/WebhookDiscussionReopened.ActionEnum} 
    ...
    constructor(action, discussion, repository, sender) { 
        ...
        WebhookDiscussionReopened.initialize(this, action, discussion, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookDiscussionReopened</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookDiscussionReopened} obj Optional instance to populate.
     * @return {module:model/WebhookDiscussionReopened} The populated <code>WebhookDiscussionReopened</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookDiscussionReopened();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDiscussionReopened</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDiscussionReopened</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookDiscussionReopened.RequiredProperties) {
...
WebhookDiscussionReopened.RequiredProperties = ["action", "discussion", "repository", "sender"];

/**
 * @member {module:model/WebhookDiscussionReopened.ActionEnum} action
 */
WebhookDiscussionReopened.prototype['action'] = undefined;

/**
 * @member {module:model/Discussion} discussion
 */
WebhookDiscussionReopened.prototype['discussion'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookDiscussionReopened.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookDiscussionReopened.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookDiscussionReopened.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookDiscussionReopened.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookDiscussionReopened.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookDiscussionReopened['ActionEnum'] = {
...
export default WebhookDiscussionReopened;
