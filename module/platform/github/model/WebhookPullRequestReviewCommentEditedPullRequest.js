...
/**
 * The WebhookPullRequestReviewCommentEditedPullRequest model module.
 * @module model/WebhookPullRequestReviewCommentEditedPullRequest
 * @version 1.1.4
 */
class WebhookPullRequestReviewCommentEditedPullRequest {
    /**
     * Constructs a new <code>WebhookPullRequestReviewCommentEditedPullRequest</code>.
     * @alias module:model/WebhookPullRequestReviewCommentEditedPullRequest
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/WebhookPullRequestReviewCommentEditedPullRequest.ActiveLockReasonEnum} 
     * @param assignee {module:model/User} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/WebhookPullRequestReviewCommentEditedPullRequest.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param state {module:model/WebhookPullRequestReviewCommentEditedPullRequest.StateEnum} 
    ...
    constructor(links, activeLockReason, assignee, assignees, authorAssociation, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
        ...
        WebhookPullRequestReviewCommentEditedPullRequest.initialize(this, links, activeLockReason, assignee, assignees, authorAssociation, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>WebhookPullRequestReviewCommentEditedPullRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookPullRequestReviewCommentEditedPullRequest} obj Optional instance to populate.
     * @return {module:model/WebhookPullRequestReviewCommentEditedPullRequest} The populated <code>WebhookPullRequestReviewCommentEditedPullRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookPullRequestReviewCommentEditedPullRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookPullRequestReviewCommentEditedPullRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookPullRequestReviewCommentEditedPullRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookPullRequestReviewCommentEditedPullRequest.RequiredProperties) {
...
WebhookPullRequestReviewCommentEditedPullRequest.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksPullRequest5Links} _links
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['_links'] = undefined;

/**
 * @member {module:model/WebhookPullRequestReviewCommentEditedPullRequest.ActiveLockReasonEnum} active_lock_reason
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User} assignee
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/WebhookPullRequestReviewCommentEditedPullRequest.AuthorAssociationEnum} author_association
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequestBase} base
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['base'] = undefined;

/**
 * @member {String} body
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['body'] = undefined;

/**
 * @member {String} closed_at
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['closed_at'] = undefined;

/**
 * @member {String} comments_url
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['commits_url'] = undefined;

/**
 * @member {String} created_at
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['created_at'] = undefined;

/**
 * @member {String} diff_url
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['diff_url'] = undefined;

/**
 * @member {Boolean} draft
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['draft'] = undefined;

/**
 * @member {module:model/WebhookPullRequestReviewCommentDeletedPullRequestHead} head
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['locked'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['merge_commit_sha'] = undefined;

/**
 * @member {String} merged_at
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['merged_at'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['patch_url'] = undefined;

/**
 * @member {Array.<module:model/WebhooksPullRequest5RequestedReviewersInner>} requested_reviewers
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['review_comment_url'] = undefined;

/**
 * @member {String} review_comments_url
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['review_comments_url'] = undefined;

/**
 * @member {module:model/WebhookPullRequestReviewCommentEditedPullRequest.StateEnum} state
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['statuses_url'] = undefined;

/**
 * @member {String} title
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['title'] = undefined;

/**
 * @member {String} updated_at
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
WebhookPullRequestReviewCommentEditedPullRequest.prototype['user'] = undefined;
 ...
 * @readonly
 */
WebhookPullRequestReviewCommentEditedPullRequest['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
WebhookPullRequestReviewCommentEditedPullRequest['AuthorAssociationEnum'] = {
 ...
 * @readonly
 */
WebhookPullRequestReviewCommentEditedPullRequest['StateEnum'] = {
...
export default WebhookPullRequestReviewCommentEditedPullRequest;
