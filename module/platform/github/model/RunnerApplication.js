...
class RunnerApplication {
     ...
     */
    constructor(os, architecture, downloadUrl, filename) { 
        
        RunnerApplication.initialize(this, os, architecture, downloadUrl, filename);
    }
     ...
     */
    static initialize(obj, os, architecture, downloadUrl, filename) { 
        obj['os'] = os;
...
RunnerApplication.RequiredProperties = ["os", "architecture", "download_url", "filename"];
