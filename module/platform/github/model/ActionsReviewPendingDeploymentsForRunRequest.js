...
class ActionsReviewPendingDeploymentsForRunRequest {
     ...
     */
    constructor(environmentIds, state, comment) { 
        
        ActionsReviewPendingDeploymentsForRunRequest.initialize(this, environmentIds, state, comment);
    }
     ...
     */
    static initialize(obj, environmentIds, state, comment) { 
...
ActionsReviewPendingDeploymentsForRunRequest.RequiredProperties = ["environment_ids", "state", "comment"];
