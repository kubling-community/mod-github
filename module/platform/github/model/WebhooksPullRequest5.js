...
import WebhooksPullRequest5Base from './WebhooksPullRequest5Base';
...
/**
 * The WebhooksPullRequest5 model module.
 * @module model/WebhooksPullRequest5
 * @version 1.1.4
 */
class WebhooksPullRequest5 {
    /**
     * Constructs a new <code>WebhooksPullRequest5</code>.
     * @alias module:model/WebhooksPullRequest5
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/WebhooksPullRequest5.ActiveLockReasonEnum} 
     * @param assignee {module:model/User1} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/WebhooksPullRequest5.AuthorAssociationEnum} How the author is associated with the repository.
     * @param autoMerge {module:model/PullRequestAutoMerge} 
     * @param base {module:model/WebhooksPullRequest5Base} 
     * @param body {String} 
     * @param closedAt {Date} 
     ...
     * @param head {module:model/WebhooksPullRequest5Base} 
     ...
     * @param state {module:model/WebhooksPullRequest5.StateEnum} State of this Pull Request. Either `open` or `closed`.
    ...
    constructor(links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
        ...
        WebhooksPullRequest5.initialize(this, links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>WebhooksPullRequest5</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhooksPullRequest5} obj Optional instance to populate.
     * @return {module:model/WebhooksPullRequest5} The populated <code>WebhooksPullRequest5</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhooksPullRequest5();
            ...
            if (data.hasOwnProperty('base')) {
                obj['base'] = WebhooksPullRequest5Base.constructFromObject(data['base']);
            }
            ...
            if (data.hasOwnProperty('head')) {
                obj['head'] = WebhooksPullRequest5Base.constructFromObject(data['head']);
            }
            ...
            if (data.hasOwnProperty('merged_by')) {
                obj['merged_by'] = User1.constructFromObject(data['merged_by']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhooksPullRequest5</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhooksPullRequest5</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhooksPullRequest5.RequiredProperties) {
        ...
        if (data['base']) { // data not null
          WebhooksPullRequest5Base.validateJSON(data['base']);
        }
        // ensure the json data is a string
        ...
        if (data['head']) { // data not null
          WebhooksPullRequest5Base.validateJSON(data['head']);
        }
        // ensure the json data is a string
        ...
        if (data['merged_by']) { // data not null
          User1.validateJSON(data['merged_by']);
        }
...
WebhooksPullRequest5.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "auto_merge", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "draft", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksPullRequest5Links} _links
 */
WebhooksPullRequest5.prototype['_links'] = undefined;

/**
 * @member {module:model/WebhooksPullRequest5.ActiveLockReasonEnum} active_lock_reason
 */
WebhooksPullRequest5.prototype['active_lock_reason'] = undefined;

/**
 * @member {Number} additions
 */
WebhooksPullRequest5.prototype['additions'] = undefined;

/**
 * @member {module:model/User1} assignee
 */
WebhooksPullRequest5.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User1>} assignees
 */
WebhooksPullRequest5.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/WebhooksPullRequest5.AuthorAssociationEnum} author_association
 */
WebhooksPullRequest5.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
WebhooksPullRequest5.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/WebhooksPullRequest5Base} base
 */
WebhooksPullRequest5.prototype['base'] = undefined;

/**
 * @member {String} body
 */
WebhooksPullRequest5.prototype['body'] = undefined;

/**
 * @member {Number} changed_files
 */
WebhooksPullRequest5.prototype['changed_files'] = undefined;

/**
 * @member {Date} closed_at
 */
WebhooksPullRequest5.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
WebhooksPullRequest5.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
WebhooksPullRequest5.prototype['comments_url'] = undefined;

/**
 * @member {Number} commits
 */
WebhooksPullRequest5.prototype['commits'] = undefined;

/**
 * @member {String} commits_url
 */
WebhooksPullRequest5.prototype['commits_url'] = undefined;

/**
 * @member {Date} created_at
 */
WebhooksPullRequest5.prototype['created_at'] = undefined;

/**
 * @member {Number} deletions
 */
WebhooksPullRequest5.prototype['deletions'] = undefined;

/**
 * @member {String} diff_url
 */
WebhooksPullRequest5.prototype['diff_url'] = undefined;

/**
 * Indicates whether or not the pull request is a draft.
 * @member {Boolean} draft
 */
WebhooksPullRequest5.prototype['draft'] = undefined;

/**
 * @member {module:model/WebhooksPullRequest5Base} head
 */
WebhooksPullRequest5.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
WebhooksPullRequest5.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhooksPullRequest5.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
WebhooksPullRequest5.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
WebhooksPullRequest5.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
WebhooksPullRequest5.prototype['locked'] = undefined;

/**
 * Indicates whether maintainers can modify the pull request.
 * @member {Boolean} maintainer_can_modify
 */
WebhooksPullRequest5.prototype['maintainer_can_modify'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
WebhooksPullRequest5.prototype['merge_commit_sha'] = undefined;

/**
 * @member {Boolean} mergeable
 */
WebhooksPullRequest5.prototype['mergeable'] = undefined;

/**
 * @member {String} mergeable_state
 */
WebhooksPullRequest5.prototype['mergeable_state'] = undefined;

/**
 * @member {Boolean} merged
 */
WebhooksPullRequest5.prototype['merged'] = undefined;

/**
 * @member {Date} merged_at
 */
WebhooksPullRequest5.prototype['merged_at'] = undefined;

/**
 * @member {module:model/User1} merged_by
 */
WebhooksPullRequest5.prototype['merged_by'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
WebhooksPullRequest5.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
WebhooksPullRequest5.prototype['node_id'] = undefined;

/**
 * Number uniquely identifying the pull request within its repository.
 * @member {Number} number
 */
WebhooksPullRequest5.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
WebhooksPullRequest5.prototype['patch_url'] = undefined;

/**
 * @member {Boolean} rebaseable
 */
WebhooksPullRequest5.prototype['rebaseable'] = undefined;

/**
 * @member {Array.<module:model/WebhooksPullRequest5RequestedReviewersInner>} requested_reviewers
 */
WebhooksPullRequest5.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
WebhooksPullRequest5.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
WebhooksPullRequest5.prototype['review_comment_url'] = undefined;

/**
 * @member {Number} review_comments
 */
WebhooksPullRequest5.prototype['review_comments'] = undefined;

/**
 * @member {String} review_comments_url
 */
WebhooksPullRequest5.prototype['review_comments_url'] = undefined;

/**
 * State of this Pull Request. Either `open` or `closed`.
 * @member {module:model/WebhooksPullRequest5.StateEnum} state
 */
WebhooksPullRequest5.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
WebhooksPullRequest5.prototype['statuses_url'] = undefined;

/**
 * The title of the pull request.
 * @member {String} title
 */
WebhooksPullRequest5.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
WebhooksPullRequest5.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
WebhooksPullRequest5.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
WebhooksPullRequest5.prototype['user'] = undefined;
 ...
 * @readonly
 */
WebhooksPullRequest5['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
WebhooksPullRequest5['AuthorAssociationEnum'] = {
 ...
 * @readonly
 */
WebhooksPullRequest5['StateEnum'] = {
...
export default WebhooksPullRequest5;
