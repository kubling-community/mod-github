...
import SimplePullRequest1Base from './SimplePullRequest1Base';
import SimplePullRequest1Head from './SimplePullRequest1Head';
import Team from './Team';
import User1 from './User1';
import WebhooksPullRequest5Links from './WebhooksPullRequest5Links';

/**
 * The SimplePullRequest1 model module.
 * @module model/SimplePullRequest1
 * @version 1.1.4
 */
class SimplePullRequest1 {
    /**
     * Constructs a new <code>SimplePullRequest1</code>.
     * @alias module:model/SimplePullRequest1
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/SimplePullRequest1.ActiveLockReasonEnum} 
     * @param assignee {module:model/User1} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/SimplePullRequest1.AuthorAssociationEnum} How the author is associated with the repository.
     * @param autoMerge {module:model/PullRequestAutoMerge} 
     * @param base {module:model/SimplePullRequest1Base} 
     * @param body {String} 
     ...
     * @param draft {Boolean} 
     * @param head {module:model/SimplePullRequest1Head} 
     ...
     * @param state {module:model/SimplePullRequest1.StateEnum} 
    ...
    /**
     * Constructs a <code>SimplePullRequest1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimplePullRequest1} obj Optional instance to populate.
     * @return {module:model/SimplePullRequest1} The populated <code>SimplePullRequest1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimplePullRequest1();
            ...
            if (data.hasOwnProperty('base')) {
                obj['base'] = SimplePullRequest1Base.constructFromObject(data['base']);
            }
            ...
            if (data.hasOwnProperty('head')) {
                obj['head'] = SimplePullRequest1Head.constructFromObject(data['head']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SimplePullRequest1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimplePullRequest1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SimplePullRequest1.RequiredProperties) {
        ...
        if (data['base']) { // data not null
          SimplePullRequest1Base.validateJSON(data['base']);
        }
        // ensure the json data is a string
        ...
        if (data['head']) { // data not null
          SimplePullRequest1Head.validateJSON(data['head']);
        }
        // ensure the json data is a string
 ...
 */
SimplePullRequest1.prototype['_links'] = undefined;

/**
 * @member {module:model/SimplePullRequest1.ActiveLockReasonEnum} active_lock_reason
 */
SimplePullRequest1.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User1} assignee
 */
SimplePullRequest1.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User1>} assignees
 */
SimplePullRequest1.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/SimplePullRequest1.AuthorAssociationEnum} author_association
 */
SimplePullRequest1.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
SimplePullRequest1.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/SimplePullRequest1Base} base
 */
SimplePullRequest1.prototype['base'] = undefined;

/**
 * @member {String} body
 */
SimplePullRequest1.prototype['body'] = undefined;

/**
 * @member {String} closed_at
 */
SimplePullRequest1.prototype['closed_at'] = undefined;

/**
 * @member {String} comments_url
 */
SimplePullRequest1.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
SimplePullRequest1.prototype['commits_url'] = undefined;

/**
 * @member {String} created_at
 */
SimplePullRequest1.prototype['created_at'] = undefined;

/**
 * @member {String} diff_url
 */
SimplePullRequest1.prototype['diff_url'] = undefined;

/**
 * @member {Boolean} draft
 */
SimplePullRequest1.prototype['draft'] = undefined;

/**
 * @member {module:model/SimplePullRequest1Head} head
 */
SimplePullRequest1.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
SimplePullRequest1.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
SimplePullRequest1.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
SimplePullRequest1.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
SimplePullRequest1.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
SimplePullRequest1.prototype['locked'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
SimplePullRequest1.prototype['merge_commit_sha'] = undefined;

/**
 * @member {String} merged_at
 */
SimplePullRequest1.prototype['merged_at'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
SimplePullRequest1.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
SimplePullRequest1.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
SimplePullRequest1.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
SimplePullRequest1.prototype['patch_url'] = undefined;

/**
 * @member {Array.<module:model/PullRequestRequestedReviewersInner>} requested_reviewers
 */
SimplePullRequest1.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
SimplePullRequest1.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
SimplePullRequest1.prototype['review_comment_url'] = undefined;

/**
 * @member {String} review_comments_url
 */
SimplePullRequest1.prototype['review_comments_url'] = undefined;

/**
 * @member {module:model/SimplePullRequest1.StateEnum} state
 */
SimplePullRequest1.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
SimplePullRequest1.prototype['statuses_url'] = undefined;

/**
 * @member {String} title
 */
SimplePullRequest1.prototype['title'] = undefined;

/**
 * @member {String} updated_at
 */
SimplePullRequest1.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
SimplePullRequest1.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
SimplePullRequest1.prototype['user'] = undefined;
 ...
 * @readonly
 */
SimplePullRequest1['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
SimplePullRequest1['AuthorAssociationEnum'] = {
...
export default SimplePullRequest1;
