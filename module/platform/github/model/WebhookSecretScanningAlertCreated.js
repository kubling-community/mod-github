...
/**
 * The WebhookSecretScanningAlertCreated model module.
 * @module model/WebhookSecretScanningAlertCreated
 * @version 1.1.4
 */
class WebhookSecretScanningAlertCreated {
    /**
     * Constructs a new <code>WebhookSecretScanningAlertCreated</code>.
     * @alias module:model/WebhookSecretScanningAlertCreated
     * @param action {module:model/WebhookSecretScanningAlertCreated.ActionEnum} 
    ...
    constructor(action, alert, repository) { 
        ...
        WebhookSecretScanningAlertCreated.initialize(this, action, alert, repository);
    }
    ...
    /**
     * Constructs a <code>WebhookSecretScanningAlertCreated</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookSecretScanningAlertCreated} obj Optional instance to populate.
     * @return {module:model/WebhookSecretScanningAlertCreated} The populated <code>WebhookSecretScanningAlertCreated</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookSecretScanningAlertCreated();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookSecretScanningAlertCreated</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookSecretScanningAlertCreated</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookSecretScanningAlertCreated.RequiredProperties) {
...
WebhookSecretScanningAlertCreated.RequiredProperties = ["action", "alert", "repository"];

/**
 * @member {module:model/WebhookSecretScanningAlertCreated.ActionEnum} action
 */
WebhookSecretScanningAlertCreated.prototype['action'] = undefined;

/**
 * @member {module:model/SecretScanningAlertWebhook} alert
 */
WebhookSecretScanningAlertCreated.prototype['alert'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookSecretScanningAlertCreated.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookSecretScanningAlertCreated.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookSecretScanningAlertCreated.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookSecretScanningAlertCreated.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookSecretScanningAlertCreated.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookSecretScanningAlertCreated['ActionEnum'] = {
...
export default WebhookSecretScanningAlertCreated;
