...
/**
 * The MarketplacePurchase1 model module.
 * @module model/MarketplacePurchase1
 * @version 1.1.4
 */
class MarketplacePurchase1 {
    /**
     * Constructs a new <code>MarketplacePurchase1</code>.
     * @alias module:model/MarketplacePurchase1
    ...
    constructor(account, billingCycle, freeTrialEndsOn, onFreeTrial, plan, unitCount) { 
        ...
        MarketplacePurchase1.initialize(this, account, billingCycle, freeTrialEndsOn, onFreeTrial, plan, unitCount);
    }
    ...
    /**
     * Constructs a <code>MarketplacePurchase1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MarketplacePurchase1} obj Optional instance to populate.
     * @return {module:model/MarketplacePurchase1} The populated <code>MarketplacePurchase1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MarketplacePurchase1();
    ...
    /**
     * Validates the JSON data with respect to <code>MarketplacePurchase1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MarketplacePurchase1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MarketplacePurchase1.RequiredProperties) {
...
MarketplacePurchase1.RequiredProperties = ["account", "billing_cycle", "free_trial_ends_on", "on_free_trial", "plan", "unit_count"];

/**
 * @member {module:model/WebhooksMarketplacePurchaseAccount} account
 */
MarketplacePurchase1.prototype['account'] = undefined;

/**
 * @member {String} billing_cycle
 */
MarketplacePurchase1.prototype['billing_cycle'] = undefined;

/**
 * @member {String} free_trial_ends_on
 */
MarketplacePurchase1.prototype['free_trial_ends_on'] = undefined;

/**
 * @member {String} next_billing_date
 */
MarketplacePurchase1.prototype['next_billing_date'] = undefined;

/**
 * @member {Boolean} on_free_trial
 */
MarketplacePurchase1.prototype['on_free_trial'] = undefined;

/**
 * @member {module:model/WebhooksPreviousMarketplacePurchasePlan} plan
 */
MarketplacePurchase1.prototype['plan'] = undefined;

/**
 * @member {Number} unit_count
 */
MarketplacePurchase1.prototype['unit_count'] = undefined;
...
export default MarketplacePurchase1;
