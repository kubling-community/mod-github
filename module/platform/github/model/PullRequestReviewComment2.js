...
/**
 * The PullRequestReviewComment2 model module.
 * @module model/PullRequestReviewComment2
 * @version 1.1.4
 */
class PullRequestReviewComment2 {
    /**
     * Constructs a new <code>PullRequestReviewComment2</code>.
     * The [comment](https://docs.github.com/rest/pulls/comments#get-a-review-comment-for-a-pull-request) itself.
     * @alias module:model/PullRequestReviewComment2
     * @param links {module:model/WebhooksReviewCommentLinks} 
     * @param authorAssociation {module:model/PullRequestReviewComment2.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param side {module:model/PullRequestReviewComment2.SideEnum} The side of the first line of the range for a multi-line comment.
     * @param startLine {Number} The first line of the range for a multi-line comment.
     * @param startSide {module:model/PullRequestReviewComment2.StartSideEnum} The side of the first line of the range for a multi-line comment.
    ...
    constructor(links, authorAssociation, body, commitId, createdAt, diffHunk, htmlUrl, id, line, nodeId, originalCommitId, originalLine, originalPosition, originalStartLine, path, position, pullRequestReviewId, pullRequestUrl, reactions, side, startLine, startSide, updatedAt, url, user) { 
        ...
        PullRequestReviewComment2.initialize(this, links, authorAssociation, body, commitId, createdAt, diffHunk, htmlUrl, id, line, nodeId, originalCommitId, originalLine, originalPosition, originalStartLine, path, position, pullRequestReviewId, pullRequestUrl, reactions, side, startLine, startSide, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>PullRequestReviewComment2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestReviewComment2} obj Optional instance to populate.
     * @return {module:model/PullRequestReviewComment2} The populated <code>PullRequestReviewComment2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestReviewComment2();
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestReviewComment2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestReviewComment2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PullRequestReviewComment2.RequiredProperties) {
...
PullRequestReviewComment2.RequiredProperties = ["_links", "author_association", "body", "commit_id", "created_at", "diff_hunk", "html_url", "id", "line", "node_id", "original_commit_id", "original_line", "original_position", "original_start_line", "path", "position", "pull_request_review_id", "pull_request_url", "reactions", "side", "start_line", "start_side", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksReviewCommentLinks} _links
 */
PullRequestReviewComment2.prototype['_links'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/PullRequestReviewComment2.AuthorAssociationEnum} author_association
 */
PullRequestReviewComment2.prototype['author_association'] = undefined;

/**
 * The text of the comment.
 * @member {String} body
 */
PullRequestReviewComment2.prototype['body'] = undefined;

/**
 * The SHA of the commit to which the comment applies.
 * @member {String} commit_id
 */
PullRequestReviewComment2.prototype['commit_id'] = undefined;

/**
 * @member {Date} created_at
 */
PullRequestReviewComment2.prototype['created_at'] = undefined;

/**
 * The diff of the line that the comment refers to.
 * @member {String} diff_hunk
 */
PullRequestReviewComment2.prototype['diff_hunk'] = undefined;

/**
 * HTML URL for the pull request review comment.
 * @member {String} html_url
 */
PullRequestReviewComment2.prototype['html_url'] = undefined;

/**
 * The ID of the pull request review comment.
 * @member {Number} id
 */
PullRequestReviewComment2.prototype['id'] = undefined;

/**
 * The comment ID to reply to.
 * @member {Number} in_reply_to_id
 */
PullRequestReviewComment2.prototype['in_reply_to_id'] = undefined;

/**
 * The line of the blob to which the comment applies. The last line of the range for a multi-line comment
 * @member {Number} line
 */
PullRequestReviewComment2.prototype['line'] = undefined;

/**
 * The node ID of the pull request review comment.
 * @member {String} node_id
 */
PullRequestReviewComment2.prototype['node_id'] = undefined;

/**
 * The SHA of the original commit to which the comment applies.
 * @member {String} original_commit_id
 */
PullRequestReviewComment2.prototype['original_commit_id'] = undefined;

/**
 * The line of the blob to which the comment applies. The last line of the range for a multi-line comment
 * @member {Number} original_line
 */
PullRequestReviewComment2.prototype['original_line'] = undefined;

/**
 * The index of the original line in the diff to which the comment applies.
 * @member {Number} original_position
 */
PullRequestReviewComment2.prototype['original_position'] = undefined;

/**
 * The first line of the range for a multi-line comment.
 * @member {Number} original_start_line
 */
PullRequestReviewComment2.prototype['original_start_line'] = undefined;

/**
 * The relative path of the file to which the comment applies.
 * @member {String} path
 */
PullRequestReviewComment2.prototype['path'] = undefined;

/**
 * The line index in the diff to which the comment applies.
 * @member {Number} position
 */
PullRequestReviewComment2.prototype['position'] = undefined;

/**
 * The ID of the pull request review to which the comment belongs.
 * @member {Number} pull_request_review_id
 */
PullRequestReviewComment2.prototype['pull_request_review_id'] = undefined;

/**
 * URL for the pull request that the review comment belongs to.
 * @member {String} pull_request_url
 */
PullRequestReviewComment2.prototype['pull_request_url'] = undefined;

/**
 * @member {module:model/Reactions} reactions
 */
PullRequestReviewComment2.prototype['reactions'] = undefined;

/**
 * The side of the first line of the range for a multi-line comment.
 * @member {module:model/PullRequestReviewComment2.SideEnum} side
 */
PullRequestReviewComment2.prototype['side'] = undefined;

/**
 * The first line of the range for a multi-line comment.
 * @member {Number} start_line
 */
PullRequestReviewComment2.prototype['start_line'] = undefined;

/**
 * The side of the first line of the range for a multi-line comment.
 * @member {module:model/PullRequestReviewComment2.StartSideEnum} start_side
 * @default 'RIGHT'
 */
PullRequestReviewComment2.prototype['start_side'] = 'RIGHT';

/**
 * The level at which the comment is targeted, can be a diff line or a file.
 * @member {module:model/PullRequestReviewComment2.SubjectTypeEnum} subject_type
 */
PullRequestReviewComment2.prototype['subject_type'] = undefined;

/**
 * @member {Date} updated_at
 */
PullRequestReviewComment2.prototype['updated_at'] = undefined;

/**
 * URL for the pull request review comment
 * @member {String} url
 */
PullRequestReviewComment2.prototype['url'] = undefined;

/**
 * @member {module:model/User} user
 */
PullRequestReviewComment2.prototype['user'] = undefined;
 ...
 * @readonly
 */
PullRequestReviewComment2['AuthorAssociationEnum'] = {
 ...
 * @readonly
 */
PullRequestReviewComment2['SideEnum'] = {
 ...
 * @readonly
 */
PullRequestReviewComment2['StartSideEnum'] = {
 ...
 * @readonly
 */
PullRequestReviewComment2['SubjectTypeEnum'] = {
...
export default PullRequestReviewComment2;
