...
class Issue {
     ...
     * @param activeLockReason {module:model/Issue.ActiveLockReasonEnum} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/Issue.AuthorAssociationEnum} How the author is associated with the repository.
    ...
    constructor(activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user) { 
        ...
        Issue.initialize(this, activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('performed_via_github_app')) {
                obj['performed_via_github_app'] = App10.constructFromObject(data['performed_via_github_app']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['performed_via_github_app']) { // data not null
          App10.validateJSON(data['performed_via_github_app']);
        }
...
Issue.RequiredProperties = ["active_lock_reason", "assignees", "author_association", "body", "closed_at", "comments", "comments_url", "created_at", "events_url", "html_url", "id", "labels_url", "milestone", "node_id", "number", "reactions", "repository_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/Issue.ActiveLockReasonEnum} active_lock_reason
 */
 ...
 * @member {module:model/Issue.AuthorAssociationEnum} author_association
 */
...
/**
 * @member {module:model/App10} performed_via_github_app
 */
