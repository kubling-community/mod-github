...
/**
 * The WebhookDependabotAlertReopened model module.
 * @module model/WebhookDependabotAlertReopened
 * @version 1.1.4
 */
class WebhookDependabotAlertReopened {
    /**
     * Constructs a new <code>WebhookDependabotAlertReopened</code>.
     * @alias module:model/WebhookDependabotAlertReopened
     * @param action {module:model/WebhookDependabotAlertReopened.ActionEnum} 
    ...
    constructor(action, alert, repository, sender) { 
        ...
        WebhookDependabotAlertReopened.initialize(this, action, alert, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookDependabotAlertReopened</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookDependabotAlertReopened} obj Optional instance to populate.
     * @return {module:model/WebhookDependabotAlertReopened} The populated <code>WebhookDependabotAlertReopened</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookDependabotAlertReopened();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDependabotAlertReopened</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDependabotAlertReopened</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookDependabotAlertReopened.RequiredProperties) {
...
WebhookDependabotAlertReopened.RequiredProperties = ["action", "alert", "repository", "sender"];

/**
 * @member {module:model/WebhookDependabotAlertReopened.ActionEnum} action
 */
WebhookDependabotAlertReopened.prototype['action'] = undefined;

/**
 * @member {module:model/DependabotAlert} alert
 */
WebhookDependabotAlertReopened.prototype['alert'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookDependabotAlertReopened.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookDependabotAlertReopened.prototype['organization'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookDependabotAlertReopened.prototype['enterprise'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookDependabotAlertReopened.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookDependabotAlertReopened.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookDependabotAlertReopened['ActionEnum'] = {
...
export default WebhookDependabotAlertReopened;
