...
class TeamDiscussion {
     ...
     * @param _private {Boolean} Whether or not this discussion should be restricted to team members and organization owners.
     * @param teamUrl {String} 
     * @param title {String} The title of the discussion.
     * @param updatedAt {Date} 
     * @param url {String} 
     */
    constructor(author, body, bodyHtml, bodyVersion, commentsCount, commentsUrl, createdAt, lastEditedAt, htmlUrl, nodeId, number, pinned, _private, teamUrl, title, updatedAt, url) { 
        
        TeamDiscussion.initialize(this, author, body, bodyHtml, bodyVersion, commentsCount, commentsUrl, createdAt, lastEditedAt, htmlUrl, nodeId, number, pinned, _private, teamUrl, title, updatedAt, url);
    }
     ...
     */
    static initialize(obj, author, body, bodyHtml, bodyVersion, commentsCount, commentsUrl, createdAt, lastEditedAt, htmlUrl, nodeId, number, pinned, _private, teamUrl, title, updatedAt, url) { 
        obj['author'] = author;
        obj['body'] = body;
...
TeamDiscussion.RequiredProperties = ["author", "body", "body_html", "body_version", "comments_count", "comments_url", "created_at", "last_edited_at", "html_url", "node_id", "number", "pinned", "private", "team_url", "title", "updated_at", "url"];
