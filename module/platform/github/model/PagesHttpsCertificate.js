...
class PagesHttpsCertificate {
     ...
     */
    constructor(state, description, domains) { 
        
        PagesHttpsCertificate.initialize(this, state, description, domains);
    }
     ...
     */
    static initialize(obj, state, description, domains) { 
        obj['state'] = state;
...
PagesHttpsCertificate.RequiredProperties = ["state", "description", "domains"];
