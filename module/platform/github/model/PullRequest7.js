...
/**
 * The PullRequest7 model module.
 * @module model/PullRequest7
 * @version 1.1.4
 */
class PullRequest7 {
    /**
     * Constructs a new <code>PullRequest7</code>.
     * @alias module:model/PullRequest7
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/PullRequest7.ActiveLockReasonEnum} 
     * @param assignee {module:model/User} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/PullRequest7.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param state {module:model/PullRequest7.StateEnum} State of this Pull Request. Either `open` or `closed`.
    ...
    constructor(links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
        ...
        PullRequest7.initialize(this, links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>PullRequest7</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequest7} obj Optional instance to populate.
     * @return {module:model/PullRequest7} The populated <code>PullRequest7</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequest7();
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequest7</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequest7</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PullRequest7.RequiredProperties) {
...
PullRequest7.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "auto_merge", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "draft", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksPullRequest5Links} _links
 */
PullRequest7.prototype['_links'] = undefined;

/**
 * @member {module:model/PullRequest7.ActiveLockReasonEnum} active_lock_reason
 */
PullRequest7.prototype['active_lock_reason'] = undefined;

/**
 * @member {Number} additions
 */
PullRequest7.prototype['additions'] = undefined;

/**
 * @member {module:model/User} assignee
 */
PullRequest7.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
PullRequest7.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/PullRequest7.AuthorAssociationEnum} author_association
 */
PullRequest7.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
PullRequest7.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequestBase} base
 */
PullRequest7.prototype['base'] = undefined;

/**
 * @member {String} body
 */
PullRequest7.prototype['body'] = undefined;

/**
 * @member {Number} changed_files
 */
PullRequest7.prototype['changed_files'] = undefined;

/**
 * @member {Date} closed_at
 */
PullRequest7.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
PullRequest7.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
PullRequest7.prototype['comments_url'] = undefined;

/**
 * @member {Number} commits
 */
PullRequest7.prototype['commits'] = undefined;

/**
 * @member {String} commits_url
 */
PullRequest7.prototype['commits_url'] = undefined;

/**
 * @member {Date} created_at
 */
PullRequest7.prototype['created_at'] = undefined;

/**
 * @member {Number} deletions
 */
PullRequest7.prototype['deletions'] = undefined;

/**
 * @member {String} diff_url
 */
PullRequest7.prototype['diff_url'] = undefined;

/**
 * Indicates whether or not the pull request is a draft.
 * @member {Boolean} draft
 */
PullRequest7.prototype['draft'] = undefined;

/**
 * @member {module:model/PullRequestBase} head
 */
PullRequest7.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
PullRequest7.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
PullRequest7.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
PullRequest7.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
PullRequest7.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
PullRequest7.prototype['locked'] = undefined;

/**
 * Indicates whether maintainers can modify the pull request.
 * @member {Boolean} maintainer_can_modify
 */
PullRequest7.prototype['maintainer_can_modify'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
PullRequest7.prototype['merge_commit_sha'] = undefined;

/**
 * @member {Boolean} mergeable
 */
PullRequest7.prototype['mergeable'] = undefined;

/**
 * @member {String} mergeable_state
 */
PullRequest7.prototype['mergeable_state'] = undefined;

/**
 * @member {Boolean} merged
 */
PullRequest7.prototype['merged'] = undefined;

/**
 * @member {Date} merged_at
 */
PullRequest7.prototype['merged_at'] = undefined;

/**
 * @member {module:model/User} merged_by
 */
PullRequest7.prototype['merged_by'] = undefined;

/**
 * @member {module:model/Milestone1} milestone
 */
PullRequest7.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
PullRequest7.prototype['node_id'] = undefined;

/**
 * Number uniquely identifying the pull request within its repository.
 * @member {Number} number
 */
PullRequest7.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
PullRequest7.prototype['patch_url'] = undefined;

/**
 * @member {Boolean} rebaseable
 */
PullRequest7.prototype['rebaseable'] = undefined;

/**
 * @member {Array.<module:model/PullRequest6RequestedReviewersInner>} requested_reviewers
 */
PullRequest7.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team1>} requested_teams
 */
PullRequest7.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
PullRequest7.prototype['review_comment_url'] = undefined;

/**
 * @member {Number} review_comments
 */
PullRequest7.prototype['review_comments'] = undefined;

/**
 * @member {String} review_comments_url
 */
PullRequest7.prototype['review_comments_url'] = undefined;

/**
 * State of this Pull Request. Either `open` or `closed`.
 * @member {module:model/PullRequest7.StateEnum} state
 */
PullRequest7.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
PullRequest7.prototype['statuses_url'] = undefined;

/**
 * The title of the pull request.
 * @member {String} title
 */
PullRequest7.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
PullRequest7.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
PullRequest7.prototype['url'] = undefined;

/**
 * @member {module:model/User} user
 */
PullRequest7.prototype['user'] = undefined;
 ...
 * @readonly
 */
PullRequest7['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
PullRequest7['AuthorAssociationEnum'] = {
