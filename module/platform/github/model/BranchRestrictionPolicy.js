...
class BranchRestrictionPolicy {
     ...
     */
    constructor(url, usersUrl, teamsUrl, appsUrl, users, teams, apps) { 
        
        BranchRestrictionPolicy.initialize(this, url, usersUrl, teamsUrl, appsUrl, users, teams, apps);
    }
     ...
     */
    static initialize(obj, url, usersUrl, teamsUrl, appsUrl, users, teams, apps) { 
        obj['url'] = url;
...
BranchRestrictionPolicy.RequiredProperties = ["url", "users_url", "teams_url", "apps_url", "users", "teams", "apps"];
