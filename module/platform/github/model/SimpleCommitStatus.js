...
class SimpleCommitStatus {
     ...
     */
    constructor(description, id, nodeId, state, context, targetUrl, avatarUrl, url, createdAt, updatedAt) { 
        
        SimpleCommitStatus.initialize(this, description, id, nodeId, state, context, targetUrl, avatarUrl, url, createdAt, updatedAt);
    }
     ...
     */
    static initialize(obj, description, id, nodeId, state, context, targetUrl, avatarUrl, url, createdAt, updatedAt) { 
...
SimpleCommitStatus.RequiredProperties = ["description", "id", "node_id", "state", "context", "target_url", "avatar_url", "url", "created_at", "updated_at"];
