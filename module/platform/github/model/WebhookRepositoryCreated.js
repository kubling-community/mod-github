...
/**
 * The WebhookRepositoryCreated model module.
 * @module model/WebhookRepositoryCreated
 * @version 1.1.4
 */
class WebhookRepositoryCreated {
    /**
     * Constructs a new <code>WebhookRepositoryCreated</code>.
     * @alias module:model/WebhookRepositoryCreated
     * @param action {module:model/WebhookRepositoryCreated.ActionEnum} 
    ...
    constructor(action, repository, sender) { 
        ...
        WebhookRepositoryCreated.initialize(this, action, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookRepositoryCreated</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookRepositoryCreated} obj Optional instance to populate.
     * @return {module:model/WebhookRepositoryCreated} The populated <code>WebhookRepositoryCreated</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookRepositoryCreated();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookRepositoryCreated</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookRepositoryCreated</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookRepositoryCreated.RequiredProperties) {
...
WebhookRepositoryCreated.RequiredProperties = ["action", "repository", "sender"];

/**
 * @member {module:model/WebhookRepositoryCreated.ActionEnum} action
 */
WebhookRepositoryCreated.prototype['action'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookRepositoryCreated.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookRepositoryCreated.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookRepositoryCreated.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookRepositoryCreated.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookRepositoryCreated.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookRepositoryCreated['ActionEnum'] = {
...
export default WebhookRepositoryCreated;
