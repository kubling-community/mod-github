...
class Contributor {
     ...
     */
    constructor(type, contributions) { 
        
        Contributor.initialize(this, type, contributions);
    }
     ...
     */
    static initialize(obj, type, contributions) { 
        obj['type'] = type;
...
Contributor.RequiredProperties = ["type", "contributions"];
