...
class LabelSearchResultItem {
     ...
     * @param score {Number} 
     */
    constructor(id, nodeId, url, name, color, _default, description, score) { 
        
        LabelSearchResultItem.initialize(this, id, nodeId, url, name, color, _default, description, score);
    }
     ...
     */
    static initialize(obj, id, nodeId, url, name, color, _default, description, score) { 
        obj['id'] = id;
        obj['node_id'] = nodeId;
        obj['url'] = url;
        obj['name'] = name;
...
LabelSearchResultItem.RequiredProperties = ["id", "node_id", "url", "name", "color", "default", "description", "score"];
