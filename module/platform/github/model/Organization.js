...
class Organization {
    ...
    constructor(avatarUrl, description, eventsUrl, hooksUrl, id, issuesUrl, login, membersUrl, nodeId, publicMembersUrl, reposUrl, url) { 
        ...
        Organization.initialize(this, avatarUrl, description, eventsUrl, hooksUrl, id, issuesUrl, login, membersUrl, nodeId, publicMembersUrl, reposUrl, url);
    }
...
Organization.RequiredProperties = ["avatar_url", "description", "events_url", "hooks_url", "id", "issues_url", "login", "members_url", "node_id", "public_members_url", "repos_url", "url"];
