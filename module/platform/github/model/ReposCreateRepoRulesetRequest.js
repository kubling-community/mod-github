...
/**
 * The ReposCreateRepoRulesetRequest model module.
 * @module model/ReposCreateRepoRulesetRequest
 * @version 1.1.4
 */
class ReposCreateRepoRulesetRequest {
    /**
     * Constructs a new <code>ReposCreateRepoRulesetRequest</code>.
     * @alias module:model/ReposCreateRepoRulesetRequest
    ...
    constructor(name, enforcement) { 
        ...
        ReposCreateRepoRulesetRequest.initialize(this, name, enforcement);
    }
    ...
    /**
     * Constructs a <code>ReposCreateRepoRulesetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReposCreateRepoRulesetRequest} obj Optional instance to populate.
     * @return {module:model/ReposCreateRepoRulesetRequest} The populated <code>ReposCreateRepoRulesetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReposCreateRepoRulesetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ReposCreateRepoRulesetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReposCreateRepoRulesetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReposCreateRepoRulesetRequest.RequiredProperties) {
...
ReposCreateRepoRulesetRequest.RequiredProperties = ["name", "enforcement"];

/**
 * The name of the ruleset.
 * @member {String} name
 */
ReposCreateRepoRulesetRequest.prototype['name'] = undefined;

/**
 * The target of the ruleset  **Note**: The `push` target is in beta and is subject to change.
 * @member {module:model/ReposCreateRepoRulesetRequest.TargetEnum} target
 */
ReposCreateRepoRulesetRequest.prototype['target'] = undefined;

/**
 * @member {module:model/RepositoryRuleEnforcement} enforcement
 */
ReposCreateRepoRulesetRequest.prototype['enforcement'] = undefined;

/**
 * The actors that can bypass the rules in this ruleset
 * @member {Array.<module:model/RepositoryRulesetBypassActor>} bypass_actors
 */
ReposCreateRepoRulesetRequest.prototype['bypass_actors'] = undefined;

/**
 * @member {module:model/RepositoryRulesetConditions} conditions
 */
ReposCreateRepoRulesetRequest.prototype['conditions'] = undefined;

/**
 * An array of rules within the ruleset.
 * @member {Array.<module:model/RepositoryRule>} rules
 */
ReposCreateRepoRulesetRequest.prototype['rules'] = undefined;
 ...
 * @readonly
 */
ReposCreateRepoRulesetRequest['TargetEnum'] = {
...
export default ReposCreateRepoRulesetRequest;
