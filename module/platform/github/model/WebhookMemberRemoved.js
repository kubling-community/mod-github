...
/**
 * The WebhookMemberRemoved model module.
 * @module model/WebhookMemberRemoved
 * @version 1.1.4
 */
class WebhookMemberRemoved {
    /**
     * Constructs a new <code>WebhookMemberRemoved</code>.
     * @alias module:model/WebhookMemberRemoved
     * @param action {module:model/WebhookMemberRemoved.ActionEnum} 
    ...
    constructor(action, member, repository, sender) { 
        ...
        WebhookMemberRemoved.initialize(this, action, member, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookMemberRemoved</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookMemberRemoved} obj Optional instance to populate.
     * @return {module:model/WebhookMemberRemoved} The populated <code>WebhookMemberRemoved</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookMemberRemoved();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookMemberRemoved</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookMemberRemoved</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookMemberRemoved.RequiredProperties) {
...
WebhookMemberRemoved.RequiredProperties = ["action", "member", "repository", "sender"];

/**
 * @member {module:model/WebhookMemberRemoved.ActionEnum} action
 */
WebhookMemberRemoved.prototype['action'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookMemberRemoved.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookMemberRemoved.prototype['installation'] = undefined;

/**
 * @member {module:model/WebhooksUser} member
 */
WebhookMemberRemoved.prototype['member'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookMemberRemoved.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookMemberRemoved.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookMemberRemoved.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookMemberRemoved['ActionEnum'] = {
...
export default WebhookMemberRemoved;
