...
/**
 * The Repository5 model module.
 * @module model/Repository5
 * @version 1.1.4
 */
class Repository5 {
    /**
     * Constructs a new <code>Repository5</code>.
     * A git repository
     * @alias module:model/Repository5
    ...
    /**
     * Constructs a <code>Repository5</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Repository5} obj Optional instance to populate.
     * @return {module:model/Repository5} The populated <code>Repository5</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Repository5();
    ...
    /**
     * Validates the JSON data with respect to <code>Repository5</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Repository5</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Repository5.RequiredProperties) {
 ...
 * @default false
 */
Repository5.prototype['allow_auto_merge'] = false;

/**
 * Whether to allow private forks
 * @member {Boolean} allow_forking
 */
Repository5.prototype['allow_forking'] = undefined;
 ...
 * @default true
 */
Repository5.prototype['allow_merge_commit'] = true;
 ...
 * @default true
 */
Repository5.prototype['allow_rebase_merge'] = true;
 ...
 * @default true
 */
Repository5.prototype['allow_squash_merge'] = true;

/**
 * @member {Boolean} allow_update_branch
 */
Repository5.prototype['allow_update_branch'] = undefined;

/**
 * @member {String} archive_url
 */
Repository5.prototype['archive_url'] = undefined;
 ...
 * @default false
 */
Repository5.prototype['archived'] = false;

/**
 * @member {String} assignees_url
 */
Repository5.prototype['assignees_url'] = undefined;

/**
 * @member {String} blobs_url
 */
Repository5.prototype['blobs_url'] = undefined;

/**
 * @member {String} branches_url
 */
Repository5.prototype['branches_url'] = undefined;

/**
 * @member {String} clone_url
 */
Repository5.prototype['clone_url'] = undefined;

/**
 * @member {String} collaborators_url
 */
Repository5.prototype['collaborators_url'] = undefined;

/**
 * @member {String} comments_url
 */
Repository5.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
Repository5.prototype['commits_url'] = undefined;

/**
 * @member {String} compare_url
 */
Repository5.prototype['compare_url'] = undefined;

/**
 * @member {String} contents_url
 */
Repository5.prototype['contents_url'] = undefined;

/**
 * @member {String} contributors_url
 */
Repository5.prototype['contributors_url'] = undefined;

/**
 * @member {module:model/RepositoryCreatedAt} created_at
 */
Repository5.prototype['created_at'] = undefined;

/**
 * The default branch of the repository.
 * @member {String} default_branch
 */
Repository5.prototype['default_branch'] = undefined;
 ...
 * @default false
 */
Repository5.prototype['delete_branch_on_merge'] = false;

/**
 * @member {String} deployments_url
 */
Repository5.prototype['deployments_url'] = undefined;

/**
 * @member {String} description
 */
Repository5.prototype['description'] = undefined;

/**
 * Returns whether or not this repository is disabled.
 * @member {Boolean} disabled
 */
Repository5.prototype['disabled'] = undefined;

/**
 * @member {String} downloads_url
 */
Repository5.prototype['downloads_url'] = undefined;

/**
 * @member {String} events_url
 */
Repository5.prototype['events_url'] = undefined;

/**
 * @member {Boolean} fork
 */
Repository5.prototype['fork'] = undefined;

/**
 * @member {Number} forks
 */
Repository5.prototype['forks'] = undefined;

/**
 * @member {Number} forks_count
 */
Repository5.prototype['forks_count'] = undefined;

/**
 * @member {String} forks_url
 */
Repository5.prototype['forks_url'] = undefined;

/**
 * @member {String} full_name
 */
Repository5.prototype['full_name'] = undefined;

/**
 * @member {String} git_commits_url
 */
Repository5.prototype['git_commits_url'] = undefined;

/**
 * @member {String} git_refs_url
 */
Repository5.prototype['git_refs_url'] = undefined;

/**
 * @member {String} git_tags_url
 */
Repository5.prototype['git_tags_url'] = undefined;

/**
 * @member {String} git_url
 */
Repository5.prototype['git_url'] = undefined;
 ...
 * @default true
 */
Repository5.prototype['has_downloads'] = true;
 ...
 * @default true
 */
Repository5.prototype['has_issues'] = true;
 ...
 * @default false
 */
Repository5.prototype['has_discussions'] = false;

/**
 * @member {Boolean} has_pages
 */
Repository5.prototype['has_pages'] = undefined;
 ...
 * @default true
 */
Repository5.prototype['has_projects'] = true;
 ...
 * @default true
 */
Repository5.prototype['has_wiki'] = true;

/**
 * @member {String} homepage
 */
Repository5.prototype['homepage'] = undefined;

/**
 * @member {String} hooks_url
 */
Repository5.prototype['hooks_url'] = undefined;

/**
 * @member {String} html_url
 */
Repository5.prototype['html_url'] = undefined;

/**
 * Unique identifier of the repository
 * @member {Number} id
 */
Repository5.prototype['id'] = undefined;

/**
 * @member {Boolean} is_template
 */
Repository5.prototype['is_template'] = undefined;

/**
 * @member {String} issue_comment_url
 */
Repository5.prototype['issue_comment_url'] = undefined;

/**
 * @member {String} issue_events_url
 */
Repository5.prototype['issue_events_url'] = undefined;

/**
 * @member {String} issues_url
 */
Repository5.prototype['issues_url'] = undefined;

/**
 * @member {String} keys_url
 */
Repository5.prototype['keys_url'] = undefined;

/**
 * @member {String} labels_url
 */
Repository5.prototype['labels_url'] = undefined;

/**
 * @member {String} language
 */
Repository5.prototype['language'] = undefined;

/**
 * @member {String} languages_url
 */
Repository5.prototype['languages_url'] = undefined;

/**
 * @member {module:model/License} license
 */
Repository5.prototype['license'] = undefined;

/**
 * @member {String} master_branch
 */
Repository5.prototype['master_branch'] = undefined;

/**
 * The default value for a merge commit message.  - `PR_TITLE` - default to the pull request's title. - `PR_BODY` - default to the pull request's body. - `BLANK` - default to a blank commit message.
 * @member {module:model/Repository5.MergeCommitMessageEnum} merge_commit_message
 */
Repository5.prototype['merge_commit_message'] = undefined;

/**
 * The default value for a merge commit title.  - `PR_TITLE` - default to the pull request's title. - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
 * @member {module:model/Repository5.MergeCommitTitleEnum} merge_commit_title
 */
Repository5.prototype['merge_commit_title'] = undefined;

/**
 * @member {String} merges_url
 */
Repository5.prototype['merges_url'] = undefined;

/**
 * @member {String} milestones_url
 */
Repository5.prototype['milestones_url'] = undefined;

/**
 * @member {String} mirror_url
 */
Repository5.prototype['mirror_url'] = undefined;

/**
 * The name of the repository.
 * @member {String} name
 */
Repository5.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
Repository5.prototype['node_id'] = undefined;

/**
 * @member {String} notifications_url
 */
Repository5.prototype['notifications_url'] = undefined;

/**
 * @member {Number} open_issues
 */
Repository5.prototype['open_issues'] = undefined;

/**
 * @member {Number} open_issues_count
 */
Repository5.prototype['open_issues_count'] = undefined;

/**
 * @member {String} organization
 */
Repository5.prototype['organization'] = undefined;

/**
 * @member {module:model/User} owner
 */
Repository5.prototype['owner'] = undefined;

/**
 * @member {module:model/RepositoryPermissions} permissions
 */
Repository5.prototype['permissions'] = undefined;

/**
 * Whether the repository is private or public.
 * @member {Boolean} private
 */
Repository5.prototype['private'] = undefined;

/**
 * @member {Boolean} public
 */
Repository5.prototype['public'] = undefined;

/**
 * @member {String} pulls_url
 */
Repository5.prototype['pulls_url'] = undefined;

/**
 * @member {module:model/RepositoryPushedAt} pushed_at
 */
Repository5.prototype['pushed_at'] = undefined;

/**
 * @member {String} releases_url
 */
Repository5.prototype['releases_url'] = undefined;

/**
 * @member {String} role_name
 */
Repository5.prototype['role_name'] = undefined;

/**
 * @member {Number} size
 */
Repository5.prototype['size'] = undefined;

/**
 * The default value for a squash merge commit message:  - `PR_BODY` - default to the pull request's body. - `COMMIT_MESSAGES` - default to the branch's commit messages. - `BLANK` - default to a blank commit message.
 * @member {module:model/Repository5.SquashMergeCommitMessageEnum} squash_merge_commit_message
 */
Repository5.prototype['squash_merge_commit_message'] = undefined;

/**
 * The default value for a squash merge commit title:  - `PR_TITLE` - default to the pull request's title. - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
 * @member {module:model/Repository5.SquashMergeCommitTitleEnum} squash_merge_commit_title
 */
Repository5.prototype['squash_merge_commit_title'] = undefined;

/**
 * @member {String} ssh_url
 */
Repository5.prototype['ssh_url'] = undefined;

/**
 * @member {Number} stargazers
 */
Repository5.prototype['stargazers'] = undefined;

/**
 * @member {Number} stargazers_count
 */
Repository5.prototype['stargazers_count'] = undefined;

/**
 * @member {String} stargazers_url
 */
Repository5.prototype['stargazers_url'] = undefined;

/**
 * @member {String} statuses_url
 */
Repository5.prototype['statuses_url'] = undefined;

/**
 * @member {String} subscribers_url
 */
Repository5.prototype['subscribers_url'] = undefined;

/**
 * @member {String} subscription_url
 */
Repository5.prototype['subscription_url'] = undefined;

/**
 * @member {String} svn_url
 */
Repository5.prototype['svn_url'] = undefined;

/**
 * @member {String} tags_url
 */
Repository5.prototype['tags_url'] = undefined;

/**
 * @member {String} teams_url
 */
Repository5.prototype['teams_url'] = undefined;

/**
 * @member {Array.<String>} topics
 */
Repository5.prototype['topics'] = undefined;

/**
 * @member {String} trees_url
 */
Repository5.prototype['trees_url'] = undefined;

/**
 * @member {Date} updated_at
 */
Repository5.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
Repository5.prototype['url'] = undefined;
 ...
 * @default false
 */
Repository5.prototype['use_squash_pr_title_as_default'] = false;

/**
 * @member {module:model/Repository5.VisibilityEnum} visibility
 */
Repository5.prototype['visibility'] = undefined;

/**
 * @member {Number} watchers
 */
Repository5.prototype['watchers'] = undefined;

/**
 * @member {Number} watchers_count
 */
Repository5.prototype['watchers_count'] = undefined;

/**
 * Whether to require contributors to sign off on web-based commits
 * @member {Boolean} web_commit_signoff_required
 */
Repository5.prototype['web_commit_signoff_required'] = undefined;
 ...
 * @readonly
 */
Repository5['MergeCommitMessageEnum'] = {
 ...
 * @readonly
 */
Repository5['MergeCommitTitleEnum'] = {
 ...
 * @readonly
 */
Repository5['SquashMergeCommitMessageEnum'] = {
 ...
 * @readonly
 */
Repository5['SquashMergeCommitTitleEnum'] = {
