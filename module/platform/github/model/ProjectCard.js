...
class ProjectCard {
    ...
    constructor(archived, columnId, columnUrl, createdAt, creator, id, nodeId, note, projectUrl, updatedAt, url) { 
        ...
        ProjectCard.initialize(this, archived, columnId, columnUrl, createdAt, creator, id, nodeId, note, projectUrl, updatedAt, url);
    }
...
ProjectCard.RequiredProperties = ["archived", "column_id", "column_url", "created_at", "creator", "id", "node_id", "note", "project_url", "updated_at", "url"];

/**
 * @member {Number} after_id
 */
ProjectCard.prototype['after_id'] = undefined;
 ...
 */
ProjectCard.prototype['column_id'] = undefined;
