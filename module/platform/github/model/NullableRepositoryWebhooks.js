...
import RepositoryWebhooksTemplateRepository from './RepositoryWebhooksTemplateRepository';
import SimpleUser from './SimpleUser';

/**
 * The NullableRepositoryWebhooks model module.
 * @module model/NullableRepositoryWebhooks
 * @version 1.1.4
 */
class NullableRepositoryWebhooks {
    /**
     * Constructs a new <code>NullableRepositoryWebhooks</code>.
     ...
     * @alias module:model/NullableRepositoryWebhooks
     ...
     * @param size {Number} The size of the repository, in kilobytes. Size is calculated hourly. When a repository is initially created, the size is 0.
     ...
     */
    constructor(id, nodeId, name, fullName, license, forks, owner, _private, htmlUrl, description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, downloadsUrl, eventsUrl, forksUrl, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, notificationsUrl, pullsUrl, releasesUrl, sshUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, cloneUrl, mirrorUrl, hooksUrl, svnUrl, homepage, language, forksCount, stargazersCount, watchersCount, size, defaultBranch, openIssuesCount, hasIssues, hasProjects, hasWiki, hasPages, hasDownloads, archived, disabled, pushedAt, createdAt, updatedAt, openIssues, watchers) { 
        
        NullableRepositoryWebhooks.initialize(this, id, nodeId, name, fullName, license, forks, owner, _private, htmlUrl, description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, downloadsUrl, eventsUrl, forksUrl, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, notificationsUrl, pullsUrl, releasesUrl, sshUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, cloneUrl, mirrorUrl, hooksUrl, svnUrl, homepage, language, forksCount, stargazersCount, watchersCount, size, defaultBranch, openIssuesCount, hasIssues, hasProjects, hasWiki, hasPages, hasDownloads, archived, disabled, pushedAt, createdAt, updatedAt, openIssues, watchers);
    }
     ...
     */
    static initialize(obj, id, nodeId, name, fullName, license, forks, owner, _private, htmlUrl, description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, downloadsUrl, eventsUrl, forksUrl, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, notificationsUrl, pullsUrl, releasesUrl, sshUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, cloneUrl, mirrorUrl, hooksUrl, svnUrl, homepage, language, forksCount, stargazersCount, watchersCount, size, defaultBranch, openIssuesCount, hasIssues, hasProjects, hasWiki, hasPages, hasDownloads, archived, disabled, pushedAt, createdAt, updatedAt, openIssues, watchers) { 
        obj['id'] = id;
        obj['node_id'] = nodeId;
        obj['name'] = name;
    ...
    /**
     * Constructs a <code>NullableRepositoryWebhooks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NullableRepositoryWebhooks} obj Optional instance to populate.
     * @return {module:model/NullableRepositoryWebhooks} The populated <code>NullableRepositoryWebhooks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NullableRepositoryWebhooks();
            ...
            if (data.hasOwnProperty('template_repository')) {
                obj['template_repository'] = RepositoryWebhooksTemplateRepository.constructFromObject(data['template_repository']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>NullableRepositoryWebhooks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NullableRepositoryWebhooks</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NullableRepositoryWebhooks.RequiredProperties) {
        ...
        if (data['template_repository']) { // data not null
          RepositoryWebhooksTemplateRepository.validateJSON(data['template_repository']);
        }
        // ensure the json data is a string
...
NullableRepositoryWebhooks.RequiredProperties = ["id", "node_id", "name", "full_name", "license", "forks", "owner", "private", "html_url", "description", "fork", "url", "archive_url", "assignees_url", "blobs_url", "branches_url", "collaborators_url", "comments_url", "commits_url", "compare_url", "contents_url", "contributors_url", "deployments_url", "downloads_url", "events_url", "forks_url", "git_commits_url", "git_refs_url", "git_tags_url", "git_url", "issue_comment_url", "issue_events_url", "issues_url", "keys_url", "labels_url", "languages_url", "merges_url", "milestones_url", "notifications_url", "pulls_url", "releases_url", "ssh_url", "stargazers_url", "statuses_url", "subscribers_url", "subscription_url", "tags_url", "teams_url", "trees_url", "clone_url", "mirror_url", "hooks_url", "svn_url", "homepage", "language", "forks_count", "stargazers_count", "watchers_count", "size", "default_branch", "open_issues_count", "has_issues", "has_projects", "has_wiki", "has_pages", "has_downloads", "archived", "disabled", "pushed_at", "created_at", "updated_at", "open_issues", "watchers"];

/**
 * Unique identifier of the repository
 * @member {Number} id
 */
NullableRepositoryWebhooks.prototype['id'] = undefined;

/**
 * @member {String} node_id
 */
NullableRepositoryWebhooks.prototype['node_id'] = undefined;

/**
 * The name of the repository.
 * @member {String} name
 */
NullableRepositoryWebhooks.prototype['name'] = undefined;

/**
 * @member {String} full_name
 */
NullableRepositoryWebhooks.prototype['full_name'] = undefined;

/**
 * @member {module:model/NullableLicenseSimple} license
 */
NullableRepositoryWebhooks.prototype['license'] = undefined;

/**
 * @member {module:model/NullableSimpleUser} organization
 */
NullableRepositoryWebhooks.prototype['organization'] = undefined;

/**
 * @member {Number} forks
 */
NullableRepositoryWebhooks.prototype['forks'] = undefined;

/**
 * @member {module:model/RepositoryPermissions} permissions
 */
NullableRepositoryWebhooks.prototype['permissions'] = undefined;

/**
 * @member {module:model/SimpleUser} owner
 */
NullableRepositoryWebhooks.prototype['owner'] = undefined;
 ...
 * @default false
 */
NullableRepositoryWebhooks.prototype['private'] = false;

/**
 * @member {String} html_url
 */
NullableRepositoryWebhooks.prototype['html_url'] = undefined;

/**
 * @member {String} description
 */
NullableRepositoryWebhooks.prototype['description'] = undefined;

/**
 * @member {Boolean} fork
 */
NullableRepositoryWebhooks.prototype['fork'] = undefined;

/**
 * @member {String} url
 */
NullableRepositoryWebhooks.prototype['url'] = undefined;

/**
 * @member {String} archive_url
 */
NullableRepositoryWebhooks.prototype['archive_url'] = undefined;

/**
 * @member {String} assignees_url
 */
NullableRepositoryWebhooks.prototype['assignees_url'] = undefined;

/**
 * @member {String} blobs_url
 */
NullableRepositoryWebhooks.prototype['blobs_url'] = undefined;

/**
 * @member {String} branches_url
 */
NullableRepositoryWebhooks.prototype['branches_url'] = undefined;

/**
 * @member {String} collaborators_url
 */
NullableRepositoryWebhooks.prototype['collaborators_url'] = undefined;

/**
 * @member {String} comments_url
 */
NullableRepositoryWebhooks.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
NullableRepositoryWebhooks.prototype['commits_url'] = undefined;

/**
 * @member {String} compare_url
 */
NullableRepositoryWebhooks.prototype['compare_url'] = undefined;

/**
 * @member {String} contents_url
 */
NullableRepositoryWebhooks.prototype['contents_url'] = undefined;

/**
 * @member {String} contributors_url
 */
NullableRepositoryWebhooks.prototype['contributors_url'] = undefined;

/**
 * @member {String} deployments_url
 */
NullableRepositoryWebhooks.prototype['deployments_url'] = undefined;

/**
 * @member {String} downloads_url
 */
NullableRepositoryWebhooks.prototype['downloads_url'] = undefined;

/**
 * @member {String} events_url
 */
NullableRepositoryWebhooks.prototype['events_url'] = undefined;

/**
 * @member {String} forks_url
 */
NullableRepositoryWebhooks.prototype['forks_url'] = undefined;

/**
 * @member {String} git_commits_url
 */
NullableRepositoryWebhooks.prototype['git_commits_url'] = undefined;

/**
 * @member {String} git_refs_url
 */
NullableRepositoryWebhooks.prototype['git_refs_url'] = undefined;

/**
 * @member {String} git_tags_url
 */
NullableRepositoryWebhooks.prototype['git_tags_url'] = undefined;

/**
 * @member {String} git_url
 */
NullableRepositoryWebhooks.prototype['git_url'] = undefined;

/**
 * @member {String} issue_comment_url
 */
NullableRepositoryWebhooks.prototype['issue_comment_url'] = undefined;

/**
 * @member {String} issue_events_url
 */
NullableRepositoryWebhooks.prototype['issue_events_url'] = undefined;

/**
 * @member {String} issues_url
 */
NullableRepositoryWebhooks.prototype['issues_url'] = undefined;

/**
 * @member {String} keys_url
 */
NullableRepositoryWebhooks.prototype['keys_url'] = undefined;

/**
 * @member {String} labels_url
 */
NullableRepositoryWebhooks.prototype['labels_url'] = undefined;

/**
 * @member {String} languages_url
 */
NullableRepositoryWebhooks.prototype['languages_url'] = undefined;

/**
 * @member {String} merges_url
 */
NullableRepositoryWebhooks.prototype['merges_url'] = undefined;

/**
 * @member {String} milestones_url
 */
NullableRepositoryWebhooks.prototype['milestones_url'] = undefined;

/**
 * @member {String} notifications_url
 */
NullableRepositoryWebhooks.prototype['notifications_url'] = undefined;

/**
 * @member {String} pulls_url
 */
NullableRepositoryWebhooks.prototype['pulls_url'] = undefined;

/**
 * @member {String} releases_url
 */
NullableRepositoryWebhooks.prototype['releases_url'] = undefined;

/**
 * @member {String} ssh_url
 */
NullableRepositoryWebhooks.prototype['ssh_url'] = undefined;

/**
 * @member {String} stargazers_url
 */
NullableRepositoryWebhooks.prototype['stargazers_url'] = undefined;

/**
 * @member {String} statuses_url
 */
NullableRepositoryWebhooks.prototype['statuses_url'] = undefined;

/**
 * @member {String} subscribers_url
 */
NullableRepositoryWebhooks.prototype['subscribers_url'] = undefined;

/**
 * @member {String} subscription_url
 */
NullableRepositoryWebhooks.prototype['subscription_url'] = undefined;

/**
 * @member {String} tags_url
 */
NullableRepositoryWebhooks.prototype['tags_url'] = undefined;

/**
 * @member {String} teams_url
 */
NullableRepositoryWebhooks.prototype['teams_url'] = undefined;

/**
 * @member {String} trees_url
 */
NullableRepositoryWebhooks.prototype['trees_url'] = undefined;

/**
 * @member {String} clone_url
 */
NullableRepositoryWebhooks.prototype['clone_url'] = undefined;

/**
 * @member {String} mirror_url
 */
NullableRepositoryWebhooks.prototype['mirror_url'] = undefined;

/**
 * @member {String} hooks_url
 */
NullableRepositoryWebhooks.prototype['hooks_url'] = undefined;

/**
 * @member {String} svn_url
 */
NullableRepositoryWebhooks.prototype['svn_url'] = undefined;

/**
 * @member {String} homepage
 */
NullableRepositoryWebhooks.prototype['homepage'] = undefined;

/**
 * @member {String} language
 */
NullableRepositoryWebhooks.prototype['language'] = undefined;

/**
 * @member {Number} forks_count
 */
NullableRepositoryWebhooks.prototype['forks_count'] = undefined;

/**
 * @member {Number} stargazers_count
 */
NullableRepositoryWebhooks.prototype['stargazers_count'] = undefined;

/**
 * @member {Number} watchers_count
 */
NullableRepositoryWebhooks.prototype['watchers_count'] = undefined;

/**
 * The size of the repository, in kilobytes. Size is calculated hourly. When a repository is initially created, the size is 0.
 * @member {Number} size
 */
NullableRepositoryWebhooks.prototype['size'] = undefined;

/**
 * The default branch of the repository.
 * @member {String} default_branch
 */
NullableRepositoryWebhooks.prototype['default_branch'] = undefined;

/**
 * @member {Number} open_issues_count
 */
NullableRepositoryWebhooks.prototype['open_issues_count'] = undefined;
 ...
 * @default false
 */
NullableRepositoryWebhooks.prototype['is_template'] = false;

/**
 * @member {Array.<String>} topics
 */
NullableRepositoryWebhooks.prototype['topics'] = undefined;

/**
 * The custom properties that were defined for the repository. The keys are the custom property names, and the values are the corresponding custom property values.
 * @member {Object.<String, Object>} custom_properties
 */
NullableRepositoryWebhooks.prototype['custom_properties'] = undefined;
 ...
 * @default true
 */
NullableRepositoryWebhooks.prototype['has_issues'] = true;
 ...
 * @default true
 */
NullableRepositoryWebhooks.prototype['has_projects'] = true;
 ...
 * @default true
 */
NullableRepositoryWebhooks.prototype['has_wiki'] = true;

/**
 * @member {Boolean} has_pages
 */
NullableRepositoryWebhooks.prototype['has_pages'] = undefined;
 ...
 * @default true
 */
NullableRepositoryWebhooks.prototype['has_downloads'] = true;
 ...
 * @default false
 */
NullableRepositoryWebhooks.prototype['has_discussions'] = false;
 ...
 * @default false
 */
NullableRepositoryWebhooks.prototype['archived'] = false;

/**
 * Returns whether or not this repository disabled.
 * @member {Boolean} disabled
 */
NullableRepositoryWebhooks.prototype['disabled'] = undefined;
 ...
 * @default 'public'
 */
NullableRepositoryWebhooks.prototype['visibility'] = 'public';

/**
 * @member {Date} pushed_at
 */
NullableRepositoryWebhooks.prototype['pushed_at'] = undefined;

/**
 * @member {Date} created_at
 */
NullableRepositoryWebhooks.prototype['created_at'] = undefined;

/**
 * @member {Date} updated_at
 */
NullableRepositoryWebhooks.prototype['updated_at'] = undefined;
 ...
 * @default true
 */
NullableRepositoryWebhooks.prototype['allow_rebase_merge'] = true;

/**
 * @member {module:model/RepositoryWebhooksTemplateRepository} template_repository
 */
NullableRepositoryWebhooks.prototype['template_repository'] = undefined;

/**
 * @member {String} temp_clone_token
 */
NullableRepositoryWebhooks.prototype['temp_clone_token'] = undefined;
 ...
 * @default true
 */
NullableRepositoryWebhooks.prototype['allow_squash_merge'] = true;
 ...
 * @default false
 */
NullableRepositoryWebhooks.prototype['allow_auto_merge'] = false;
 ...
 * @default false
 */
NullableRepositoryWebhooks.prototype['delete_branch_on_merge'] = false;
 ...
 * @default false
 */
NullableRepositoryWebhooks.prototype['allow_update_branch'] = false;
 ...
 * @default false
 */
NullableRepositoryWebhooks.prototype['use_squash_pr_title_as_default'] = false;

/**
 * The default value for a squash merge commit title:  - `PR_TITLE` - default to the pull request's title. - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
 * @member {module:model/NullableRepositoryWebhooks.SquashMergeCommitTitleEnum} squash_merge_commit_title
 */
NullableRepositoryWebhooks.prototype['squash_merge_commit_title'] = undefined;

/**
 * The default value for a squash merge commit message:  - `PR_BODY` - default to the pull request's body. - `COMMIT_MESSAGES` - default to the branch's commit messages. - `BLANK` - default to a blank commit message.
 * @member {module:model/NullableRepositoryWebhooks.SquashMergeCommitMessageEnum} squash_merge_commit_message
 */
NullableRepositoryWebhooks.prototype['squash_merge_commit_message'] = undefined;

/**
 * The default value for a merge commit title.  - `PR_TITLE` - default to the pull request's title. - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
 * @member {module:model/NullableRepositoryWebhooks.MergeCommitTitleEnum} merge_commit_title
 */
NullableRepositoryWebhooks.prototype['merge_commit_title'] = undefined;

/**
 * The default value for a merge commit message.  - `PR_TITLE` - default to the pull request's title. - `PR_BODY` - default to the pull request's body. - `BLANK` - default to a blank commit message.
 * @member {module:model/NullableRepositoryWebhooks.MergeCommitMessageEnum} merge_commit_message
 */
NullableRepositoryWebhooks.prototype['merge_commit_message'] = undefined;
 ...
 * @default true
 */
NullableRepositoryWebhooks.prototype['allow_merge_commit'] = true;

/**
 * Whether to allow forking this repo
 * @member {Boolean} allow_forking
 */
NullableRepositoryWebhooks.prototype['allow_forking'] = undefined;
 ...
 * @default false
 */
NullableRepositoryWebhooks.prototype['web_commit_signoff_required'] = false;

/**
 * @member {Number} subscribers_count
 */
NullableRepositoryWebhooks.prototype['subscribers_count'] = undefined;

/**
 * @member {Number} network_count
 */
NullableRepositoryWebhooks.prototype['network_count'] = undefined;

/**
 * @member {Number} open_issues
 */
NullableRepositoryWebhooks.prototype['open_issues'] = undefined;

/**
 * @member {Number} watchers
 */
NullableRepositoryWebhooks.prototype['watchers'] = undefined;

/**
 * @member {String} master_branch
 */
NullableRepositoryWebhooks.prototype['master_branch'] = undefined;

/**
 * @member {String} starred_at
 */
NullableRepositoryWebhooks.prototype['starred_at'] = undefined;

/**
 * Whether anonymous git access is enabled for this repository
 * @member {Boolean} anonymous_access_enabled
 */
NullableRepositoryWebhooks.prototype['anonymous_access_enabled'] = undefined;
 ...
 * @readonly
 */
NullableRepositoryWebhooks['SquashMergeCommitTitleEnum'] = {
 ...
 * @readonly
 */
NullableRepositoryWebhooks['SquashMergeCommitMessageEnum'] = {
 ...
 * @readonly
 */
NullableRepositoryWebhooks['MergeCommitTitleEnum'] = {
 ...
 * @readonly
 */
NullableRepositoryWebhooks['MergeCommitMessageEnum'] = {
...
export default NullableRepositoryWebhooks;
