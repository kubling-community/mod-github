...
/**
 * The Issue7 model module.
 * @module model/Issue7
 * @version 1.1.4
 */
class Issue7 {
    /**
     * Constructs a new <code>Issue7</code>.
     * The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
     * @alias module:model/Issue7
     * @param activeLockReason {module:model/Issue7.ActiveLockReasonEnum} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/Issue7.AuthorAssociationEnum} How the author is associated with the repository.
    ...
    constructor(activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user) { 
        ...
        Issue7.initialize(this, activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>Issue7</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Issue7} obj Optional instance to populate.
     * @return {module:model/Issue7} The populated <code>Issue7</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('performed_via_github_app')) {
                obj['performed_via_github_app'] = App12.constructFromObject(data['performed_via_github_app']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Issue7</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Issue7</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Issue7.RequiredProperties) {
        ...
        if (data['performed_via_github_app']) { // data not null
          App12.validateJSON(data['performed_via_github_app']);
        }
...
Issue7.RequiredProperties = ["active_lock_reason", "assignees", "author_association", "body", "closed_at", "comments", "comments_url", "created_at", "events_url", "html_url", "id", "labels_url", "milestone", "node_id", "number", "reactions", "repository_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/Issue7.ActiveLockReasonEnum} active_lock_reason
 */
Issue7.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User} assignee
 */
Issue7.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
Issue7.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/Issue7.AuthorAssociationEnum} author_association
 */
Issue7.prototype['author_association'] = undefined;

/**
 * Contents of the issue
 * @member {String} body
 */
Issue7.prototype['body'] = undefined;

/**
 * @member {Date} closed_at
 */
Issue7.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
Issue7.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
Issue7.prototype['comments_url'] = undefined;

/**
 * @member {Date} created_at
 */
Issue7.prototype['created_at'] = undefined;

/**
 * @member {Boolean} draft
 */
Issue7.prototype['draft'] = undefined;

/**
 * @member {String} events_url
 */
Issue7.prototype['events_url'] = undefined;

/**
 * @member {String} html_url
 */
Issue7.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
Issue7.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
Issue7.prototype['labels'] = undefined;

/**
 * @member {String} labels_url
 */
Issue7.prototype['labels_url'] = undefined;

/**
 * @member {Boolean} locked
 */
Issue7.prototype['locked'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
Issue7.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
Issue7.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
Issue7.prototype['number'] = undefined;

/**
 * @member {module:model/App12} performed_via_github_app
 */
Issue7.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/WebhooksIssuePullRequest} pull_request
 */
Issue7.prototype['pull_request'] = undefined;

/**
 * @member {module:model/Reactions} reactions
 */
Issue7.prototype['reactions'] = undefined;

/**
 * @member {String} repository_url
 */
Issue7.prototype['repository_url'] = undefined;

/**
 * State of the issue; either 'open' or 'closed'
 * @member {module:model/Issue7.StateEnum} state
 */
Issue7.prototype['state'] = undefined;

/**
 * @member {String} state_reason
 */
Issue7.prototype['state_reason'] = undefined;

/**
 * @member {String} timeline_url
 */
Issue7.prototype['timeline_url'] = undefined;

/**
 * Title of the issue
 * @member {String} title
 */
Issue7.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
Issue7.prototype['updated_at'] = undefined;

/**
 * URL for the issue
 * @member {String} url
 */
Issue7.prototype['url'] = undefined;

/**
 * @member {module:model/User} user
 */
Issue7.prototype['user'] = undefined;
