...
/**
 * The WebhooksUserMannequin model module.
 * @module model/WebhooksUserMannequin
 * @version 1.1.4
 */
class WebhooksUserMannequin {
    /**
     * Constructs a new <code>WebhooksUserMannequin</code>.
     * @alias module:model/WebhooksUserMannequin
     * @param id {Number} 
     * @param login {String} 
     */
    constructor(id, login) { 
        
        WebhooksUserMannequin.initialize(this, id, login);
    }
    ...
    /**
     * Constructs a <code>WebhooksUserMannequin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhooksUserMannequin} obj Optional instance to populate.
     * @return {module:model/WebhooksUserMannequin} The populated <code>WebhooksUserMannequin</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhooksUserMannequin();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhooksUserMannequin</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhooksUserMannequin</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhooksUserMannequin.RequiredProperties) {
...
WebhooksUserMannequin.RequiredProperties = ["id", "login"];

/**
 * @member {String} avatar_url
 */
WebhooksUserMannequin.prototype['avatar_url'] = undefined;

/**
 * @member {Boolean} deleted
 */
WebhooksUserMannequin.prototype['deleted'] = undefined;

/**
 * @member {String} email
 */
WebhooksUserMannequin.prototype['email'] = undefined;

/**
 * @member {String} events_url
 */
WebhooksUserMannequin.prototype['events_url'] = undefined;

/**
 * @member {String} followers_url
 */
WebhooksUserMannequin.prototype['followers_url'] = undefined;

/**
 * @member {String} following_url
 */
WebhooksUserMannequin.prototype['following_url'] = undefined;

/**
 * @member {String} gists_url
 */
WebhooksUserMannequin.prototype['gists_url'] = undefined;

/**
 * @member {String} gravatar_id
 */
WebhooksUserMannequin.prototype['gravatar_id'] = undefined;

/**
 * @member {String} html_url
 */
WebhooksUserMannequin.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhooksUserMannequin.prototype['id'] = undefined;

/**
 * @member {String} login
 */
WebhooksUserMannequin.prototype['login'] = undefined;

/**
 * @member {String} name
 */
WebhooksUserMannequin.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
WebhooksUserMannequin.prototype['node_id'] = undefined;

/**
 * @member {String} organizations_url
 */
WebhooksUserMannequin.prototype['organizations_url'] = undefined;

/**
 * @member {String} received_events_url
 */
WebhooksUserMannequin.prototype['received_events_url'] = undefined;

/**
 * @member {String} repos_url
 */
WebhooksUserMannequin.prototype['repos_url'] = undefined;

/**
 * @member {Boolean} site_admin
 */
WebhooksUserMannequin.prototype['site_admin'] = undefined;

/**
 * @member {String} starred_url
 */
WebhooksUserMannequin.prototype['starred_url'] = undefined;

/**
 * @member {String} subscriptions_url
 */
WebhooksUserMannequin.prototype['subscriptions_url'] = undefined;

/**
 * @member {module:model/WebhooksUserMannequin.TypeEnum} type
 */
WebhooksUserMannequin.prototype['type'] = undefined;

/**
 * @member {String} url
 */
WebhooksUserMannequin.prototype['url'] = undefined;
 ...
 * @readonly
 */
WebhooksUserMannequin['TypeEnum'] = {
...
export default WebhooksUserMannequin;
