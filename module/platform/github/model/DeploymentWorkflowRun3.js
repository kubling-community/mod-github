...
/**
 * The DeploymentWorkflowRun3 model module.
 * @module model/DeploymentWorkflowRun3
 * @version 1.1.4
 */
class DeploymentWorkflowRun3 {
    /**
     * Constructs a new <code>DeploymentWorkflowRun3</code>.
     * @alias module:model/DeploymentWorkflowRun3
     * @param actor {module:model/User} 
     * @param checkSuiteId {Number} 
     * @param checkSuiteNodeId {String} 
     * @param conclusion {module:model/DeploymentWorkflowRun3.ConclusionEnum} 
     ...
     * @param status {module:model/DeploymentWorkflowRun3.StatusEnum} 
    ...
    constructor(actor, checkSuiteId, checkSuiteNodeId, conclusion, createdAt, event, headBranch, headSha, htmlUrl, id, name, nodeId, path, pullRequests, runAttempt, runNumber, runStartedAt, status, triggeringActor, updatedAt, url, workflowId, displayTitle) { 
        ...
        DeploymentWorkflowRun3.initialize(this, actor, checkSuiteId, checkSuiteNodeId, conclusion, createdAt, event, headBranch, headSha, htmlUrl, id, name, nodeId, path, pullRequests, runAttempt, runNumber, runStartedAt, status, triggeringActor, updatedAt, url, workflowId, displayTitle);
    }
    ...
    /**
     * Constructs a <code>DeploymentWorkflowRun3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeploymentWorkflowRun3} obj Optional instance to populate.
     * @return {module:model/DeploymentWorkflowRun3} The populated <code>DeploymentWorkflowRun3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeploymentWorkflowRun3();
    ...
    /**
     * Validates the JSON data with respect to <code>DeploymentWorkflowRun3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeploymentWorkflowRun3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeploymentWorkflowRun3.RequiredProperties) {
...
DeploymentWorkflowRun3.RequiredProperties = ["actor", "check_suite_id", "check_suite_node_id", "conclusion", "created_at", "event", "head_branch", "head_sha", "html_url", "id", "name", "node_id", "path", "pull_requests", "run_attempt", "run_number", "run_started_at", "status", "triggering_actor", "updated_at", "url", "workflow_id", "display_title"];

/**
 * @member {module:model/User} actor
 */
DeploymentWorkflowRun3.prototype['actor'] = undefined;

/**
 * @member {String} artifacts_url
 */
DeploymentWorkflowRun3.prototype['artifacts_url'] = undefined;

/**
 * @member {String} cancel_url
 */
DeploymentWorkflowRun3.prototype['cancel_url'] = undefined;

/**
 * @member {Number} check_suite_id
 */
DeploymentWorkflowRun3.prototype['check_suite_id'] = undefined;

/**
 * @member {String} check_suite_node_id
 */
DeploymentWorkflowRun3.prototype['check_suite_node_id'] = undefined;

/**
 * @member {String} check_suite_url
 */
DeploymentWorkflowRun3.prototype['check_suite_url'] = undefined;

/**
 * @member {module:model/DeploymentWorkflowRun3.ConclusionEnum} conclusion
 */
DeploymentWorkflowRun3.prototype['conclusion'] = undefined;

/**
 * @member {Date} created_at
 */
DeploymentWorkflowRun3.prototype['created_at'] = undefined;

/**
 * @member {String} event
 */
DeploymentWorkflowRun3.prototype['event'] = undefined;

/**
 * @member {String} head_branch
 */
DeploymentWorkflowRun3.prototype['head_branch'] = undefined;

/**
 * @member {Object} head_commit
 */
DeploymentWorkflowRun3.prototype['head_commit'] = undefined;

/**
 * @member {module:model/DeploymentWorkflowRun1HeadRepository} head_repository
 */
DeploymentWorkflowRun3.prototype['head_repository'] = undefined;

/**
 * @member {String} head_sha
 */
DeploymentWorkflowRun3.prototype['head_sha'] = undefined;

/**
 * @member {String} html_url
 */
DeploymentWorkflowRun3.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
DeploymentWorkflowRun3.prototype['id'] = undefined;

/**
 * @member {String} jobs_url
 */
DeploymentWorkflowRun3.prototype['jobs_url'] = undefined;

/**
 * @member {String} logs_url
 */
DeploymentWorkflowRun3.prototype['logs_url'] = undefined;

/**
 * @member {String} name
 */
DeploymentWorkflowRun3.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
DeploymentWorkflowRun3.prototype['node_id'] = undefined;

/**
 * @member {String} path
 */
DeploymentWorkflowRun3.prototype['path'] = undefined;

/**
 * @member {String} previous_attempt_url
 */
DeploymentWorkflowRun3.prototype['previous_attempt_url'] = undefined;

/**
 * @member {Array.<module:model/CheckRunPullRequest>} pull_requests
 */
DeploymentWorkflowRun3.prototype['pull_requests'] = undefined;

/**
 * @member {Array.<module:model/DeploymentWorkflowRunReferencedWorkflowsInner>} referenced_workflows
 */
DeploymentWorkflowRun3.prototype['referenced_workflows'] = undefined;

/**
 * @member {module:model/DeploymentWorkflowRun1HeadRepository} repository
 */
DeploymentWorkflowRun3.prototype['repository'] = undefined;

/**
 * @member {String} rerun_url
 */
DeploymentWorkflowRun3.prototype['rerun_url'] = undefined;

/**
 * @member {Number} run_attempt
 */
DeploymentWorkflowRun3.prototype['run_attempt'] = undefined;

/**
 * @member {Number} run_number
 */
DeploymentWorkflowRun3.prototype['run_number'] = undefined;

/**
 * @member {Date} run_started_at
 */
DeploymentWorkflowRun3.prototype['run_started_at'] = undefined;

/**
 * @member {module:model/DeploymentWorkflowRun3.StatusEnum} status
 */
DeploymentWorkflowRun3.prototype['status'] = undefined;

/**
 * @member {module:model/User} triggering_actor
 */
DeploymentWorkflowRun3.prototype['triggering_actor'] = undefined;

/**
 * @member {Date} updated_at
 */
DeploymentWorkflowRun3.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
DeploymentWorkflowRun3.prototype['url'] = undefined;

/**
 * @member {Number} workflow_id
 */
DeploymentWorkflowRun3.prototype['workflow_id'] = undefined;

/**
 * @member {String} workflow_url
 */
DeploymentWorkflowRun3.prototype['workflow_url'] = undefined;

/**
 * @member {String} display_title
 */
DeploymentWorkflowRun3.prototype['display_title'] = undefined;
 ...
 * @readonly
 */
DeploymentWorkflowRun3['ConclusionEnum'] = {
 ...
 * @readonly
 */
DeploymentWorkflowRun3['StatusEnum'] = {
...
export default DeploymentWorkflowRun3;
