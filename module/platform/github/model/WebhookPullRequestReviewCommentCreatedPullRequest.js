...
import WebhookPullRequestReviewCommentCreatedPullRequestHead from './WebhookPullRequestReviewCommentCreatedPullRequestHead';
import WebhooksPullRequest5Links from './WebhooksPullRequest5Links';

/**
 * The WebhookPullRequestReviewCommentCreatedPullRequest model module.
 * @module model/WebhookPullRequestReviewCommentCreatedPullRequest
 * @version 1.1.4
 */
class WebhookPullRequestReviewCommentCreatedPullRequest {
    /**
     * Constructs a new <code>WebhookPullRequestReviewCommentCreatedPullRequest</code>.
     * @alias module:model/WebhookPullRequestReviewCommentCreatedPullRequest
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/WebhookPullRequestReviewCommentCreatedPullRequest.ActiveLockReasonEnum} 
     * @param assignee {module:model/User1} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/WebhookPullRequestReviewCommentCreatedPullRequest.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param head {module:model/WebhookPullRequestReviewCommentCreatedPullRequestHead} 
     ...
     * @param state {module:model/WebhookPullRequestReviewCommentCreatedPullRequest.StateEnum} 
    ...
    constructor(links, activeLockReason, assignee, assignees, authorAssociation, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
        ...
        WebhookPullRequestReviewCommentCreatedPullRequest.initialize(this, links, activeLockReason, assignee, assignees, authorAssociation, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>WebhookPullRequestReviewCommentCreatedPullRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookPullRequestReviewCommentCreatedPullRequest} obj Optional instance to populate.
     * @return {module:model/WebhookPullRequestReviewCommentCreatedPullRequest} The populated <code>WebhookPullRequestReviewCommentCreatedPullRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookPullRequestReviewCommentCreatedPullRequest();
            ...
            if (data.hasOwnProperty('head')) {
                obj['head'] = WebhookPullRequestReviewCommentCreatedPullRequestHead.constructFromObject(data['head']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookPullRequestReviewCommentCreatedPullRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookPullRequestReviewCommentCreatedPullRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookPullRequestReviewCommentCreatedPullRequest.RequiredProperties) {
        ...
        if (data['head']) { // data not null
          WebhookPullRequestReviewCommentCreatedPullRequestHead.validateJSON(data['head']);
        }
        // ensure the json data is a string
...
WebhookPullRequestReviewCommentCreatedPullRequest.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksPullRequest5Links} _links
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['_links'] = undefined;

/**
 * @member {module:model/WebhookPullRequestReviewCommentCreatedPullRequest.ActiveLockReasonEnum} active_lock_reason
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User1} assignee
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User1>} assignees
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/WebhookPullRequestReviewCommentCreatedPullRequest.AuthorAssociationEnum} author_association
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequestBase} base
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['base'] = undefined;

/**
 * @member {String} body
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['body'] = undefined;

/**
 * @member {String} closed_at
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['closed_at'] = undefined;

/**
 * @member {String} comments_url
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['commits_url'] = undefined;

/**
 * @member {String} created_at
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['created_at'] = undefined;

/**
 * @member {String} diff_url
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['diff_url'] = undefined;

/**
 * @member {Boolean} draft
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['draft'] = undefined;

/**
 * @member {module:model/WebhookPullRequestReviewCommentCreatedPullRequestHead} head
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['locked'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['merge_commit_sha'] = undefined;

/**
 * @member {String} merged_at
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['merged_at'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['patch_url'] = undefined;

/**
 * @member {Array.<module:model/PullRequestRequestedReviewersInner>} requested_reviewers
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['review_comment_url'] = undefined;

/**
 * @member {String} review_comments_url
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['review_comments_url'] = undefined;

/**
 * @member {module:model/WebhookPullRequestReviewCommentCreatedPullRequest.StateEnum} state
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['statuses_url'] = undefined;

/**
 * @member {String} title
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['title'] = undefined;

/**
 * @member {String} updated_at
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
WebhookPullRequestReviewCommentCreatedPullRequest.prototype['user'] = undefined;
 ...
 * @readonly
 */
WebhookPullRequestReviewCommentCreatedPullRequest['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
WebhookPullRequestReviewCommentCreatedPullRequest['AuthorAssociationEnum'] = {
 ...
 * @readonly
 */
WebhookPullRequestReviewCommentCreatedPullRequest['StateEnum'] = {
...
export default WebhookPullRequestReviewCommentCreatedPullRequest;
