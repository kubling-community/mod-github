...
/**
 * The WebhooksApprover model module.
 * @module model/WebhooksApprover
 * @version 1.1.4
 */
class WebhooksApprover {
    /**
     * Constructs a new <code>WebhooksApprover</code>.
     * @alias module:model/WebhooksApprover
     */
    constructor() { 
        
        WebhooksApprover.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhooksApprover</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhooksApprover} obj Optional instance to populate.
     * @return {module:model/WebhooksApprover} The populated <code>WebhooksApprover</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhooksApprover();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhooksApprover</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhooksApprover</code>.
     */
 ...
 */
WebhooksApprover.prototype['avatar_url'] = undefined;

/**
 * @member {String} events_url
 */
WebhooksApprover.prototype['events_url'] = undefined;

/**
 * @member {String} followers_url
 */
WebhooksApprover.prototype['followers_url'] = undefined;

/**
 * @member {String} following_url
 */
WebhooksApprover.prototype['following_url'] = undefined;

/**
 * @member {String} gists_url
 */
WebhooksApprover.prototype['gists_url'] = undefined;

/**
 * @member {String} gravatar_id
 */
WebhooksApprover.prototype['gravatar_id'] = undefined;

/**
 * @member {String} html_url
 */
WebhooksApprover.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhooksApprover.prototype['id'] = undefined;

/**
 * @member {String} login
 */
WebhooksApprover.prototype['login'] = undefined;

/**
 * @member {String} node_id
 */
WebhooksApprover.prototype['node_id'] = undefined;

/**
 * @member {String} organizations_url
 */
WebhooksApprover.prototype['organizations_url'] = undefined;

/**
 * @member {String} received_events_url
 */
WebhooksApprover.prototype['received_events_url'] = undefined;

/**
 * @member {String} repos_url
 */
WebhooksApprover.prototype['repos_url'] = undefined;

/**
 * @member {Boolean} site_admin
 */
WebhooksApprover.prototype['site_admin'] = undefined;

/**
 * @member {String} starred_url
 */
WebhooksApprover.prototype['starred_url'] = undefined;

/**
 * @member {String} subscriptions_url
 */
WebhooksApprover.prototype['subscriptions_url'] = undefined;

/**
 * @member {String} type
 */
WebhooksApprover.prototype['type'] = undefined;

/**
 * @member {String} url
 */
WebhooksApprover.prototype['url'] = undefined;
...
export default WebhooksApprover;
