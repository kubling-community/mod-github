...
/**
 * The MilestonedIssueEvent model module.
 * @module model/MilestonedIssueEvent
 * @version 1.1.4
 */
class MilestonedIssueEvent {
    /**
     * Constructs a new <code>MilestonedIssueEvent</code>.
     * Milestoned Issue Event
     * @alias module:model/MilestonedIssueEvent
     * @param id {Number} 
     * @param nodeId {String} 
     * @param url {String} 
    ...
    constructor(id, nodeId, url, actor, event, commitId, commitUrl, createdAt, performedViaGithubApp, milestone) { 
        ...
        MilestonedIssueEvent.initialize(this, id, nodeId, url, actor, event, commitId, commitUrl, createdAt, performedViaGithubApp, milestone);
    }
    ...
    /**
     * Constructs a <code>MilestonedIssueEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MilestonedIssueEvent} obj Optional instance to populate.
     * @return {module:model/MilestonedIssueEvent} The populated <code>MilestonedIssueEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MilestonedIssueEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>MilestonedIssueEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MilestonedIssueEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MilestonedIssueEvent.RequiredProperties) {
...
MilestonedIssueEvent.RequiredProperties = ["id", "node_id", "url", "actor", "event", "commit_id", "commit_url", "created_at", "performed_via_github_app", "milestone"];

/**
 * @member {Number} id
 */
MilestonedIssueEvent.prototype['id'] = undefined;

/**
 * @member {String} node_id
 */
MilestonedIssueEvent.prototype['node_id'] = undefined;

/**
 * @member {String} url
 */
MilestonedIssueEvent.prototype['url'] = undefined;

/**
 * @member {module:model/SimpleUser} actor
 */
MilestonedIssueEvent.prototype['actor'] = undefined;

/**
 * @member {String} event
 */
MilestonedIssueEvent.prototype['event'] = undefined;

/**
 * @member {String} commit_id
 */
MilestonedIssueEvent.prototype['commit_id'] = undefined;

/**
 * @member {String} commit_url
 */
MilestonedIssueEvent.prototype['commit_url'] = undefined;

/**
 * @member {String} created_at
 */
MilestonedIssueEvent.prototype['created_at'] = undefined;

/**
 * @member {module:model/NullableIntegration} performed_via_github_app
 */
MilestonedIssueEvent.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/MilestonedIssueEventMilestone} milestone
 */
MilestonedIssueEvent.prototype['milestone'] = undefined;
...
export default MilestonedIssueEvent;
