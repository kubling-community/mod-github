...
/**
 * The App16 model module.
 * @module model/App16
 * @version 1.1.4
 */
class App16 {
    /**
     * Constructs a new <code>App16</code>.
     * GitHub apps are a new way to extend GitHub. They can be installed directly on organizations and user accounts and granted access to specific repositories. They come with granular permissions and built-in webhooks. GitHub apps are first class actors within GitHub.
     * @alias module:model/App16
    ...
    constructor(createdAt, description, externalUrl, htmlUrl, id, name, nodeId, owner, updatedAt) { 
        ...
        App16.initialize(this, createdAt, description, externalUrl, htmlUrl, id, name, nodeId, owner, updatedAt);
    }
    ...
    /**
     * Constructs a <code>App16</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/App16} obj Optional instance to populate.
     * @return {module:model/App16} The populated <code>App16</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>App16</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>App16</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of App16.RequiredProperties) {
...
App16.RequiredProperties = ["created_at", "description", "external_url", "html_url", "id", "name", "node_id", "owner", "updated_at"];

/**
 * @member {Date} created_at
 */
App16.prototype['created_at'] = undefined;

/**
 * @member {String} description
 */
App16.prototype['description'] = undefined;

/**
 * The list of events for the GitHub app
 * @member {Array.<module:model/App16.EventsEnum>} events
 */
App16.prototype['events'] = undefined;

/**
 * @member {String} external_url
 */
App16.prototype['external_url'] = undefined;

/**
 * @member {String} html_url
 */
App16.prototype['html_url'] = undefined;

/**
 * Unique identifier of the GitHub app
 * @member {Number} id
 */
App16.prototype['id'] = undefined;

/**
 * The name of the GitHub app
 * @member {String} name
 */
App16.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
App16.prototype['node_id'] = undefined;

/**
 * @member {module:model/User} owner
 */
App16.prototype['owner'] = undefined;

/**
 * @member {module:model/App2Permissions} permissions
 */
App16.prototype['permissions'] = undefined;

/**
 * The slug name of the GitHub app
 * @member {String} slug
 */
App16.prototype['slug'] = undefined;

/**
 * @member {Date} updated_at
 */
App16.prototype['updated_at'] = undefined;
