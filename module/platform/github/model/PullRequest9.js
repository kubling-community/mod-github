...
/**
 * The PullRequest9 model module.
 * @module model/PullRequest9
 * @version 1.1.4
 */
class PullRequest9 {
    /**
     * Constructs a new <code>PullRequest9</code>.
     * @alias module:model/PullRequest9
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/PullRequest9.ActiveLockReasonEnum} 
     * @param assignee {module:model/User1} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/PullRequest9.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param state {module:model/PullRequest9.StateEnum} State of this Pull Request. Either `open` or `closed`.
    ...
    constructor(links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
        ...
        PullRequest9.initialize(this, links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>PullRequest9</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequest9} obj Optional instance to populate.
     * @return {module:model/PullRequest9} The populated <code>PullRequest9</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequest9();
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequest9</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequest9</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PullRequest9.RequiredProperties) {
...
PullRequest9.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "auto_merge", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "draft", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksPullRequest5Links} _links
 */
PullRequest9.prototype['_links'] = undefined;

/**
 * @member {module:model/PullRequest9.ActiveLockReasonEnum} active_lock_reason
 */
PullRequest9.prototype['active_lock_reason'] = undefined;

/**
 * @member {Number} additions
 */
PullRequest9.prototype['additions'] = undefined;

/**
 * @member {module:model/User1} assignee
 */
PullRequest9.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User1>} assignees
 */
PullRequest9.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/PullRequest9.AuthorAssociationEnum} author_association
 */
PullRequest9.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
PullRequest9.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequestBase} base
 */
PullRequest9.prototype['base'] = undefined;

/**
 * @member {String} body
 */
PullRequest9.prototype['body'] = undefined;

/**
 * @member {Number} changed_files
 */
PullRequest9.prototype['changed_files'] = undefined;

/**
 * @member {Date} closed_at
 */
PullRequest9.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
PullRequest9.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
PullRequest9.prototype['comments_url'] = undefined;

/**
 * @member {Number} commits
 */
PullRequest9.prototype['commits'] = undefined;

/**
 * @member {String} commits_url
 */
PullRequest9.prototype['commits_url'] = undefined;

/**
 * @member {Date} created_at
 */
PullRequest9.prototype['created_at'] = undefined;

/**
 * @member {Number} deletions
 */
PullRequest9.prototype['deletions'] = undefined;

/**
 * @member {String} diff_url
 */
PullRequest9.prototype['diff_url'] = undefined;

/**
 * Indicates whether or not the pull request is a draft.
 * @member {Boolean} draft
 */
PullRequest9.prototype['draft'] = undefined;

/**
 * @member {module:model/PullRequestBase} head
 */
PullRequest9.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
PullRequest9.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
PullRequest9.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
PullRequest9.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
PullRequest9.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
PullRequest9.prototype['locked'] = undefined;

/**
 * Indicates whether maintainers can modify the pull request.
 * @member {Boolean} maintainer_can_modify
 */
PullRequest9.prototype['maintainer_can_modify'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
PullRequest9.prototype['merge_commit_sha'] = undefined;

/**
 * @member {Boolean} mergeable
 */
PullRequest9.prototype['mergeable'] = undefined;

/**
 * @member {String} mergeable_state
 */
PullRequest9.prototype['mergeable_state'] = undefined;

/**
 * @member {Boolean} merged
 */
PullRequest9.prototype['merged'] = undefined;

/**
 * @member {Date} merged_at
 */
PullRequest9.prototype['merged_at'] = undefined;

/**
 * @member {module:model/User} merged_by
 */
PullRequest9.prototype['merged_by'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
PullRequest9.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
PullRequest9.prototype['node_id'] = undefined;

/**
 * Number uniquely identifying the pull request within its repository.
 * @member {Number} number
 */
PullRequest9.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
PullRequest9.prototype['patch_url'] = undefined;

/**
 * @member {Boolean} rebaseable
 */
PullRequest9.prototype['rebaseable'] = undefined;

/**
 * @member {Array.<module:model/WebhooksPullRequest5RequestedReviewersInner>} requested_reviewers
 */
PullRequest9.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
PullRequest9.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
PullRequest9.prototype['review_comment_url'] = undefined;

/**
 * @member {Number} review_comments
 */
PullRequest9.prototype['review_comments'] = undefined;

/**
 * @member {String} review_comments_url
 */
PullRequest9.prototype['review_comments_url'] = undefined;

/**
 * State of this Pull Request. Either `open` or `closed`.
 * @member {module:model/PullRequest9.StateEnum} state
 */
PullRequest9.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
PullRequest9.prototype['statuses_url'] = undefined;

/**
 * The title of the pull request.
 * @member {String} title
 */
PullRequest9.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
PullRequest9.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
PullRequest9.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
PullRequest9.prototype['user'] = undefined;
 ...
 * @readonly
 */
PullRequest9['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
PullRequest9['AuthorAssociationEnum'] = {
