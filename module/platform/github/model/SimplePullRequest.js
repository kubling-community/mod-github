...
/**
 * The SimplePullRequest model module.
 * @module model/SimplePullRequest
 * @version 1.1.4
 */
class SimplePullRequest {
    /**
     * Constructs a new <code>SimplePullRequest</code>.
     * @alias module:model/SimplePullRequest
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/SimplePullRequest.ActiveLockReasonEnum} 
     * @param assignee {module:model/User1} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/SimplePullRequest.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param state {module:model/SimplePullRequest.StateEnum} 
    ...
    /**
     * Constructs a <code>SimplePullRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimplePullRequest} obj Optional instance to populate.
     * @return {module:model/SimplePullRequest} The populated <code>SimplePullRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimplePullRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>SimplePullRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimplePullRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SimplePullRequest.RequiredProperties) {
 ...
 */
SimplePullRequest.prototype['_links'] = undefined;

/**
 * @member {module:model/SimplePullRequest.ActiveLockReasonEnum} active_lock_reason
 */
SimplePullRequest.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User1} assignee
 */
SimplePullRequest.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User1>} assignees
 */
SimplePullRequest.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/SimplePullRequest.AuthorAssociationEnum} author_association
 */
SimplePullRequest.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
SimplePullRequest.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequestBase} base
 */
SimplePullRequest.prototype['base'] = undefined;

/**
 * @member {String} body
 */
SimplePullRequest.prototype['body'] = undefined;

/**
 * @member {String} closed_at
 */
SimplePullRequest.prototype['closed_at'] = undefined;

/**
 * @member {String} comments_url
 */
SimplePullRequest.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
SimplePullRequest.prototype['commits_url'] = undefined;

/**
 * @member {String} created_at
 */
SimplePullRequest.prototype['created_at'] = undefined;

/**
 * @member {String} diff_url
 */
SimplePullRequest.prototype['diff_url'] = undefined;

/**
 * @member {Boolean} draft
 */
SimplePullRequest.prototype['draft'] = undefined;

/**
 * @member {module:model/WebhookPullRequestReviewCommentDeletedPullRequestHead} head
 */
SimplePullRequest.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
SimplePullRequest.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
SimplePullRequest.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
SimplePullRequest.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
SimplePullRequest.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
SimplePullRequest.prototype['locked'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
SimplePullRequest.prototype['merge_commit_sha'] = undefined;

/**
 * @member {String} merged_at
 */
SimplePullRequest.prototype['merged_at'] = undefined;

/**
 * @member {module:model/Milestone1} milestone
 */
SimplePullRequest.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
SimplePullRequest.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
SimplePullRequest.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
SimplePullRequest.prototype['patch_url'] = undefined;

/**
 * @member {Array.<module:model/PullRequestRequestedReviewersInner>} requested_reviewers
 */
SimplePullRequest.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
SimplePullRequest.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
SimplePullRequest.prototype['review_comment_url'] = undefined;

/**
 * @member {String} review_comments_url
 */
SimplePullRequest.prototype['review_comments_url'] = undefined;

/**
 * @member {module:model/SimplePullRequest.StateEnum} state
 */
SimplePullRequest.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
SimplePullRequest.prototype['statuses_url'] = undefined;

/**
 * @member {String} title
 */
SimplePullRequest.prototype['title'] = undefined;

/**
 * @member {String} updated_at
 */
SimplePullRequest.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
SimplePullRequest.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
SimplePullRequest.prototype['user'] = undefined;
 ...
 * @readonly
 */
SimplePullRequest['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
SimplePullRequest['AuthorAssociationEnum'] = {
...
export default SimplePullRequest;
