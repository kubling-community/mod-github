...
class PullRequestHeadRepo {
    ...
    constructor(archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, description, downloadsUrl, eventsUrl, fork, forksUrl, fullName, gitCommitsUrl, gitRefsUrl, gitTagsUrl, hooksUrl, htmlUrl, id, nodeId, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, name, notificationsUrl, owner, _private, pullsUrl, releasesUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, url, cloneUrl, defaultBranch, forks, forksCount, gitUrl, hasDownloads, hasIssues, hasProjects, hasWiki, hasPages, hasDiscussions, homepage, language, archived, disabled, mirrorUrl, openIssues, openIssuesCount, license, pushedAt, size, sshUrl, stargazersCount, svnUrl, watchers, watchersCount, createdAt, updatedAt) { 
        ...
        PullRequestHeadRepo.initialize(this, archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, description, downloadsUrl, eventsUrl, fork, forksUrl, fullName, gitCommitsUrl, gitRefsUrl, gitTagsUrl, hooksUrl, htmlUrl, id, nodeId, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, name, notificationsUrl, owner, _private, pullsUrl, releasesUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, url, cloneUrl, defaultBranch, forks, forksCount, gitUrl, hasDownloads, hasIssues, hasProjects, hasWiki, hasPages, hasDiscussions, homepage, language, archived, disabled, mirrorUrl, openIssues, openIssuesCount, license, pushedAt, size, sshUrl, stargazersCount, svnUrl, watchers, watchersCount, createdAt, updatedAt);
    }
 ...
 */
PullRequestHeadRepo.prototype['web_commit_signoff_required'] = undefined;
