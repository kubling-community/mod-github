...
class TeamProject {
     ...
     */
    constructor(ownerUrl, url, htmlUrl, columnsUrl, id, nodeId, name, body, number, state, creator, createdAt, updatedAt, permissions) { 
        
        TeamProject.initialize(this, ownerUrl, url, htmlUrl, columnsUrl, id, nodeId, name, body, number, state, creator, createdAt, updatedAt, permissions);
    }
     ...
     */
    static initialize(obj, ownerUrl, url, htmlUrl, columnsUrl, id, nodeId, name, body, number, state, creator, createdAt, updatedAt, permissions) { 
...
TeamProject.RequiredProperties = ["owner_url", "url", "html_url", "columns_url", "id", "node_id", "name", "body", "number", "state", "creator", "created_at", "updated_at", "permissions"];
