...
class ReviewDismissedIssueEventDismissedReview {
     ...
     */
    constructor(state, reviewId, dismissalMessage) { 
        
        ReviewDismissedIssueEventDismissedReview.initialize(this, state, reviewId, dismissalMessage);
    }
     ...
     */
    static initialize(obj, state, reviewId, dismissalMessage) { 
        obj['state'] = state;
...
ReviewDismissedIssueEventDismissedReview.RequiredProperties = ["state", "review_id", "dismissal_message"];
