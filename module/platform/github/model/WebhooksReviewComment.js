...
/**
 * The WebhooksReviewComment model module.
 * @module model/WebhooksReviewComment
 * @version 1.1.4
 */
class WebhooksReviewComment {
    /**
     * Constructs a new <code>WebhooksReviewComment</code>.
     * The [comment](https://docs.github.com/rest/pulls/comments#get-a-review-comment-for-a-pull-request) itself.
     * @alias module:model/WebhooksReviewComment
     * @param links {module:model/WebhooksReviewCommentLinks} 
     * @param authorAssociation {module:model/WebhooksReviewComment.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param side {module:model/WebhooksReviewComment.SideEnum} The side of the first line of the range for a multi-line comment.
     * @param startLine {Number} The first line of the range for a multi-line comment.
     * @param startSide {module:model/WebhooksReviewComment.StartSideEnum} The side of the first line of the range for a multi-line comment.
    ...
    constructor(links, authorAssociation, body, commitId, createdAt, diffHunk, htmlUrl, id, line, nodeId, originalCommitId, originalLine, originalPosition, originalStartLine, path, position, pullRequestReviewId, pullRequestUrl, reactions, side, startLine, startSide, updatedAt, url, user) { 
        ...
        WebhooksReviewComment.initialize(this, links, authorAssociation, body, commitId, createdAt, diffHunk, htmlUrl, id, line, nodeId, originalCommitId, originalLine, originalPosition, originalStartLine, path, position, pullRequestReviewId, pullRequestUrl, reactions, side, startLine, startSide, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>WebhooksReviewComment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhooksReviewComment} obj Optional instance to populate.
     * @return {module:model/WebhooksReviewComment} The populated <code>WebhooksReviewComment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhooksReviewComment();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhooksReviewComment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhooksReviewComment</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhooksReviewComment.RequiredProperties) {
...
WebhooksReviewComment.RequiredProperties = ["_links", "author_association", "body", "commit_id", "created_at", "diff_hunk", "html_url", "id", "line", "node_id", "original_commit_id", "original_line", "original_position", "original_start_line", "path", "position", "pull_request_review_id", "pull_request_url", "reactions", "side", "start_line", "start_side", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksReviewCommentLinks} _links
 */
WebhooksReviewComment.prototype['_links'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/WebhooksReviewComment.AuthorAssociationEnum} author_association
 */
WebhooksReviewComment.prototype['author_association'] = undefined;

/**
 * The text of the comment.
 * @member {String} body
 */
WebhooksReviewComment.prototype['body'] = undefined;

/**
 * The SHA of the commit to which the comment applies.
 * @member {String} commit_id
 */
WebhooksReviewComment.prototype['commit_id'] = undefined;

/**
 * @member {Date} created_at
 */
WebhooksReviewComment.prototype['created_at'] = undefined;

/**
 * The diff of the line that the comment refers to.
 * @member {String} diff_hunk
 */
WebhooksReviewComment.prototype['diff_hunk'] = undefined;

/**
 * HTML URL for the pull request review comment.
 * @member {String} html_url
 */
WebhooksReviewComment.prototype['html_url'] = undefined;

/**
 * The ID of the pull request review comment.
 * @member {Number} id
 */
WebhooksReviewComment.prototype['id'] = undefined;

/**
 * The comment ID to reply to.
 * @member {Number} in_reply_to_id
 */
WebhooksReviewComment.prototype['in_reply_to_id'] = undefined;

/**
 * The line of the blob to which the comment applies. The last line of the range for a multi-line comment
 * @member {Number} line
 */
WebhooksReviewComment.prototype['line'] = undefined;

/**
 * The node ID of the pull request review comment.
 * @member {String} node_id
 */
WebhooksReviewComment.prototype['node_id'] = undefined;

/**
 * The SHA of the original commit to which the comment applies.
 * @member {String} original_commit_id
 */
WebhooksReviewComment.prototype['original_commit_id'] = undefined;

/**
 * The line of the blob to which the comment applies. The last line of the range for a multi-line comment
 * @member {Number} original_line
 */
WebhooksReviewComment.prototype['original_line'] = undefined;

/**
 * The index of the original line in the diff to which the comment applies.
 * @member {Number} original_position
 */
WebhooksReviewComment.prototype['original_position'] = undefined;

/**
 * The first line of the range for a multi-line comment.
 * @member {Number} original_start_line
 */
WebhooksReviewComment.prototype['original_start_line'] = undefined;

/**
 * The relative path of the file to which the comment applies.
 * @member {String} path
 */
WebhooksReviewComment.prototype['path'] = undefined;

/**
 * The line index in the diff to which the comment applies.
 * @member {Number} position
 */
WebhooksReviewComment.prototype['position'] = undefined;

/**
 * The ID of the pull request review to which the comment belongs.
 * @member {Number} pull_request_review_id
 */
WebhooksReviewComment.prototype['pull_request_review_id'] = undefined;

/**
 * URL for the pull request that the review comment belongs to.
 * @member {String} pull_request_url
 */
WebhooksReviewComment.prototype['pull_request_url'] = undefined;

/**
 * @member {module:model/Reactions} reactions
 */
WebhooksReviewComment.prototype['reactions'] = undefined;

/**
 * The side of the first line of the range for a multi-line comment.
 * @member {module:model/WebhooksReviewComment.SideEnum} side
 */
WebhooksReviewComment.prototype['side'] = undefined;

/**
 * The first line of the range for a multi-line comment.
 * @member {Number} start_line
 */
WebhooksReviewComment.prototype['start_line'] = undefined;

/**
 * The side of the first line of the range for a multi-line comment.
 * @member {module:model/WebhooksReviewComment.StartSideEnum} start_side
 * @default 'RIGHT'
 */
WebhooksReviewComment.prototype['start_side'] = 'RIGHT';

/**
 * The level at which the comment is targeted, can be a diff line or a file.
 * @member {module:model/WebhooksReviewComment.SubjectTypeEnum} subject_type
 */
WebhooksReviewComment.prototype['subject_type'] = undefined;

/**
 * @member {Date} updated_at
 */
WebhooksReviewComment.prototype['updated_at'] = undefined;

/**
 * URL for the pull request review comment
 * @member {String} url
 */
WebhooksReviewComment.prototype['url'] = undefined;

/**
 * @member {module:model/User} user
 */
WebhooksReviewComment.prototype['user'] = undefined;
 ...
 * @readonly
 */
WebhooksReviewComment['AuthorAssociationEnum'] = {
 ...
 * @readonly
 */
WebhooksReviewComment['SideEnum'] = {
 ...
 * @readonly
 */
WebhooksReviewComment['StartSideEnum'] = {
 ...
 * @readonly
 */
WebhooksReviewComment['SubjectTypeEnum'] = {
...
export default WebhooksReviewComment;
