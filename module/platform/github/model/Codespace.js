...
/**
 * The Codespace model module.
 * @module model/Codespace
 * @version 1.1.4
 */
class Codespace {
    /**
     * Constructs a new <code>Codespace</code>.
     * A codespace.
     * @alias module:model/Codespace
     * @param id {Number} 
     ...
     * @param state {module:model/Codespace.StateEnum} State of this codespace.
     * @param url {String} API URL for this codespace.
     * @param gitStatus {module:model/CodespaceGitStatus} 
     * @param location {module:model/Codespace.LocationEnum} The initally assigned location of a new codespace.
    ...
    constructor(id, name, environmentId, owner, billableOwner, repository, machine, prebuild, createdAt, updatedAt, lastUsedAt, state, url, gitStatus, location, idleTimeoutMinutes, webUrl, machinesUrl, startUrl, stopUrl, pullsUrl, recentFolders) { 
        ...
        Codespace.initialize(this, id, name, environmentId, owner, billableOwner, repository, machine, prebuild, createdAt, updatedAt, lastUsedAt, state, url, gitStatus, location, idleTimeoutMinutes, webUrl, machinesUrl, startUrl, stopUrl, pullsUrl, recentFolders);
    }
    ...
    /**
     * Constructs a <code>Codespace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Codespace} obj Optional instance to populate.
     * @return {module:model/Codespace} The populated <code>Codespace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Codespace();
            ...
            if (data.hasOwnProperty('last_known_stop_notice')) {
                obj['last_known_stop_notice'] = ApiClient.convertToType(data['last_known_stop_notice'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Codespace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Codespace</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Codespace.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['last_known_stop_notice'] && !(typeof data['last_known_stop_notice'] === 'string' || data['last_known_stop_notice'] instanceof String)) {
            throw new Error("Expected the field `last_known_stop_notice` to be a primitive type in the JSON string but got " + data['last_known_stop_notice']);
        }
...
Codespace.RequiredProperties = ["id", "name", "environment_id", "owner", "billable_owner", "repository", "machine", "prebuild", "created_at", "updated_at", "last_used_at", "state", "url", "git_status", "location", "idle_timeout_minutes", "web_url", "machines_url", "start_url", "stop_url", "pulls_url", "recent_folders"];

/**
 * @member {Number} id
 */
Codespace.prototype['id'] = undefined;

/**
 * Automatically generated name of this codespace.
 * @member {String} name
 */
Codespace.prototype['name'] = undefined;

/**
 * Display name for this codespace.
 * @member {String} display_name
 */
Codespace.prototype['display_name'] = undefined;

/**
 * UUID identifying this codespace's environment.
 * @member {String} environment_id
 */
Codespace.prototype['environment_id'] = undefined;

/**
 * @member {module:model/SimpleUser} owner
 */
Codespace.prototype['owner'] = undefined;

/**
 * @member {module:model/SimpleUser} billable_owner
 */
Codespace.prototype['billable_owner'] = undefined;

/**
 * @member {module:model/MinimalRepository} repository
 */
Codespace.prototype['repository'] = undefined;

/**
 * @member {module:model/NullableCodespaceMachine} machine
 */
Codespace.prototype['machine'] = undefined;

/**
 * Path to devcontainer.json from repo root used to create Codespace.
 * @member {String} devcontainer_path
 */
Codespace.prototype['devcontainer_path'] = undefined;

/**
 * Whether the codespace was created from a prebuild.
 * @member {Boolean} prebuild
 */
Codespace.prototype['prebuild'] = undefined;

/**
 * @member {Date} created_at
 */
Codespace.prototype['created_at'] = undefined;

/**
 * @member {Date} updated_at
 */
Codespace.prototype['updated_at'] = undefined;

/**
 * Last known time this codespace was started.
 * @member {Date} last_used_at
 */
Codespace.prototype['last_used_at'] = undefined;

/**
 * State of this codespace.
 * @member {module:model/Codespace.StateEnum} state
 */
Codespace.prototype['state'] = undefined;

/**
 * API URL for this codespace.
 * @member {String} url
 */
Codespace.prototype['url'] = undefined;

/**
 * @member {module:model/CodespaceGitStatus} git_status
 */
Codespace.prototype['git_status'] = undefined;

/**
 * The initally assigned location of a new codespace.
 * @member {module:model/Codespace.LocationEnum} location
 */
Codespace.prototype['location'] = undefined;

/**
 * The number of minutes of inactivity after which this codespace will be automatically stopped.
 * @member {Number} idle_timeout_minutes
 */
Codespace.prototype['idle_timeout_minutes'] = undefined;

/**
 * URL to access this codespace on the web.
 * @member {String} web_url
 */
Codespace.prototype['web_url'] = undefined;

/**
 * API URL to access available alternate machine types for this codespace.
 * @member {String} machines_url
 */
Codespace.prototype['machines_url'] = undefined;

/**
 * API URL to start this codespace.
 * @member {String} start_url
 */
Codespace.prototype['start_url'] = undefined;

/**
 * API URL to stop this codespace.
 * @member {String} stop_url
 */
Codespace.prototype['stop_url'] = undefined;

/**
 * API URL to publish this codespace to a new repository.
 * @member {String} publish_url
 */
Codespace.prototype['publish_url'] = undefined;

/**
 * API URL for the Pull Request associated with this codespace, if any.
 * @member {String} pulls_url
 */
Codespace.prototype['pulls_url'] = undefined;

/**
 * @member {Array.<String>} recent_folders
 */
Codespace.prototype['recent_folders'] = undefined;

/**
 * @member {module:model/CodespaceRuntimeConstraints} runtime_constraints
 */
Codespace.prototype['runtime_constraints'] = undefined;

/**
 * Whether or not a codespace has a pending async operation. This would mean that the codespace is temporarily unavailable. The only thing that you can do with a codespace in this state is delete it.
 * @member {Boolean} pending_operation
 */
Codespace.prototype['pending_operation'] = undefined;

/**
 * Text to show user when codespace is disabled by a pending operation
 * @member {String} pending_operation_disabled_reason
 */
Codespace.prototype['pending_operation_disabled_reason'] = undefined;

/**
 * Text to show user when codespace idle timeout minutes has been overriden by an organization policy
 * @member {String} idle_timeout_notice
 */
Codespace.prototype['idle_timeout_notice'] = undefined;

/**
 * Duration in minutes after codespace has gone idle in which it will be deleted. Must be integer minutes between 0 and 43200 (30 days).
 * @member {Number} retention_period_minutes
 */
Codespace.prototype['retention_period_minutes'] = undefined;

/**
 * When a codespace will be auto-deleted based on the \"retention_period_minutes\" and \"last_used_at\"
 * @member {Date} retention_expires_at
 */
Codespace.prototype['retention_expires_at'] = undefined;

/**
 * The text to display to a user when a codespace has been stopped for a potentially actionable reason.
 * @member {String} last_known_stop_notice
 */
Codespace.prototype['last_known_stop_notice'] = undefined;
