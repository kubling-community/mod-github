...
class DeploymentPayload {
     ...
     * @param {(module:model/Object|module:model/String)} instance The actual instance to initialize DeploymentPayload.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `DeploymentPayload` with oneOf schemas Object, String. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `DeploymentPayload` with oneOf schemas Object, String. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
...
DeploymentPayload.OneOf = ["Object", "String"];
