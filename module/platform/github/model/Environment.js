...
class Environment {
     ...
     */
    constructor(id, nodeId, name, url, htmlUrl, createdAt, updatedAt) { 
        
        Environment.initialize(this, id, nodeId, name, url, htmlUrl, createdAt, updatedAt);
    }
     ...
     */
    static initialize(obj, id, nodeId, name, url, htmlUrl, createdAt, updatedAt) { 
        obj['id'] = id;
        obj['node_id'] = nodeId;
        obj['name'] = name;
        obj['url'] = url;
...
Environment.RequiredProperties = ["id", "node_id", "name", "url", "html_url", "created_at", "updated_at"];
