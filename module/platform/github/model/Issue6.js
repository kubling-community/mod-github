...
/**
 * The Issue6 model module.
 * @module model/Issue6
 * @version 1.1.4
 */
class Issue6 {
    /**
     * Constructs a new <code>Issue6</code>.
     * The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
     * @alias module:model/Issue6
     * @param activeLockReason {module:model/Issue6.ActiveLockReasonEnum} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/Issue6.AuthorAssociationEnum} How the author is associated with the repository.
    ...
    constructor(activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user) { 
        ...
        Issue6.initialize(this, activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>Issue6</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Issue6} obj Optional instance to populate.
     * @return {module:model/Issue6} The populated <code>Issue6</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Issue6</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Issue6</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Issue6.RequiredProperties) {
...
Issue6.RequiredProperties = ["active_lock_reason", "assignees", "author_association", "body", "closed_at", "comments", "comments_url", "created_at", "events_url", "html_url", "id", "labels_url", "milestone", "node_id", "number", "reactions", "repository_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/Issue6.ActiveLockReasonEnum} active_lock_reason
 */
Issue6.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User} assignee
 */
Issue6.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
Issue6.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/Issue6.AuthorAssociationEnum} author_association
 */
Issue6.prototype['author_association'] = undefined;

/**
 * Contents of the issue
 * @member {String} body
 */
Issue6.prototype['body'] = undefined;

/**
 * @member {Date} closed_at
 */
Issue6.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
Issue6.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
Issue6.prototype['comments_url'] = undefined;

/**
 * @member {Date} created_at
 */
Issue6.prototype['created_at'] = undefined;

/**
 * @member {Boolean} draft
 */
Issue6.prototype['draft'] = undefined;

/**
 * @member {String} events_url
 */
Issue6.prototype['events_url'] = undefined;

/**
 * @member {String} html_url
 */
Issue6.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
Issue6.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
Issue6.prototype['labels'] = undefined;

/**
 * @member {String} labels_url
 */
Issue6.prototype['labels_url'] = undefined;

/**
 * @member {Boolean} locked
 */
Issue6.prototype['locked'] = undefined;

/**
 * @member {module:model/Milestone1} milestone
 */
Issue6.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
Issue6.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
Issue6.prototype['number'] = undefined;

/**
 * @member {module:model/App1} performed_via_github_app
 */
Issue6.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/WebhooksIssuePullRequest} pull_request
 */
Issue6.prototype['pull_request'] = undefined;

/**
 * @member {module:model/Reactions} reactions
 */
Issue6.prototype['reactions'] = undefined;

/**
 * @member {String} repository_url
 */
Issue6.prototype['repository_url'] = undefined;

/**
 * State of the issue; either 'open' or 'closed'
 * @member {module:model/Issue6.StateEnum} state
 */
Issue6.prototype['state'] = undefined;

/**
 * @member {String} state_reason
 */
Issue6.prototype['state_reason'] = undefined;

/**
 * @member {String} timeline_url
 */
Issue6.prototype['timeline_url'] = undefined;

/**
 * Title of the issue
 * @member {String} title
 */
Issue6.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
Issue6.prototype['updated_at'] = undefined;

/**
 * URL for the issue
 * @member {String} url
 */
Issue6.prototype['url'] = undefined;

/**
 * @member {module:model/User} user
 */
Issue6.prototype['user'] = undefined;
