...
/**
 * The WebhookProjectCardMovedProjectCardAllOfCreator model module.
 * @module model/WebhookProjectCardMovedProjectCardAllOfCreator
 * @version 1.1.4
 */
class WebhookProjectCardMovedProjectCardAllOfCreator {
    /**
     * Constructs a new <code>WebhookProjectCardMovedProjectCardAllOfCreator</code>.
     * @alias module:model/WebhookProjectCardMovedProjectCardAllOfCreator
     */
    constructor() { 
        
        WebhookProjectCardMovedProjectCardAllOfCreator.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhookProjectCardMovedProjectCardAllOfCreator</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookProjectCardMovedProjectCardAllOfCreator} obj Optional instance to populate.
     * @return {module:model/WebhookProjectCardMovedProjectCardAllOfCreator} The populated <code>WebhookProjectCardMovedProjectCardAllOfCreator</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookProjectCardMovedProjectCardAllOfCreator();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookProjectCardMovedProjectCardAllOfCreator</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookProjectCardMovedProjectCardAllOfCreator</code>.
     */
 ...
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['avatar_url'] = undefined;

/**
 * @member {String} events_url
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['events_url'] = undefined;

/**
 * @member {String} followers_url
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['followers_url'] = undefined;

/**
 * @member {String} following_url
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['following_url'] = undefined;

/**
 * @member {String} gists_url
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['gists_url'] = undefined;

/**
 * @member {String} gravatar_id
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['gravatar_id'] = undefined;

/**
 * @member {String} html_url
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['id'] = undefined;

/**
 * @member {String} login
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['login'] = undefined;

/**
 * @member {String} node_id
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['node_id'] = undefined;

/**
 * @member {String} organizations_url
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['organizations_url'] = undefined;

/**
 * @member {String} received_events_url
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['received_events_url'] = undefined;

/**
 * @member {String} repos_url
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['repos_url'] = undefined;

/**
 * @member {Boolean} site_admin
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['site_admin'] = undefined;

/**
 * @member {String} starred_url
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['starred_url'] = undefined;

/**
 * @member {String} subscriptions_url
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['subscriptions_url'] = undefined;

/**
 * @member {String} type
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['type'] = undefined;

/**
 * @member {String} url
 */
WebhookProjectCardMovedProjectCardAllOfCreator.prototype['url'] = undefined;
...
export default WebhookProjectCardMovedProjectCardAllOfCreator;
