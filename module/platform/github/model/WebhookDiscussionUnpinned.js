...
/**
 * The WebhookDiscussionUnpinned model module.
 * @module model/WebhookDiscussionUnpinned
 * @version 1.1.4
 */
class WebhookDiscussionUnpinned {
    /**
     * Constructs a new <code>WebhookDiscussionUnpinned</code>.
     * @alias module:model/WebhookDiscussionUnpinned
     * @param action {module:model/WebhookDiscussionUnpinned.ActionEnum} 
    ...
    constructor(action, discussion, repository, sender) { 
        ...
        WebhookDiscussionUnpinned.initialize(this, action, discussion, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookDiscussionUnpinned</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookDiscussionUnpinned} obj Optional instance to populate.
     * @return {module:model/WebhookDiscussionUnpinned} The populated <code>WebhookDiscussionUnpinned</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookDiscussionUnpinned();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDiscussionUnpinned</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDiscussionUnpinned</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookDiscussionUnpinned.RequiredProperties) {
...
WebhookDiscussionUnpinned.RequiredProperties = ["action", "discussion", "repository", "sender"];

/**
 * @member {module:model/WebhookDiscussionUnpinned.ActionEnum} action
 */
WebhookDiscussionUnpinned.prototype['action'] = undefined;

/**
 * @member {module:model/Discussion} discussion
 */
WebhookDiscussionUnpinned.prototype['discussion'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookDiscussionUnpinned.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookDiscussionUnpinned.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookDiscussionUnpinned.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookDiscussionUnpinned.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookDiscussionUnpinned.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookDiscussionUnpinned['ActionEnum'] = {
...
export default WebhookDiscussionUnpinned;
