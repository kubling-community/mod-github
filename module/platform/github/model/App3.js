...
/**
 * The App3 model module.
 * @module model/App3
 * @version 1.1.4
 */
class App3 {
    /**
     * Constructs a new <code>App3</code>.
     * GitHub apps are a new way to extend GitHub. They can be installed directly on organizations and user accounts and granted access to specific repositories. They come with granular permissions and built-in webhooks. GitHub apps are first class actors within GitHub.
     * @alias module:model/App3
    ...
    constructor(createdAt, description, externalUrl, htmlUrl, id, name, nodeId, owner, updatedAt) { 
        ...
        App3.initialize(this, createdAt, description, externalUrl, htmlUrl, id, name, nodeId, owner, updatedAt);
    }
    ...
    /**
     * Constructs a <code>App3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/App3} obj Optional instance to populate.
     * @return {module:model/App3} The populated <code>App3</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>App3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>App3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of App3.RequiredProperties) {
...
App3.RequiredProperties = ["created_at", "description", "external_url", "html_url", "id", "name", "node_id", "owner", "updated_at"];

/**
 * @member {Date} created_at
 */
App3.prototype['created_at'] = undefined;

/**
 * @member {String} description
 */
App3.prototype['description'] = undefined;

/**
 * The list of events for the GitHub app
 * @member {Array.<module:model/App3.EventsEnum>} events
 */
App3.prototype['events'] = undefined;

/**
 * @member {String} external_url
 */
App3.prototype['external_url'] = undefined;

/**
 * @member {String} html_url
 */
App3.prototype['html_url'] = undefined;

/**
 * Unique identifier of the GitHub app
 * @member {Number} id
 */
App3.prototype['id'] = undefined;

/**
 * The name of the GitHub app
 * @member {String} name
 */
App3.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
App3.prototype['node_id'] = undefined;

/**
 * @member {module:model/User} owner
 */
App3.prototype['owner'] = undefined;

/**
 * @member {module:model/App2Permissions} permissions
 */
App3.prototype['permissions'] = undefined;

/**
 * The slug name of the GitHub app
 * @member {String} slug
 */
App3.prototype['slug'] = undefined;

/**
 * @member {Date} updated_at
 */
App3.prototype['updated_at'] = undefined;
