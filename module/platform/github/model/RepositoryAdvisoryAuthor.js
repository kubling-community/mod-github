...
/**
 * The RepositoryAdvisoryAuthor model module.
 * @module model/RepositoryAdvisoryAuthor
 * @version 1.1.4
 */
class RepositoryAdvisoryAuthor {
    /**
     * Constructs a new <code>RepositoryAdvisoryAuthor</code>.
     * The author of the advisory.
     * @alias module:model/RepositoryAdvisoryAuthor
    ...
    constructor(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl, followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl, organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin) { 
        ...
        RepositoryAdvisoryAuthor.initialize(this, login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl, followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl, organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin);
    }
    ...
    /**
     * Constructs a <code>RepositoryAdvisoryAuthor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryAdvisoryAuthor} obj Optional instance to populate.
     * @return {module:model/RepositoryAdvisoryAuthor} The populated <code>RepositoryAdvisoryAuthor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryAdvisoryAuthor();
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryAdvisoryAuthor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryAdvisoryAuthor</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RepositoryAdvisoryAuthor.RequiredProperties) {
...
RepositoryAdvisoryAuthor.RequiredProperties = ["login", "id", "node_id", "avatar_url", "gravatar_id", "url", "html_url", "followers_url", "following_url", "gists_url", "starred_url", "subscriptions_url", "organizations_url", "repos_url", "events_url", "received_events_url", "type", "site_admin"];

/**
 * @member {String} name
 */
RepositoryAdvisoryAuthor.prototype['name'] = undefined;

/**
 * @member {String} email
 */
RepositoryAdvisoryAuthor.prototype['email'] = undefined;

/**
 * @member {String} login
 */
RepositoryAdvisoryAuthor.prototype['login'] = undefined;

/**
 * @member {Number} id
 */
RepositoryAdvisoryAuthor.prototype['id'] = undefined;

/**
 * @member {String} node_id
 */
RepositoryAdvisoryAuthor.prototype['node_id'] = undefined;

/**
 * @member {String} avatar_url
 */
RepositoryAdvisoryAuthor.prototype['avatar_url'] = undefined;

/**
 * @member {String} gravatar_id
 */
RepositoryAdvisoryAuthor.prototype['gravatar_id'] = undefined;

/**
 * @member {String} url
 */
RepositoryAdvisoryAuthor.prototype['url'] = undefined;

/**
 * @member {String} html_url
 */
RepositoryAdvisoryAuthor.prototype['html_url'] = undefined;

/**
 * @member {String} followers_url
 */
RepositoryAdvisoryAuthor.prototype['followers_url'] = undefined;

/**
 * @member {String} following_url
 */
RepositoryAdvisoryAuthor.prototype['following_url'] = undefined;

/**
 * @member {String} gists_url
 */
RepositoryAdvisoryAuthor.prototype['gists_url'] = undefined;

/**
 * @member {String} starred_url
 */
RepositoryAdvisoryAuthor.prototype['starred_url'] = undefined;

/**
 * @member {String} subscriptions_url
 */
RepositoryAdvisoryAuthor.prototype['subscriptions_url'] = undefined;

/**
 * @member {String} organizations_url
 */
RepositoryAdvisoryAuthor.prototype['organizations_url'] = undefined;

/**
 * @member {String} repos_url
 */
RepositoryAdvisoryAuthor.prototype['repos_url'] = undefined;

/**
 * @member {String} events_url
 */
RepositoryAdvisoryAuthor.prototype['events_url'] = undefined;

/**
 * @member {String} received_events_url
 */
RepositoryAdvisoryAuthor.prototype['received_events_url'] = undefined;

/**
 * @member {String} type
 */
RepositoryAdvisoryAuthor.prototype['type'] = undefined;

/**
 * @member {Boolean} site_admin
 */
RepositoryAdvisoryAuthor.prototype['site_admin'] = undefined;

/**
 * @member {String} starred_at
 */
RepositoryAdvisoryAuthor.prototype['starred_at'] = undefined;
...
export default RepositoryAdvisoryAuthor;
