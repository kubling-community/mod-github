...
class NullableScopedInstallation {
     ...
     */
    constructor(permissions, repositorySelection, singleFileName, repositoriesUrl, account) { 
        
        NullableScopedInstallation.initialize(this, permissions, repositorySelection, singleFileName, repositoriesUrl, account);
    }
     ...
     */
    static initialize(obj, permissions, repositorySelection, singleFileName, repositoriesUrl, account) { 
...
NullableScopedInstallation.RequiredProperties = ["permissions", "repository_selection", "single_file_name", "repositories_url", "account"];
