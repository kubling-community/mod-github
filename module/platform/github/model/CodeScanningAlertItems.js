...
class CodeScanningAlertItems {
     ...
     */
    constructor(number, createdAt, url, htmlUrl, instancesUrl, state, dismissedBy, dismissedAt, dismissedReason, rule, tool, mostRecentInstance) { 
        
        CodeScanningAlertItems.initialize(this, number, createdAt, url, htmlUrl, instancesUrl, state, dismissedBy, dismissedAt, dismissedReason, rule, tool, mostRecentInstance);
    }
     ...
     */
    static initialize(obj, number, createdAt, url, htmlUrl, instancesUrl, state, dismissedBy, dismissedAt, dismissedReason, rule, tool, mostRecentInstance) { 
        obj['number'] = number;
...
CodeScanningAlertItems.RequiredProperties = ["number", "created_at", "url", "html_url", "instances_url", "state", "dismissed_by", "dismissed_at", "dismissed_reason", "rule", "tool", "most_recent_instance"];
 ...
 */
CodeScanningAlertItems.prototype['dismissed_comment'] = undefined;
