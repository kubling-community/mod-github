...
/**
 * The RepositoryWebhooks model module.
 * @module model/RepositoryWebhooks
 * @version 1.1.4
 */
class RepositoryWebhooks {
    /**
     * Constructs a new <code>RepositoryWebhooks</code>.
     ...
     * @alias module:model/RepositoryWebhooks
    ...
    constructor(id, nodeId, name, fullName, license, forks, owner, _private, htmlUrl, description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, downloadsUrl, eventsUrl, forksUrl, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, notificationsUrl, pullsUrl, releasesUrl, sshUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, cloneUrl, mirrorUrl, hooksUrl, svnUrl, homepage, language, forksCount, stargazersCount, watchersCount, size, defaultBranch, openIssuesCount, hasIssues, hasProjects, hasWiki, hasPages, hasDownloads, archived, disabled, pushedAt, createdAt, updatedAt, openIssues, watchers) { 
        ...
        RepositoryWebhooks.initialize(this, id, nodeId, name, fullName, license, forks, owner, _private, htmlUrl, description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, downloadsUrl, eventsUrl, forksUrl, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, notificationsUrl, pullsUrl, releasesUrl, sshUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, cloneUrl, mirrorUrl, hooksUrl, svnUrl, homepage, language, forksCount, stargazersCount, watchersCount, size, defaultBranch, openIssuesCount, hasIssues, hasProjects, hasWiki, hasPages, hasDownloads, archived, disabled, pushedAt, createdAt, updatedAt, openIssues, watchers);
    }
    ...
    /**
     * Constructs a <code>RepositoryWebhooks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryWebhooks} obj Optional instance to populate.
     * @return {module:model/RepositoryWebhooks} The populated <code>RepositoryWebhooks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryWebhooks();
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryWebhooks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryWebhooks</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RepositoryWebhooks.RequiredProperties) {
 ...
 * @default false
 */
RepositoryWebhooks.prototype['private'] = false;

/**
 * @member {String} html_url
 */
RepositoryWebhooks.prototype['html_url'] = undefined;

/**
 * @member {String} description
 */
RepositoryWebhooks.prototype['description'] = undefined;

/**
 * @member {Boolean} fork
 */
RepositoryWebhooks.prototype['fork'] = undefined;

/**
 * @member {String} url
 */
RepositoryWebhooks.prototype['url'] = undefined;

/**
 * @member {String} archive_url
 */
RepositoryWebhooks.prototype['archive_url'] = undefined;

/**
 * @member {String} assignees_url
 */
RepositoryWebhooks.prototype['assignees_url'] = undefined;

/**
 * @member {String} blobs_url
 */
RepositoryWebhooks.prototype['blobs_url'] = undefined;

/**
 * @member {String} branches_url
 */
RepositoryWebhooks.prototype['branches_url'] = undefined;

/**
 * @member {String} collaborators_url
 */
RepositoryWebhooks.prototype['collaborators_url'] = undefined;

/**
 * @member {String} comments_url
 */
RepositoryWebhooks.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
RepositoryWebhooks.prototype['commits_url'] = undefined;

/**
 * @member {String} compare_url
 */
RepositoryWebhooks.prototype['compare_url'] = undefined;

/**
 * @member {String} contents_url
 */
RepositoryWebhooks.prototype['contents_url'] = undefined;

/**
 * @member {String} contributors_url
 */
RepositoryWebhooks.prototype['contributors_url'] = undefined;

/**
 * @member {String} deployments_url
 */
RepositoryWebhooks.prototype['deployments_url'] = undefined;

/**
 * @member {String} downloads_url
 */
RepositoryWebhooks.prototype['downloads_url'] = undefined;

/**
 * @member {String} events_url
 */
RepositoryWebhooks.prototype['events_url'] = undefined;

/**
 * @member {String} forks_url
 */
RepositoryWebhooks.prototype['forks_url'] = undefined;

/**
 * @member {String} git_commits_url
 */
RepositoryWebhooks.prototype['git_commits_url'] = undefined;

/**
 * @member {String} git_refs_url
 */
RepositoryWebhooks.prototype['git_refs_url'] = undefined;

/**
 * @member {String} git_tags_url
 */
RepositoryWebhooks.prototype['git_tags_url'] = undefined;

/**
 * @member {String} git_url
 */
RepositoryWebhooks.prototype['git_url'] = undefined;

/**
 * @member {String} issue_comment_url
 */
RepositoryWebhooks.prototype['issue_comment_url'] = undefined;

/**
 * @member {String} issue_events_url
 */
RepositoryWebhooks.prototype['issue_events_url'] = undefined;

/**
 * @member {String} issues_url
 */
RepositoryWebhooks.prototype['issues_url'] = undefined;

/**
 * @member {String} keys_url
 */
RepositoryWebhooks.prototype['keys_url'] = undefined;

/**
 * @member {String} labels_url
 */
RepositoryWebhooks.prototype['labels_url'] = undefined;

/**
 * @member {String} languages_url
 */
RepositoryWebhooks.prototype['languages_url'] = undefined;

/**
 * @member {String} merges_url
 */
RepositoryWebhooks.prototype['merges_url'] = undefined;

/**
 * @member {String} milestones_url
 */
RepositoryWebhooks.prototype['milestones_url'] = undefined;

/**
 * @member {String} notifications_url
 */
RepositoryWebhooks.prototype['notifications_url'] = undefined;

/**
 * @member {String} pulls_url
 */
RepositoryWebhooks.prototype['pulls_url'] = undefined;

/**
 * @member {String} releases_url
 */
RepositoryWebhooks.prototype['releases_url'] = undefined;

/**
 * @member {String} ssh_url
 */
RepositoryWebhooks.prototype['ssh_url'] = undefined;

/**
 * @member {String} stargazers_url
 */
RepositoryWebhooks.prototype['stargazers_url'] = undefined;

/**
 * @member {String} statuses_url
 */
RepositoryWebhooks.prototype['statuses_url'] = undefined;

/**
 * @member {String} subscribers_url
 */
RepositoryWebhooks.prototype['subscribers_url'] = undefined;

/**
 * @member {String} subscription_url
 */
RepositoryWebhooks.prototype['subscription_url'] = undefined;

/**
 * @member {String} tags_url
 */
RepositoryWebhooks.prototype['tags_url'] = undefined;

/**
 * @member {String} teams_url
 */
RepositoryWebhooks.prototype['teams_url'] = undefined;

/**
 * @member {String} trees_url
 */
RepositoryWebhooks.prototype['trees_url'] = undefined;

/**
 * @member {String} clone_url
 */
RepositoryWebhooks.prototype['clone_url'] = undefined;

/**
 * @member {String} mirror_url
 */
RepositoryWebhooks.prototype['mirror_url'] = undefined;

/**
 * @member {String} hooks_url
 */
RepositoryWebhooks.prototype['hooks_url'] = undefined;

/**
 * @member {String} svn_url
 */
RepositoryWebhooks.prototype['svn_url'] = undefined;

/**
 * @member {String} homepage
 */
RepositoryWebhooks.prototype['homepage'] = undefined;

/**
 * @member {String} language
 */
RepositoryWebhooks.prototype['language'] = undefined;

/**
 * @member {Number} forks_count
 */
RepositoryWebhooks.prototype['forks_count'] = undefined;

/**
 * @member {Number} stargazers_count
 */
RepositoryWebhooks.prototype['stargazers_count'] = undefined;

/**
 * @member {Number} watchers_count
 */
RepositoryWebhooks.prototype['watchers_count'] = undefined;

/**
 * The size of the repository, in kilobytes. Size is calculated hourly. When a repository is initially created, the size is 0.
 * @member {Number} size
 */
RepositoryWebhooks.prototype['size'] = undefined;

/**
 * The default branch of the repository.
 * @member {String} default_branch
 */
RepositoryWebhooks.prototype['default_branch'] = undefined;

/**
 * @member {Number} open_issues_count
 */
RepositoryWebhooks.prototype['open_issues_count'] = undefined;
 ...
 * @default false
 */
RepositoryWebhooks.prototype['is_template'] = false;

/**
 * @member {Array.<String>} topics
 */
RepositoryWebhooks.prototype['topics'] = undefined;

/**
 * The custom properties that were defined for the repository. The keys are the custom property names, and the values are the corresponding custom property values.
 * @member {Object.<String, Object>} custom_properties
 */
RepositoryWebhooks.prototype['custom_properties'] = undefined;
 ...
 * @default true
 */
RepositoryWebhooks.prototype['has_issues'] = true;
 ...
 * @default true
 */
RepositoryWebhooks.prototype['has_projects'] = true;
 ...
 * @default true
 */
RepositoryWebhooks.prototype['has_wiki'] = true;

/**
 * @member {Boolean} has_pages
 */
RepositoryWebhooks.prototype['has_pages'] = undefined;
 ...
 * @default true
 */
RepositoryWebhooks.prototype['has_downloads'] = true;
 ...
 * @default false
 */
RepositoryWebhooks.prototype['has_discussions'] = false;
 ...
 * @default false
 */
RepositoryWebhooks.prototype['archived'] = false;

/**
 * Returns whether or not this repository disabled.
 * @member {Boolean} disabled
 */
RepositoryWebhooks.prototype['disabled'] = undefined;
 ...
 * @default 'public'
 */
RepositoryWebhooks.prototype['visibility'] = 'public';

/**
 * @member {Date} pushed_at
 */
RepositoryWebhooks.prototype['pushed_at'] = undefined;

/**
 * @member {Date} created_at
 */
RepositoryWebhooks.prototype['created_at'] = undefined;

/**
 * @member {Date} updated_at
 */
RepositoryWebhooks.prototype['updated_at'] = undefined;
 ...
 * @default true
 */
RepositoryWebhooks.prototype['allow_rebase_merge'] = true;

/**
 * @member {module:model/RepositoryWebhooksTemplateRepository} template_repository
 */
RepositoryWebhooks.prototype['template_repository'] = undefined;

/**
 * @member {String} temp_clone_token
 */
RepositoryWebhooks.prototype['temp_clone_token'] = undefined;
 ...
 * @default true
 */
RepositoryWebhooks.prototype['allow_squash_merge'] = true;
 ...
 * @default false
 */
RepositoryWebhooks.prototype['allow_auto_merge'] = false;
 ...
 * @default false
 */
RepositoryWebhooks.prototype['delete_branch_on_merge'] = false;
 ...
 * @default false
 */
RepositoryWebhooks.prototype['allow_update_branch'] = false;
 ...
 * @default false
 */
RepositoryWebhooks.prototype['use_squash_pr_title_as_default'] = false;

/**
 * The default value for a squash merge commit title:  - `PR_TITLE` - default to the pull request's title. - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
 * @member {module:model/RepositoryWebhooks.SquashMergeCommitTitleEnum} squash_merge_commit_title
 */
RepositoryWebhooks.prototype['squash_merge_commit_title'] = undefined;

/**
 * The default value for a squash merge commit message:  - `PR_BODY` - default to the pull request's body. - `COMMIT_MESSAGES` - default to the branch's commit messages. - `BLANK` - default to a blank commit message.
 * @member {module:model/RepositoryWebhooks.SquashMergeCommitMessageEnum} squash_merge_commit_message
 */
RepositoryWebhooks.prototype['squash_merge_commit_message'] = undefined;

/**
 * The default value for a merge commit title.  - `PR_TITLE` - default to the pull request's title. - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
 * @member {module:model/RepositoryWebhooks.MergeCommitTitleEnum} merge_commit_title
 */
RepositoryWebhooks.prototype['merge_commit_title'] = undefined;

/**
 * The default value for a merge commit message.  - `PR_TITLE` - default to the pull request's title. - `PR_BODY` - default to the pull request's body. - `BLANK` - default to a blank commit message.
 * @member {module:model/RepositoryWebhooks.MergeCommitMessageEnum} merge_commit_message
 */
RepositoryWebhooks.prototype['merge_commit_message'] = undefined;
 ...
 * @default true
 */
RepositoryWebhooks.prototype['allow_merge_commit'] = true;

/**
 * Whether to allow forking this repo
 * @member {Boolean} allow_forking
 */
RepositoryWebhooks.prototype['allow_forking'] = undefined;
 ...
 * @default false
 */
RepositoryWebhooks.prototype['web_commit_signoff_required'] = false;

/**
 * @member {Number} subscribers_count
 */
RepositoryWebhooks.prototype['subscribers_count'] = undefined;

/**
 * @member {Number} network_count
 */
RepositoryWebhooks.prototype['network_count'] = undefined;

/**
 * @member {Number} open_issues
 */
RepositoryWebhooks.prototype['open_issues'] = undefined;

/**
 * @member {Number} watchers
 */
RepositoryWebhooks.prototype['watchers'] = undefined;

/**
 * @member {String} master_branch
 */
RepositoryWebhooks.prototype['master_branch'] = undefined;

/**
 * @member {String} starred_at
 */
RepositoryWebhooks.prototype['starred_at'] = undefined;

/**
 * Whether anonymous git access is enabled for this repository
 * @member {Boolean} anonymous_access_enabled
 */
RepositoryWebhooks.prototype['anonymous_access_enabled'] = undefined;
 ...
 * @readonly
 */
RepositoryWebhooks['SquashMergeCommitTitleEnum'] = {
 ...
 * @readonly
 */
RepositoryWebhooks['SquashMergeCommitMessageEnum'] = {
 ...
 * @readonly
 */
RepositoryWebhooks['MergeCommitTitleEnum'] = {
 ...
 * @readonly
 */
RepositoryWebhooks['MergeCommitMessageEnum'] = {
