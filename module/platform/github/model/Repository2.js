...
/**
 * The Repository2 model module.
 * @module model/Repository2
 * @version 1.1.4
 */
class Repository2 {
    /**
     * Constructs a new <code>Repository2</code>.
     * A git repository
     * @alias module:model/Repository2
     ...
     * @param url {String} 
     * @param visibility {module:model/Repository2.VisibilityEnum} 
    ...
    constructor(archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl, cloneUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description, downloadsUrl, eventsUrl, fork, forks, forksCount, forksUrl, fullName, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, hasDownloads, hasIssues, hasPages, hasProjects, hasWiki, hasDiscussions, homepage, hooksUrl, htmlUrl, id, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, language, languagesUrl, license, mergesUrl, milestonesUrl, mirrorUrl, name, nodeId, notificationsUrl, openIssues, openIssuesCount, owner, _private, pullsUrl, pushedAt, releasesUrl, size, sshUrl, stargazersCount, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, svnUrl, tagsUrl, teamsUrl, topics, treesUrl, updatedAt, url, visibility, watchers, watchersCount) { 
        ...
        Repository2.initialize(this, archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl, cloneUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description, downloadsUrl, eventsUrl, fork, forks, forksCount, forksUrl, fullName, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, hasDownloads, hasIssues, hasPages, hasProjects, hasWiki, hasDiscussions, homepage, hooksUrl, htmlUrl, id, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, language, languagesUrl, license, mergesUrl, milestonesUrl, mirrorUrl, name, nodeId, notificationsUrl, openIssues, openIssuesCount, owner, _private, pullsUrl, pushedAt, releasesUrl, size, sshUrl, stargazersCount, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, svnUrl, tagsUrl, teamsUrl, topics, treesUrl, updatedAt, url, visibility, watchers, watchersCount);
    }
    ...
    /**
     * Constructs a <code>Repository2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Repository2} obj Optional instance to populate.
     * @return {module:model/Repository2} The populated <code>Repository2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Repository2();
    ...
    /**
     * Validates the JSON data with respect to <code>Repository2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Repository2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Repository2.RequiredProperties) {
 ...
 * @default false
 */
Repository2.prototype['allow_auto_merge'] = false;

/**
 * Whether to allow private forks
 * @member {Boolean} allow_forking
 */
Repository2.prototype['allow_forking'] = undefined;
 ...
 * @default true
 */
Repository2.prototype['allow_merge_commit'] = true;
 ...
 * @default true
 */
Repository2.prototype['allow_rebase_merge'] = true;
 ...
 * @default true
 */
Repository2.prototype['allow_squash_merge'] = true;

/**
 * @member {Boolean} allow_update_branch
 */
Repository2.prototype['allow_update_branch'] = undefined;

/**
 * @member {String} archive_url
 */
Repository2.prototype['archive_url'] = undefined;
 ...
 * @default false
 */
Repository2.prototype['archived'] = false;

/**
 * @member {String} assignees_url
 */
Repository2.prototype['assignees_url'] = undefined;

/**
 * @member {String} blobs_url
 */
Repository2.prototype['blobs_url'] = undefined;

/**
 * @member {String} branches_url
 */
Repository2.prototype['branches_url'] = undefined;

/**
 * @member {String} clone_url
 */
Repository2.prototype['clone_url'] = undefined;

/**
 * @member {String} collaborators_url
 */
Repository2.prototype['collaborators_url'] = undefined;

/**
 * @member {String} comments_url
 */
Repository2.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
Repository2.prototype['commits_url'] = undefined;

/**
 * @member {String} compare_url
 */
Repository2.prototype['compare_url'] = undefined;

/**
 * @member {String} contents_url
 */
Repository2.prototype['contents_url'] = undefined;

/**
 * @member {String} contributors_url
 */
Repository2.prototype['contributors_url'] = undefined;

/**
 * @member {module:model/RepositoryCreatedAt} created_at
 */
Repository2.prototype['created_at'] = undefined;

/**
 * The custom properties that were defined for the repository. The keys are the custom property names, and the values are the corresponding custom property values.
 * @member {Object.<String, Object>} custom_properties
 */
Repository2.prototype['custom_properties'] = undefined;

/**
 * The default branch of the repository.
 * @member {String} default_branch
 */
Repository2.prototype['default_branch'] = undefined;
 ...
 * @default false
 */
Repository2.prototype['delete_branch_on_merge'] = false;

/**
 * @member {String} deployments_url
 */
Repository2.prototype['deployments_url'] = undefined;

/**
 * @member {String} description
 */
Repository2.prototype['description'] = undefined;

/**
 * Returns whether or not this repository is disabled.
 * @member {Boolean} disabled
 */
Repository2.prototype['disabled'] = undefined;

/**
 * @member {String} downloads_url
 */
Repository2.prototype['downloads_url'] = undefined;

/**
 * @member {String} events_url
 */
Repository2.prototype['events_url'] = undefined;

/**
 * @member {Boolean} fork
 */
Repository2.prototype['fork'] = undefined;

/**
 * @member {Number} forks
 */
Repository2.prototype['forks'] = undefined;

/**
 * @member {Number} forks_count
 */
Repository2.prototype['forks_count'] = undefined;

/**
 * @member {String} forks_url
 */
Repository2.prototype['forks_url'] = undefined;

/**
 * @member {String} full_name
 */
Repository2.prototype['full_name'] = undefined;

/**
 * @member {String} git_commits_url
 */
Repository2.prototype['git_commits_url'] = undefined;

/**
 * @member {String} git_refs_url
 */
Repository2.prototype['git_refs_url'] = undefined;

/**
 * @member {String} git_tags_url
 */
Repository2.prototype['git_tags_url'] = undefined;

/**
 * @member {String} git_url
 */
Repository2.prototype['git_url'] = undefined;
 ...
 * @default true
 */
Repository2.prototype['has_downloads'] = true;
 ...
 * @default true
 */
Repository2.prototype['has_issues'] = true;

/**
 * @member {Boolean} has_pages
 */
Repository2.prototype['has_pages'] = undefined;
 ...
 * @default true
 */
Repository2.prototype['has_projects'] = true;
 ...
 * @default true
 */
Repository2.prototype['has_wiki'] = true;
 ...
 * @default false
 */
Repository2.prototype['has_discussions'] = false;

/**
 * @member {String} homepage
 */
Repository2.prototype['homepage'] = undefined;

/**
 * @member {String} hooks_url
 */
Repository2.prototype['hooks_url'] = undefined;

/**
 * @member {String} html_url
 */
Repository2.prototype['html_url'] = undefined;

/**
 * Unique identifier of the repository
 * @member {Number} id
 */
Repository2.prototype['id'] = undefined;

/**
 * @member {Boolean} is_template
 */
Repository2.prototype['is_template'] = undefined;

/**
 * @member {String} issue_comment_url
 */
Repository2.prototype['issue_comment_url'] = undefined;

/**
 * @member {String} issue_events_url
 */
Repository2.prototype['issue_events_url'] = undefined;

/**
 * @member {String} issues_url
 */
Repository2.prototype['issues_url'] = undefined;

/**
 * @member {String} keys_url
 */
Repository2.prototype['keys_url'] = undefined;

/**
 * @member {String} labels_url
 */
Repository2.prototype['labels_url'] = undefined;

/**
 * @member {String} language
 */
Repository2.prototype['language'] = undefined;

/**
 * @member {String} languages_url
 */
Repository2.prototype['languages_url'] = undefined;

/**
 * @member {module:model/License} license
 */
Repository2.prototype['license'] = undefined;

/**
 * @member {String} master_branch
 */
Repository2.prototype['master_branch'] = undefined;

/**
 * @member {String} merges_url
 */
Repository2.prototype['merges_url'] = undefined;

/**
 * @member {String} milestones_url
 */
Repository2.prototype['milestones_url'] = undefined;

/**
 * @member {String} mirror_url
 */
Repository2.prototype['mirror_url'] = undefined;

/**
 * The name of the repository.
 * @member {String} name
 */
Repository2.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
Repository2.prototype['node_id'] = undefined;

/**
 * @member {String} notifications_url
 */
Repository2.prototype['notifications_url'] = undefined;

/**
 * @member {Number} open_issues
 */
Repository2.prototype['open_issues'] = undefined;

/**
 * @member {Number} open_issues_count
 */
Repository2.prototype['open_issues_count'] = undefined;

/**
 * @member {String} organization
 */
Repository2.prototype['organization'] = undefined;

/**
 * @member {module:model/User} owner
 */
Repository2.prototype['owner'] = undefined;

/**
 * @member {module:model/RepositoryPermissions} permissions
 */
Repository2.prototype['permissions'] = undefined;

/**
 * Whether the repository is private or public.
 * @member {Boolean} private
 */
Repository2.prototype['private'] = undefined;

/**
 * @member {Boolean} public
 */
Repository2.prototype['public'] = undefined;

/**
 * @member {String} pulls_url
 */
Repository2.prototype['pulls_url'] = undefined;

/**
 * @member {module:model/RepositoryPushedAt} pushed_at
 */
Repository2.prototype['pushed_at'] = undefined;

/**
 * @member {String} releases_url
 */
Repository2.prototype['releases_url'] = undefined;

/**
 * @member {String} role_name
 */
Repository2.prototype['role_name'] = undefined;

/**
 * @member {Number} size
 */
Repository2.prototype['size'] = undefined;

/**
 * @member {String} ssh_url
 */
Repository2.prototype['ssh_url'] = undefined;

/**
 * @member {Number} stargazers
 */
Repository2.prototype['stargazers'] = undefined;

/**
 * @member {Number} stargazers_count
 */
Repository2.prototype['stargazers_count'] = undefined;

/**
 * @member {String} stargazers_url
 */
Repository2.prototype['stargazers_url'] = undefined;

/**
 * @member {String} statuses_url
 */
Repository2.prototype['statuses_url'] = undefined;

/**
 * @member {String} subscribers_url
 */
Repository2.prototype['subscribers_url'] = undefined;

/**
 * @member {String} subscription_url
 */
Repository2.prototype['subscription_url'] = undefined;

/**
 * @member {String} svn_url
 */
Repository2.prototype['svn_url'] = undefined;

/**
 * @member {String} tags_url
 */
Repository2.prototype['tags_url'] = undefined;

/**
 * @member {String} teams_url
 */
Repository2.prototype['teams_url'] = undefined;

/**
 * @member {Array.<String>} topics
 */
Repository2.prototype['topics'] = undefined;

/**
 * @member {String} trees_url
 */
Repository2.prototype['trees_url'] = undefined;

/**
 * @member {Date} updated_at
 */
Repository2.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
Repository2.prototype['url'] = undefined;

/**
 * @member {module:model/Repository2.VisibilityEnum} visibility
 */
Repository2.prototype['visibility'] = undefined;

/**
 * @member {Number} watchers
 */
Repository2.prototype['watchers'] = undefined;

/**
 * @member {Number} watchers_count
 */
Repository2.prototype['watchers_count'] = undefined;

/**
 * Whether to require contributors to sign off on web-based commits
 * @member {Boolean} web_commit_signoff_required
 */
Repository2.prototype['web_commit_signoff_required'] = undefined;
