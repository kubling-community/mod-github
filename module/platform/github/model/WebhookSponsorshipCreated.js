...
/**
 * The WebhookSponsorshipCreated model module.
 * @module model/WebhookSponsorshipCreated
 * @version 1.1.4
 */
class WebhookSponsorshipCreated {
    /**
     * Constructs a new <code>WebhookSponsorshipCreated</code>.
     * @alias module:model/WebhookSponsorshipCreated
     * @param action {module:model/WebhookSponsorshipCreated.ActionEnum} 
    ...
    constructor(action, sender, sponsorship) { 
        ...
        WebhookSponsorshipCreated.initialize(this, action, sender, sponsorship);
    }
    ...
    /**
     * Constructs a <code>WebhookSponsorshipCreated</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookSponsorshipCreated} obj Optional instance to populate.
     * @return {module:model/WebhookSponsorshipCreated} The populated <code>WebhookSponsorshipCreated</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookSponsorshipCreated();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookSponsorshipCreated</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookSponsorshipCreated</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookSponsorshipCreated.RequiredProperties) {
...
WebhookSponsorshipCreated.RequiredProperties = ["action", "sender", "sponsorship"];

/**
 * @member {module:model/WebhookSponsorshipCreated.ActionEnum} action
 */
WebhookSponsorshipCreated.prototype['action'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookSponsorshipCreated.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookSponsorshipCreated.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookSponsorshipCreated.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookSponsorshipCreated.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookSponsorshipCreated.prototype['sender'] = undefined;

/**
 * @member {module:model/WebhooksSponsorship} sponsorship
 */
WebhookSponsorshipCreated.prototype['sponsorship'] = undefined;
 ...
 * @readonly
 */
WebhookSponsorshipCreated['ActionEnum'] = {
...
export default WebhookSponsorshipCreated;
