...
/**
 * The RepositoryLite1 model module.
 * @module model/RepositoryLite1
 * @version 1.1.4
 */
class RepositoryLite1 {
    /**
     * Constructs a new <code>RepositoryLite1</code>.
     * @alias module:model/RepositoryLite1
    ...
    /**
     * Constructs a <code>RepositoryLite1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryLite1} obj Optional instance to populate.
     * @return {module:model/RepositoryLite1} The populated <code>RepositoryLite1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryLite1();
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryLite1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryLite1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RepositoryLite1.RequiredProperties) {
 ...
 */
RepositoryLite1.prototype['archive_url'] = undefined;

/**
 * @member {String} assignees_url
 */
RepositoryLite1.prototype['assignees_url'] = undefined;

/**
 * @member {String} blobs_url
 */
RepositoryLite1.prototype['blobs_url'] = undefined;

/**
 * @member {String} branches_url
 */
RepositoryLite1.prototype['branches_url'] = undefined;

/**
 * @member {String} collaborators_url
 */
RepositoryLite1.prototype['collaborators_url'] = undefined;

/**
 * @member {String} comments_url
 */
RepositoryLite1.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
RepositoryLite1.prototype['commits_url'] = undefined;

/**
 * @member {String} compare_url
 */
RepositoryLite1.prototype['compare_url'] = undefined;

/**
 * @member {String} contents_url
 */
RepositoryLite1.prototype['contents_url'] = undefined;

/**
 * @member {String} contributors_url
 */
RepositoryLite1.prototype['contributors_url'] = undefined;

/**
 * @member {String} deployments_url
 */
RepositoryLite1.prototype['deployments_url'] = undefined;

/**
 * @member {String} description
 */
RepositoryLite1.prototype['description'] = undefined;

/**
 * @member {String} downloads_url
 */
RepositoryLite1.prototype['downloads_url'] = undefined;

/**
 * @member {String} events_url
 */
RepositoryLite1.prototype['events_url'] = undefined;

/**
 * @member {Boolean} fork
 */
RepositoryLite1.prototype['fork'] = undefined;

/**
 * @member {String} forks_url
 */
RepositoryLite1.prototype['forks_url'] = undefined;

/**
 * @member {String} full_name
 */
RepositoryLite1.prototype['full_name'] = undefined;

/**
 * @member {String} git_commits_url
 */
RepositoryLite1.prototype['git_commits_url'] = undefined;

/**
 * @member {String} git_refs_url
 */
RepositoryLite1.prototype['git_refs_url'] = undefined;

/**
 * @member {String} git_tags_url
 */
RepositoryLite1.prototype['git_tags_url'] = undefined;

/**
 * @member {String} hooks_url
 */
RepositoryLite1.prototype['hooks_url'] = undefined;

/**
 * @member {String} html_url
 */
RepositoryLite1.prototype['html_url'] = undefined;

/**
 * Unique identifier of the repository
 * @member {Number} id
 */
RepositoryLite1.prototype['id'] = undefined;

/**
 * @member {String} issue_comment_url
 */
RepositoryLite1.prototype['issue_comment_url'] = undefined;

/**
 * @member {String} issue_events_url
 */
RepositoryLite1.prototype['issue_events_url'] = undefined;

/**
 * @member {String} issues_url
 */
RepositoryLite1.prototype['issues_url'] = undefined;

/**
 * @member {String} keys_url
 */
RepositoryLite1.prototype['keys_url'] = undefined;

/**
 * @member {String} labels_url
 */
RepositoryLite1.prototype['labels_url'] = undefined;

/**
 * @member {String} languages_url
 */
RepositoryLite1.prototype['languages_url'] = undefined;

/**
 * @member {String} merges_url
 */
RepositoryLite1.prototype['merges_url'] = undefined;

/**
 * @member {String} milestones_url
 */
RepositoryLite1.prototype['milestones_url'] = undefined;

/**
 * The name of the repository.
 * @member {String} name
 */
RepositoryLite1.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
RepositoryLite1.prototype['node_id'] = undefined;

/**
 * @member {String} notifications_url
 */
RepositoryLite1.prototype['notifications_url'] = undefined;

/**
 * @member {module:model/User} owner
 */
RepositoryLite1.prototype['owner'] = undefined;

/**
 * Whether the repository is private or public.
 * @member {Boolean} private
 */
RepositoryLite1.prototype['private'] = undefined;

/**
 * @member {String} pulls_url
 */
RepositoryLite1.prototype['pulls_url'] = undefined;

/**
 * @member {String} releases_url
 */
RepositoryLite1.prototype['releases_url'] = undefined;

/**
 * @member {String} stargazers_url
 */
RepositoryLite1.prototype['stargazers_url'] = undefined;

/**
 * @member {String} statuses_url
 */
RepositoryLite1.prototype['statuses_url'] = undefined;

/**
 * @member {String} subscribers_url
 */
RepositoryLite1.prototype['subscribers_url'] = undefined;

/**
 * @member {String} subscription_url
 */
RepositoryLite1.prototype['subscription_url'] = undefined;

/**
 * @member {String} tags_url
 */
RepositoryLite1.prototype['tags_url'] = undefined;

/**
 * @member {String} teams_url
 */
RepositoryLite1.prototype['teams_url'] = undefined;

/**
 * @member {String} trees_url
 */
RepositoryLite1.prototype['trees_url'] = undefined;

/**
 * @member {String} url
 */
RepositoryLite1.prototype['url'] = undefined;
...
export default RepositoryLite1;
