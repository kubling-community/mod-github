...
/**
 * The WebhookDependabotAlertFixed model module.
 * @module model/WebhookDependabotAlertFixed
 * @version 1.1.4
 */
class WebhookDependabotAlertFixed {
    /**
     * Constructs a new <code>WebhookDependabotAlertFixed</code>.
     * @alias module:model/WebhookDependabotAlertFixed
     * @param action {module:model/WebhookDependabotAlertFixed.ActionEnum} 
    ...
    constructor(action, alert, repository, sender) { 
        ...
        WebhookDependabotAlertFixed.initialize(this, action, alert, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookDependabotAlertFixed</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookDependabotAlertFixed} obj Optional instance to populate.
     * @return {module:model/WebhookDependabotAlertFixed} The populated <code>WebhookDependabotAlertFixed</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookDependabotAlertFixed();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDependabotAlertFixed</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDependabotAlertFixed</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookDependabotAlertFixed.RequiredProperties) {
...
WebhookDependabotAlertFixed.RequiredProperties = ["action", "alert", "repository", "sender"];

/**
 * @member {module:model/WebhookDependabotAlertFixed.ActionEnum} action
 */
WebhookDependabotAlertFixed.prototype['action'] = undefined;

/**
 * @member {module:model/DependabotAlert} alert
 */
WebhookDependabotAlertFixed.prototype['alert'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookDependabotAlertFixed.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookDependabotAlertFixed.prototype['organization'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookDependabotAlertFixed.prototype['enterprise'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookDependabotAlertFixed.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookDependabotAlertFixed.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookDependabotAlertFixed['ActionEnum'] = {
...
export default WebhookDependabotAlertFixed;
