...
class CommitSearchResultItemCommit {
     ...
     * @param url {String} 
     */
    constructor(author, committer, commentCount, message, tree, url) { 
        
        CommitSearchResultItemCommit.initialize(this, author, committer, commentCount, message, tree, url);
    }
     ...
     */
    static initialize(obj, author, committer, commentCount, message, tree, url) { 
        obj['author'] = author;
...
CommitSearchResultItemCommit.RequiredProperties = ["author", "committer", "comment_count", "message", "tree", "url"];
