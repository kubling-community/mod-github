...
class ReposCreateDeploymentStatusRequest {
     ...
     * @param state {module:model/ReposCreateDeploymentStatusRequest.StateEnum} The state of the status. When you set a transient deployment to `inactive`, the deployment will be shown as `destroyed` in GitHub.
     */
    constructor(state) { 
