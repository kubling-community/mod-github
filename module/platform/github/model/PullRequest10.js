...
import PullRequest10Head from './PullRequest10Head';
...
/**
 * The PullRequest10 model module.
 * @module model/PullRequest10
 * @version 1.1.4
 */
class PullRequest10 {
    /**
     * Constructs a new <code>PullRequest10</code>.
     * @alias module:model/PullRequest10
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/PullRequest10.ActiveLockReasonEnum} 
     * @param assignee {module:model/User1} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/PullRequest10.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param head {module:model/PullRequest10Head} 
     ...
     * @param state {module:model/PullRequest10.StateEnum} State of this Pull Request. Either `open` or `closed`.
    ...
    /**
     * Constructs a <code>PullRequest10</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequest10} obj Optional instance to populate.
     * @return {module:model/PullRequest10} The populated <code>PullRequest10</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequest10();
            ...
            if (data.hasOwnProperty('head')) {
                obj['head'] = PullRequest10Head.constructFromObject(data['head']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequest10</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequest10</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PullRequest10.RequiredProperties) {
        ...
        if (data['head']) { // data not null
          PullRequest10Head.validateJSON(data['head']);
        }
        // ensure the json data is a string
 ...
 */
PullRequest10.prototype['_links'] = undefined;

/**
 * @member {module:model/PullRequest10.ActiveLockReasonEnum} active_lock_reason
 */
PullRequest10.prototype['active_lock_reason'] = undefined;

/**
 * @member {Number} additions
 */
PullRequest10.prototype['additions'] = undefined;

/**
 * @member {module:model/User1} assignee
 */
PullRequest10.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User1>} assignees
 */
PullRequest10.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/PullRequest10.AuthorAssociationEnum} author_association
 */
PullRequest10.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
PullRequest10.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequestBase} base
 */
PullRequest10.prototype['base'] = undefined;

/**
 * @member {String} body
 */
PullRequest10.prototype['body'] = undefined;

/**
 * @member {Number} changed_files
 */
PullRequest10.prototype['changed_files'] = undefined;

/**
 * @member {Date} closed_at
 */
PullRequest10.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
PullRequest10.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
PullRequest10.prototype['comments_url'] = undefined;

/**
 * @member {Number} commits
 */
PullRequest10.prototype['commits'] = undefined;

/**
 * @member {String} commits_url
 */
PullRequest10.prototype['commits_url'] = undefined;

/**
 * @member {Date} created_at
 */
PullRequest10.prototype['created_at'] = undefined;

/**
 * @member {Number} deletions
 */
PullRequest10.prototype['deletions'] = undefined;

/**
 * @member {String} diff_url
 */
PullRequest10.prototype['diff_url'] = undefined;

/**
 * Indicates whether or not the pull request is a draft.
 * @member {Boolean} draft
 */
PullRequest10.prototype['draft'] = undefined;

/**
 * @member {module:model/PullRequest10Head} head
 */
PullRequest10.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
PullRequest10.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
PullRequest10.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
PullRequest10.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
PullRequest10.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
PullRequest10.prototype['locked'] = undefined;

/**
 * Indicates whether maintainers can modify the pull request.
 * @member {Boolean} maintainer_can_modify
 */
PullRequest10.prototype['maintainer_can_modify'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
PullRequest10.prototype['merge_commit_sha'] = undefined;

/**
 * @member {Boolean} mergeable
 */
PullRequest10.prototype['mergeable'] = undefined;

/**
 * @member {String} mergeable_state
 */
PullRequest10.prototype['mergeable_state'] = undefined;

/**
 * @member {Boolean} merged
 */
PullRequest10.prototype['merged'] = undefined;

/**
 * @member {Date} merged_at
 */
PullRequest10.prototype['merged_at'] = undefined;

/**
 * @member {module:model/User} merged_by
 */
PullRequest10.prototype['merged_by'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
PullRequest10.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
PullRequest10.prototype['node_id'] = undefined;

/**
 * Number uniquely identifying the pull request within its repository.
 * @member {Number} number
 */
PullRequest10.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
PullRequest10.prototype['patch_url'] = undefined;

/**
 * @member {Boolean} rebaseable
 */
PullRequest10.prototype['rebaseable'] = undefined;

/**
 * @member {Array.<module:model/PullRequestRequestedReviewersInner>} requested_reviewers
 */
PullRequest10.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
PullRequest10.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
PullRequest10.prototype['review_comment_url'] = undefined;

/**
 * @member {Number} review_comments
 */
PullRequest10.prototype['review_comments'] = undefined;

/**
 * @member {String} review_comments_url
 */
PullRequest10.prototype['review_comments_url'] = undefined;

/**
 * State of this Pull Request. Either `open` or `closed`.
 * @member {module:model/PullRequest10.StateEnum} state
 */
PullRequest10.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
PullRequest10.prototype['statuses_url'] = undefined;

/**
 * The title of the pull request.
 * @member {String} title
 */
PullRequest10.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
PullRequest10.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
PullRequest10.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
PullRequest10.prototype['user'] = undefined;
 ...
 * @readonly
 */
PullRequest10['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
PullRequest10['AuthorAssociationEnum'] = {
