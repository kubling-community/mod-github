...
class SearchLabels200Response {
    ...
    constructor(totalCount, incompleteResults, items) { 
        ...
        SearchLabels200Response.initialize(this, totalCount, incompleteResults, items);
    }
...
SearchLabels200Response.RequiredProperties = ["total_count", "incomplete_results", "items"];
