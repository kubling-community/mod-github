...
/**
 * The WebhookMarketplacePurchaseCancelled model module.
 * @module model/WebhookMarketplacePurchaseCancelled
 * @version 1.1.4
 */
class WebhookMarketplacePurchaseCancelled {
    /**
     * Constructs a new <code>WebhookMarketplacePurchaseCancelled</code>.
     * @alias module:model/WebhookMarketplacePurchaseCancelled
     * @param action {module:model/WebhookMarketplacePurchaseCancelled.ActionEnum} 
    ...
    constructor(action, effectiveDate, marketplacePurchase, sender) { 
        ...
        WebhookMarketplacePurchaseCancelled.initialize(this, action, effectiveDate, marketplacePurchase, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookMarketplacePurchaseCancelled</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookMarketplacePurchaseCancelled} obj Optional instance to populate.
     * @return {module:model/WebhookMarketplacePurchaseCancelled} The populated <code>WebhookMarketplacePurchaseCancelled</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookMarketplacePurchaseCancelled();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookMarketplacePurchaseCancelled</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookMarketplacePurchaseCancelled</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookMarketplacePurchaseCancelled.RequiredProperties) {
...
WebhookMarketplacePurchaseCancelled.RequiredProperties = ["action", "effective_date", "marketplace_purchase", "sender"];

/**
 * @member {module:model/WebhookMarketplacePurchaseCancelled.ActionEnum} action
 */
WebhookMarketplacePurchaseCancelled.prototype['action'] = undefined;

/**
 * @member {String} effective_date
 */
WebhookMarketplacePurchaseCancelled.prototype['effective_date'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookMarketplacePurchaseCancelled.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookMarketplacePurchaseCancelled.prototype['installation'] = undefined;

/**
 * @member {module:model/WebhooksMarketplacePurchase} marketplace_purchase
 */
WebhookMarketplacePurchaseCancelled.prototype['marketplace_purchase'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookMarketplacePurchaseCancelled.prototype['organization'] = undefined;

/**
 * @member {module:model/WebhooksPreviousMarketplacePurchase} previous_marketplace_purchase
 */
WebhookMarketplacePurchaseCancelled.prototype['previous_marketplace_purchase'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookMarketplacePurchaseCancelled.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookMarketplacePurchaseCancelled.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookMarketplacePurchaseCancelled['ActionEnum'] = {
...
export default WebhookMarketplacePurchaseCancelled;
