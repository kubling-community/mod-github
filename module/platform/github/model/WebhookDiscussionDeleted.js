...
/**
 * The WebhookDiscussionDeleted model module.
 * @module model/WebhookDiscussionDeleted
 * @version 1.1.4
 */
class WebhookDiscussionDeleted {
    /**
     * Constructs a new <code>WebhookDiscussionDeleted</code>.
     * @alias module:model/WebhookDiscussionDeleted
     * @param action {module:model/WebhookDiscussionDeleted.ActionEnum} 
    ...
    constructor(action, discussion, repository, sender) { 
        ...
        WebhookDiscussionDeleted.initialize(this, action, discussion, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookDiscussionDeleted</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookDiscussionDeleted} obj Optional instance to populate.
     * @return {module:model/WebhookDiscussionDeleted} The populated <code>WebhookDiscussionDeleted</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookDiscussionDeleted();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDiscussionDeleted</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDiscussionDeleted</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookDiscussionDeleted.RequiredProperties) {
...
WebhookDiscussionDeleted.RequiredProperties = ["action", "discussion", "repository", "sender"];

/**
 * @member {module:model/WebhookDiscussionDeleted.ActionEnum} action
 */
WebhookDiscussionDeleted.prototype['action'] = undefined;

/**
 * @member {module:model/Discussion} discussion
 */
WebhookDiscussionDeleted.prototype['discussion'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookDiscussionDeleted.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookDiscussionDeleted.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookDiscussionDeleted.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookDiscussionDeleted.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookDiscussionDeleted.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookDiscussionDeleted['ActionEnum'] = {
...
export default WebhookDiscussionDeleted;
