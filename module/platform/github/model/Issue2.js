...
/**
 * The Issue2 model module.
 * @module model/Issue2
 * @version 1.1.4
 */
class Issue2 {
    /**
     * Constructs a new <code>Issue2</code>.
     * The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
     * @alias module:model/Issue2
     * @param activeLockReason {module:model/Issue2.ActiveLockReasonEnum} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/Issue2.AuthorAssociationEnum} How the author is associated with the repository.
    ...
    constructor(activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user) { 
        ...
        Issue2.initialize(this, activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>Issue2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Issue2} obj Optional instance to populate.
     * @return {module:model/Issue2} The populated <code>Issue2</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Issue2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Issue2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Issue2.RequiredProperties) {
...
Issue2.RequiredProperties = ["active_lock_reason", "assignees", "author_association", "body", "closed_at", "comments", "comments_url", "created_at", "events_url", "html_url", "id", "labels_url", "milestone", "node_id", "number", "reactions", "repository_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/Issue2.ActiveLockReasonEnum} active_lock_reason
 */
Issue2.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User1} assignee
 */
Issue2.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User1>} assignees
 */
Issue2.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/Issue2.AuthorAssociationEnum} author_association
 */
Issue2.prototype['author_association'] = undefined;

/**
 * Contents of the issue
 * @member {String} body
 */
Issue2.prototype['body'] = undefined;

/**
 * @member {Date} closed_at
 */
Issue2.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
Issue2.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
Issue2.prototype['comments_url'] = undefined;

/**
 * @member {Date} created_at
 */
Issue2.prototype['created_at'] = undefined;

/**
 * @member {Boolean} draft
 */
Issue2.prototype['draft'] = undefined;

/**
 * @member {String} events_url
 */
Issue2.prototype['events_url'] = undefined;

/**
 * @member {String} html_url
 */
Issue2.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
Issue2.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
Issue2.prototype['labels'] = undefined;

/**
 * @member {String} labels_url
 */
Issue2.prototype['labels_url'] = undefined;

/**
 * @member {Boolean} locked
 */
Issue2.prototype['locked'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
Issue2.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
Issue2.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
Issue2.prototype['number'] = undefined;

/**
 * @member {module:model/App12} performed_via_github_app
 */
Issue2.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/WebhooksIssuePullRequest} pull_request
 */
Issue2.prototype['pull_request'] = undefined;

/**
 * @member {module:model/Reactions} reactions
 */
Issue2.prototype['reactions'] = undefined;

/**
 * @member {String} repository_url
 */
Issue2.prototype['repository_url'] = undefined;

/**
 * State of the issue; either 'open' or 'closed'
 * @member {module:model/Issue2.StateEnum} state
 */
Issue2.prototype['state'] = undefined;

/**
 * @member {String} state_reason
 */
Issue2.prototype['state_reason'] = undefined;

/**
 * @member {String} timeline_url
 */
Issue2.prototype['timeline_url'] = undefined;

/**
 * Title of the issue
 * @member {String} title
 */
Issue2.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
Issue2.prototype['updated_at'] = undefined;

/**
 * URL for the issue
 * @member {String} url
 */
Issue2.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
Issue2.prototype['user'] = undefined;
