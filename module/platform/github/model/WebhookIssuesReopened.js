...
/**
 * The WebhookIssuesReopened model module.
 * @module model/WebhookIssuesReopened
 * @version 1.1.4
 */
class WebhookIssuesReopened {
    /**
     * Constructs a new <code>WebhookIssuesReopened</code>.
     * @alias module:model/WebhookIssuesReopened
     * @param action {module:model/WebhookIssuesReopened.ActionEnum} 
     * @param issue {module:model/Issue8} 
    ...
    constructor(action, issue, repository, sender) { 
        ...
        WebhookIssuesReopened.initialize(this, action, issue, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookIssuesReopened</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookIssuesReopened} obj Optional instance to populate.
     * @return {module:model/WebhookIssuesReopened} The populated <code>WebhookIssuesReopened</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookIssuesReopened();
            ...
            if (data.hasOwnProperty('issue')) {
                obj['issue'] = Issue8.constructFromObject(data['issue']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookIssuesReopened</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookIssuesReopened</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookIssuesReopened.RequiredProperties) {
        ...
        if (data['issue']) { // data not null
          Issue8.validateJSON(data['issue']);
        }
...
WebhookIssuesReopened.RequiredProperties = ["action", "issue", "repository", "sender"];

/**
 * @member {module:model/WebhookIssuesReopened.ActionEnum} action
 */
WebhookIssuesReopened.prototype['action'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookIssuesReopened.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookIssuesReopened.prototype['installation'] = undefined;

/**
 * @member {module:model/Issue8} issue
 */
WebhookIssuesReopened.prototype['issue'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookIssuesReopened.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookIssuesReopened.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookIssuesReopened.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookIssuesReopened['ActionEnum'] = {
...
export default WebhookIssuesReopened;
