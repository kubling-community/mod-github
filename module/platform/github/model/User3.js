...
/**
 * The User3 model module.
 * @module model/User3
 * @version 1.1.4
 */
class User3 {
    /**
     * Constructs a new <code>User3</code>.
     * @alias module:model/User3
     */
    constructor() { 
        
        User3.initialize(this);
    }
    ...
    /**
     * Constructs a <code>User3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/User3} obj Optional instance to populate.
     * @return {module:model/User3} The populated <code>User3</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>User3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>User3</code>.
     */
 ...
 */
User3.prototype['avatar_url'] = undefined;

/**
 * @member {Boolean} deleted
 */
User3.prototype['deleted'] = undefined;

/**
 * @member {String} email
 */
User3.prototype['email'] = undefined;

/**
 * @member {String} events_url
 */
User3.prototype['events_url'] = undefined;

/**
 * @member {String} followers_url
 */
User3.prototype['followers_url'] = undefined;

/**
 * @member {String} following_url
 */
User3.prototype['following_url'] = undefined;

/**
 * @member {String} gists_url
 */
User3.prototype['gists_url'] = undefined;

/**
 * @member {String} gravatar_id
 */
User3.prototype['gravatar_id'] = undefined;

/**
 * @member {String} html_url
 */
User3.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
User3.prototype['id'] = undefined;

/**
 * @member {String} login
 */
User3.prototype['login'] = undefined;

/**
 * @member {String} name
 */
User3.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
User3.prototype['node_id'] = undefined;

/**
 * @member {String} organizations_url
 */
User3.prototype['organizations_url'] = undefined;

/**
 * @member {String} received_events_url
 */
User3.prototype['received_events_url'] = undefined;

/**
 * @member {String} repos_url
 */
User3.prototype['repos_url'] = undefined;

/**
 * @member {Boolean} site_admin
 */
User3.prototype['site_admin'] = undefined;

/**
 * @member {String} starred_url
 */
User3.prototype['starred_url'] = undefined;

/**
 * @member {String} subscriptions_url
 */
User3.prototype['subscriptions_url'] = undefined;

/**
 * @member {module:model/User3.TypeEnum} type
 */
User3.prototype['type'] = undefined;

/**
 * @member {String} url
 */
User3.prototype['url'] = undefined;
