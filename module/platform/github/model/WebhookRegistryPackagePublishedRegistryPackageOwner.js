...
/**
 * The WebhookRegistryPackagePublishedRegistryPackageOwner model module.
 * @module model/WebhookRegistryPackagePublishedRegistryPackageOwner
 * @version 1.1.4
 */
class WebhookRegistryPackagePublishedRegistryPackageOwner {
    /**
     * Constructs a new <code>WebhookRegistryPackagePublishedRegistryPackageOwner</code>.
     * @alias module:model/WebhookRegistryPackagePublishedRegistryPackageOwner
    ...
    constructor(avatarUrl, eventsUrl, followersUrl, followingUrl, gistsUrl, gravatarId, htmlUrl, id, login, nodeId, organizationsUrl, receivedEventsUrl, reposUrl, siteAdmin, starredUrl, subscriptionsUrl, type, url) { 
        ...
        WebhookRegistryPackagePublishedRegistryPackageOwner.initialize(this, avatarUrl, eventsUrl, followersUrl, followingUrl, gistsUrl, gravatarId, htmlUrl, id, login, nodeId, organizationsUrl, receivedEventsUrl, reposUrl, siteAdmin, starredUrl, subscriptionsUrl, type, url);
    }
    ...
    /**
     * Constructs a <code>WebhookRegistryPackagePublishedRegistryPackageOwner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookRegistryPackagePublishedRegistryPackageOwner} obj Optional instance to populate.
     * @return {module:model/WebhookRegistryPackagePublishedRegistryPackageOwner} The populated <code>WebhookRegistryPackagePublishedRegistryPackageOwner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookRegistryPackagePublishedRegistryPackageOwner();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookRegistryPackagePublishedRegistryPackageOwner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookRegistryPackagePublishedRegistryPackageOwner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookRegistryPackagePublishedRegistryPackageOwner.RequiredProperties) {
...
WebhookRegistryPackagePublishedRegistryPackageOwner.RequiredProperties = ["avatar_url", "events_url", "followers_url", "following_url", "gists_url", "gravatar_id", "html_url", "id", "login", "node_id", "organizations_url", "received_events_url", "repos_url", "site_admin", "starred_url", "subscriptions_url", "type", "url"];

/**
 * @member {String} avatar_url
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['avatar_url'] = undefined;

/**
 * @member {String} events_url
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['events_url'] = undefined;

/**
 * @member {String} followers_url
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['followers_url'] = undefined;

/**
 * @member {String} following_url
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['following_url'] = undefined;

/**
 * @member {String} gists_url
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['gists_url'] = undefined;

/**
 * @member {String} gravatar_id
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['gravatar_id'] = undefined;

/**
 * @member {String} html_url
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['id'] = undefined;

/**
 * @member {String} login
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['login'] = undefined;

/**
 * @member {String} node_id
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['node_id'] = undefined;

/**
 * @member {String} organizations_url
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['organizations_url'] = undefined;

/**
 * @member {String} received_events_url
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['received_events_url'] = undefined;

/**
 * @member {String} repos_url
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['repos_url'] = undefined;

/**
 * @member {Boolean} site_admin
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['site_admin'] = undefined;

/**
 * @member {String} starred_url
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['starred_url'] = undefined;

/**
 * @member {String} subscriptions_url
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['subscriptions_url'] = undefined;

/**
 * @member {String} type
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['type'] = undefined;

/**
 * @member {String} url
 */
WebhookRegistryPackagePublishedRegistryPackageOwner.prototype['url'] = undefined;
...
export default WebhookRegistryPackagePublishedRegistryPackageOwner;
