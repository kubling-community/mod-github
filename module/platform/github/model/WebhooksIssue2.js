...
/**
 * The WebhooksIssue2 model module.
 * @module model/WebhooksIssue2
 * @version 1.1.4
 */
class WebhooksIssue2 {
    /**
     * Constructs a new <code>WebhooksIssue2</code>.
     * The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
     * @alias module:model/WebhooksIssue2
     * @param activeLockReason {module:model/WebhooksIssue2.ActiveLockReasonEnum} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/WebhooksIssue2.AuthorAssociationEnum} How the author is associated with the repository.
    ...
    constructor(activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user) { 
        ...
        WebhooksIssue2.initialize(this, activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>WebhooksIssue2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhooksIssue2} obj Optional instance to populate.
     * @return {module:model/WebhooksIssue2} The populated <code>WebhooksIssue2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhooksIssue2();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhooksIssue2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhooksIssue2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhooksIssue2.RequiredProperties) {
...
WebhooksIssue2.RequiredProperties = ["active_lock_reason", "assignees", "author_association", "body", "closed_at", "comments", "comments_url", "created_at", "events_url", "html_url", "id", "labels_url", "milestone", "node_id", "number", "reactions", "repository_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksIssue2.ActiveLockReasonEnum} active_lock_reason
 */
WebhooksIssue2.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User} assignee
 */
WebhooksIssue2.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
WebhooksIssue2.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/WebhooksIssue2.AuthorAssociationEnum} author_association
 */
WebhooksIssue2.prototype['author_association'] = undefined;

/**
 * Contents of the issue
 * @member {String} body
 */
WebhooksIssue2.prototype['body'] = undefined;

/**
 * @member {Date} closed_at
 */
WebhooksIssue2.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
WebhooksIssue2.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
WebhooksIssue2.prototype['comments_url'] = undefined;

/**
 * @member {Date} created_at
 */
WebhooksIssue2.prototype['created_at'] = undefined;

/**
 * @member {Boolean} draft
 */
WebhooksIssue2.prototype['draft'] = undefined;

/**
 * @member {String} events_url
 */
WebhooksIssue2.prototype['events_url'] = undefined;

/**
 * @member {String} html_url
 */
WebhooksIssue2.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhooksIssue2.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
WebhooksIssue2.prototype['labels'] = undefined;

/**
 * @member {String} labels_url
 */
WebhooksIssue2.prototype['labels_url'] = undefined;

/**
 * @member {Boolean} locked
 */
WebhooksIssue2.prototype['locked'] = undefined;

/**
 * @member {module:model/Milestone1} milestone
 */
WebhooksIssue2.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
WebhooksIssue2.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
WebhooksIssue2.prototype['number'] = undefined;

/**
 * @member {module:model/App1} performed_via_github_app
 */
WebhooksIssue2.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/WebhooksIssuePullRequest} pull_request
 */
WebhooksIssue2.prototype['pull_request'] = undefined;

/**
 * @member {module:model/Reactions} reactions
 */
WebhooksIssue2.prototype['reactions'] = undefined;

/**
 * @member {String} repository_url
 */
WebhooksIssue2.prototype['repository_url'] = undefined;

/**
 * State of the issue; either 'open' or 'closed'
 * @member {module:model/WebhooksIssue2.StateEnum} state
 */
WebhooksIssue2.prototype['state'] = undefined;

/**
 * @member {String} state_reason
 */
WebhooksIssue2.prototype['state_reason'] = undefined;

/**
 * @member {String} timeline_url
 */
WebhooksIssue2.prototype['timeline_url'] = undefined;

/**
 * Title of the issue
 * @member {String} title
 */
WebhooksIssue2.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
WebhooksIssue2.prototype['updated_at'] = undefined;

/**
 * URL for the issue
 * @member {String} url
 */
WebhooksIssue2.prototype['url'] = undefined;

/**
 * @member {module:model/User} user
 */
WebhooksIssue2.prototype['user'] = undefined;
 ...
 * @readonly
 */
WebhooksIssue2['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
WebhooksIssue2['AuthorAssociationEnum'] = {
