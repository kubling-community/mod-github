...
/**
 * The AddedToProjectIssueEvent model module.
 * @module model/AddedToProjectIssueEvent
 * @version 1.1.4
 */
class AddedToProjectIssueEvent {
    /**
     * Constructs a new <code>AddedToProjectIssueEvent</code>.
     * Added to Project Issue Event
     * @alias module:model/AddedToProjectIssueEvent
     * @param id {Number} 
     * @param nodeId {String} 
     * @param url {String} 
    ...
    constructor(id, nodeId, url, actor, event, commitId, commitUrl, createdAt, performedViaGithubApp) { 
        ...
        AddedToProjectIssueEvent.initialize(this, id, nodeId, url, actor, event, commitId, commitUrl, createdAt, performedViaGithubApp);
    }
    ...
    /**
     * Constructs a <code>AddedToProjectIssueEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddedToProjectIssueEvent} obj Optional instance to populate.
     * @return {module:model/AddedToProjectIssueEvent} The populated <code>AddedToProjectIssueEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddedToProjectIssueEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>AddedToProjectIssueEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddedToProjectIssueEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddedToProjectIssueEvent.RequiredProperties) {
...
AddedToProjectIssueEvent.RequiredProperties = ["id", "node_id", "url", "actor", "event", "commit_id", "commit_url", "created_at", "performed_via_github_app"];

/**
 * @member {Number} id
 */
AddedToProjectIssueEvent.prototype['id'] = undefined;

/**
 * @member {String} node_id
 */
AddedToProjectIssueEvent.prototype['node_id'] = undefined;

/**
 * @member {String} url
 */
AddedToProjectIssueEvent.prototype['url'] = undefined;

/**
 * @member {module:model/SimpleUser} actor
 */
AddedToProjectIssueEvent.prototype['actor'] = undefined;

/**
 * @member {String} event
 */
AddedToProjectIssueEvent.prototype['event'] = undefined;

/**
 * @member {String} commit_id
 */
AddedToProjectIssueEvent.prototype['commit_id'] = undefined;

/**
 * @member {String} commit_url
 */
AddedToProjectIssueEvent.prototype['commit_url'] = undefined;

/**
 * @member {String} created_at
 */
AddedToProjectIssueEvent.prototype['created_at'] = undefined;

/**
 * @member {module:model/NullableIntegration} performed_via_github_app
 */
AddedToProjectIssueEvent.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/AddedToProjectIssueEventProjectCard} project_card
 */
AddedToProjectIssueEvent.prototype['project_card'] = undefined;
...
export default AddedToProjectIssueEvent;
