...
class Workflow {
     ...
     */
    constructor(id, nodeId, name, path, state, createdAt, updatedAt, url, htmlUrl, badgeUrl) { 
        
        Workflow.initialize(this, id, nodeId, name, path, state, createdAt, updatedAt, url, htmlUrl, badgeUrl);
    }
     ...
     */
    static initialize(obj, id, nodeId, name, path, state, createdAt, updatedAt, url, htmlUrl, badgeUrl) { 
        obj['id'] = id;
        obj['node_id'] = nodeId;
        obj['name'] = name;
        obj['path'] = path;
...
Workflow.RequiredProperties = ["id", "node_id", "name", "path", "state", "created_at", "updated_at", "url", "html_url", "badge_url"];
