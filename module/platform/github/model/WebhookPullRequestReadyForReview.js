...
/**
 * The WebhookPullRequestReadyForReview model module.
 * @module model/WebhookPullRequestReadyForReview
 * @version 1.1.4
 */
class WebhookPullRequestReadyForReview {
    /**
     * Constructs a new <code>WebhookPullRequestReadyForReview</code>.
     * @alias module:model/WebhookPullRequestReadyForReview
     * @param action {module:model/WebhookPullRequestReadyForReview.ActionEnum} 
    ...
    constructor(action, number, pullRequest, repository, sender) { 
        ...
        WebhookPullRequestReadyForReview.initialize(this, action, number, pullRequest, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookPullRequestReadyForReview</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookPullRequestReadyForReview} obj Optional instance to populate.
     * @return {module:model/WebhookPullRequestReadyForReview} The populated <code>WebhookPullRequestReadyForReview</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookPullRequestReadyForReview();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookPullRequestReadyForReview</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookPullRequestReadyForReview</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookPullRequestReadyForReview.RequiredProperties) {
...
WebhookPullRequestReadyForReview.RequiredProperties = ["action", "number", "pull_request", "repository", "sender"];

/**
 * @member {module:model/WebhookPullRequestReadyForReview.ActionEnum} action
 */
WebhookPullRequestReadyForReview.prototype['action'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookPullRequestReadyForReview.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookPullRequestReadyForReview.prototype['installation'] = undefined;

/**
 * The pull request number.
 * @member {Number} number
 */
WebhookPullRequestReadyForReview.prototype['number'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookPullRequestReadyForReview.prototype['organization'] = undefined;

/**
 * @member {module:model/PullRequestWebhook} pull_request
 */
WebhookPullRequestReadyForReview.prototype['pull_request'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookPullRequestReadyForReview.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookPullRequestReadyForReview.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookPullRequestReadyForReview['ActionEnum'] = {
...
export default WebhookPullRequestReadyForReview;
