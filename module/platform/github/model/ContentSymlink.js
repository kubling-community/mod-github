...
class ContentSymlink {
     ...
     */
    constructor(type, target, size, name, path, sha, url, gitUrl, htmlUrl, downloadUrl, links) { 
        
        ContentSymlink.initialize(this, type, target, size, name, path, sha, url, gitUrl, htmlUrl, downloadUrl, links);
    }
     ...
     */
    static initialize(obj, type, target, size, name, path, sha, url, gitUrl, htmlUrl, downloadUrl, links) { 
        obj['type'] = type;
        obj['target'] = target;
        obj['size'] = size;
        obj['name'] = name;
...
ContentSymlink.RequiredProperties = ["type", "target", "size", "name", "path", "sha", "url", "git_url", "html_url", "download_url", "_links"];
