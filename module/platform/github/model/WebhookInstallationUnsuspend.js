...
/**
 * The WebhookInstallationUnsuspend model module.
 * @module model/WebhookInstallationUnsuspend
 * @version 1.1.4
 */
class WebhookInstallationUnsuspend {
    /**
     * Constructs a new <code>WebhookInstallationUnsuspend</code>.
     * @alias module:model/WebhookInstallationUnsuspend
     * @param action {module:model/WebhookInstallationUnsuspend.ActionEnum} 
    ...
    constructor(action, installation, sender) { 
        ...
        WebhookInstallationUnsuspend.initialize(this, action, installation, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookInstallationUnsuspend</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookInstallationUnsuspend} obj Optional instance to populate.
     * @return {module:model/WebhookInstallationUnsuspend} The populated <code>WebhookInstallationUnsuspend</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookInstallationUnsuspend();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookInstallationUnsuspend</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookInstallationUnsuspend</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookInstallationUnsuspend.RequiredProperties) {
...
WebhookInstallationUnsuspend.RequiredProperties = ["action", "installation", "sender"];

/**
 * @member {module:model/WebhookInstallationUnsuspend.ActionEnum} action
 */
WebhookInstallationUnsuspend.prototype['action'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookInstallationUnsuspend.prototype['enterprise'] = undefined;

/**
 * @member {module:model/Installation} installation
 */
WebhookInstallationUnsuspend.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookInstallationUnsuspend.prototype['organization'] = undefined;

/**
 * An array of repository objects that the installation can access.
 * @member {Array.<module:model/WebhooksRepositoriesInner>} repositories
 */
WebhookInstallationUnsuspend.prototype['repositories'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookInstallationUnsuspend.prototype['repository'] = undefined;

/**
 * @member {Object} requester
 */
WebhookInstallationUnsuspend.prototype['requester'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookInstallationUnsuspend.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookInstallationUnsuspend['ActionEnum'] = {
...
export default WebhookInstallationUnsuspend;
