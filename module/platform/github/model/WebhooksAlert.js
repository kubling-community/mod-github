...
/**
 * The WebhooksAlert model module.
 * @module model/WebhooksAlert
 * @version 1.1.4
 */
class WebhooksAlert {
    /**
     * Constructs a new <code>WebhooksAlert</code>.
     * The security alert of the vulnerable dependency.
     * @alias module:model/WebhooksAlert
     ...
     * @param state {module:model/WebhooksAlert.StateEnum} 
     */
    constructor(affectedPackageName, affectedRange, createdAt, externalIdentifier, externalReference, ghsaId, id, nodeId, number, severity, state) { 
        
        WebhooksAlert.initialize(this, affectedPackageName, affectedRange, createdAt, externalIdentifier, externalReference, ghsaId, id, nodeId, number, severity, state);
    }
     ...
     */
    static initialize(obj, affectedPackageName, affectedRange, createdAt, externalIdentifier, externalReference, ghsaId, id, nodeId, number, severity, state) { 
    ...
    /**
     * Constructs a <code>WebhooksAlert</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhooksAlert} obj Optional instance to populate.
     * @return {module:model/WebhooksAlert} The populated <code>WebhooksAlert</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhooksAlert();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhooksAlert</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhooksAlert</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhooksAlert.RequiredProperties) {
...
WebhooksAlert.RequiredProperties = ["affected_package_name", "affected_range", "created_at", "external_identifier", "external_reference", "ghsa_id", "id", "node_id", "number", "severity", "state"];

/**
 * @member {String} affected_package_name
 */
WebhooksAlert.prototype['affected_package_name'] = undefined;

/**
 * @member {String} affected_range
 */
WebhooksAlert.prototype['affected_range'] = undefined;

/**
 * @member {String} created_at
 */
WebhooksAlert.prototype['created_at'] = undefined;

/**
 * @member {String} dismiss_reason
 */
WebhooksAlert.prototype['dismiss_reason'] = undefined;

/**
 * @member {String} dismissed_at
 */
WebhooksAlert.prototype['dismissed_at'] = undefined;

/**
 * @member {module:model/User} dismisser
 */
WebhooksAlert.prototype['dismisser'] = undefined;

/**
 * @member {String} external_identifier
 */
WebhooksAlert.prototype['external_identifier'] = undefined;

/**
 * @member {String} external_reference
 */
WebhooksAlert.prototype['external_reference'] = undefined;

/**
 * @member {String} fix_reason
 */
WebhooksAlert.prototype['fix_reason'] = undefined;

/**
 * @member {Date} fixed_at
 */
WebhooksAlert.prototype['fixed_at'] = undefined;

/**
 * @member {String} fixed_in
 */
WebhooksAlert.prototype['fixed_in'] = undefined;

/**
 * @member {String} ghsa_id
 */
WebhooksAlert.prototype['ghsa_id'] = undefined;

/**
 * @member {Number} id
 */
WebhooksAlert.prototype['id'] = undefined;

/**
 * @member {String} node_id
 */
WebhooksAlert.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
WebhooksAlert.prototype['number'] = undefined;

/**
 * @member {String} severity
 */
WebhooksAlert.prototype['severity'] = undefined;

/**
 * @member {module:model/WebhooksAlert.StateEnum} state
 */
WebhooksAlert.prototype['state'] = undefined;
