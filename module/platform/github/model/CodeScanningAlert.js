...
class CodeScanningAlert {
    ...
    constructor(number, createdAt, url, htmlUrl, instancesUrl, state, dismissedBy, dismissedAt, dismissedReason, rule, tool, mostRecentInstance) { 
        ...
        CodeScanningAlert.initialize(this, number, createdAt, url, htmlUrl, instancesUrl, state, dismissedBy, dismissedAt, dismissedReason, rule, tool, mostRecentInstance);
    }
...
CodeScanningAlert.RequiredProperties = ["number", "created_at", "url", "html_url", "instances_url", "state", "dismissed_by", "dismissed_at", "dismissed_reason", "rule", "tool", "most_recent_instance"];
 ...
 */
CodeScanningAlert.prototype['dismissed_comment'] = undefined;
