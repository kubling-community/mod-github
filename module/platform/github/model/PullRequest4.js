...
/**
 * The PullRequest4 model module.
 * @module model/PullRequest4
 * @version 1.1.4
 */
class PullRequest4 {
    /**
     * Constructs a new <code>PullRequest4</code>.
     * @alias module:model/PullRequest4
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/PullRequest4.ActiveLockReasonEnum} 
     * @param assignee {module:model/User1} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/PullRequest4.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param state {module:model/PullRequest4.StateEnum} State of this Pull Request. Either `open` or `closed`.
    ...
    constructor(links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
        ...
        PullRequest4.initialize(this, links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>PullRequest4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequest4} obj Optional instance to populate.
     * @return {module:model/PullRequest4} The populated <code>PullRequest4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequest4();
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequest4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequest4</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PullRequest4.RequiredProperties) {
...
PullRequest4.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "auto_merge", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "draft", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksPullRequest5Links} _links
 */
PullRequest4.prototype['_links'] = undefined;

/**
 * @member {module:model/PullRequest4.ActiveLockReasonEnum} active_lock_reason
 */
PullRequest4.prototype['active_lock_reason'] = undefined;

/**
 * @member {Number} additions
 */
PullRequest4.prototype['additions'] = undefined;

/**
 * @member {module:model/User1} assignee
 */
PullRequest4.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User1>} assignees
 */
PullRequest4.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/PullRequest4.AuthorAssociationEnum} author_association
 */
PullRequest4.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
PullRequest4.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequestBase} base
 */
PullRequest4.prototype['base'] = undefined;

/**
 * @member {String} body
 */
PullRequest4.prototype['body'] = undefined;

/**
 * @member {Number} changed_files
 */
PullRequest4.prototype['changed_files'] = undefined;

/**
 * @member {Date} closed_at
 */
PullRequest4.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
PullRequest4.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
PullRequest4.prototype['comments_url'] = undefined;

/**
 * @member {Number} commits
 */
PullRequest4.prototype['commits'] = undefined;

/**
 * @member {String} commits_url
 */
PullRequest4.prototype['commits_url'] = undefined;

/**
 * @member {Date} created_at
 */
PullRequest4.prototype['created_at'] = undefined;

/**
 * @member {Number} deletions
 */
PullRequest4.prototype['deletions'] = undefined;

/**
 * @member {String} diff_url
 */
PullRequest4.prototype['diff_url'] = undefined;

/**
 * Indicates whether or not the pull request is a draft.
 * @member {Boolean} draft
 */
PullRequest4.prototype['draft'] = undefined;

/**
 * @member {module:model/PullRequestHead} head
 */
PullRequest4.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
PullRequest4.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
PullRequest4.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
PullRequest4.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
PullRequest4.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
PullRequest4.prototype['locked'] = undefined;

/**
 * Indicates whether maintainers can modify the pull request.
 * @member {Boolean} maintainer_can_modify
 */
PullRequest4.prototype['maintainer_can_modify'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
PullRequest4.prototype['merge_commit_sha'] = undefined;

/**
 * @member {Boolean} mergeable
 */
PullRequest4.prototype['mergeable'] = undefined;

/**
 * @member {String} mergeable_state
 */
PullRequest4.prototype['mergeable_state'] = undefined;

/**
 * @member {Boolean} merged
 */
PullRequest4.prototype['merged'] = undefined;

/**
 * @member {Date} merged_at
 */
PullRequest4.prototype['merged_at'] = undefined;

/**
 * @member {module:model/User1} merged_by
 */
PullRequest4.prototype['merged_by'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
PullRequest4.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
PullRequest4.prototype['node_id'] = undefined;

/**
 * Number uniquely identifying the pull request within its repository.
 * @member {Number} number
 */
PullRequest4.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
PullRequest4.prototype['patch_url'] = undefined;

/**
 * @member {Boolean} rebaseable
 */
PullRequest4.prototype['rebaseable'] = undefined;

/**
 * @member {Array.<module:model/PullRequestRequestedReviewersInner>} requested_reviewers
 */
PullRequest4.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
PullRequest4.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
PullRequest4.prototype['review_comment_url'] = undefined;

/**
 * @member {Number} review_comments
 */
PullRequest4.prototype['review_comments'] = undefined;

/**
 * @member {String} review_comments_url
 */
PullRequest4.prototype['review_comments_url'] = undefined;

/**
 * State of this Pull Request. Either `open` or `closed`.
 * @member {module:model/PullRequest4.StateEnum} state
 */
PullRequest4.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
PullRequest4.prototype['statuses_url'] = undefined;

/**
 * The title of the pull request.
 * @member {String} title
 */
PullRequest4.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
PullRequest4.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
PullRequest4.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
PullRequest4.prototype['user'] = undefined;
 ...
 * @readonly
 */
PullRequest4['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
PullRequest4['AuthorAssociationEnum'] = {
