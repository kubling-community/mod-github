...
import PullRequest11Base from './PullRequest11Base';
...
/**
 * The PullRequest11 model module.
 * @module model/PullRequest11
 * @version 1.1.4
 */
class PullRequest11 {
    /**
     * Constructs a new <code>PullRequest11</code>.
     * @alias module:model/PullRequest11
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/PullRequest11.ActiveLockReasonEnum} 
     * @param assignee {module:model/User1} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/PullRequest11.AuthorAssociationEnum} How the author is associated with the repository.
     * @param autoMerge {module:model/PullRequestAutoMerge} 
     * @param base {module:model/PullRequest11Base} 
     * @param body {String} 
     * @param closedAt {Date} 
     ...
     * @param state {module:model/PullRequest11.StateEnum} State of this Pull Request. Either `open` or `closed`.
    ...
    constructor(links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
        ...
        PullRequest11.initialize(this, links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>PullRequest11</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequest11} obj Optional instance to populate.
     * @return {module:model/PullRequest11} The populated <code>PullRequest11</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequest11();
            ...
            if (data.hasOwnProperty('base')) {
                obj['base'] = PullRequest11Base.constructFromObject(data['base']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequest11</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequest11</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PullRequest11.RequiredProperties) {
        ...
        if (data['base']) { // data not null
          PullRequest11Base.validateJSON(data['base']);
        }
        // ensure the json data is a string
...
PullRequest11.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "auto_merge", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "draft", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksPullRequest5Links} _links
 */
PullRequest11.prototype['_links'] = undefined;

/**
 * @member {module:model/PullRequest11.ActiveLockReasonEnum} active_lock_reason
 */
PullRequest11.prototype['active_lock_reason'] = undefined;

/**
 * @member {Number} additions
 */
PullRequest11.prototype['additions'] = undefined;

/**
 * @member {module:model/User1} assignee
 */
PullRequest11.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User1>} assignees
 */
PullRequest11.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/PullRequest11.AuthorAssociationEnum} author_association
 */
PullRequest11.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
PullRequest11.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequest11Base} base
 */
PullRequest11.prototype['base'] = undefined;

/**
 * @member {String} body
 */
PullRequest11.prototype['body'] = undefined;

/**
 * @member {Number} changed_files
 */
PullRequest11.prototype['changed_files'] = undefined;

/**
 * @member {Date} closed_at
 */
PullRequest11.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
PullRequest11.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
PullRequest11.prototype['comments_url'] = undefined;

/**
 * @member {Number} commits
 */
PullRequest11.prototype['commits'] = undefined;

/**
 * @member {String} commits_url
 */
PullRequest11.prototype['commits_url'] = undefined;

/**
 * @member {Date} created_at
 */
PullRequest11.prototype['created_at'] = undefined;

/**
 * @member {Number} deletions
 */
PullRequest11.prototype['deletions'] = undefined;

/**
 * @member {String} diff_url
 */
PullRequest11.prototype['diff_url'] = undefined;

/**
 * Indicates whether or not the pull request is a draft.
 * @member {Boolean} draft
 */
PullRequest11.prototype['draft'] = undefined;

/**
 * @member {module:model/PullRequestHead} head
 */
PullRequest11.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
PullRequest11.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
PullRequest11.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
PullRequest11.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
PullRequest11.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
PullRequest11.prototype['locked'] = undefined;

/**
 * Indicates whether maintainers can modify the pull request.
 * @member {Boolean} maintainer_can_modify
 */
PullRequest11.prototype['maintainer_can_modify'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
PullRequest11.prototype['merge_commit_sha'] = undefined;

/**
 * @member {Boolean} mergeable
 */
PullRequest11.prototype['mergeable'] = undefined;

/**
 * @member {String} mergeable_state
 */
PullRequest11.prototype['mergeable_state'] = undefined;

/**
 * @member {Boolean} merged
 */
PullRequest11.prototype['merged'] = undefined;

/**
 * @member {Date} merged_at
 */
PullRequest11.prototype['merged_at'] = undefined;

/**
 * @member {module:model/User1} merged_by
 */
PullRequest11.prototype['merged_by'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
PullRequest11.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
PullRequest11.prototype['node_id'] = undefined;

/**
 * Number uniquely identifying the pull request within its repository.
 * @member {Number} number
 */
PullRequest11.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
PullRequest11.prototype['patch_url'] = undefined;

/**
 * @member {Boolean} rebaseable
 */
PullRequest11.prototype['rebaseable'] = undefined;

/**
 * @member {Array.<module:model/PullRequestRequestedReviewersInner>} requested_reviewers
 */
PullRequest11.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
PullRequest11.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
PullRequest11.prototype['review_comment_url'] = undefined;

/**
 * @member {Number} review_comments
 */
PullRequest11.prototype['review_comments'] = undefined;

/**
 * @member {String} review_comments_url
 */
PullRequest11.prototype['review_comments_url'] = undefined;

/**
 * State of this Pull Request. Either `open` or `closed`.
 * @member {module:model/PullRequest11.StateEnum} state
 */
PullRequest11.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
PullRequest11.prototype['statuses_url'] = undefined;

/**
 * The title of the pull request.
 * @member {String} title
 */
PullRequest11.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
PullRequest11.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
PullRequest11.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
PullRequest11.prototype['user'] = undefined;
 ...
 * @readonly
 */
PullRequest11['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
PullRequest11['AuthorAssociationEnum'] = {
