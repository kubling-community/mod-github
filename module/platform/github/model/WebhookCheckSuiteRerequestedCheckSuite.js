...
/**
 * The WebhookCheckSuiteRerequestedCheckSuite model module.
 * @module model/WebhookCheckSuiteRerequestedCheckSuite
 * @version 1.1.4
 */
class WebhookCheckSuiteRerequestedCheckSuite {
    /**
     * Constructs a new <code>WebhookCheckSuiteRerequestedCheckSuite</code>.
     * The [check_suite](https://docs.github.com/rest/checks/suites#get-a-check-suite).
     * @alias module:model/WebhookCheckSuiteRerequestedCheckSuite
     * @param after {String} 
     * @param app {module:model/App4} 
     * @param before {String} 
     * @param checkRunsUrl {String} 
     * @param conclusion {module:model/WebhookCheckSuiteRerequestedCheckSuite.ConclusionEnum} The summary conclusion for all check runs that are part of the check suite. This value will be `null` until the check run has completed.
     ...
     * @param status {module:model/WebhookCheckSuiteRerequestedCheckSuite.StatusEnum} The summary status for all check runs that are part of the check suite. Can be `requested`, `in_progress`, or `completed`.
    ...
    constructor(after, app, before, checkRunsUrl, conclusion, createdAt, headBranch, headCommit, headSha, id, latestCheckRunsCount, nodeId, pullRequests, status, updatedAt, url) { 
        ...
        WebhookCheckSuiteRerequestedCheckSuite.initialize(this, after, app, before, checkRunsUrl, conclusion, createdAt, headBranch, headCommit, headSha, id, latestCheckRunsCount, nodeId, pullRequests, status, updatedAt, url);
    }
    ...
    /**
     * Constructs a <code>WebhookCheckSuiteRerequestedCheckSuite</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookCheckSuiteRerequestedCheckSuite} obj Optional instance to populate.
     * @return {module:model/WebhookCheckSuiteRerequestedCheckSuite} The populated <code>WebhookCheckSuiteRerequestedCheckSuite</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookCheckSuiteRerequestedCheckSuite();

            if (data.hasOwnProperty('after')) {
                obj['after'] = ApiClient.convertToType(data['after'], 'String');
            }
            if (data.hasOwnProperty('app')) {
                obj['app'] = App4.constructFromObject(data['app']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookCheckSuiteRerequestedCheckSuite</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookCheckSuiteRerequestedCheckSuite</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookCheckSuiteRerequestedCheckSuite.RequiredProperties) {
...
WebhookCheckSuiteRerequestedCheckSuite.RequiredProperties = ["after", "app", "before", "check_runs_url", "conclusion", "created_at", "head_branch", "head_commit", "head_sha", "id", "latest_check_runs_count", "node_id", "pull_requests", "status", "updated_at", "url"];

/**
 * @member {String} after
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['after'] = undefined;

/**
 * @member {module:model/App4} app
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['app'] = undefined;

/**
 * @member {String} before
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['before'] = undefined;

/**
 * @member {String} check_runs_url
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['check_runs_url'] = undefined;
 ...
 * @member {module:model/WebhookCheckSuiteRerequestedCheckSuite.ConclusionEnum} conclusion
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['conclusion'] = undefined;

/**
 * @member {Date} created_at
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['created_at'] = undefined;

/**
 * The head branch name the changes are on.
 * @member {String} head_branch
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['head_branch'] = undefined;

/**
 * @member {module:model/SimpleCommit} head_commit
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['head_commit'] = undefined;

/**
 * The SHA of the head commit that is being checked.
 * @member {String} head_sha
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['head_sha'] = undefined;

/**
 * @member {Number} id
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['id'] = undefined;

/**
 * @member {Number} latest_check_runs_count
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['latest_check_runs_count'] = undefined;

/**
 * @member {String} node_id
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['node_id'] = undefined;

/**
 * An array of pull requests that match this check suite. A pull request matches a check suite if they have the same `head_sha` and `head_branch`. When the check suite's `head_branch` is in a forked repository it will be `null` and the `pull_requests` array will be empty.
 * @member {Array.<module:model/CheckRunPullRequest>} pull_requests
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['pull_requests'] = undefined;

/**
 * @member {Boolean} rerequestable
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['rerequestable'] = undefined;

/**
 * @member {Boolean} runs_rerequestable
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['runs_rerequestable'] = undefined;

/**
 * The summary status for all check runs that are part of the check suite. Can be `requested`, `in_progress`, or `completed`.
 * @member {module:model/WebhookCheckSuiteRerequestedCheckSuite.StatusEnum} status
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['status'] = undefined;

/**
 * @member {Date} updated_at
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['updated_at'] = undefined;

/**
 * URL that points to the check suite API resource.
 * @member {String} url
 */
WebhookCheckSuiteRerequestedCheckSuite.prototype['url'] = undefined;
 ...
 * @readonly
 */
WebhookCheckSuiteRerequestedCheckSuite['ConclusionEnum'] = {
 ...
 * @readonly
 */
WebhookCheckSuiteRerequestedCheckSuite['StatusEnum'] = {
...
export default WebhookCheckSuiteRerequestedCheckSuite;
