...
class CommitComment {
     ...
     */
    constructor(htmlUrl, url, id, nodeId, body, path, position, line, commitId, user, createdAt, updatedAt, authorAssociation) { 
        
        CommitComment.initialize(this, htmlUrl, url, id, nodeId, body, path, position, line, commitId, user, createdAt, updatedAt, authorAssociation);
    }
     ...
     */
    static initialize(obj, htmlUrl, url, id, nodeId, body, path, position, line, commitId, user, createdAt, updatedAt, authorAssociation) { 
...
CommitComment.RequiredProperties = ["html_url", "url", "id", "node_id", "body", "path", "position", "line", "commit_id", "user", "created_at", "updated_at", "author_association"];
