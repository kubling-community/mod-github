...
class Enterprise {
    ...
    constructor(htmlUrl, id, nodeId, name, slug, createdAt, updatedAt, avatarUrl) { 
        ...
        Enterprise.initialize(this, htmlUrl, id, nodeId, name, slug, createdAt, updatedAt, avatarUrl);
    }
...
Enterprise.RequiredProperties = ["html_url", "id", "node_id", "name", "slug", "created_at", "updated_at", "avatar_url"];
