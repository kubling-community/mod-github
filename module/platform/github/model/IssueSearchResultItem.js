...
class IssueSearchResultItem {
     ...
     */
    constructor(url, repositoryUrl, labelsUrl, commentsUrl, eventsUrl, htmlUrl, id, nodeId, number, title, locked, user, labels, state, assignee, milestone, comments, createdAt, updatedAt, closedAt, score, authorAssociation) { 
        
        IssueSearchResultItem.initialize(this, url, repositoryUrl, labelsUrl, commentsUrl, eventsUrl, htmlUrl, id, nodeId, number, title, locked, user, labels, state, assignee, milestone, comments, createdAt, updatedAt, closedAt, score, authorAssociation);
    }
     ...
     */
    static initialize(obj, url, repositoryUrl, labelsUrl, commentsUrl, eventsUrl, htmlUrl, id, nodeId, number, title, locked, user, labels, state, assignee, milestone, comments, createdAt, updatedAt, closedAt, score, authorAssociation) { 
        obj['url'] = url;
...
IssueSearchResultItem.RequiredProperties = ["url", "repository_url", "labels_url", "comments_url", "events_url", "html_url", "id", "node_id", "number", "title", "locked", "user", "labels", "state", "assignee", "milestone", "comments", "created_at", "updated_at", "closed_at", "score", "author_association"];
 ...
 */
IssueSearchResultItem.prototype['state_reason'] = undefined;
