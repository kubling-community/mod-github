...
/**
 * The RepositoryRuleDetailedOneOf4 model module.
 * @module model/RepositoryRuleDetailedOneOf4
 * @version 1.1.4
 */
class RepositoryRuleDetailedOneOf4 {
    /**
     * Constructs a new <code>RepositoryRuleDetailedOneOf4</code>.
     * @alias module:model/RepositoryRuleDetailedOneOf4
     * @implements module:model/RepositoryRuleRequiredDeployments
     * @implements module:model/RepositoryRuleRulesetInfo
     * @param type {module:model/RepositoryRuleDetailedOneOf4.TypeEnum} 
     */
    constructor(type) { 
        RepositoryRuleRequiredDeployments.initialize(this, type);RepositoryRuleRulesetInfo.initialize(this);
        RepositoryRuleDetailedOneOf4.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>RepositoryRuleDetailedOneOf4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryRuleDetailedOneOf4} obj Optional instance to populate.
     * @return {module:model/RepositoryRuleDetailedOneOf4} The populated <code>RepositoryRuleDetailedOneOf4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryRuleDetailedOneOf4();
            RepositoryRuleRequiredDeployments.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryRuleDetailedOneOf4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryRuleDetailedOneOf4</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RepositoryRuleDetailedOneOf4.RequiredProperties) {
...
RepositoryRuleDetailedOneOf4.RequiredProperties = ["type"];

/**
 * @member {module:model/RepositoryRuleDetailedOneOf4.TypeEnum} type
 */
RepositoryRuleDetailedOneOf4.prototype['type'] = undefined;

/**
 * @member {module:model/RepositoryRuleRequiredDeploymentsParameters} parameters
 */
RepositoryRuleDetailedOneOf4.prototype['parameters'] = undefined;

/**
 * The type of source for the ruleset that includes this rule.
 * @member {module:model/RepositoryRuleDetailedOneOf4.RulesetSourceTypeEnum} ruleset_source_type
 */
RepositoryRuleDetailedOneOf4.prototype['ruleset_source_type'] = undefined;

/**
 * The name of the source of the ruleset that includes this rule.
 * @member {String} ruleset_source
 */
RepositoryRuleDetailedOneOf4.prototype['ruleset_source'] = undefined;

/**
 * The ID of the ruleset that includes this rule.
 * @member {Number} ruleset_id
 */
RepositoryRuleDetailedOneOf4.prototype['ruleset_id'] = undefined;


// Implement RepositoryRuleRequiredDeployments interface:
/**
 ...
 * @readonly
 */
RepositoryRuleDetailedOneOf4['TypeEnum'] = {
 ...
 * @readonly
 */
RepositoryRuleDetailedOneOf4['RulesetSourceTypeEnum'] = {
...
export default RepositoryRuleDetailedOneOf4;
