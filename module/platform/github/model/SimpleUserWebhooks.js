...
/**
 * The SimpleUserWebhooks model module.
 * @module model/SimpleUserWebhooks
 * @version 1.1.4
 */
class SimpleUserWebhooks {
    /**
     * Constructs a new <code>SimpleUserWebhooks</code>.
     * The GitHub user that triggered the event. This property is included in every webhook payload.
     * @alias module:model/SimpleUserWebhooks
     * @param login {String} 
     * @param id {Number} 
     * @param nodeId {String} 
    ...
    constructor(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl, followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl, organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin) { 
        ...
        SimpleUserWebhooks.initialize(this, login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl, followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl, organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin);
    }
    ...
    /**
     * Constructs a <code>SimpleUserWebhooks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimpleUserWebhooks} obj Optional instance to populate.
     * @return {module:model/SimpleUserWebhooks} The populated <code>SimpleUserWebhooks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimpleUserWebhooks();
    ...
    /**
     * Validates the JSON data with respect to <code>SimpleUserWebhooks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimpleUserWebhooks</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SimpleUserWebhooks.RequiredProperties) {
...
SimpleUserWebhooks.RequiredProperties = ["login", "id", "node_id", "avatar_url", "gravatar_id", "url", "html_url", "followers_url", "following_url", "gists_url", "starred_url", "subscriptions_url", "organizations_url", "repos_url", "events_url", "received_events_url", "type", "site_admin"];

/**
 * @member {String} name
 */
SimpleUserWebhooks.prototype['name'] = undefined;

/**
 * @member {String} email
 */
SimpleUserWebhooks.prototype['email'] = undefined;

/**
 * @member {String} login
 */
SimpleUserWebhooks.prototype['login'] = undefined;

/**
 * @member {Number} id
 */
SimpleUserWebhooks.prototype['id'] = undefined;

/**
 * @member {String} node_id
 */
SimpleUserWebhooks.prototype['node_id'] = undefined;

/**
 * @member {String} avatar_url
 */
SimpleUserWebhooks.prototype['avatar_url'] = undefined;

/**
 * @member {String} gravatar_id
 */
SimpleUserWebhooks.prototype['gravatar_id'] = undefined;

/**
 * @member {String} url
 */
SimpleUserWebhooks.prototype['url'] = undefined;

/**
 * @member {String} html_url
 */
SimpleUserWebhooks.prototype['html_url'] = undefined;

/**
 * @member {String} followers_url
 */
SimpleUserWebhooks.prototype['followers_url'] = undefined;

/**
 * @member {String} following_url
 */
SimpleUserWebhooks.prototype['following_url'] = undefined;

/**
 * @member {String} gists_url
 */
SimpleUserWebhooks.prototype['gists_url'] = undefined;

/**
 * @member {String} starred_url
 */
SimpleUserWebhooks.prototype['starred_url'] = undefined;

/**
 * @member {String} subscriptions_url
 */
SimpleUserWebhooks.prototype['subscriptions_url'] = undefined;

/**
 * @member {String} organizations_url
 */
SimpleUserWebhooks.prototype['organizations_url'] = undefined;

/**
 * @member {String} repos_url
 */
SimpleUserWebhooks.prototype['repos_url'] = undefined;

/**
 * @member {String} events_url
 */
SimpleUserWebhooks.prototype['events_url'] = undefined;

/**
 * @member {String} received_events_url
 */
SimpleUserWebhooks.prototype['received_events_url'] = undefined;

/**
 * @member {String} type
 */
SimpleUserWebhooks.prototype['type'] = undefined;

/**
 * @member {Boolean} site_admin
 */
SimpleUserWebhooks.prototype['site_admin'] = undefined;

/**
 * @member {String} starred_at
 */
SimpleUserWebhooks.prototype['starred_at'] = undefined;
...
export default SimpleUserWebhooks;
