...
import PullRequest1Base from './PullRequest1Base';
...
/**
 * The PullRequest1 model module.
 * @module model/PullRequest1
 * @version 1.1.4
 */
class PullRequest1 {
    /**
     * Constructs a new <code>PullRequest1</code>.
     * @alias module:model/PullRequest1
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/PullRequest1.ActiveLockReasonEnum} 
     * @param assignee {module:model/User} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/PullRequest1.AuthorAssociationEnum} How the author is associated with the repository.
     * @param autoMerge {module:model/PullRequestAutoMerge} 
     * @param base {module:model/PullRequest1Base} 
     * @param body {String} 
     * @param closedAt {Date} 
     ...
     * @param state {module:model/PullRequest1.StateEnum} State of this Pull Request. Either `open` or `closed`.
    ...
    constructor(links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
        ...
        PullRequest1.initialize(this, links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>PullRequest1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequest1} obj Optional instance to populate.
     * @return {module:model/PullRequest1} The populated <code>PullRequest1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequest1();
            ...
            if (data.hasOwnProperty('base')) {
                obj['base'] = PullRequest1Base.constructFromObject(data['base']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequest1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequest1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PullRequest1.RequiredProperties) {
        ...
        if (data['base']) { // data not null
          PullRequest1Base.validateJSON(data['base']);
        }
        // ensure the json data is a string
...
PullRequest1.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "auto_merge", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "draft", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksPullRequest5Links} _links
 */
PullRequest1.prototype['_links'] = undefined;

/**
 * @member {module:model/PullRequest1.ActiveLockReasonEnum} active_lock_reason
 */
PullRequest1.prototype['active_lock_reason'] = undefined;

/**
 * @member {Number} additions
 */
PullRequest1.prototype['additions'] = undefined;

/**
 * @member {module:model/User} assignee
 */
PullRequest1.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
PullRequest1.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/PullRequest1.AuthorAssociationEnum} author_association
 */
PullRequest1.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
PullRequest1.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequest1Base} base
 */
PullRequest1.prototype['base'] = undefined;

/**
 * @member {String} body
 */
PullRequest1.prototype['body'] = undefined;

/**
 * @member {Number} changed_files
 */
PullRequest1.prototype['changed_files'] = undefined;

/**
 * @member {Date} closed_at
 */
PullRequest1.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
PullRequest1.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
PullRequest1.prototype['comments_url'] = undefined;

/**
 * @member {Number} commits
 */
PullRequest1.prototype['commits'] = undefined;

/**
 * @member {String} commits_url
 */
PullRequest1.prototype['commits_url'] = undefined;

/**
 * @member {Date} created_at
 */
PullRequest1.prototype['created_at'] = undefined;

/**
 * @member {Number} deletions
 */
PullRequest1.prototype['deletions'] = undefined;

/**
 * @member {String} diff_url
 */
PullRequest1.prototype['diff_url'] = undefined;

/**
 * Indicates whether or not the pull request is a draft.
 * @member {Boolean} draft
 */
PullRequest1.prototype['draft'] = undefined;

/**
 * @member {module:model/PullRequestBase} head
 */
PullRequest1.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
PullRequest1.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
PullRequest1.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
PullRequest1.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
PullRequest1.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
PullRequest1.prototype['locked'] = undefined;

/**
 * Indicates whether maintainers can modify the pull request.
 * @member {Boolean} maintainer_can_modify
 */
PullRequest1.prototype['maintainer_can_modify'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
PullRequest1.prototype['merge_commit_sha'] = undefined;

/**
 * @member {Boolean} mergeable
 */
PullRequest1.prototype['mergeable'] = undefined;

/**
 * @member {String} mergeable_state
 */
PullRequest1.prototype['mergeable_state'] = undefined;

/**
 * @member {Boolean} merged
 */
PullRequest1.prototype['merged'] = undefined;

/**
 * @member {Date} merged_at
 */
PullRequest1.prototype['merged_at'] = undefined;

/**
 * @member {module:model/User} merged_by
 */
PullRequest1.prototype['merged_by'] = undefined;

/**
 * @member {module:model/Milestone1} milestone
 */
PullRequest1.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
PullRequest1.prototype['node_id'] = undefined;

/**
 * Number uniquely identifying the pull request within its repository.
 * @member {Number} number
 */
PullRequest1.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
PullRequest1.prototype['patch_url'] = undefined;

/**
 * @member {Boolean} rebaseable
 */
PullRequest1.prototype['rebaseable'] = undefined;

/**
 * @member {Array.<module:model/PullRequestRequestedReviewersInner>} requested_reviewers
 */
PullRequest1.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
PullRequest1.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
PullRequest1.prototype['review_comment_url'] = undefined;

/**
 * @member {Number} review_comments
 */
PullRequest1.prototype['review_comments'] = undefined;

/**
 * @member {String} review_comments_url
 */
PullRequest1.prototype['review_comments_url'] = undefined;

/**
 * State of this Pull Request. Either `open` or `closed`.
 * @member {module:model/PullRequest1.StateEnum} state
 */
PullRequest1.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
PullRequest1.prototype['statuses_url'] = undefined;

/**
 * The title of the pull request.
 * @member {String} title
 */
PullRequest1.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
PullRequest1.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
PullRequest1.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
PullRequest1.prototype['user'] = undefined;
 ...
 * @readonly
 */
PullRequest1['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
PullRequest1['AuthorAssociationEnum'] = {
