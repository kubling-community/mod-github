...
import PullRequest6Base from './PullRequest6Base';
...
/**
 * The PullRequest6 model module.
 * @module model/PullRequest6
 * @version 1.1.4
 */
class PullRequest6 {
    /**
     * Constructs a new <code>PullRequest6</code>.
     * @alias module:model/PullRequest6
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/PullRequest6.ActiveLockReasonEnum} 
     * @param assignee {module:model/User} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/PullRequest6.AuthorAssociationEnum} How the author is associated with the repository.
     * @param autoMerge {module:model/PullRequestAutoMerge} 
     * @param base {module:model/PullRequest6Base} 
     * @param body {String} 
     * @param closedAt {Date} 
     ...
     * @param requestedTeams {Array.<module:model/Team1>} 
     * @param reviewCommentUrl {String} 
     * @param reviewCommentsUrl {String} 
     * @param state {module:model/PullRequest6.StateEnum} State of this Pull Request. Either `open` or `closed`.
    ...
    /**
     * Constructs a <code>PullRequest6</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequest6} obj Optional instance to populate.
     * @return {module:model/PullRequest6} The populated <code>PullRequest6</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequest6();
            ...
            if (data.hasOwnProperty('base')) {
                obj['base'] = PullRequest6Base.constructFromObject(data['base']);
            }
            ...
            if (data.hasOwnProperty('requested_teams')) {
                obj['requested_teams'] = ApiClient.convertToType(data['requested_teams'], [Team1]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequest6</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequest6</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PullRequest6.RequiredProperties) {
        ...
        if (data['base']) { // data not null
          PullRequest6Base.validateJSON(data['base']);
        }
        // ensure the json data is a string
 ...
 */
PullRequest6.prototype['_links'] = undefined;

/**
 * @member {module:model/PullRequest6.ActiveLockReasonEnum} active_lock_reason
 */
PullRequest6.prototype['active_lock_reason'] = undefined;

/**
 * @member {Number} additions
 */
PullRequest6.prototype['additions'] = undefined;

/**
 * @member {module:model/User} assignee
 */
PullRequest6.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
PullRequest6.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/PullRequest6.AuthorAssociationEnum} author_association
 */
PullRequest6.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
PullRequest6.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/PullRequest6Base} base
 */
PullRequest6.prototype['base'] = undefined;

/**
 * @member {String} body
 */
PullRequest6.prototype['body'] = undefined;

/**
 * @member {Number} changed_files
 */
PullRequest6.prototype['changed_files'] = undefined;

/**
 * @member {Date} closed_at
 */
PullRequest6.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
PullRequest6.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
PullRequest6.prototype['comments_url'] = undefined;

/**
 * @member {Number} commits
 */
PullRequest6.prototype['commits'] = undefined;

/**
 * @member {String} commits_url
 */
PullRequest6.prototype['commits_url'] = undefined;

/**
 * @member {Date} created_at
 */
PullRequest6.prototype['created_at'] = undefined;

/**
 * @member {Number} deletions
 */
PullRequest6.prototype['deletions'] = undefined;

/**
 * @member {String} diff_url
 */
PullRequest6.prototype['diff_url'] = undefined;

/**
 * Indicates whether or not the pull request is a draft.
 * @member {Boolean} draft
 */
PullRequest6.prototype['draft'] = undefined;

/**
 * @member {module:model/PullRequestBase} head
 */
PullRequest6.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
PullRequest6.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
PullRequest6.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
PullRequest6.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
PullRequest6.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
PullRequest6.prototype['locked'] = undefined;

/**
 * Indicates whether maintainers can modify the pull request.
 * @member {Boolean} maintainer_can_modify
 */
PullRequest6.prototype['maintainer_can_modify'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
PullRequest6.prototype['merge_commit_sha'] = undefined;

/**
 * @member {Boolean} mergeable
 */
PullRequest6.prototype['mergeable'] = undefined;

/**
 * @member {String} mergeable_state
 */
PullRequest6.prototype['mergeable_state'] = undefined;

/**
 * @member {Boolean} merged
 */
PullRequest6.prototype['merged'] = undefined;

/**
 * @member {Date} merged_at
 */
PullRequest6.prototype['merged_at'] = undefined;

/**
 * @member {module:model/User} merged_by
 */
PullRequest6.prototype['merged_by'] = undefined;

/**
 * @member {module:model/Milestone1} milestone
 */
PullRequest6.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
PullRequest6.prototype['node_id'] = undefined;

/**
 * Number uniquely identifying the pull request within its repository.
 * @member {Number} number
 */
PullRequest6.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
PullRequest6.prototype['patch_url'] = undefined;

/**
 * @member {Boolean} rebaseable
 */
PullRequest6.prototype['rebaseable'] = undefined;

/**
 * @member {Array.<module:model/PullRequest6RequestedReviewersInner>} requested_reviewers
 */
PullRequest6.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team1>} requested_teams
 */
PullRequest6.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
PullRequest6.prototype['review_comment_url'] = undefined;

/**
 * @member {Number} review_comments
 */
PullRequest6.prototype['review_comments'] = undefined;

/**
 * @member {String} review_comments_url
 */
PullRequest6.prototype['review_comments_url'] = undefined;

/**
 * State of this Pull Request. Either `open` or `closed`.
 * @member {module:model/PullRequest6.StateEnum} state
 */
PullRequest6.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
PullRequest6.prototype['statuses_url'] = undefined;

/**
 * The title of the pull request.
 * @member {String} title
 */
PullRequest6.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
PullRequest6.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
PullRequest6.prototype['url'] = undefined;

/**
 * @member {module:model/User} user
 */
PullRequest6.prototype['user'] = undefined;
 ...
 * @readonly
 */
PullRequest6['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
PullRequest6['AuthorAssociationEnum'] = {
