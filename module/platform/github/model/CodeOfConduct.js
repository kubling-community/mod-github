...
class CodeOfConduct {
     ...
     */
    constructor(key, name, url, htmlUrl) { 
        
        CodeOfConduct.initialize(this, key, name, url, htmlUrl);
    }
     ...
     */
    static initialize(obj, key, name, url, htmlUrl) { 
        obj['key'] = key;
        obj['name'] = name;
        obj['url'] = url;
...
CodeOfConduct.RequiredProperties = ["key", "name", "url", "html_url"];
