...
class TeamMembership {
     ...
     */
    constructor(url, role, state) { 
        
        TeamMembership.initialize(this, url, role, state);
    }
     ...
     */
    static initialize(obj, url, role, state) { 
        obj['url'] = url;
...
TeamMembership.RequiredProperties = ["url", "role", "state"];
