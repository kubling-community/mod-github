...
/**
 * The WebhookDependabotAlertDismissed model module.
 * @module model/WebhookDependabotAlertDismissed
 * @version 1.1.4
 */
class WebhookDependabotAlertDismissed {
    /**
     * Constructs a new <code>WebhookDependabotAlertDismissed</code>.
     * @alias module:model/WebhookDependabotAlertDismissed
     * @param action {module:model/WebhookDependabotAlertDismissed.ActionEnum} 
    ...
    constructor(action, alert, repository, sender) { 
        ...
        WebhookDependabotAlertDismissed.initialize(this, action, alert, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookDependabotAlertDismissed</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookDependabotAlertDismissed} obj Optional instance to populate.
     * @return {module:model/WebhookDependabotAlertDismissed} The populated <code>WebhookDependabotAlertDismissed</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookDependabotAlertDismissed();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDependabotAlertDismissed</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDependabotAlertDismissed</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookDependabotAlertDismissed.RequiredProperties) {
...
WebhookDependabotAlertDismissed.RequiredProperties = ["action", "alert", "repository", "sender"];

/**
 * @member {module:model/WebhookDependabotAlertDismissed.ActionEnum} action
 */
WebhookDependabotAlertDismissed.prototype['action'] = undefined;

/**
 * @member {module:model/DependabotAlert} alert
 */
WebhookDependabotAlertDismissed.prototype['alert'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookDependabotAlertDismissed.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookDependabotAlertDismissed.prototype['organization'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookDependabotAlertDismissed.prototype['enterprise'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookDependabotAlertDismissed.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookDependabotAlertDismissed.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookDependabotAlertDismissed['ActionEnum'] = {
...
export default WebhookDependabotAlertDismissed;
