...
/**
 * The WebhookMarketplacePurchasePurchased model module.
 * @module model/WebhookMarketplacePurchasePurchased
 * @version 1.1.4
 */
class WebhookMarketplacePurchasePurchased {
    /**
     * Constructs a new <code>WebhookMarketplacePurchasePurchased</code>.
     * @alias module:model/WebhookMarketplacePurchasePurchased
     * @param action {module:model/WebhookMarketplacePurchasePurchased.ActionEnum} 
    ...
    constructor(action, effectiveDate, marketplacePurchase, sender) { 
        ...
        WebhookMarketplacePurchasePurchased.initialize(this, action, effectiveDate, marketplacePurchase, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookMarketplacePurchasePurchased</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookMarketplacePurchasePurchased} obj Optional instance to populate.
     * @return {module:model/WebhookMarketplacePurchasePurchased} The populated <code>WebhookMarketplacePurchasePurchased</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookMarketplacePurchasePurchased();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookMarketplacePurchasePurchased</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookMarketplacePurchasePurchased</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookMarketplacePurchasePurchased.RequiredProperties) {
...
WebhookMarketplacePurchasePurchased.RequiredProperties = ["action", "effective_date", "marketplace_purchase", "sender"];

/**
 * @member {module:model/WebhookMarketplacePurchasePurchased.ActionEnum} action
 */
WebhookMarketplacePurchasePurchased.prototype['action'] = undefined;

/**
 * @member {String} effective_date
 */
WebhookMarketplacePurchasePurchased.prototype['effective_date'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookMarketplacePurchasePurchased.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookMarketplacePurchasePurchased.prototype['installation'] = undefined;

/**
 * @member {module:model/WebhooksMarketplacePurchase} marketplace_purchase
 */
WebhookMarketplacePurchasePurchased.prototype['marketplace_purchase'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookMarketplacePurchasePurchased.prototype['organization'] = undefined;

/**
 * @member {module:model/WebhooksPreviousMarketplacePurchase} previous_marketplace_purchase
 */
WebhookMarketplacePurchasePurchased.prototype['previous_marketplace_purchase'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookMarketplacePurchasePurchased.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookMarketplacePurchasePurchased.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookMarketplacePurchasePurchased['ActionEnum'] = {
...
export default WebhookMarketplacePurchasePurchased;
