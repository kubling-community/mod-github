...
class CheckAnnotation {
     ...
     */
    constructor(path, startLine, endLine, startColumn, endColumn, annotationLevel, title, message, rawDetails, blobHref) { 
        
        CheckAnnotation.initialize(this, path, startLine, endLine, startColumn, endColumn, annotationLevel, title, message, rawDetails, blobHref);
    }
     ...
     */
    static initialize(obj, path, startLine, endLine, startColumn, endColumn, annotationLevel, title, message, rawDetails, blobHref) { 
        obj['path'] = path;
...
CheckAnnotation.RequiredProperties = ["path", "start_line", "end_line", "start_column", "end_column", "annotation_level", "title", "message", "raw_details", "blob_href"];
