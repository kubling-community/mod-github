...
class ReposUpdateBranchProtectionRequest {
     ...
     */
    constructor(requiredStatusChecks, enforceAdmins, requiredPullRequestReviews, restrictions) { 
        
        ReposUpdateBranchProtectionRequest.initialize(this, requiredStatusChecks, enforceAdmins, requiredPullRequestReviews, restrictions);
    }
     ...
     */
    static initialize(obj, requiredStatusChecks, enforceAdmins, requiredPullRequestReviews, restrictions) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('lock_branch')) {
                obj['lock_branch'] = ApiClient.convertToType(data['lock_branch'], 'Boolean');
            }
            if (data.hasOwnProperty('allow_fork_syncing')) {
                obj['allow_fork_syncing'] = ApiClient.convertToType(data['allow_fork_syncing'], 'Boolean');
            }
        }
        return obj;
    }
...
ReposUpdateBranchProtectionRequest.RequiredProperties = ["required_status_checks", "enforce_admins", "required_pull_request_reviews", "restrictions"];
 ...
 * @member {Boolean} lock_branch
 * @default false
 */
ReposUpdateBranchProtectionRequest.prototype['lock_branch'] = false;

/**
 * Whether users can pull changes from upstream when the branch is locked. Set to `true` to allow fork syncing. Set to `false` to prevent fork syncing. Default: `false`.
 * @member {Boolean} allow_fork_syncing
 * @default false
 */
ReposUpdateBranchProtectionRequest.prototype['allow_fork_syncing'] = false;
