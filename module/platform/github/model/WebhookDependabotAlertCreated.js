...
/**
 * The WebhookDependabotAlertCreated model module.
 * @module model/WebhookDependabotAlertCreated
 * @version 1.1.4
 */
class WebhookDependabotAlertCreated {
    /**
     * Constructs a new <code>WebhookDependabotAlertCreated</code>.
     * @alias module:model/WebhookDependabotAlertCreated
     * @param action {module:model/WebhookDependabotAlertCreated.ActionEnum} 
    ...
    constructor(action, alert, repository, sender) { 
        ...
        WebhookDependabotAlertCreated.initialize(this, action, alert, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookDependabotAlertCreated</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookDependabotAlertCreated} obj Optional instance to populate.
     * @return {module:model/WebhookDependabotAlertCreated} The populated <code>WebhookDependabotAlertCreated</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookDependabotAlertCreated();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDependabotAlertCreated</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDependabotAlertCreated</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookDependabotAlertCreated.RequiredProperties) {
...
WebhookDependabotAlertCreated.RequiredProperties = ["action", "alert", "repository", "sender"];

/**
 * @member {module:model/WebhookDependabotAlertCreated.ActionEnum} action
 */
WebhookDependabotAlertCreated.prototype['action'] = undefined;

/**
 * @member {module:model/DependabotAlert} alert
 */
WebhookDependabotAlertCreated.prototype['alert'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookDependabotAlertCreated.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookDependabotAlertCreated.prototype['organization'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookDependabotAlertCreated.prototype['enterprise'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookDependabotAlertCreated.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookDependabotAlertCreated.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookDependabotAlertCreated['ActionEnum'] = {
...
export default WebhookDependabotAlertCreated;
