...
import RepositoryLite1 from './RepositoryLite1';
import SimpleCommit from './SimpleCommit';
import User from './User';
import WorkflowRunPullRequestsInner from './WorkflowRunPullRequestsInner';

/**
 * The WorkflowRun1 model module.
 * @module model/WorkflowRun1
 * @version 1.1.4
 */
class WorkflowRun1 {
    /**
     * Constructs a new <code>WorkflowRun1</code>.
     * @alias module:model/WorkflowRun1
     ...
     * @param conclusion {module:model/WorkflowRun1.ConclusionEnum} 
     * @param createdAt {Date} 
     * @param event {String} 
     * @param headBranch {String} 
     * @param headCommit {module:model/SimpleCommit} 
     * @param headRepository {module:model/RepositoryLite1} 
     ...
     * @param status {module:model/WorkflowRun1.StatusEnum} 
    ...
    constructor(actor, artifactsUrl, cancelUrl, checkSuiteId, checkSuiteNodeId, checkSuiteUrl, conclusion, createdAt, event, headBranch, headCommit, headRepository, headSha, htmlUrl, id, jobsUrl, logsUrl, name, nodeId, path, previousAttemptUrl, pullRequests, repository, rerunUrl, runAttempt, runNumber, runStartedAt, status, triggeringActor, updatedAt, url, workflowId, workflowUrl) { 
        ...
        WorkflowRun1.initialize(this, actor, artifactsUrl, cancelUrl, checkSuiteId, checkSuiteNodeId, checkSuiteUrl, conclusion, createdAt, event, headBranch, headCommit, headRepository, headSha, htmlUrl, id, jobsUrl, logsUrl, name, nodeId, path, previousAttemptUrl, pullRequests, repository, rerunUrl, runAttempt, runNumber, runStartedAt, status, triggeringActor, updatedAt, url, workflowId, workflowUrl);
    }
    ...
    /**
     * Constructs a <code>WorkflowRun1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WorkflowRun1} obj Optional instance to populate.
     * @return {module:model/WorkflowRun1} The populated <code>WorkflowRun1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkflowRun1();
            ...
            if (data.hasOwnProperty('head_repository')) {
                obj['head_repository'] = RepositoryLite1.constructFromObject(data['head_repository']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WorkflowRun1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorkflowRun1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WorkflowRun1.RequiredProperties) {
        ...
        if (data['head_repository']) { // data not null
          RepositoryLite1.validateJSON(data['head_repository']);
        }
        // ensure the json data is a string
...
WorkflowRun1.RequiredProperties = ["actor", "artifacts_url", "cancel_url", "check_suite_id", "check_suite_node_id", "check_suite_url", "conclusion", "created_at", "event", "head_branch", "head_commit", "head_repository", "head_sha", "html_url", "id", "jobs_url", "logs_url", "name", "node_id", "path", "previous_attempt_url", "pull_requests", "repository", "rerun_url", "run_attempt", "run_number", "run_started_at", "status", "triggering_actor", "updated_at", "url", "workflow_id", "workflow_url"];

/**
 * @member {module:model/User} actor
 */
WorkflowRun1.prototype['actor'] = undefined;

/**
 * @member {String} artifacts_url
 */
WorkflowRun1.prototype['artifacts_url'] = undefined;

/**
 * @member {String} cancel_url
 */
WorkflowRun1.prototype['cancel_url'] = undefined;

/**
 * @member {Number} check_suite_id
 */
WorkflowRun1.prototype['check_suite_id'] = undefined;

/**
 * @member {String} check_suite_node_id
 */
WorkflowRun1.prototype['check_suite_node_id'] = undefined;

/**
 * @member {String} check_suite_url
 */
WorkflowRun1.prototype['check_suite_url'] = undefined;

/**
 * @member {module:model/WorkflowRun1.ConclusionEnum} conclusion
 */
WorkflowRun1.prototype['conclusion'] = undefined;

/**
 * @member {Date} created_at
 */
WorkflowRun1.prototype['created_at'] = undefined;

/**
 * @member {String} event
 */
WorkflowRun1.prototype['event'] = undefined;

/**
 * @member {String} head_branch
 */
WorkflowRun1.prototype['head_branch'] = undefined;

/**
 * @member {module:model/SimpleCommit} head_commit
 */
WorkflowRun1.prototype['head_commit'] = undefined;

/**
 * @member {module:model/RepositoryLite1} head_repository
 */
WorkflowRun1.prototype['head_repository'] = undefined;

/**
 * @member {String} head_sha
 */
WorkflowRun1.prototype['head_sha'] = undefined;

/**
 * @member {String} html_url
 */
WorkflowRun1.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WorkflowRun1.prototype['id'] = undefined;

/**
 * @member {String} jobs_url
 */
WorkflowRun1.prototype['jobs_url'] = undefined;

/**
 * @member {String} logs_url
 */
WorkflowRun1.prototype['logs_url'] = undefined;

/**
 * @member {String} name
 */
WorkflowRun1.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
WorkflowRun1.prototype['node_id'] = undefined;

/**
 * @member {String} path
 */
WorkflowRun1.prototype['path'] = undefined;

/**
 * @member {String} previous_attempt_url
 */
WorkflowRun1.prototype['previous_attempt_url'] = undefined;

/**
 * @member {Array.<module:model/WorkflowRunPullRequestsInner>} pull_requests
 */
WorkflowRun1.prototype['pull_requests'] = undefined;

/**
 * @member {Array.<module:model/DeploymentWorkflowRunReferencedWorkflowsInner>} referenced_workflows
 */
WorkflowRun1.prototype['referenced_workflows'] = undefined;

/**
 * @member {module:model/RepositoryLite} repository
 */
WorkflowRun1.prototype['repository'] = undefined;

/**
 * @member {String} rerun_url
 */
WorkflowRun1.prototype['rerun_url'] = undefined;

/**
 * @member {Number} run_attempt
 */
WorkflowRun1.prototype['run_attempt'] = undefined;

/**
 * @member {Number} run_number
 */
WorkflowRun1.prototype['run_number'] = undefined;

/**
 * @member {Date} run_started_at
 */
WorkflowRun1.prototype['run_started_at'] = undefined;

/**
 * @member {module:model/WorkflowRun1.StatusEnum} status
 */
WorkflowRun1.prototype['status'] = undefined;

/**
 * @member {module:model/User} triggering_actor
 */
WorkflowRun1.prototype['triggering_actor'] = undefined;

/**
 * @member {Date} updated_at
 */
WorkflowRun1.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
WorkflowRun1.prototype['url'] = undefined;

/**
 * @member {Number} workflow_id
 */
WorkflowRun1.prototype['workflow_id'] = undefined;

/**
 * @member {String} workflow_url
 */
WorkflowRun1.prototype['workflow_url'] = undefined;
