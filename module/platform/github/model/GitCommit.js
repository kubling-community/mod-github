...
class GitCommit {
    ...
    constructor(sha, nodeId, url, author, committer, message, tree, parents, verification, htmlUrl) { 
        ...
        GitCommit.initialize(this, sha, nodeId, url, author, committer, message, tree, parents, verification, htmlUrl);
    }
...
GitCommit.RequiredProperties = ["sha", "node_id", "url", "author", "committer", "message", "tree", "parents", "verification", "html_url"];
