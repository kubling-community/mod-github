...
/**
 * The WebhooksTeam model module.
 * @module model/WebhooksTeam
 * @version 1.1.4
 */
class WebhooksTeam {
    /**
     * Constructs a new <code>WebhooksTeam</code>.
     * Groups of organization members that gives permissions on specified repositories.
     * @alias module:model/WebhooksTeam
     * @param id {Number} Unique identifier of the team
     * @param name {String} Name of the team
     */
    constructor(id, name) { 
        
        WebhooksTeam.initialize(this, id, name);
    }
    ...
    /**
     * Constructs a <code>WebhooksTeam</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhooksTeam} obj Optional instance to populate.
     * @return {module:model/WebhooksTeam} The populated <code>WebhooksTeam</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhooksTeam();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhooksTeam</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhooksTeam</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhooksTeam.RequiredProperties) {
...
WebhooksTeam.RequiredProperties = ["id", "name"];

/**
 * @member {Boolean} deleted
 */
WebhooksTeam.prototype['deleted'] = undefined;

/**
 * Description of the team
 * @member {String} description
 */
WebhooksTeam.prototype['description'] = undefined;

/**
 * @member {String} html_url
 */
WebhooksTeam.prototype['html_url'] = undefined;

/**
 * Unique identifier of the team
 * @member {Number} id
 */
WebhooksTeam.prototype['id'] = undefined;

/**
 * @member {String} members_url
 */
WebhooksTeam.prototype['members_url'] = undefined;

/**
 * Name of the team
 * @member {String} name
 */
WebhooksTeam.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
WebhooksTeam.prototype['node_id'] = undefined;

/**
 * @member {module:model/WebhooksTeamParent} parent
 */
WebhooksTeam.prototype['parent'] = undefined;

/**
 * Permission that the team will have for its repositories
 * @member {String} permission
 */
WebhooksTeam.prototype['permission'] = undefined;

/**
 * @member {module:model/WebhooksTeam.PrivacyEnum} privacy
 */
WebhooksTeam.prototype['privacy'] = undefined;

/**
 * @member {module:model/WebhooksTeam.NotificationSettingEnum} notification_setting
 */
WebhooksTeam.prototype['notification_setting'] = undefined;

/**
 * @member {String} repositories_url
 */
WebhooksTeam.prototype['repositories_url'] = undefined;

/**
 * @member {String} slug
 */
WebhooksTeam.prototype['slug'] = undefined;

/**
 * URL for the team
 * @member {String} url
 */
WebhooksTeam.prototype['url'] = undefined;
 ...
 * @readonly
 */
WebhooksTeam['NotificationSettingEnum'] = {
