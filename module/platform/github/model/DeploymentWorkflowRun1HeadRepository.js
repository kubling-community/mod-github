...
/**
 * The DeploymentWorkflowRun1HeadRepository model module.
 * @module model/DeploymentWorkflowRun1HeadRepository
 * @version 1.1.4
 */
class DeploymentWorkflowRun1HeadRepository {
    /**
     * Constructs a new <code>DeploymentWorkflowRun1HeadRepository</code>.
     * @alias module:model/DeploymentWorkflowRun1HeadRepository
     */
    constructor() { 
        
        DeploymentWorkflowRun1HeadRepository.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeploymentWorkflowRun1HeadRepository</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeploymentWorkflowRun1HeadRepository} obj Optional instance to populate.
     * @return {module:model/DeploymentWorkflowRun1HeadRepository} The populated <code>DeploymentWorkflowRun1HeadRepository</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeploymentWorkflowRun1HeadRepository();
    ...
    /**
     * Validates the JSON data with respect to <code>DeploymentWorkflowRun1HeadRepository</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeploymentWorkflowRun1HeadRepository</code>.
     */
 ...
 */
DeploymentWorkflowRun1HeadRepository.prototype['archive_url'] = undefined;

/**
 * @member {String} assignees_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['assignees_url'] = undefined;

/**
 * @member {String} blobs_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['blobs_url'] = undefined;

/**
 * @member {String} branches_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['branches_url'] = undefined;

/**
 * @member {String} collaborators_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['collaborators_url'] = undefined;

/**
 * @member {String} comments_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['commits_url'] = undefined;

/**
 * @member {String} compare_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['compare_url'] = undefined;

/**
 * @member {String} contents_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['contents_url'] = undefined;

/**
 * @member {String} contributors_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['contributors_url'] = undefined;

/**
 * @member {String} deployments_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['deployments_url'] = undefined;

/**
 * @member {String} description
 */
DeploymentWorkflowRun1HeadRepository.prototype['description'] = undefined;

/**
 * @member {String} downloads_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['downloads_url'] = undefined;

/**
 * @member {String} events_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['events_url'] = undefined;

/**
 * @member {Boolean} fork
 */
DeploymentWorkflowRun1HeadRepository.prototype['fork'] = undefined;

/**
 * @member {String} forks_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['forks_url'] = undefined;

/**
 * @member {String} full_name
 */
DeploymentWorkflowRun1HeadRepository.prototype['full_name'] = undefined;

/**
 * @member {String} git_commits_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['git_commits_url'] = undefined;

/**
 * @member {String} git_refs_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['git_refs_url'] = undefined;

/**
 * @member {String} git_tags_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['git_tags_url'] = undefined;

/**
 * @member {String} hooks_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['hooks_url'] = undefined;

/**
 * @member {String} html_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
DeploymentWorkflowRun1HeadRepository.prototype['id'] = undefined;

/**
 * @member {String} issue_comment_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['issue_comment_url'] = undefined;

/**
 * @member {String} issue_events_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['issue_events_url'] = undefined;

/**
 * @member {String} issues_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['issues_url'] = undefined;

/**
 * @member {String} keys_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['keys_url'] = undefined;

/**
 * @member {String} labels_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['labels_url'] = undefined;

/**
 * @member {String} languages_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['languages_url'] = undefined;

/**
 * @member {String} merges_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['merges_url'] = undefined;

/**
 * @member {String} milestones_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['milestones_url'] = undefined;

/**
 * @member {String} name
 */
DeploymentWorkflowRun1HeadRepository.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
DeploymentWorkflowRun1HeadRepository.prototype['node_id'] = undefined;

/**
 * @member {String} notifications_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['notifications_url'] = undefined;

/**
 * @member {module:model/WebhooksSponsorshipMaintainer} owner
 */
DeploymentWorkflowRun1HeadRepository.prototype['owner'] = undefined;

/**
 * @member {Boolean} private
 */
DeploymentWorkflowRun1HeadRepository.prototype['private'] = undefined;

/**
 * @member {String} pulls_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['pulls_url'] = undefined;

/**
 * @member {String} releases_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['releases_url'] = undefined;

/**
 * @member {String} stargazers_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['stargazers_url'] = undefined;

/**
 * @member {String} statuses_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['statuses_url'] = undefined;

/**
 * @member {String} subscribers_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['subscribers_url'] = undefined;

/**
 * @member {String} subscription_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['subscription_url'] = undefined;

/**
 * @member {String} tags_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['tags_url'] = undefined;

/**
 * @member {String} teams_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['teams_url'] = undefined;

/**
 * @member {String} trees_url
 */
DeploymentWorkflowRun1HeadRepository.prototype['trees_url'] = undefined;

/**
 * @member {String} url
 */
DeploymentWorkflowRun1HeadRepository.prototype['url'] = undefined;
...
export default DeploymentWorkflowRun1HeadRepository;
