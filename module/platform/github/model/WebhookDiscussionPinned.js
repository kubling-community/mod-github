...
/**
 * The WebhookDiscussionPinned model module.
 * @module model/WebhookDiscussionPinned
 * @version 1.1.4
 */
class WebhookDiscussionPinned {
    /**
     * Constructs a new <code>WebhookDiscussionPinned</code>.
     * @alias module:model/WebhookDiscussionPinned
     * @param action {module:model/WebhookDiscussionPinned.ActionEnum} 
    ...
    constructor(action, discussion, repository, sender) { 
        ...
        WebhookDiscussionPinned.initialize(this, action, discussion, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookDiscussionPinned</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookDiscussionPinned} obj Optional instance to populate.
     * @return {module:model/WebhookDiscussionPinned} The populated <code>WebhookDiscussionPinned</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookDiscussionPinned();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDiscussionPinned</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDiscussionPinned</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookDiscussionPinned.RequiredProperties) {
...
WebhookDiscussionPinned.RequiredProperties = ["action", "discussion", "repository", "sender"];

/**
 * @member {module:model/WebhookDiscussionPinned.ActionEnum} action
 */
WebhookDiscussionPinned.prototype['action'] = undefined;

/**
 * @member {module:model/Discussion} discussion
 */
WebhookDiscussionPinned.prototype['discussion'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookDiscussionPinned.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookDiscussionPinned.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookDiscussionPinned.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookDiscussionPinned.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookDiscussionPinned.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookDiscussionPinned['ActionEnum'] = {
...
export default WebhookDiscussionPinned;
