...
class MovedColumnInProjectIssueEvent {
    ...
    constructor(id, nodeId, url, actor, event, commitId, commitUrl, createdAt, performedViaGithubApp) { 
        ...
        MovedColumnInProjectIssueEvent.initialize(this, id, nodeId, url, actor, event, commitId, commitUrl, createdAt, performedViaGithubApp);
    }
...
MovedColumnInProjectIssueEvent.RequiredProperties = ["id", "node_id", "url", "actor", "event", "commit_id", "commit_url", "created_at", "performed_via_github_app"];
