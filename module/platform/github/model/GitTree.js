...
class GitTree {
     ...
     */
    constructor(sha, url, truncated, tree) { 
        
        GitTree.initialize(this, sha, url, truncated, tree);
    }
     ...
     */
    static initialize(obj, sha, url, truncated, tree) { 
        obj['sha'] = sha;
        obj['url'] = url;
...
GitTree.RequiredProperties = ["sha", "url", "truncated", "tree"];
