...
import WorkflowRun2PullRequestsInner from './WorkflowRun2PullRequestsInner';

/**
 * The WorkflowRun2 model module.
 * @module model/WorkflowRun2
 * @version 1.1.4
 */
class WorkflowRun2 {
    /**
     * Constructs a new <code>WorkflowRun2</code>.
     * @alias module:model/WorkflowRun2
     ...
     * @param conclusion {module:model/WorkflowRun2.ConclusionEnum} 
     ...
     * @param pullRequests {Array.<module:model/WorkflowRun2PullRequestsInner>} 
     ...
     * @param status {module:model/WorkflowRun2.StatusEnum} 
     ...
     */
    constructor(actor, artifactsUrl, cancelUrl, checkSuiteId, checkSuiteNodeId, checkSuiteUrl, conclusion, createdAt, event, headBranch, headCommit, headRepository, headSha, htmlUrl, id, jobsUrl, logsUrl, name, nodeId, path, previousAttemptUrl, pullRequests, repository, rerunUrl, runAttempt, runNumber, runStartedAt, status, triggeringActor, updatedAt, url, workflowId, workflowUrl, displayTitle) { 
        
        WorkflowRun2.initialize(this, actor, artifactsUrl, cancelUrl, checkSuiteId, checkSuiteNodeId, checkSuiteUrl, conclusion, createdAt, event, headBranch, headCommit, headRepository, headSha, htmlUrl, id, jobsUrl, logsUrl, name, nodeId, path, previousAttemptUrl, pullRequests, repository, rerunUrl, runAttempt, runNumber, runStartedAt, status, triggeringActor, updatedAt, url, workflowId, workflowUrl, displayTitle);
    }
    ...
    /**
     * Constructs a <code>WorkflowRun2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WorkflowRun2} obj Optional instance to populate.
     * @return {module:model/WorkflowRun2} The populated <code>WorkflowRun2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkflowRun2();
            ...
            if (data.hasOwnProperty('pull_requests')) {
                obj['pull_requests'] = ApiClient.convertToType(data['pull_requests'], [WorkflowRun2PullRequestsInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WorkflowRun2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorkflowRun2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WorkflowRun2.RequiredProperties) {
        ...
        if (data['pull_requests']) { // data not null
            ...
            for (const item of data['pull_requests']) {
                WorkflowRun2PullRequestsInner.validateJSON(item);
            };
        }
...
WorkflowRun2.RequiredProperties = ["actor", "artifacts_url", "cancel_url", "check_suite_id", "check_suite_node_id", "check_suite_url", "conclusion", "created_at", "event", "head_branch", "head_commit", "head_repository", "head_sha", "html_url", "id", "jobs_url", "logs_url", "name", "node_id", "path", "previous_attempt_url", "pull_requests", "repository", "rerun_url", "run_attempt", "run_number", "run_started_at", "status", "triggering_actor", "updated_at", "url", "workflow_id", "workflow_url", "display_title"];

/**
 * @member {module:model/User} actor
 */
WorkflowRun2.prototype['actor'] = undefined;

/**
 * @member {String} artifacts_url
 */
WorkflowRun2.prototype['artifacts_url'] = undefined;

/**
 * @member {String} cancel_url
 */
WorkflowRun2.prototype['cancel_url'] = undefined;

/**
 * @member {Number} check_suite_id
 */
WorkflowRun2.prototype['check_suite_id'] = undefined;

/**
 * @member {String} check_suite_node_id
 */
WorkflowRun2.prototype['check_suite_node_id'] = undefined;

/**
 * @member {String} check_suite_url
 */
WorkflowRun2.prototype['check_suite_url'] = undefined;

/**
 * @member {module:model/WorkflowRun2.ConclusionEnum} conclusion
 */
WorkflowRun2.prototype['conclusion'] = undefined;

/**
 * @member {Date} created_at
 */
WorkflowRun2.prototype['created_at'] = undefined;

/**
 * @member {String} event
 */
WorkflowRun2.prototype['event'] = undefined;

/**
 * @member {String} head_branch
 */
WorkflowRun2.prototype['head_branch'] = undefined;

/**
 * @member {module:model/SimpleCommit} head_commit
 */
WorkflowRun2.prototype['head_commit'] = undefined;

/**
 * @member {module:model/RepositoryLite} head_repository
 */
WorkflowRun2.prototype['head_repository'] = undefined;

/**
 * @member {String} head_sha
 */
WorkflowRun2.prototype['head_sha'] = undefined;

/**
 * @member {String} html_url
 */
WorkflowRun2.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WorkflowRun2.prototype['id'] = undefined;

/**
 * @member {String} jobs_url
 */
WorkflowRun2.prototype['jobs_url'] = undefined;

/**
 * @member {String} logs_url
 */
WorkflowRun2.prototype['logs_url'] = undefined;

/**
 * @member {String} name
 */
WorkflowRun2.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
WorkflowRun2.prototype['node_id'] = undefined;

/**
 * @member {String} path
 */
WorkflowRun2.prototype['path'] = undefined;

/**
 * @member {String} previous_attempt_url
 */
WorkflowRun2.prototype['previous_attempt_url'] = undefined;

/**
 * @member {Array.<module:model/WorkflowRun2PullRequestsInner>} pull_requests
 */
WorkflowRun2.prototype['pull_requests'] = undefined;

/**
 * @member {Array.<module:model/DeploymentWorkflowRunReferencedWorkflowsInner>} referenced_workflows
 */
WorkflowRun2.prototype['referenced_workflows'] = undefined;

/**
 * @member {module:model/RepositoryLite} repository
 */
WorkflowRun2.prototype['repository'] = undefined;

/**
 * @member {String} rerun_url
 */
WorkflowRun2.prototype['rerun_url'] = undefined;

/**
 * @member {Number} run_attempt
 */
WorkflowRun2.prototype['run_attempt'] = undefined;

/**
 * @member {Number} run_number
 */
WorkflowRun2.prototype['run_number'] = undefined;

/**
 * @member {Date} run_started_at
 */
WorkflowRun2.prototype['run_started_at'] = undefined;

/**
 * @member {module:model/WorkflowRun2.StatusEnum} status
 */
WorkflowRun2.prototype['status'] = undefined;

/**
 * @member {module:model/User} triggering_actor
 */
WorkflowRun2.prototype['triggering_actor'] = undefined;

/**
 * @member {Date} updated_at
 */
WorkflowRun2.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
WorkflowRun2.prototype['url'] = undefined;

/**
 * @member {Number} workflow_id
 */
WorkflowRun2.prototype['workflow_id'] = undefined;

/**
 * @member {String} workflow_url
 */
WorkflowRun2.prototype['workflow_url'] = undefined;

/**
 * @member {String} display_title
 */
WorkflowRun2.prototype['display_title'] = undefined;
