...
/**
 * The NullableCodespaceMachine model module.
 * @module model/NullableCodespaceMachine
 * @version 1.1.4
 */
class NullableCodespaceMachine {
    /**
     * Constructs a new <code>NullableCodespaceMachine</code>.
     * A description of the machine powering a codespace.
     * @alias module:model/NullableCodespaceMachine
     ...
     * @param prebuildAvailability {module:model/NullableCodespaceMachine.PrebuildAvailabilityEnum} Whether a prebuild is currently available when creating a codespace for this machine and repository. If a branch was not specified as a ref, the default branch will be assumed. Value will be \"null\" if prebuilds are not supported or prebuild availability could not be determined. Value will be \"none\" if no prebuild is available. Latest values \"ready\" and \"in_progress\" indicate the prebuild availability status.
     */
    constructor(name, displayName, operatingSystem, storageInBytes, memoryInBytes, cpus, prebuildAvailability) { 
        
        NullableCodespaceMachine.initialize(this, name, displayName, operatingSystem, storageInBytes, memoryInBytes, cpus, prebuildAvailability);
    }
    ...
    /**
     * Constructs a <code>NullableCodespaceMachine</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NullableCodespaceMachine} obj Optional instance to populate.
     * @return {module:model/NullableCodespaceMachine} The populated <code>NullableCodespaceMachine</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NullableCodespaceMachine();
    ...
    /**
     * Validates the JSON data with respect to <code>NullableCodespaceMachine</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NullableCodespaceMachine</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NullableCodespaceMachine.RequiredProperties) {
...
NullableCodespaceMachine.RequiredProperties = ["name", "display_name", "operating_system", "storage_in_bytes", "memory_in_bytes", "cpus", "prebuild_availability"];

/**
 * The name of the machine.
 * @member {String} name
 */
NullableCodespaceMachine.prototype['name'] = undefined;

/**
 * The display name of the machine includes cores, memory, and storage.
 * @member {String} display_name
 */
NullableCodespaceMachine.prototype['display_name'] = undefined;

/**
 * The operating system of the machine.
 * @member {String} operating_system
 */
NullableCodespaceMachine.prototype['operating_system'] = undefined;

/**
 * How much storage is available to the codespace.
 * @member {Number} storage_in_bytes
 */
NullableCodespaceMachine.prototype['storage_in_bytes'] = undefined;

/**
 * How much memory is available to the codespace.
 * @member {Number} memory_in_bytes
 */
NullableCodespaceMachine.prototype['memory_in_bytes'] = undefined;

/**
 * How many cores are available to the codespace.
 * @member {Number} cpus
 */
NullableCodespaceMachine.prototype['cpus'] = undefined;

/**
 * Whether a prebuild is currently available when creating a codespace for this machine and repository. If a branch was not specified as a ref, the default branch will be assumed. Value will be \"null\" if prebuilds are not supported or prebuild availability could not be determined. Value will be \"none\" if no prebuild is available. Latest values \"ready\" and \"in_progress\" indicate the prebuild availability status.
 * @member {module:model/NullableCodespaceMachine.PrebuildAvailabilityEnum} prebuild_availability
 */
NullableCodespaceMachine.prototype['prebuild_availability'] = undefined;
 ...
 * @readonly
 */
NullableCodespaceMachine['PrebuildAvailabilityEnum'] = {
...
export default NullableCodespaceMachine;
