...
/**
 * The Issue1 model module.
 * @module model/Issue1
 * @version 1.1.4
 */
class Issue1 {
    /**
     * Constructs a new <code>Issue1</code>.
     * The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
     * @alias module:model/Issue1
     * @param activeLockReason {module:model/Issue1.ActiveLockReasonEnum} 
     * @param assignees {Array.<module:model/User1>} 
     * @param authorAssociation {module:model/Issue1.AuthorAssociationEnum} How the author is associated with the repository.
    ...
    constructor(activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user) { 
        ...
        Issue1.initialize(this, activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>Issue1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Issue1} obj Optional instance to populate.
     * @return {module:model/Issue1} The populated <code>Issue1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('performed_via_github_app')) {
                obj['performed_via_github_app'] = App11.constructFromObject(data['performed_via_github_app']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Issue1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Issue1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Issue1.RequiredProperties) {
        ...
        if (data['performed_via_github_app']) { // data not null
          App11.validateJSON(data['performed_via_github_app']);
        }
...
Issue1.RequiredProperties = ["active_lock_reason", "assignees", "author_association", "body", "closed_at", "comments", "comments_url", "created_at", "events_url", "html_url", "id", "labels_url", "milestone", "node_id", "number", "reactions", "repository_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/Issue1.ActiveLockReasonEnum} active_lock_reason
 */
Issue1.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User1} assignee
 */
Issue1.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User1>} assignees
 */
Issue1.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/Issue1.AuthorAssociationEnum} author_association
 */
Issue1.prototype['author_association'] = undefined;

/**
 * Contents of the issue
 * @member {String} body
 */
Issue1.prototype['body'] = undefined;

/**
 * @member {Date} closed_at
 */
Issue1.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
Issue1.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
Issue1.prototype['comments_url'] = undefined;

/**
 * @member {Date} created_at
 */
Issue1.prototype['created_at'] = undefined;

/**
 * @member {Boolean} draft
 */
Issue1.prototype['draft'] = undefined;

/**
 * @member {String} events_url
 */
Issue1.prototype['events_url'] = undefined;

/**
 * @member {String} html_url
 */
Issue1.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
Issue1.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label1>} labels
 */
Issue1.prototype['labels'] = undefined;

/**
 * @member {String} labels_url
 */
Issue1.prototype['labels_url'] = undefined;

/**
 * @member {Boolean} locked
 */
Issue1.prototype['locked'] = undefined;

/**
 * @member {module:model/Milestone} milestone
 */
Issue1.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
Issue1.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
Issue1.prototype['number'] = undefined;

/**
 * @member {module:model/App11} performed_via_github_app
 */
Issue1.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/WebhooksIssuePullRequest} pull_request
 */
Issue1.prototype['pull_request'] = undefined;

/**
 * @member {module:model/Reactions} reactions
 */
Issue1.prototype['reactions'] = undefined;

/**
 * @member {String} repository_url
 */
Issue1.prototype['repository_url'] = undefined;

/**
 * State of the issue; either 'open' or 'closed'
 * @member {module:model/Issue1.StateEnum} state
 */
Issue1.prototype['state'] = undefined;

/**
 * @member {String} state_reason
 */
Issue1.prototype['state_reason'] = undefined;

/**
 * @member {String} timeline_url
 */
Issue1.prototype['timeline_url'] = undefined;

/**
 * Title of the issue
 * @member {String} title
 */
Issue1.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
Issue1.prototype['updated_at'] = undefined;

/**
 * URL for the issue
 * @member {String} url
 */
Issue1.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
Issue1.prototype['user'] = undefined;
