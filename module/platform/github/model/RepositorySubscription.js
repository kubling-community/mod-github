...
class RepositorySubscription {
     ...
     */
    constructor(subscribed, ignored, reason, createdAt, url, repositoryUrl) { 
        
        RepositorySubscription.initialize(this, subscribed, ignored, reason, createdAt, url, repositoryUrl);
    }
     ...
     */
    static initialize(obj, subscribed, ignored, reason, createdAt, url, repositoryUrl) { 
...
RepositorySubscription.RequiredProperties = ["subscribed", "ignored", "reason", "created_at", "url", "repository_url"];
