...
/**
 * The Issue9 model module.
 * @module model/Issue9
 * @version 1.1.4
 */
class Issue9 {
    /**
     * Constructs a new <code>Issue9</code>.
     * The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
     * @alias module:model/Issue9
     * @param activeLockReason {module:model/Issue9.ActiveLockReasonEnum} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/Issue9.AuthorAssociationEnum} How the author is associated with the repository.
    ...
    constructor(activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user) { 
        ...
        Issue9.initialize(this, activeLockReason, assignees, authorAssociation, body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>Issue9</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Issue9} obj Optional instance to populate.
     * @return {module:model/Issue9} The populated <code>Issue9</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Issue9</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Issue9</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Issue9.RequiredProperties) {
...
Issue9.RequiredProperties = ["active_lock_reason", "assignees", "author_association", "body", "closed_at", "comments", "comments_url", "created_at", "events_url", "html_url", "id", "labels_url", "milestone", "node_id", "number", "reactions", "repository_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/Issue9.ActiveLockReasonEnum} active_lock_reason
 */
Issue9.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User} assignee
 */
Issue9.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
Issue9.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/Issue9.AuthorAssociationEnum} author_association
 */
Issue9.prototype['author_association'] = undefined;

/**
 * Contents of the issue
 * @member {String} body
 */
Issue9.prototype['body'] = undefined;

/**
 * @member {Date} closed_at
 */
Issue9.prototype['closed_at'] = undefined;

/**
 * @member {Number} comments
 */
Issue9.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
Issue9.prototype['comments_url'] = undefined;

/**
 * @member {Date} created_at
 */
Issue9.prototype['created_at'] = undefined;

/**
 * @member {Boolean} draft
 */
Issue9.prototype['draft'] = undefined;

/**
 * @member {String} events_url
 */
Issue9.prototype['events_url'] = undefined;

/**
 * @member {String} html_url
 */
Issue9.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
Issue9.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
Issue9.prototype['labels'] = undefined;

/**
 * @member {String} labels_url
 */
Issue9.prototype['labels_url'] = undefined;

/**
 * @member {Boolean} locked
 */
Issue9.prototype['locked'] = undefined;

/**
 * @member {module:model/Milestone1} milestone
 */
Issue9.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
Issue9.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
Issue9.prototype['number'] = undefined;

/**
 * @member {module:model/App1} performed_via_github_app
 */
Issue9.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/WebhooksIssuePullRequest} pull_request
 */
Issue9.prototype['pull_request'] = undefined;

/**
 * @member {module:model/Reactions} reactions
 */
Issue9.prototype['reactions'] = undefined;

/**
 * @member {String} repository_url
 */
Issue9.prototype['repository_url'] = undefined;

/**
 * State of the issue; either 'open' or 'closed'
 * @member {module:model/Issue9.StateEnum} state
 */
Issue9.prototype['state'] = undefined;

/**
 * @member {String} state_reason
 */
Issue9.prototype['state_reason'] = undefined;

/**
 * @member {String} timeline_url
 */
Issue9.prototype['timeline_url'] = undefined;

/**
 * Title of the issue
 * @member {String} title
 */
Issue9.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
Issue9.prototype['updated_at'] = undefined;

/**
 * URL for the issue
 * @member {String} url
 */
Issue9.prototype['url'] = undefined;

/**
 * @member {module:model/User} user
 */
Issue9.prototype['user'] = undefined;
