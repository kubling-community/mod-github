...
class CommitCommit {
     ...
     */
    constructor(url, author, committer, message, commentCount, tree) { 
        
        CommitCommit.initialize(this, url, author, committer, message, commentCount, tree);
    }
     ...
     */
    static initialize(obj, url, author, committer, message, commentCount, tree) { 
        obj['url'] = url;
        obj['author'] = author;
...
CommitCommit.RequiredProperties = ["url", "author", "committer", "message", "comment_count", "tree"];
