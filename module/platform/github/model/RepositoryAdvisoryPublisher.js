...
/**
 * The RepositoryAdvisoryPublisher model module.
 * @module model/RepositoryAdvisoryPublisher
 * @version 1.1.4
 */
class RepositoryAdvisoryPublisher {
    /**
     * Constructs a new <code>RepositoryAdvisoryPublisher</code>.
     * The publisher of the advisory.
     * @alias module:model/RepositoryAdvisoryPublisher
     * @implements module:model/SimpleUser
     * @param login {String} 
     * @param id {Number} 
     * @param nodeId {String} 
     ...
     */
    constructor(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl, followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl, organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin) { 
        SimpleUser.initialize(this, login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl, followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl, organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin);
        RepositoryAdvisoryPublisher.initialize(this, login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl, followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl, organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin);
    }
     ...
     */
    static initialize(obj, login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl, followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl, organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin) { 
        obj['login'] = login;
        obj['id'] = id;
        obj['node_id'] = nodeId;
    ...
    /**
     * Constructs a <code>RepositoryAdvisoryPublisher</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryAdvisoryPublisher} obj Optional instance to populate.
     * @return {module:model/RepositoryAdvisoryPublisher} The populated <code>RepositoryAdvisoryPublisher</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryAdvisoryPublisher();
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryAdvisoryPublisher</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryAdvisoryPublisher</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RepositoryAdvisoryPublisher.RequiredProperties) {
...
RepositoryAdvisoryPublisher.RequiredProperties = ["login", "id", "node_id", "avatar_url", "gravatar_id", "url", "html_url", "followers_url", "following_url", "gists_url", "starred_url", "subscriptions_url", "organizations_url", "repos_url", "events_url", "received_events_url", "type", "site_admin"];

/**
 * @member {String} name
 */
RepositoryAdvisoryPublisher.prototype['name'] = undefined;

/**
 * @member {String} email
 */
RepositoryAdvisoryPublisher.prototype['email'] = undefined;

/**
 * @member {String} login
 */
RepositoryAdvisoryPublisher.prototype['login'] = undefined;

/**
 * @member {Number} id
 */
RepositoryAdvisoryPublisher.prototype['id'] = undefined;

/**
 * @member {String} node_id
 */
RepositoryAdvisoryPublisher.prototype['node_id'] = undefined;

/**
 * @member {String} avatar_url
 */
RepositoryAdvisoryPublisher.prototype['avatar_url'] = undefined;

/**
 * @member {String} gravatar_id
 */
RepositoryAdvisoryPublisher.prototype['gravatar_id'] = undefined;

/**
 * @member {String} url
 */
RepositoryAdvisoryPublisher.prototype['url'] = undefined;

/**
 * @member {String} html_url
 */
RepositoryAdvisoryPublisher.prototype['html_url'] = undefined;

/**
 * @member {String} followers_url
 */
RepositoryAdvisoryPublisher.prototype['followers_url'] = undefined;

/**
 * @member {String} following_url
 */
RepositoryAdvisoryPublisher.prototype['following_url'] = undefined;

/**
 * @member {String} gists_url
 */
RepositoryAdvisoryPublisher.prototype['gists_url'] = undefined;

/**
 * @member {String} starred_url
 */
RepositoryAdvisoryPublisher.prototype['starred_url'] = undefined;

/**
 * @member {String} subscriptions_url
 */
RepositoryAdvisoryPublisher.prototype['subscriptions_url'] = undefined;

/**
 * @member {String} organizations_url
 */
RepositoryAdvisoryPublisher.prototype['organizations_url'] = undefined;

/**
 * @member {String} repos_url
 */
RepositoryAdvisoryPublisher.prototype['repos_url'] = undefined;

/**
 * @member {String} events_url
 */
RepositoryAdvisoryPublisher.prototype['events_url'] = undefined;

/**
 * @member {String} received_events_url
 */
RepositoryAdvisoryPublisher.prototype['received_events_url'] = undefined;

/**
 * @member {String} type
 */
RepositoryAdvisoryPublisher.prototype['type'] = undefined;

/**
 * @member {Boolean} site_admin
 */
RepositoryAdvisoryPublisher.prototype['site_admin'] = undefined;

/**
 * @member {String} starred_at
 */
RepositoryAdvisoryPublisher.prototype['starred_at'] = undefined;


// Implement SimpleUser interface:
/**
 * @member {String} name
 */
...
export default RepositoryAdvisoryPublisher;
