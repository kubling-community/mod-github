...
class GitCreateTagRequest {
     ...
     */
    constructor(tag, message, object, type) { 
        
        GitCreateTagRequest.initialize(this, tag, message, object, type);
    }
     ...
     */
    static initialize(obj, tag, message, object, type) { 
        obj['tag'] = tag;
        obj['message'] = message;
        obj['object'] = object;
        obj['type'] = type;
...
GitCreateTagRequest.RequiredProperties = ["tag", "message", "object", "type"];
