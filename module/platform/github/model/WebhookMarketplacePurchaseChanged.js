...
/**
 * The WebhookMarketplacePurchaseChanged model module.
 * @module model/WebhookMarketplacePurchaseChanged
 * @version 1.1.4
 */
class WebhookMarketplacePurchaseChanged {
    /**
     * Constructs a new <code>WebhookMarketplacePurchaseChanged</code>.
     * @alias module:model/WebhookMarketplacePurchaseChanged
     * @param action {module:model/WebhookMarketplacePurchaseChanged.ActionEnum} 
    ...
    constructor(action, effectiveDate, marketplacePurchase, sender) { 
        ...
        WebhookMarketplacePurchaseChanged.initialize(this, action, effectiveDate, marketplacePurchase, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookMarketplacePurchaseChanged</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookMarketplacePurchaseChanged} obj Optional instance to populate.
     * @return {module:model/WebhookMarketplacePurchaseChanged} The populated <code>WebhookMarketplacePurchaseChanged</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookMarketplacePurchaseChanged();
            ...
            if (data.hasOwnProperty('previous_marketplace_purchase')) {
                obj['previous_marketplace_purchase'] = MarketplacePurchase.constructFromObject(data['previous_marketplace_purchase']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookMarketplacePurchaseChanged</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookMarketplacePurchaseChanged</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookMarketplacePurchaseChanged.RequiredProperties) {
        ...
        if (data['previous_marketplace_purchase']) { // data not null
          MarketplacePurchase.validateJSON(data['previous_marketplace_purchase']);
        }
...
WebhookMarketplacePurchaseChanged.RequiredProperties = ["action", "effective_date", "marketplace_purchase", "sender"];

/**
 * @member {module:model/WebhookMarketplacePurchaseChanged.ActionEnum} action
 */
WebhookMarketplacePurchaseChanged.prototype['action'] = undefined;

/**
 * @member {String} effective_date
 */
WebhookMarketplacePurchaseChanged.prototype['effective_date'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookMarketplacePurchaseChanged.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookMarketplacePurchaseChanged.prototype['installation'] = undefined;

/**
 * @member {module:model/WebhooksMarketplacePurchase} marketplace_purchase
 */
WebhookMarketplacePurchaseChanged.prototype['marketplace_purchase'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookMarketplacePurchaseChanged.prototype['organization'] = undefined;

/**
 * @member {module:model/MarketplacePurchase} previous_marketplace_purchase
 */
WebhookMarketplacePurchaseChanged.prototype['previous_marketplace_purchase'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookMarketplacePurchaseChanged.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookMarketplacePurchaseChanged.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookMarketplacePurchaseChanged['ActionEnum'] = {
...
export default WebhookMarketplacePurchaseChanged;
