...
/**
 * The WebhookIssuesDeleted model module.
 * @module model/WebhookIssuesDeleted
 * @version 1.1.4
 */
class WebhookIssuesDeleted {
    /**
     * Constructs a new <code>WebhookIssuesDeleted</code>.
     * @alias module:model/WebhookIssuesDeleted
     * @param action {module:model/WebhookIssuesDeleted.ActionEnum} 
     * @param issue {module:model/Issue} 
    ...
    constructor(action, issue, repository, sender) { 
        ...
        WebhookIssuesDeleted.initialize(this, action, issue, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookIssuesDeleted</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookIssuesDeleted} obj Optional instance to populate.
     * @return {module:model/WebhookIssuesDeleted} The populated <code>WebhookIssuesDeleted</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookIssuesDeleted();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookIssuesDeleted</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookIssuesDeleted</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookIssuesDeleted.RequiredProperties) {
...
WebhookIssuesDeleted.RequiredProperties = ["action", "issue", "repository", "sender"];

/**
 * @member {module:model/WebhookIssuesDeleted.ActionEnum} action
 */
WebhookIssuesDeleted.prototype['action'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookIssuesDeleted.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookIssuesDeleted.prototype['installation'] = undefined;

/**
 * @member {module:model/Issue} issue
 */
WebhookIssuesDeleted.prototype['issue'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookIssuesDeleted.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookIssuesDeleted.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookIssuesDeleted.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookIssuesDeleted['ActionEnum'] = {
...
export default WebhookIssuesDeleted;
