...
/**
 * The WebhookDiscussionLocked model module.
 * @module model/WebhookDiscussionLocked
 * @version 1.1.4
 */
class WebhookDiscussionLocked {
    /**
     * Constructs a new <code>WebhookDiscussionLocked</code>.
     * @alias module:model/WebhookDiscussionLocked
     * @param action {module:model/WebhookDiscussionLocked.ActionEnum} 
    ...
    constructor(action, discussion, repository, sender) { 
        ...
        WebhookDiscussionLocked.initialize(this, action, discussion, repository, sender);
    }
    ...
    /**
     * Constructs a <code>WebhookDiscussionLocked</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookDiscussionLocked} obj Optional instance to populate.
     * @return {module:model/WebhookDiscussionLocked} The populated <code>WebhookDiscussionLocked</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookDiscussionLocked();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDiscussionLocked</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDiscussionLocked</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookDiscussionLocked.RequiredProperties) {
...
WebhookDiscussionLocked.RequiredProperties = ["action", "discussion", "repository", "sender"];

/**
 * @member {module:model/WebhookDiscussionLocked.ActionEnum} action
 */
WebhookDiscussionLocked.prototype['action'] = undefined;

/**
 * @member {module:model/Discussion} discussion
 */
WebhookDiscussionLocked.prototype['discussion'] = undefined;

/**
 * @member {module:model/EnterpriseWebhooks} enterprise
 */
WebhookDiscussionLocked.prototype['enterprise'] = undefined;

/**
 * @member {module:model/SimpleInstallation} installation
 */
WebhookDiscussionLocked.prototype['installation'] = undefined;

/**
 * @member {module:model/OrganizationSimpleWebhooks} organization
 */
WebhookDiscussionLocked.prototype['organization'] = undefined;

/**
 * @member {module:model/RepositoryWebhooks} repository
 */
WebhookDiscussionLocked.prototype['repository'] = undefined;

/**
 * @member {module:model/SimpleUserWebhooks} sender
 */
WebhookDiscussionLocked.prototype['sender'] = undefined;
 ...
 * @readonly
 */
WebhookDiscussionLocked['ActionEnum'] = {
...
export default WebhookDiscussionLocked;
