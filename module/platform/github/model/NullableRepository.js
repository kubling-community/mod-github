...
class NullableRepository {
    ...
    constructor(id, nodeId, name, fullName, license, forks, owner, _private, htmlUrl, description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, downloadsUrl, eventsUrl, forksUrl, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, notificationsUrl, pullsUrl, releasesUrl, sshUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, cloneUrl, mirrorUrl, hooksUrl, svnUrl, homepage, language, forksCount, stargazersCount, watchersCount, size, defaultBranch, openIssuesCount, hasIssues, hasProjects, hasWiki, hasPages, hasDownloads, archived, disabled, pushedAt, createdAt, updatedAt, openIssues, watchers) { 
        ...
        NullableRepository.initialize(this, id, nodeId, name, fullName, license, forks, owner, _private, htmlUrl, description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, deploymentsUrl, downloadsUrl, eventsUrl, forksUrl, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, languagesUrl, mergesUrl, milestonesUrl, notificationsUrl, pullsUrl, releasesUrl, sshUrl, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, tagsUrl, teamsUrl, treesUrl, cloneUrl, mirrorUrl, hooksUrl, svnUrl, homepage, language, forksCount, stargazersCount, watchersCount, size, defaultBranch, openIssuesCount, hasIssues, hasProjects, hasWiki, hasPages, hasDownloads, archived, disabled, pushedAt, createdAt, updatedAt, openIssues, watchers);
    }
 ...
 * @default false
 */
NullableRepository.prototype['has_discussions'] = false;
 ...
 * @default false
 */
NullableRepository.prototype['use_squash_pr_title_as_default'] = false;

/**
 * The default value for a squash merge commit title:  - `PR_TITLE` - default to the pull request's title. - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
 * @member {module:model/NullableRepository.SquashMergeCommitTitleEnum} squash_merge_commit_title
 */
NullableRepository.prototype['squash_merge_commit_title'] = undefined;

/**
 * The default value for a squash merge commit message:  - `PR_BODY` - default to the pull request's body. - `COMMIT_MESSAGES` - default to the branch's commit messages. - `BLANK` - default to a blank commit message.
 * @member {module:model/NullableRepository.SquashMergeCommitMessageEnum} squash_merge_commit_message
 */
NullableRepository.prototype['squash_merge_commit_message'] = undefined;

/**
 * The default value for a merge commit title.  - `PR_TITLE` - default to the pull request's title. - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
 * @member {module:model/NullableRepository.MergeCommitTitleEnum} merge_commit_title
 */
NullableRepository.prototype['merge_commit_title'] = undefined;

/**
 * The default value for a merge commit message.  - `PR_TITLE` - default to the pull request's title. - `PR_BODY` - default to the pull request's body. - `BLANK` - default to a blank commit message.
 * @member {module:model/NullableRepository.MergeCommitMessageEnum} merge_commit_message
 */
NullableRepository.prototype['merge_commit_message'] = undefined;
 ...
 * @default false
 */
NullableRepository.prototype['web_commit_signoff_required'] = false;
 ...
 * @readonly
 */
NullableRepository['SquashMergeCommitTitleEnum'] = {
 ...
 * @readonly
 */
NullableRepository['SquashMergeCommitMessageEnum'] = {
 ...
 * @readonly
 */
NullableRepository['MergeCommitTitleEnum'] = {
 ...
 * @readonly
 */
NullableRepository['MergeCommitMessageEnum'] = {
