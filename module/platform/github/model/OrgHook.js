...
class OrgHook {
     ...
     * @param type {String} 
     */
    constructor(id, url, pingUrl, name, events, active, config, updatedAt, createdAt, type) { 
        
        OrgHook.initialize(this, id, url, pingUrl, name, events, active, config, updatedAt, createdAt, type);
    }
     ...
     */
    static initialize(obj, id, url, pingUrl, name, events, active, config, updatedAt, createdAt, type) { 
        obj['id'] = id;
        obj['url'] = url;
...
OrgHook.RequiredProperties = ["id", "url", "ping_url", "name", "events", "active", "config", "updated_at", "created_at", "type"];
 ...
 */
OrgHook.prototype['deliveries_url'] = undefined;
