...
/**
 * The ConvertedNoteToIssueIssueEvent model module.
 * @module model/ConvertedNoteToIssueIssueEvent
 * @version 1.1.4
 */
class ConvertedNoteToIssueIssueEvent {
    /**
     * Constructs a new <code>ConvertedNoteToIssueIssueEvent</code>.
     * Converted Note to Issue Issue Event
     * @alias module:model/ConvertedNoteToIssueIssueEvent
     * @param id {Number} 
     * @param nodeId {String} 
     * @param url {String} 
    ...
    constructor(id, nodeId, url, actor, event, commitId, commitUrl, createdAt, performedViaGithubApp) { 
        ...
        ConvertedNoteToIssueIssueEvent.initialize(this, id, nodeId, url, actor, event, commitId, commitUrl, createdAt, performedViaGithubApp);
    }
    ...
    /**
     * Constructs a <code>ConvertedNoteToIssueIssueEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConvertedNoteToIssueIssueEvent} obj Optional instance to populate.
     * @return {module:model/ConvertedNoteToIssueIssueEvent} The populated <code>ConvertedNoteToIssueIssueEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConvertedNoteToIssueIssueEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>ConvertedNoteToIssueIssueEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConvertedNoteToIssueIssueEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConvertedNoteToIssueIssueEvent.RequiredProperties) {
...
ConvertedNoteToIssueIssueEvent.RequiredProperties = ["id", "node_id", "url", "actor", "event", "commit_id", "commit_url", "created_at", "performed_via_github_app"];

/**
 * @member {Number} id
 */
ConvertedNoteToIssueIssueEvent.prototype['id'] = undefined;

/**
 * @member {String} node_id
 */
ConvertedNoteToIssueIssueEvent.prototype['node_id'] = undefined;

/**
 * @member {String} url
 */
ConvertedNoteToIssueIssueEvent.prototype['url'] = undefined;

/**
 * @member {module:model/SimpleUser} actor
 */
ConvertedNoteToIssueIssueEvent.prototype['actor'] = undefined;

/**
 * @member {String} event
 */
ConvertedNoteToIssueIssueEvent.prototype['event'] = undefined;

/**
 * @member {String} commit_id
 */
ConvertedNoteToIssueIssueEvent.prototype['commit_id'] = undefined;

/**
 * @member {String} commit_url
 */
ConvertedNoteToIssueIssueEvent.prototype['commit_url'] = undefined;

/**
 * @member {String} created_at
 */
ConvertedNoteToIssueIssueEvent.prototype['created_at'] = undefined;

/**
 * @member {module:model/Integration} performed_via_github_app
 */
ConvertedNoteToIssueIssueEvent.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/AddedToProjectIssueEventProjectCard} project_card
 */
ConvertedNoteToIssueIssueEvent.prototype['project_card'] = undefined;
...
export default ConvertedNoteToIssueIssueEvent;
