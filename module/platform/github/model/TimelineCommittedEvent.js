...
class TimelineCommittedEvent {
     ...
     */
    constructor(sha, nodeId, url, author, committer, message, tree, parents, verification, htmlUrl) { 
        
        TimelineCommittedEvent.initialize(this, sha, nodeId, url, author, committer, message, tree, parents, verification, htmlUrl);
    }
     ...
     */
    static initialize(obj, sha, nodeId, url, author, committer, message, tree, parents, verification, htmlUrl) { 
        obj['sha'] = sha;
        obj['node_id'] = nodeId;
        obj['url'] = url;
        obj['author'] = author;
...
TimelineCommittedEvent.RequiredProperties = ["sha", "node_id", "url", "author", "committer", "message", "tree", "parents", "verification", "html_url"];
