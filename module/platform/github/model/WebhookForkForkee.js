...
/**
 * The WebhookForkForkee model module.
 * @module model/WebhookForkForkee
 * @version 1.1.4
 */
class WebhookForkForkee {
    /**
     * Constructs a new <code>WebhookForkForkee</code>.
     * The created [&#x60;repository&#x60;](https://docs.github.com/rest/repos/repos#get-a-repository) resource.
     * @alias module:model/WebhookForkForkee
    ...
    constructor(archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl, cloneUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description, downloadsUrl, eventsUrl, fork, forks, forksCount, forksUrl, fullName, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, hasDownloads, hasIssues, hasPages, hasProjects, hasWiki, homepage, hooksUrl, htmlUrl, id, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, language, languagesUrl, license, mergesUrl, milestonesUrl, mirrorUrl, name, nodeId, notificationsUrl, openIssues, openIssuesCount, owner, _private, pullsUrl, pushedAt, releasesUrl, size, sshUrl, stargazersCount, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, svnUrl, tagsUrl, teamsUrl, topics, treesUrl, updatedAt, url, visibility, watchers, watchersCount) { 
        ...
        WebhookForkForkee.initialize(this, archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl, cloneUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description, downloadsUrl, eventsUrl, fork, forks, forksCount, forksUrl, fullName, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, hasDownloads, hasIssues, hasPages, hasProjects, hasWiki, homepage, hooksUrl, htmlUrl, id, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, language, languagesUrl, license, mergesUrl, milestonesUrl, mirrorUrl, name, nodeId, notificationsUrl, openIssues, openIssuesCount, owner, _private, pullsUrl, pushedAt, releasesUrl, size, sshUrl, stargazersCount, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, svnUrl, tagsUrl, teamsUrl, topics, treesUrl, updatedAt, url, visibility, watchers, watchersCount);
    }
    ...
    /**
     * Constructs a <code>WebhookForkForkee</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookForkForkee} obj Optional instance to populate.
     * @return {module:model/WebhookForkForkee} The populated <code>WebhookForkForkee</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookForkForkee();
            ...
            if (data.hasOwnProperty('mirror_url')) {
                obj['mirror_url'] = ApiClient.convertToType(data['mirror_url'], Object);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookForkForkee</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookForkForkee</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebhookForkForkee.RequiredProperties) {
 ...
 * @default false
 */
WebhookForkForkee.prototype['allow_auto_merge'] = false;

/**
 * @member {Boolean} allow_forking
 */
WebhookForkForkee.prototype['allow_forking'] = undefined;
 ...
 * @default true
 */
WebhookForkForkee.prototype['allow_merge_commit'] = true;
 ...
 * @default true
 */
WebhookForkForkee.prototype['allow_rebase_merge'] = true;
 ...
 * @default true
 */
WebhookForkForkee.prototype['allow_squash_merge'] = true;

/**
 * @member {Boolean} allow_update_branch
 */
WebhookForkForkee.prototype['allow_update_branch'] = undefined;

/**
 * @member {String} archive_url
 */
WebhookForkForkee.prototype['archive_url'] = undefined;

/**
 * @member {Boolean} archived
 */
WebhookForkForkee.prototype['archived'] = undefined;

/**
 * @member {String} assignees_url
 */
WebhookForkForkee.prototype['assignees_url'] = undefined;

/**
 * @member {String} blobs_url
 */
WebhookForkForkee.prototype['blobs_url'] = undefined;

/**
 * @member {String} branches_url
 */
WebhookForkForkee.prototype['branches_url'] = undefined;

/**
 * @member {String} clone_url
 */
WebhookForkForkee.prototype['clone_url'] = undefined;

/**
 * @member {String} collaborators_url
 */
WebhookForkForkee.prototype['collaborators_url'] = undefined;

/**
 * @member {String} comments_url
 */
WebhookForkForkee.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
WebhookForkForkee.prototype['commits_url'] = undefined;

/**
 * @member {String} compare_url
 */
WebhookForkForkee.prototype['compare_url'] = undefined;

/**
 * @member {String} contents_url
 */
WebhookForkForkee.prototype['contents_url'] = undefined;

/**
 * @member {String} contributors_url
 */
WebhookForkForkee.prototype['contributors_url'] = undefined;

/**
 * @member {String} created_at
 */
WebhookForkForkee.prototype['created_at'] = undefined;

/**
 * @member {String} default_branch
 */
WebhookForkForkee.prototype['default_branch'] = undefined;
 ...
 * @default false
 */
WebhookForkForkee.prototype['delete_branch_on_merge'] = false;

/**
 * @member {String} deployments_url
 */
WebhookForkForkee.prototype['deployments_url'] = undefined;

/**
 * @member {String} description
 */
WebhookForkForkee.prototype['description'] = undefined;

/**
 * @member {Boolean} disabled
 */
WebhookForkForkee.prototype['disabled'] = undefined;

/**
 * @member {String} downloads_url
 */
WebhookForkForkee.prototype['downloads_url'] = undefined;

/**
 * @member {String} events_url
 */
WebhookForkForkee.prototype['events_url'] = undefined;

/**
 * @member {Boolean} fork
 */
WebhookForkForkee.prototype['fork'] = undefined;

/**
 * @member {Number} forks
 */
WebhookForkForkee.prototype['forks'] = undefined;

/**
 * @member {Number} forks_count
 */
WebhookForkForkee.prototype['forks_count'] = undefined;

/**
 * @member {String} forks_url
 */
WebhookForkForkee.prototype['forks_url'] = undefined;

/**
 * @member {String} full_name
 */
WebhookForkForkee.prototype['full_name'] = undefined;

/**
 * @member {String} git_commits_url
 */
WebhookForkForkee.prototype['git_commits_url'] = undefined;

/**
 * @member {String} git_refs_url
 */
WebhookForkForkee.prototype['git_refs_url'] = undefined;

/**
 * @member {String} git_tags_url
 */
WebhookForkForkee.prototype['git_tags_url'] = undefined;

/**
 * @member {String} git_url
 */
WebhookForkForkee.prototype['git_url'] = undefined;

/**
 * @member {Boolean} has_downloads
 */
WebhookForkForkee.prototype['has_downloads'] = undefined;

/**
 * @member {Boolean} has_issues
 */
WebhookForkForkee.prototype['has_issues'] = undefined;

/**
 * @member {Boolean} has_pages
 */
WebhookForkForkee.prototype['has_pages'] = undefined;

/**
 * @member {Boolean} has_projects
 */
WebhookForkForkee.prototype['has_projects'] = undefined;

/**
 * @member {Boolean} has_wiki
 */
WebhookForkForkee.prototype['has_wiki'] = undefined;

/**
 * @member {String} homepage
 */
WebhookForkForkee.prototype['homepage'] = undefined;

/**
 * @member {String} hooks_url
 */
WebhookForkForkee.prototype['hooks_url'] = undefined;

/**
 * @member {String} html_url
 */
WebhookForkForkee.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
WebhookForkForkee.prototype['id'] = undefined;

/**
 * @member {Boolean} is_template
 */
WebhookForkForkee.prototype['is_template'] = undefined;

/**
 * @member {String} issue_comment_url
 */
WebhookForkForkee.prototype['issue_comment_url'] = undefined;

/**
 * @member {String} issue_events_url
 */
WebhookForkForkee.prototype['issue_events_url'] = undefined;

/**
 * @member {String} issues_url
 */
WebhookForkForkee.prototype['issues_url'] = undefined;

/**
 * @member {String} keys_url
 */
WebhookForkForkee.prototype['keys_url'] = undefined;

/**
 * @member {String} labels_url
 */
WebhookForkForkee.prototype['labels_url'] = undefined;

/**
 * @member {Object} language
 */
WebhookForkForkee.prototype['language'] = undefined;

/**
 * @member {String} languages_url
 */
WebhookForkForkee.prototype['languages_url'] = undefined;

/**
 * @member {Object} license
 */
WebhookForkForkee.prototype['license'] = undefined;

/**
 * @member {String} master_branch
 */
WebhookForkForkee.prototype['master_branch'] = undefined;

/**
 * @member {String} merges_url
 */
WebhookForkForkee.prototype['merges_url'] = undefined;

/**
 * @member {String} milestones_url
 */
WebhookForkForkee.prototype['milestones_url'] = undefined;

/**
 * @member {Object} mirror_url
 */
WebhookForkForkee.prototype['mirror_url'] = undefined;

/**
 * @member {String} name
 */
WebhookForkForkee.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
WebhookForkForkee.prototype['node_id'] = undefined;

/**
 * @member {String} notifications_url
 */
WebhookForkForkee.prototype['notifications_url'] = undefined;

/**
 * @member {Number} open_issues
 */
WebhookForkForkee.prototype['open_issues'] = undefined;

/**
 * @member {Number} open_issues_count
 */
WebhookForkForkee.prototype['open_issues_count'] = undefined;

/**
 * @member {String} organization
 */
WebhookForkForkee.prototype['organization'] = undefined;

/**
 * @member {module:model/WebhooksSponsorshipMaintainer} owner
 */
WebhookForkForkee.prototype['owner'] = undefined;

/**
 * @member {module:model/RepositoryPermissions} permissions
 */
WebhookForkForkee.prototype['permissions'] = undefined;

/**
 * @member {Boolean} private
 */
WebhookForkForkee.prototype['private'] = undefined;

/**
 * @member {Boolean} public
 */
WebhookForkForkee.prototype['public'] = undefined;

/**
 * @member {String} pulls_url
 */
WebhookForkForkee.prototype['pulls_url'] = undefined;

/**
 * @member {String} pushed_at
 */
WebhookForkForkee.prototype['pushed_at'] = undefined;

/**
 * @member {String} releases_url
 */
WebhookForkForkee.prototype['releases_url'] = undefined;

/**
 * @member {String} role_name
 */
WebhookForkForkee.prototype['role_name'] = undefined;

/**
 * @member {Number} size
 */
WebhookForkForkee.prototype['size'] = undefined;

/**
 * @member {String} ssh_url
 */
WebhookForkForkee.prototype['ssh_url'] = undefined;

/**
 * @member {Number} stargazers
 */
WebhookForkForkee.prototype['stargazers'] = undefined;

/**
 * @member {Number} stargazers_count
 */
WebhookForkForkee.prototype['stargazers_count'] = undefined;

/**
 * @member {String} stargazers_url
 */
WebhookForkForkee.prototype['stargazers_url'] = undefined;

/**
 * @member {String} statuses_url
 */
WebhookForkForkee.prototype['statuses_url'] = undefined;

/**
 * @member {String} subscribers_url
 */
WebhookForkForkee.prototype['subscribers_url'] = undefined;

/**
 * @member {String} subscription_url
 */
WebhookForkForkee.prototype['subscription_url'] = undefined;

/**
 * @member {String} svn_url
 */
WebhookForkForkee.prototype['svn_url'] = undefined;

/**
 * @member {String} tags_url
 */
WebhookForkForkee.prototype['tags_url'] = undefined;

/**
 * @member {String} teams_url
 */
WebhookForkForkee.prototype['teams_url'] = undefined;

/**
 * @member {Array.<Object>} topics
 */
WebhookForkForkee.prototype['topics'] = undefined;

/**
 * @member {String} trees_url
 */
WebhookForkForkee.prototype['trees_url'] = undefined;

/**
 * @member {String} updated_at
 */
WebhookForkForkee.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
WebhookForkForkee.prototype['url'] = undefined;

/**
 * @member {String} visibility
 */
WebhookForkForkee.prototype['visibility'] = undefined;

/**
 * @member {Number} watchers
 */
WebhookForkForkee.prototype['watchers'] = undefined;

/**
 * @member {Number} watchers_count
 */
WebhookForkForkee.prototype['watchers_count'] = undefined;

/**
 * Whether to require contributors to sign off on web-based commits
 * @member {Boolean} web_commit_signoff_required
 */
WebhookForkForkee.prototype['web_commit_signoff_required'] = undefined;
...
export default WebhookForkForkee;
