...
/**
 * The CodespacesCreateWithRepoForAuthenticatedUserRequest model module.
 * @module model/CodespacesCreateWithRepoForAuthenticatedUserRequest
 * @version 1.1.4
 */
class CodespacesCreateWithRepoForAuthenticatedUserRequest {
    /**
     * Constructs a new <code>CodespacesCreateWithRepoForAuthenticatedUserRequest</code>.
     * @alias module:model/CodespacesCreateWithRepoForAuthenticatedUserRequest
     */
    constructor() { 
        
        CodespacesCreateWithRepoForAuthenticatedUserRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CodespacesCreateWithRepoForAuthenticatedUserRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CodespacesCreateWithRepoForAuthenticatedUserRequest} obj Optional instance to populate.
     * @return {module:model/CodespacesCreateWithRepoForAuthenticatedUserRequest} The populated <code>CodespacesCreateWithRepoForAuthenticatedUserRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CodespacesCreateWithRepoForAuthenticatedUserRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CodespacesCreateWithRepoForAuthenticatedUserRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CodespacesCreateWithRepoForAuthenticatedUserRequest</code>.
     */
 ...
 * @member {String} ref
 */
CodespacesCreateWithRepoForAuthenticatedUserRequest.prototype['ref'] = undefined;

/**
 * The requested location for a new codespace. Best efforts are made to respect this upon creation. Assigned by IP if not provided.
 * @member {String} location
 */
CodespacesCreateWithRepoForAuthenticatedUserRequest.prototype['location'] = undefined;

/**
 * The geographic area for this codespace. If not specified, the value is assigned by IP. This property replaces `location`, which is being deprecated.
 * @member {module:model/CodespacesCreateWithRepoForAuthenticatedUserRequest.GeoEnum} geo
 */
CodespacesCreateWithRepoForAuthenticatedUserRequest.prototype['geo'] = undefined;

/**
 * IP for location auto-detection when proxying a request
 * @member {String} client_ip
 */
CodespacesCreateWithRepoForAuthenticatedUserRequest.prototype['client_ip'] = undefined;

/**
 * Machine type to use for this codespace
 * @member {String} machine
 */
CodespacesCreateWithRepoForAuthenticatedUserRequest.prototype['machine'] = undefined;

/**
 * Path to devcontainer.json config to use for this codespace
 * @member {String} devcontainer_path
 */
CodespacesCreateWithRepoForAuthenticatedUserRequest.prototype['devcontainer_path'] = undefined;

/**
 * Whether to authorize requested permissions from devcontainer.json
 * @member {Boolean} multi_repo_permissions_opt_out
 */
CodespacesCreateWithRepoForAuthenticatedUserRequest.prototype['multi_repo_permissions_opt_out'] = undefined;

/**
 * Working directory for this codespace
 * @member {String} working_directory
 */
CodespacesCreateWithRepoForAuthenticatedUserRequest.prototype['working_directory'] = undefined;

/**
 * Time in minutes before codespace stops from inactivity
 * @member {Number} idle_timeout_minutes
 */
CodespacesCreateWithRepoForAuthenticatedUserRequest.prototype['idle_timeout_minutes'] = undefined;

/**
 * Display name for this codespace
 * @member {String} display_name
 */
CodespacesCreateWithRepoForAuthenticatedUserRequest.prototype['display_name'] = undefined;

/**
 * Duration in minutes after codespace has gone idle in which it will be deleted. Must be integer minutes between 0 and 43200 (30 days).
 * @member {Number} retention_period_minutes
 */
CodespacesCreateWithRepoForAuthenticatedUserRequest.prototype['retention_period_minutes'] = undefined;
 ...
 * @readonly
 */
CodespacesCreateWithRepoForAuthenticatedUserRequest['GeoEnum'] = {
...
export default CodespacesCreateWithRepoForAuthenticatedUserRequest;
