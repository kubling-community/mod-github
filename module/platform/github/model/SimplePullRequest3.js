...
import SimplePullRequest3Head from './SimplePullRequest3Head';
...
/**
 * The SimplePullRequest3 model module.
 * @module model/SimplePullRequest3
 * @version 1.1.4
 */
class SimplePullRequest3 {
    /**
     * Constructs a new <code>SimplePullRequest3</code>.
     * @alias module:model/SimplePullRequest3
     * @param links {module:model/WebhooksPullRequest5Links} 
     * @param activeLockReason {module:model/SimplePullRequest3.ActiveLockReasonEnum} 
     * @param assignee {module:model/User} 
     * @param assignees {Array.<module:model/User>} 
     * @param authorAssociation {module:model/SimplePullRequest3.AuthorAssociationEnum} How the author is associated with the repository.
     ...
     * @param draft {Boolean} 
     * @param head {module:model/SimplePullRequest3Head} 
     ...
     * @param state {module:model/SimplePullRequest3.StateEnum} 
    ...
    constructor(links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
        ...
        SimplePullRequest3.initialize(this, links, activeLockReason, assignee, assignees, authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>SimplePullRequest3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimplePullRequest3} obj Optional instance to populate.
     * @return {module:model/SimplePullRequest3} The populated <code>SimplePullRequest3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimplePullRequest3();
            ...
            if (data.hasOwnProperty('head')) {
                obj['head'] = SimplePullRequest3Head.constructFromObject(data['head']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SimplePullRequest3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimplePullRequest3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SimplePullRequest3.RequiredProperties) {
        ...
        if (data['head']) { // data not null
          SimplePullRequest3Head.validateJSON(data['head']);
        }
        // ensure the json data is a string
...
SimplePullRequest3.RequiredProperties = ["_links", "active_lock_reason", "assignee", "assignees", "author_association", "auto_merge", "base", "body", "closed_at", "comments_url", "commits_url", "created_at", "diff_url", "draft", "head", "html_url", "id", "issue_url", "labels", "locked", "merge_commit_sha", "merged_at", "milestone", "node_id", "number", "patch_url", "requested_reviewers", "requested_teams", "review_comment_url", "review_comments_url", "state", "statuses_url", "title", "updated_at", "url", "user"];

/**
 * @member {module:model/WebhooksPullRequest5Links} _links
 */
SimplePullRequest3.prototype['_links'] = undefined;

/**
 * @member {module:model/SimplePullRequest3.ActiveLockReasonEnum} active_lock_reason
 */
SimplePullRequest3.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/User} assignee
 */
SimplePullRequest3.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/User>} assignees
 */
SimplePullRequest3.prototype['assignees'] = undefined;

/**
 * How the author is associated with the repository.
 * @member {module:model/SimplePullRequest3.AuthorAssociationEnum} author_association
 */
SimplePullRequest3.prototype['author_association'] = undefined;

/**
 * @member {module:model/PullRequestAutoMerge} auto_merge
 */
SimplePullRequest3.prototype['auto_merge'] = undefined;

/**
 * @member {module:model/SimplePullRequest3Base} base
 */
SimplePullRequest3.prototype['base'] = undefined;

/**
 * @member {String} body
 */
SimplePullRequest3.prototype['body'] = undefined;

/**
 * @member {String} closed_at
 */
SimplePullRequest3.prototype['closed_at'] = undefined;

/**
 * @member {String} comments_url
 */
SimplePullRequest3.prototype['comments_url'] = undefined;

/**
 * @member {String} commits_url
 */
SimplePullRequest3.prototype['commits_url'] = undefined;

/**
 * @member {String} created_at
 */
SimplePullRequest3.prototype['created_at'] = undefined;

/**
 * @member {String} diff_url
 */
SimplePullRequest3.prototype['diff_url'] = undefined;

/**
 * @member {Boolean} draft
 */
SimplePullRequest3.prototype['draft'] = undefined;

/**
 * @member {module:model/SimplePullRequest3Head} head
 */
SimplePullRequest3.prototype['head'] = undefined;

/**
 * @member {String} html_url
 */
SimplePullRequest3.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
SimplePullRequest3.prototype['id'] = undefined;

/**
 * @member {String} issue_url
 */
SimplePullRequest3.prototype['issue_url'] = undefined;

/**
 * @member {Array.<module:model/Label>} labels
 */
SimplePullRequest3.prototype['labels'] = undefined;

/**
 * @member {Boolean} locked
 */
SimplePullRequest3.prototype['locked'] = undefined;

/**
 * @member {String} merge_commit_sha
 */
SimplePullRequest3.prototype['merge_commit_sha'] = undefined;

/**
 * @member {String} merged_at
 */
SimplePullRequest3.prototype['merged_at'] = undefined;

/**
 * @member {module:model/Milestone1} milestone
 */
SimplePullRequest3.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
SimplePullRequest3.prototype['node_id'] = undefined;

/**
 * @member {Number} number
 */
SimplePullRequest3.prototype['number'] = undefined;

/**
 * @member {String} patch_url
 */
SimplePullRequest3.prototype['patch_url'] = undefined;

/**
 * @member {Array.<module:model/PullRequestRequestedReviewersInner>} requested_reviewers
 */
SimplePullRequest3.prototype['requested_reviewers'] = undefined;

/**
 * @member {Array.<module:model/Team>} requested_teams
 */
SimplePullRequest3.prototype['requested_teams'] = undefined;

/**
 * @member {String} review_comment_url
 */
SimplePullRequest3.prototype['review_comment_url'] = undefined;

/**
 * @member {String} review_comments_url
 */
SimplePullRequest3.prototype['review_comments_url'] = undefined;

/**
 * @member {module:model/SimplePullRequest3.StateEnum} state
 */
SimplePullRequest3.prototype['state'] = undefined;

/**
 * @member {String} statuses_url
 */
SimplePullRequest3.prototype['statuses_url'] = undefined;

/**
 * @member {String} title
 */
SimplePullRequest3.prototype['title'] = undefined;

/**
 * @member {String} updated_at
 */
SimplePullRequest3.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
SimplePullRequest3.prototype['url'] = undefined;

/**
 * @member {module:model/User1} user
 */
SimplePullRequest3.prototype['user'] = undefined;
 ...
 * @readonly
 */
SimplePullRequest3['ActiveLockReasonEnum'] = {
 ...
 * @readonly
 */
SimplePullRequest3['AuthorAssociationEnum'] = {
...
export default SimplePullRequest3;
