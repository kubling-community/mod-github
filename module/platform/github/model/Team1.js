...
class Team1 {
     ...
     * @param privacy {module:model/Team1.PrivacyEnum} 
    ...
    constructor(description, htmlUrl, id, membersUrl, name, nodeId, permission, privacy, repositoriesUrl, slug, url) { 
        ...
        Team1.initialize(this, description, htmlUrl, id, membersUrl, name, nodeId, permission, privacy, repositoriesUrl, slug, url);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Team1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Team1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Team1.RequiredProperties) {
...
Team1.RequiredProperties = ["description", "html_url", "id", "members_url", "name", "node_id", "permission", "privacy", "repositories_url", "slug", "url"];

/**
 * @member {Boolean} deleted
 */
Team1.prototype['deleted'] = undefined;

/**
 * Description of the team
 * @member {String} description
 */
Team1.prototype['description'] = undefined;

/**
 * @member {String} html_url
 */
Team1.prototype['html_url'] = undefined;

/**
 * Unique identifier of the team
 * @member {Number} id
 */
Team1.prototype['id'] = undefined;

/**
 * @member {String} members_url
 */
Team1.prototype['members_url'] = undefined;

/**
 * Name of the team
 * @member {String} name
 */
Team1.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
Team1.prototype['node_id'] = undefined;

/**
 * @member {module:model/TeamParent} parent
 */
Team1.prototype['parent'] = undefined;

/**
 * Permission that the team will have for its repositories
 * @member {String} permission
 */
Team1.prototype['permission'] = undefined;

/**
 * @member {module:model/Team1.PrivacyEnum} privacy
 */
Team1.prototype['privacy'] = undefined;

/**
 * @member {String} repositories_url
 */
Team1.prototype['repositories_url'] = undefined;

/**
 * @member {String} slug
 */
Team1.prototype['slug'] = undefined;

/**
 * URL for the team
 * @member {String} url
 */
Team1.prototype['url'] = undefined;
