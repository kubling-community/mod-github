    ...
    */
    ...
    codeScanningDeleteAnalysis(owner, repo, analysisId, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'owner': owner,'repo': repo,'analysis_id': analysisId},
        // queryParams
    ...
    codeScanningGetAlert(owner, repo, alertNumber, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'owner': owner,'repo': repo,'alert_number': alertNumber},
        // queryParams
        {},
        // headerParams
        {},
    ...
    codeScanningGetSarif(owner, repo, sarifId, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'owner': owner,'repo': repo,'sarif_id': sarifId},
        // queryParams
        {},
        // headerParams
        {},
    ...
    codeScanningGetVariantAnalysis(owner, repo, codeqlVariantAnalysisId, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'owner': owner,'repo': repo,'codeql_variant_analysis_id': codeqlVariantAnalysisId},
        // queryParams
        {},
        // headerParams
        {},
    ...
    codeScanningGetVariantAnalysisRepoTask(owner, repo, codeqlVariantAnalysisId, repoOwner, repoName, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'owner': owner,'repo': repo,'codeql_variant_analysis_id': codeqlVariantAnalysisId,'repo_owner': repoOwner,'repo_name': repoName},
        // queryParams
        {},
        // headerParams
        {},
    ...
    codeScanningListAlertInstances(owner, repo, alertNumber, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {'owner': owner,'repo': repo,'alert_number': alertNumber},
        // queryParams
        {'page': opts['page'],'per_page': opts['perPage'],'ref': opts['ref']},
        // headerParams
        {},
        // formParams
        {},
    ...
    codeScanningListAlertsForOrg(org, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {'org': org},
        // queryParams
        {'tool_name': opts['toolName'],'tool_guid': opts['toolGuid'],'before': opts['before'],'after': opts['after'],'page': opts['page'],'per_page': opts['perPage'],'direction': opts['direction'],'state': opts['state'],'sort': opts['sort'],'severity': opts['severity']},
        // headerParams
        {},
        // formParams
        {},
    ...
    codeScanningListAlertsForRepo(owner, repo, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {'owner': owner,'repo': repo},
        // queryParams
        {'tool_name': opts['toolName'],'tool_guid': opts['toolGuid'],'page': opts['page'],'per_page': opts['perPage'],'ref': opts['ref'],'direction': opts['direction'],'sort': opts['sort'],'state': opts['state'],'severity': opts['severity']},
        // headerParams
        {},
        // formParams
        {},
    ...
    codeScanningListRecentAnalyses(owner, repo, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {'owner': owner,'repo': repo},
        // queryParams
        {'tool_name': opts['toolName'],'tool_guid': opts['toolGuid'],'page': opts['page'],'per_page': opts['perPage'],'ref': opts['ref'],'sarif_id': opts['sarifId'],'direction': opts['direction'],'sort': opts['sort']},
        // headerParams
        {},
        // formParams
        {},
