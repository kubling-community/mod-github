    ...
    */
    ...
    pullsCreateReplyForReviewComment(owner, repo, pullNumber, commentId, pullsCreateReplyForReviewCommentRequest, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'owner': owner,'repo': repo,'pull_number': pullNumber,'comment_id': commentId},
        // queryParams
        {},
        // headerParams
        {},
    ...
    pullsDeletePendingReview(owner, repo, pullNumber, reviewId, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'owner': owner,'repo': repo,'pull_number': pullNumber,'review_id': reviewId},
        // queryParams
        {},
        // headerParams
        {},
    ...
    pullsList(owner, repo, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {'owner': owner,'repo': repo},
        // queryParams
        {'state': opts['state'],'head': opts['head'],'base': opts['base'],'sort': opts['sort'],'direction': opts['direction'],'per_page': opts['perPage'],'page': opts['page']},
        // headerParams
        {},
        // formParams
        {},
    ...
    pullsRequestReviewers(owner, repo, pullNumber, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {},
        // bodyParam
        opts['pullsRequestReviewersRequest'],
        // authNames
        [],
        // contentTypes
        ['application/json'],
