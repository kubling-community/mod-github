    ...
    */
    ...
    reactionsCreateForTeamDiscussionCommentInOrg(org, teamSlug, discussionNumber, commentNumber, reactionsCreateForTeamDiscussionCommentInOrgRequest, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'org': org,'team_slug': teamSlug,'discussion_number': discussionNumber,'comment_number': commentNumber},
        // queryParams
        {},
        // headerParams
        {},
    ...
    reactionsCreateForTeamDiscussionCommentLegacy(teamId, discussionNumber, commentNumber, reactionsCreateForTeamDiscussionCommentInOrgRequest, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'team_id': teamId,'discussion_number': discussionNumber,'comment_number': commentNumber},
        // queryParams
        {},
        // headerParams
        {},
    ...
    reactionsCreateForTeamDiscussionInOrg(org, teamSlug, discussionNumber, reactionsCreateForTeamDiscussionInOrgRequest, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'org': org,'team_slug': teamSlug,'discussion_number': discussionNumber},
        // queryParams
        {},
        // headerParams
        {},
    ...
    reactionsCreateForTeamDiscussionLegacy(teamId, discussionNumber, reactionsCreateForTeamDiscussionInOrgRequest, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'team_id': teamId,'discussion_number': discussionNumber},
        // queryParams
        {},
        // headerParams
        {},
    ...
    reactionsDeleteForCommitComment(owner, repo, commentId, reactionId, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'owner': owner,'repo': repo,'comment_id': commentId,'reaction_id': reactionId},
        // queryParams
        {},
        // headerParams
        {},
    ...
    reactionsDeleteForIssue(owner, repo, issueNumber, reactionId, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'owner': owner,'repo': repo,'issue_number': issueNumber,'reaction_id': reactionId},
        // queryParams
        {},
        // headerParams
        {},
    ...
    reactionsDeleteForRelease(owner, repo, releaseId, reactionId, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'owner': owner,'repo': repo,'release_id': releaseId,'reaction_id': reactionId},
        // queryParams
        {},
        // headerParams
        {},
    ...
    reactionsDeleteForTeamDiscussion(org, teamSlug, discussionNumber, reactionId, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'org': org,'team_slug': teamSlug,'discussion_number': discussionNumber,'reaction_id': reactionId},
        // queryParams
        {},
        // headerParams
        {},
    ...
    reactionsDeleteForTeamDiscussionComment(org, teamSlug, discussionNumber, commentNumber, reactionId, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'org': org,'team_slug': teamSlug,'discussion_number': discussionNumber,'comment_number': commentNumber,'reaction_id': reactionId},
        // queryParams
        {},
        // headerParams
        {},
     ...
     * @param {module:model/String} [content] Returns a single [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a commit comment.
    ...
    reactionsListForCommitComment(owner, repo, commentId, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {'owner': owner,'repo': repo,'comment_id': commentId},
        // queryParams
        {'content': opts['content'],'per_page': opts['perPage'],'page': opts['page']},
        // headerParams
        {},
        // formParams
        {},
     ...
     * @param {Number} issueNumber The number that identifies the issue.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [content] Returns a single [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to an issue.
     * @param {Number} [perPage = 30)] The number of results per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     * @param {Number} [page = 1)] The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     ...
     * @param {Number} commentId The unique identifier of the comment.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [content] Returns a single [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to an issue comment.
     * @param {Number} [perPage = 30)] The number of results per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     * @param {Number} [page = 1)] The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     ...
     * @param {Number} commentId The unique identifier of the comment.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [content] Returns a single [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a pull request review comment.
     * @param {Number} [perPage = 30)] The number of results per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     * @param {Number} [page = 1)] The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     ...
     * @param {Number} releaseId The unique identifier of the release.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [content] Returns a single [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a release.
     * @param {Number} [perPage = 30)] The number of results per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     * @param {Number} [page = 1)] The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     ...
     * @param {Number} commentNumber The number that identifies the comment.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [content] Returns a single [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a team discussion comment.
     * @param {Number} [perPage = 30)] The number of results per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     * @param {Number} [page = 1)] The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     ...
     * @param {Number} discussionNumber The number that identifies the discussion.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [content] Returns a single [reaction type](https://docs.github.com/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a team discussion.
     * @param {Number} [perPage = 30)] The number of results per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     * @param {Number} [page = 1)] The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
