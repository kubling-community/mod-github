    ...
    */
    ...
    checksGet(owner, repo, checkRunId, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'owner': owner,'repo': repo,'check_run_id': checkRunId},
        // queryParams
        {},
        // headerParams
        {},
    ...
    checksGetSuite(owner, repo, checkSuiteId, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'owner': owner,'repo': repo,'check_suite_id': checkSuiteId},
        // queryParams
        {},
        // headerParams
        {},
    ...
    checksListForRef(owner, repo, ref, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // queryParams
        {'check_name': opts['checkName'],'status': opts['status'],'filter': opts['filter'],'per_page': opts['perPage'],'page': opts['page'],'app_id': opts['appId']},
        // headerParams
        {},
        // formParams
        {},
    ...
    checksListForSuite(owner, repo, checkSuiteId, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {'owner': owner,'repo': repo,'check_suite_id': checkSuiteId},
        // queryParams
        {'check_name': opts['checkName'],'status': opts['status'],'filter': opts['filter'],'per_page': opts['perPage'],'page': opts['page']},
        // headerParams
        {},
        // formParams
        {},
    ...
    checksListSuitesForRef(owner, repo, ref, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {'owner': owner,'repo': repo,'ref': ref},
        // queryParams
        {'app_id': opts['appId'],'check_name': opts['checkName'],'per_page': opts['perPage'],'page': opts['page']},
        // headerParams
        {},
        // formParams
        {},
    ...
    /**
     * Callback function to receive the result of the checksRerequestRun operation.
     * @callback module:api/ChecksApi~checksRerequestRunCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} repo The name of the repository without the `.git` extension. The name is not case sensitive.
     * @param {Number} checkRunId The unique identifier of the check run.
     * @param {module:api/ChecksApi~checksRerequestRunCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    checksRerequestRun(owner, repo, checkRunId, callback) {
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling checksRerequestRun");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling checksRerequestRun");
      }
      // verify the required parameter 'checkRunId' is set
      if (checkRunId === undefined || checkRunId === null) {
        throw new Error("Missing the required parameter 'checkRunId' when calling checksRerequestRun");
      }
      return this.apiClient.callApi(
