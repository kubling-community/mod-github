    ...
    */
    ...
    dependabotListAlertsForEnterprise(enterprise, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // queryParams
        {'state': opts['state'],'severity': opts['severity'],'ecosystem': opts['ecosystem'],'package': opts['_package'],'scope': opts['scope'],'sort': opts['sort'],'direction': opts['direction'],'before': opts['before'],'after': opts['after'],'first': opts['first'],'last': opts['last'],'per_page': opts['perPage']},
        // headerParams
        {},
        // formParams
        {},
    ...
    dependabotListAlertsForRepo(owner, repo, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {'owner': owner,'repo': repo},
        // queryParams
        {'state': opts['state'],'severity': opts['severity'],'ecosystem': opts['ecosystem'],'package': opts['_package'],'manifest': opts['manifest'],'scope': opts['scope'],'sort': opts['sort'],'direction': opts['direction'],'page': opts['page'],'per_page': opts['perPage'],'before': opts['before'],'after': opts['after'],'first': opts['first'],'last': opts['last']},
        // headerParams
        {},
        // formParams
        {},
