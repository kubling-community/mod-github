    ...
    */
    ...
    securityAdvisoriesCreateFork(owner, repo, ghsaId, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // pathParams
        {'owner': owner,'repo': repo,'ghsa_id': ghsaId},
        // queryParams
        {},
        // headerParams
        {},
    ...
    securityAdvisoriesListGlobalAdvisories(opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {},
        // queryParams
        {'ghsa_id': opts['ghsaId'],'type': opts['type'],'cve_id': opts['cveId'],'ecosystem': opts['ecosystem'],'severity': opts['severity'],'cwes': opts['cwes'],'is_withdrawn': opts['isWithdrawn'],'affects': opts['affects'],'published': opts['published'],'updated': opts['updated'],'modified': opts['modified'],'before': opts['before'],'after': opts['after'],'direction': opts['direction'],'per_page': opts['perPage'],'sort': opts['sort']},
        // headerParams
        {},
        // formParams
        {},
    ...
    securityAdvisoriesListOrgRepositoryAdvisories(org, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {'org': org},
        // queryParams
        {'direction': opts['direction'],'sort': opts['sort'],'before': opts['before'],'after': opts['after'],'per_page': opts['perPage'],'state': opts['state']},
        // headerParams
        {},
        // formParams
        {},
