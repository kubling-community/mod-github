    ...
    */
    ...
    secretScanningListAlertsForEnterprise(enterprise, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        // queryParams
        {'state': opts['state'],'secret_type': opts['secretType'],'resolution': opts['resolution'],'sort': opts['sort'],'direction': opts['direction'],'per_page': opts['perPage'],'before': opts['before'],'after': opts['after'],'validity': opts['validity']},
        // headerParams
        {},
        // formParams
        {},
    ...
    secretScanningListAlertsForOrg(org, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {'org': org},
        // queryParams
        {'state': opts['state'],'secret_type': opts['secretType'],'resolution': opts['resolution'],'sort': opts['sort'],'direction': opts['direction'],'page': opts['page'],'per_page': opts['perPage'],'before': opts['before'],'after': opts['after'],'validity': opts['validity']},
        // headerParams
        {},
        // formParams
        {},
