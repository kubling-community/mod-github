...
export default class SearchApi {
    ...
    */
     ...
     * @param {module:model/String} [sort] **This field is deprecated.** Sorts the results of your query. Can only be `indexed`, which indicates how recently a file has been indexed by the GitHub search infrastructure. Default: [best match](https://docs.github.com/rest/search/search#ranking-search-results)
     * @param {module:model/String} [order = 'desc')] **This field is deprecated.** Determines whether the first search result returned is the highest number of matches (`desc`) or lowest number of matches (`asc`). This parameter is ignored unless you provide `sort`. 
    ...
    searchCode(q, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {},
        // queryParams
        {'q': q,'sort': opts['sort'],'order': opts['order'],'per_page': opts['perPage'],'page': opts['page']},
        // headerParams
        {},
        // formParams
        {},
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [sort] Sorts the results of your query by `author-date` or `committer-date`. Default: [best match](https://docs.github.com/rest/search/search#ranking-search-results)
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [sort] Sorts the results of your query by when the label was `created` or `updated`. Default: [best match](https://docs.github.com/rest/search/search#ranking-search-results)
     * @param {module:model/String} [order = 'desc')] Determines whether the first search result returned is the highest number of matches (`desc`) or lowest number of matches (`asc`). This parameter is ignored unless you provide `sort`.
     * @param {Number} [perPage = 30)] The number of results per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     * @param {Number} [page = 1)] The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
    ...
    searchLabels(repositoryId, q, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {},
        // queryParams
        {'repository_id': repositoryId,'q': q,'sort': opts['sort'],'order': opts['order'],'per_page': opts['perPage'],'page': opts['page']},
        // headerParams
        {},
        // formParams
        {},
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [sort] Sorts the results of your query by number of `stars`, `forks`, or `help-wanted-issues` or how recently the items were `updated`. Default: [best match](https://docs.github.com/rest/search/search#ranking-search-results)
     * @param {module:model/String} [order = 'desc')] Determines whether the first search result returned is the highest number of matches (`desc`) or lowest number of matches (`asc`). This parameter is ignored unless you provide `sort`.
     * @param {Number} [perPage = 30)] The number of results per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     * @param {Number} [page = 1)] The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
    ...
    searchTopics(q, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {},
        // queryParams
        {'q': q,'per_page': opts['perPage'],'page': opts['page']},
        // headerParams
        {},
        // formParams
        {},
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [sort] Sorts the results of your query by number of `followers` or `repositories`, or when the person `joined` GitHub. Default: [best match](https://docs.github.com/rest/search/search#ranking-search-results)
     * @param {module:model/String} [order = 'desc')] Determines whether the first search result returned is the highest number of matches (`desc`) or lowest number of matches (`asc`). This parameter is ignored unless you provide `sort`.
     * @param {Number} [perPage = 30)] The number of results per page (max 100). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     * @param {Number} [page = 1)] The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
