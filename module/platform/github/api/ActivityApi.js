...
export default class ActivityApi {
    ...
    */
     ...
     * @param {Number} [page = 1)] The page number of the results to fetch. For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
     * @param {Number} [perPage = 50)] The number of results per page (max 50). For more information, see \"[Using pagination in the REST API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the-rest-api).\"
    ...
    activityListNotificationsForAuthenticatedUser(opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {},
        // queryParams
        {'all': opts['all'],'participating': opts['participating'],'since': opts['since'],'before': opts['before'],'page': opts['page'],'per_page': opts['perPage']},
        // headerParams
        {},
        // formParams
        {},
    ...
    activityListRepoNotificationsForAuthenticatedUser(owner, repo, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {'owner': owner,'repo': repo},
        // queryParams
        {'all': opts['all'],'participating': opts['participating'],'since': opts['since'],'before': opts['before'],'per_page': opts['perPage'],'page': opts['page']},
        // headerParams
        {},
        // formParams
        {},
    ...
    activityMarkNotificationsAsRead(opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {},
        // bodyParam
        opts['activityMarkNotificationsAsReadRequest'],
        // authNames
        [],
        // contentTypes
        ['application/json'],
    ...
    activityMarkRepoNotificationsAsRead(owner, repo, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {},
        // bodyParam
        opts['activityMarkRepoNotificationsAsReadRequest'],
        // authNames
        [],
        // contentTypes
        ['application/json'],
    ...
    /**
     * Callback function to receive the result of the activityMarkThreadAsDone operation.
     * @callback module:api/ActivityApi~activityMarkThreadAsDoneCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} threadId The unique identifier of the notification thread. This corresponds to the value returned in the `id` field when you retrieve notifications (for example with the [`GET /notifications` operation](https://docs.github.com/rest/activity/notifications#list-notifications-for-the-authenticated-user)).
     * @param {module:api/ActivityApi~activityMarkThreadAsDoneCallback} callback The callback function, accepting three arguments: error, data, response
     */
    activityMarkThreadAsDone(threadId, callback) {
      // verify the required parameter 'threadId' is set
      if (threadId === undefined || threadId === null) {
        throw new Error("Missing the required parameter 'threadId' when calling activityMarkThreadAsDone");
      }
      return this.apiClient.callApi(
        '/notifications/threads/{thread_id}', 'DELETE',
        // pathParams
        {'thread_id': threadId},
        // queryParams
        {},
    ...
    activitySetRepoSubscription(owner, repo, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {},
        // bodyParam
        opts['activitySetRepoSubscriptionRequest'],
        // authNames
        [],
        // contentTypes
        ['application/json'],
    ...
    activitySetThreadSubscription(threadId, opts, callback) {
      ...
      return this.apiClient.callApi(
        ...
        {},
        // bodyParam
        opts['activitySetThreadSubscriptionRequest'],
        // authNames
        [],
        // contentTypes
        ['application/json'],
